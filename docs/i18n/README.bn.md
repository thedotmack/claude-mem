...
<p align="center">
  Magic-Claude-Mem স্বয়ংক্রিয়ভাবে টুল ব্যবহারের পর্যবেক্ষণ ক্যাপচার করে, সিমান্টিক সারসংক্ষেপ তৈরি করে এবং সেগুলি ভবিষ্যতের সেশনে উপলব্ধ করে সেশন জুড়ে প্রসঙ্গ নির্বিঘ্নে সংরক্ষণ করে। এটি Claude কে সেশন শেষ হওয়ার বা পুনঃসংযোগের পরেও প্রকল্প সম্পর্কে জ্ঞানের ধারাবাহিকতা বজায় রাখতে সক্ষম করে।
</p>
...
- **[ইনস্টলেশন গাইড](https://docs.magic-claude-mem.ai/installation)** - দ্রুত শুরু এবং উন্নত ইনস্টলেশন
- **[ব্যবহার গাইড](https://docs.magic-claude-mem.ai/usage/getting-started)** - Magic-Claude-Mem কীভাবে স্বয়ংক্রিয়ভাবে কাজ করে
- **[অনুসন্ধান টুল](https://docs.magic-claude-mem.ai/usage/search-tools)** - প্রাকৃতিক ভাষা দিয়ে আপনার প্রকল্পের ইতিহাস অনুসন্ধান করুন

### সর্বোত্তম অনুশীলন

- **[প্রসঙ্গ ইঞ্জিনিয়ারিং](https://docs.magic-claude-mem.ai/context-engineering)** - AI এজেন্ট প্রসঙ্গ অপটিমাইজেশন নীতি
- **[প্রগতিশীল প্রকাশ](https://docs.magic-claude-mem.ai/progressive-disclosure)** - Magic-Claude-Mem-এর প্রসঙ্গ প্রাইমিং কৌশলের পিছনে দর্শন

### আর্কিটেকচার

- **[সারসংক্ষেপ](https://docs.magic-claude-mem.ai/architecture/overview)** - সিস্টেম উপাদান এবং ডেটা ফ্লো
- **[আর্কিটেকচার বিবর্তন](https://docs.magic-claude-mem.ai/architecture-evolution)** - v3 থেকে v5 পর্যন্ত যাত্রা
- **[হুকস আর্কিটেকচার](https://docs.magic-claude-mem.ai/hooks-architecture)** - Magic-Claude-Mem কীভাবে লাইফসাইকেল হুক ব্যবহার করে
- **[হুকস রেফারেন্স](https://docs.magic-claude-mem.ai/architecture/hooks)** - ৭টি হুক স্ক্রিপ্ট ব্যাখ্যা করা হয়েছে
- **[ওয়ার্কার সার্ভিস](https://docs.magic-claude-mem.ai/architecture/worker-service)** - HTTP API এবং Node.js ম্যানেজমেন্ট
- **[ডাটাবেস](https://docs.magic-claude-mem.ai/architecture/database)** - SQLite স্কিমা এবং FTS5 অনুসন্ধান
- **[অনুসন্ধান আর্কিটেকচার](https://docs.magic-claude-mem.ai/architecture/search-architecture)** - Chroma ভেক্টর ডাটাবেস সহ হাইব্রিড অনুসন্ধান

### কনফিগারেশন এবং ডেভেলপমেন্ট

- **[কনফিগারেশন](https://docs.magic-claude-mem.ai/configuration)** - পরিবেশ ভেরিয়েবল এবং সেটিংস
- **[ডেভেলপমেন্ট](https://docs.magic-claude-mem.ai/development)** - বিল্ডিং, টেস্টিং, অবদান
- **[সমস্যা সমাধান](https://docs.magic-claude-mem.ai/troubleshooting)** - সাধারণ সমস্যা এবং সমাধান
...
3. **ওয়ার্কার সার্ভিস** - ওয়েব ভিউয়ার UI এবং ১০টি অনুসন্ধান এন্ডপয়েন্ট সহ পোর্ট 37777-এ HTTP API, Node.js দ্বারা পরিচালিত
...
বিস্তারিত জানতে [আর্কিটেকচার সারসংক্ষেপ](https://docs.magic-claude-mem.ai/architecture/overview) দেখুন।

---

## অনুসন্ধান টুল

Magic-Claude-Mem, mem-search skill-এর মাধ্যমে বুদ্ধিমান অনুসন্ধান প্রদান করে যা আপনি পূর্ববর্তী কাজ সম্পর্কে জিজ্ঞাসা করলে স্বয়ংক্রিয়ভাবে চালু হয়:
...
বিস্তারিত উদাহরণের জন্য [অনুসন্ধান টুল গাইড](https://docs.magic-claude-mem.ai/usage/search-tools) দেখুন।
...
সেটিংস `~/.magic-claude-mem/settings.json`-এ পরিচালিত হয় (প্রথম রানে ডিফল্ট সহ স্বয়ংক্রিয়ভাবে তৈরি হয়)। AI মডেল, ওয়ার্কার পোর্ট, ডেটা ডিরেক্টরি, লগ লেভেল এবং প্রসঙ্গ ইনজেকশন সেটিংস কনফিগার করুন।

সমস্ত উপলব্ধ সেটিংস এবং উদাহরণের জন্য **[কনফিগারেশন গাইড](https://docs.magic-claude-mem.ai/configuration)** দেখুন।

---

## ডেভেলপমেন্ট

বিল্ড নির্দেশাবলী, টেস্টিং এবং অবদান ওয়ার্কফ্লোর জন্য **[ডেভেলপমেন্ট গাইড](https://docs.magic-claude-mem.ai/development)** দেখুন।
...
সাধারণ সমস্যা এবং সমাধানের জন্য **[সমস্যা সমাধান গাইড](https://docs.magic-claude-mem.ai/troubleshooting)** দেখুন।
...
অবদান ওয়ার্কফ্লোর জন্য [ডেভেলপমেন্ট গাইড](https://docs.magic-claude-mem.ai/development) দেখুন।
