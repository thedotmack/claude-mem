...
<p align="center">
  Magic-Claude-Mem bewahrt nahtlos Kontext über Sitzungen hinweg, indem es automatisch Beobachtungen zur Tool-Nutzung erfasst, semantische Zusammenfassungen generiert und diese für zukünftige Sitzungen verfügbar macht. Dies ermöglicht es Claude, die Kontinuität des Wissens über Projekte aufrechtzuerhalten, auch nachdem Sitzungen beendet wurden oder die Verbindung wiederhergestellt wird.
</p>
...
- **[Installationsanleitung](https://docs.magic-claude-mem.ai/installation)** - Schnellstart & erweiterte Installation
- **[Nutzungsanleitung](https://docs.magic-claude-mem.ai/usage/getting-started)** - Wie Magic-Claude-Mem automatisch funktioniert
- **[Suchwerkzeuge](https://docs.magic-claude-mem.ai/usage/search-tools)** - Durchsuchen Sie Ihre Projekthistorie mit natürlicher Sprache

### Best Practices

- **[Context Engineering](https://docs.magic-claude-mem.ai/context-engineering)** - Prinzipien der Kontextoptimierung für KI-Agenten
- **[Progressive Disclosure](https://docs.magic-claude-mem.ai/progressive-disclosure)** - Philosophie hinter Magic-Claude-Mems Kontext-Priming-Strategie

### Architektur

- **[Übersicht](https://docs.magic-claude-mem.ai/architecture/overview)** - Systemkomponenten & Datenfluss
- **[Architekturentwicklung](https://docs.magic-claude-mem.ai/architecture-evolution)** - Die Reise von v3 zu v5
- **[Hooks-Architektur](https://docs.magic-claude-mem.ai/hooks-architecture)** - Wie Magic-Claude-Mem Lifecycle-Hooks verwendet
- **[Hooks-Referenz](https://docs.magic-claude-mem.ai/architecture/hooks)** - 7 Hook-Skripte erklärt
- **[Worker Service](https://docs.magic-claude-mem.ai/architecture/worker-service)** - HTTP API & Node.js-Verwaltung
- **[Datenbank](https://docs.magic-claude-mem.ai/architecture/database)** - SQLite-Schema & FTS5-Suche
- **[Such-Architektur](https://docs.magic-claude-mem.ai/architecture/search-architecture)** - Hybride Suche mit Chroma-Vektordatenbank

### Konfiguration & Entwicklung

- **[Konfiguration](https://docs.magic-claude-mem.ai/configuration)** - Umgebungsvariablen & Einstellungen
- **[Entwicklung](https://docs.magic-claude-mem.ai/development)** - Erstellen, Testen, Beitragen
- **[Fehlerbehebung](https://docs.magic-claude-mem.ai/troubleshooting)** - Häufige Probleme & Lösungen
...
Siehe [Architekturübersicht](https://docs.magic-claude-mem.ai/architecture/overview) für Details.

---

## mem-search Skill

Magic-Claude-Mem bietet intelligente Suche durch den mem-search Skill, der sich automatisch aktiviert, wenn Sie nach früheren Arbeiten fragen:
...
Siehe [Suchwerkzeuge-Anleitung](https://docs.magic-claude-mem.ai/usage/search-tools) für detaillierte Beispiele.
...
Einstellungen werden in `~/.magic-claude-mem/settings.json` verwaltet (wird beim ersten Start automatisch mit Standardwerten erstellt). Konfigurieren Sie KI-Modell, Worker-Port, Datenverzeichnis, Log-Level und Kontext-Injektionseinstellungen.

Siehe die **[Konfigurationsanleitung](https://docs.magic-claude-mem.ai/configuration)** für alle verfügbaren Einstellungen und Beispiele.

---

## Entwicklung

Siehe die **[Entwicklungsanleitung](https://docs.magic-claude-mem.ai/development)** für Build-Anweisungen, Tests und Beitrags-Workflow.
...
Siehe die **[Fehlerbehebungsanleitung](https://docs.magic-claude-mem.ai/troubleshooting)** für häufige Probleme und Lösungen.
...
Siehe [Entwicklungsanleitung](https://docs.magic-claude-mem.ai/development) für den Beitrags-Workflow.
...
Copyright (C) 2026 Frederic Thomas (fthomas@apache.org). Alle Rechte vorbehalten.
