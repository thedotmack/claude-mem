...
- **[Guida all'Installazione](https://docs.magic-claude-mem.ai/installation)** - Avvio rapido e installazione avanzata
- **[Guida all'Uso](https://docs.magic-claude-mem.ai/usage/getting-started)** - Come funziona automaticamente Magic-Claude-Mem
- **[Strumenti di Ricerca](https://docs.magic-claude-mem.ai/usage/search-tools)** - Interroga la cronologia del progetto con linguaggio naturale

### Best Practice

- **[Context Engineering](https://docs.magic-claude-mem.ai/context-engineering)** - Principi di ottimizzazione del contesto per agenti AI
- **[Progressive Disclosure](https://docs.magic-claude-mem.ai/progressive-disclosure)** - Filosofia alla base della strategia di priming del contesto di Magic-Claude-Mem

### Architettura

- **[Panoramica](https://docs.magic-claude-mem.ai/architecture/overview)** - Componenti del sistema e flusso dei dati
- **[Evoluzione dell'Architettura](https://docs.magic-claude-mem.ai/architecture-evolution)** - Il percorso dalla v3 alla v5
- **[Architettura degli Hook](https://docs.magic-claude-mem.ai/hooks-architecture)** - Come Magic-Claude-Mem utilizza gli hook del ciclo di vita
- **[Riferimento Hook](https://docs.magic-claude-mem.ai/architecture/hooks)** - Spiegazione dei 7 script hook
- **[Servizio Worker](https://docs.magic-claude-mem.ai/architecture/worker-service)** - API HTTP e gestione Node.js
- **[Database](https://docs.magic-claude-mem.ai/architecture/database)** - Schema SQLite e ricerca FTS5
- **[Architettura di Ricerca](https://docs.magic-claude-mem.ai/architecture/search-architecture)** - Ricerca ibrida con database vettoriale Chroma

### Configurazione e Sviluppo

- **[Configurazione](https://docs.magic-claude-mem.ai/configuration)** - Variabili d'ambiente e impostazioni
- **[Sviluppo](https://docs.magic-claude-mem.ai/development)** - Build, test e flusso di contribuzione
- **[Risoluzione dei Problemi](https://docs.magic-claude-mem.ai/troubleshooting)** - Problemi comuni e soluzioni
...
Vedi [Panoramica dell'Architettura](https://docs.magic-claude-mem.ai/architecture/overview) per i dettagli.

---

## Skill mem-search

Magic-Claude-Mem fornisce una ricerca intelligente tramite la skill mem-search che si attiva automaticamente quando chiedi del lavoro passato:
...
Vedi [Guida agli Strumenti di Ricerca](https://docs.magic-claude-mem.ai/usage/search-tools) per esempi dettagliati.
...
Le impostazioni sono gestite in `~/.magic-claude-mem/settings.json` (creato automaticamente con valori predefiniti alla prima esecuzione). Configura il modello AI, la porta del worker, la directory dei dati, il livello di log e le impostazioni di iniezione del contesto.

Vedi la **[Guida alla Configurazione](https://docs.magic-claude-mem.ai/configuration)** per tutte le impostazioni disponibili ed esempi.

---

## Sviluppo

Vedi la **[Guida allo Sviluppo](https://docs.magic-claude-mem.ai/development)** per le istruzioni di build, test e flusso di contribuzione.
...
Vedi la **[Guida alla Risoluzione dei Problemi](https://docs.magic-claude-mem.ai/troubleshooting)** per problemi comuni e soluzioni.
...
Vedi [Guida allo Sviluppo](https://docs.magic-claude-mem.ai/development) per il flusso di contribuzione.
...
Copyright (C) 2026 Frederic Thomas (fthomas@apache.org). Tutti i diritti riservati.
...
- **Problemi**: [GitHub Issues](https://github.com/doublefx/magic-claude-mem/issues)
- **Repository**: [github.com/doublefx/magic-claude-mem](https://github.com/doublefx/magic-claude-mem)
- **Autore**: Frederic Thomas ([fthomas@apache.org](https://github.com/doublefx))
