...
<p align="center">
  Magic-Claude-Memは、ツール使用の観察を自動的にキャプチャし、セマンティックサマリーを生成して将来のセッションで利用可能にすることで、セッション間のコンテキストをシームレスに保持します。これにより、Claudeはセッションが終了または再接続された後でも、プロジェクトに関する知識の連続性を維持できます。
</p>
...
- **[インストールガイド](https://docs.magic-claude-mem.ai/installation)** - クイックスタートと高度なインストール
- **[使用ガイド](https://docs.magic-claude-mem.ai/usage/getting-started)** - Magic-Claude-Memが自動的に動作する仕組み
- **[検索ツール](https://docs.magic-claude-mem.ai/usage/search-tools)** - 自然言語でプロジェクト履歴をクエリ

### ベストプラクティス

- **[コンテキストエンジニアリング](https://docs.magic-claude-mem.ai/context-engineering)** - AIエージェントのコンテキスト最適化原則
- **[プログレッシブディスクロージャー](https://docs.magic-claude-mem.ai/progressive-disclosure)** - Magic-Claude-Memのコンテキストプライミング戦略の背後にある哲学

### アーキテクチャ

- **[概要](https://docs.magic-claude-mem.ai/architecture/overview)** - システムコンポーネントとデータフロー
- **[アーキテクチャの進化](https://docs.magic-claude-mem.ai/architecture-evolution)** - v3からv5への道のり
- **[フックアーキテクチャ](https://docs.magic-claude-mem.ai/hooks-architecture)** - Magic-Claude-Memがライフサイクルフックを使用する方法
- **[フックリファレンス](https://docs.magic-claude-mem.ai/architecture/hooks)** - 7つのフックスクリプトの説明
- **[ワーカーサービス](https://docs.magic-claude-mem.ai/architecture/worker-service)** - HTTP APIとNode.js管理
- **[データベース](https://docs.magic-claude-mem.ai/architecture/database)** - SQLiteスキーマとFTS5検索
- **[検索アーキテクチャ](https://docs.magic-claude-mem.ai/architecture/search-architecture)** - Chromaベクトルデータベースを使用したハイブリッド検索

### 設定と開発

- **[設定](https://docs.magic-claude-mem.ai/configuration)** - 環境変数と設定
- **[開発](https://docs.magic-claude-mem.ai/development)** - ビルド、テスト、コントリビューション
- **[トラブルシューティング](https://docs.magic-claude-mem.ai/troubleshooting)** - よくある問題と解決策
...
詳細は[アーキテクチャ概要](https://docs.magic-claude-mem.ai/architecture/overview)を参照してください。

---

## mem-searchスキル

Magic-Claude-Memは、過去の作業について尋ねると自動的に呼び出されるmem-searchスキルを通じてインテリジェント検索を提供します:
...
詳細な例は[検索ツールガイド](https://docs.magic-claude-mem.ai/usage/search-tools)を参照してください。
...
設定は`~/.magic-claude-mem/settings.json`で管理されます(初回実行時にデフォルト値で自動作成)。AIモデル、ワーカーポート、データディレクトリ、ログレベル、コンテキスト注入設定を構成します。

利用可能なすべての設定と例については、**[設定ガイド](https://docs.magic-claude-mem.ai/configuration)**を参照してください。

---

## 開発

ビルド手順、テスト、コントリビューションワークフローについては、**[開発ガイド](https://docs.magic-claude-mem.ai/development)**を参照してください。
...
よくある問題と解決策については、**[トラブルシューティングガイド](https://docs.magic-claude-mem.ai/troubleshooting)**を参照してください。
...
コントリビューションワークフローについては[開発ガイド](https://docs.magic-claude-mem.ai/development)を参照してください。
...
- **リポジトリ**: [github.com/doublefx/magic-claude-mem](https://github.com/doublefx/magic-claude-mem)
- **作者**: Frederic Thomas ([fthomas@apache.org](https://github.com/doublefx))
