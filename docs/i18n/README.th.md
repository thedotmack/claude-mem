...
<p align="center">
  Magic-Claude-Mem รักษาบริบทข้ามเซสชันได้อย่างราบรื่นโดยการบันทึกผลการสังเกตจากการใช้เครื่องมือโดยอัตโนมัติ สร้างสรุปความหมาย และทำให้พร้อมใช้งานสำหรับเซสชันในอนาคต ทำให้ Claude สามารถรักษาความต่อเนื่องของความรู้เกี่ยวกับโปรเจกต์แม้หลังจากเซสชันสิ้นสุดหรือเชื่อมต่อใหม่
</p>
...
- **[คู่มือการติดตั้ง](https://docs.magic-claude-mem.ai/installation)** - เริ่มต้นอย่างรวดเร็วและการติดตั้งขั้นสูง
- **[คู่มือการใช้งาน](https://docs.magic-claude-mem.ai/usage/getting-started)** - วิธีที่ Magic-Claude-Mem ทำงานโดยอัตโนมัติ
- **[เครื่องมือค้นหา](https://docs.magic-claude-mem.ai/usage/search-tools)** - สืบค้นประวัติโปรเจกต์ของคุณด้วยภาษาธรรมชาติ

### แนวปฏิบัติที่ดี

- **[Context Engineering](https://docs.magic-claude-mem.ai/context-engineering)** - หลักการปรับบริบทสำหรับเอเจนต์ AI
- **[Progressive Disclosure](https://docs.magic-claude-mem.ai/progressive-disclosure)** - ปรัชญาเบื้องหลังกลยุทธ์การเตรียมบริบทของ Magic-Claude-Mem

### สถาปัตยกรรม

- **[ภาพรวม](https://docs.magic-claude-mem.ai/architecture/overview)** - ส่วนประกอบของระบบและการไหลของข้อมูล
- **[วิวัฒนาการของสถาปัตยกรรม](https://docs.magic-claude-mem.ai/architecture-evolution)** - การเดินทางจาก v3 สู่ v5
- **[สถาปัตยกรรม Hooks](https://docs.magic-claude-mem.ai/hooks-architecture)** - วิธีที่ Magic-Claude-Mem ใช้ lifecycle hooks
- **[การอ้างอิง Hooks](https://docs.magic-claude-mem.ai/architecture/hooks)** - อธิบาย hook scripts ทั้ง 7 ตัว
- **[Worker Service](https://docs.magic-claude-mem.ai/architecture/worker-service)** - HTTP API และการจัดการ Node.js
- **[ฐานข้อมูล](https://docs.magic-claude-mem.ai/architecture/database)** - SQLite schema และการค้นหา FTS5
- **[สถาปัตยกรรมการค้นหา](https://docs.magic-claude-mem.ai/architecture/search-architecture)** - การค้นหาแบบไฮบริดด้วยฐานข้อมูลเวกเตอร์ Chroma

### การกำหนดค่าและการพัฒนา

- **[การกำหนดค่า](https://docs.magic-claude-mem.ai/configuration)** - ตัวแปรสภาพแวดล้อมและการตั้งค่า
- **[การพัฒนา](https://docs.magic-claude-mem.ai/development)** - การสร้าง การทดสอบ การมีส่วนร่วม
- **[การแก้ไขปัญหา](https://docs.magic-claude-mem.ai/troubleshooting)** - ปัญหาและการแก้ไขทั่วไป
...
ดู [ภาพรวมสถาปัตยกรรม](https://docs.magic-claude-mem.ai/architecture/overview) สำหรับรายละเอียด

---

## ทักษะ mem-search

Magic-Claude-Mem ให้บริการการค้นหาอัจฉริยะผ่านทักษะ mem-search ที่เรียกใช้อัตโนมัติเมื่อคุณถามเกี่ยวกับงานที่ผ่านมา:
...
ดู [คู่มือเครื่องมือค้นหา](https://docs.magic-claude-mem.ai/usage/search-tools) สำหรับตัวอย่างโดยละเอียด
...
การตั้งค่าจะถูกจัดการใน `~/.magic-claude-mem/settings.json` (สร้างอัตโนมัติพร้อมค่าเริ่มต้นในการรันครั้งแรก) กำหนดค่าโมเดล AI พอร์ต worker ไดเรกทอรีข้อมูล ระดับ log และการตั้งค่าการฉีดบริบท

ดู **[คู่มือการกำหนดค่า](https://docs.magic-claude-mem.ai/configuration)** สำหรับการตั้งค่าทั้งหมดที่มีและตัวอย่าง

---

## การพัฒนา

ดู **[คู่มือการพัฒนา](https://docs.magic-claude-mem.ai/development)** สำหรับคำแนะนำการสร้าง การทดสอบ และขั้นตอนการมีส่วนร่วม
...
ดู **[คู่มือการแก้ไขปัญหา](https://docs.magic-claude-mem.ai/troubleshooting)** สำหรับปัญหาและการแก้ไขทั่วไป
...
ดู [คู่มือการพัฒนา](https://docs.magic-claude-mem.ai/development) สำหรับขั้นตอนการมีส่วนร่วม
