...
- **[Hướng Dẫn Cài Đặt](https://docs.magic-claude-mem.ai/installation)** - Bắt đầu nhanh & cài đặt nâng cao
- **[Hướng Dẫn Sử Dụng](https://docs.magic-claude-mem.ai/usage/getting-started)** - Cách Magic-Claude-Mem hoạt động tự động
- **[Công Cụ Tìm Kiếm](https://docs.magic-claude-mem.ai/usage/search-tools)** - Truy vấn lịch sử dự án bằng ngôn ngữ tự nhiên

### Thực Hành Tốt Nhất

- **[Kỹ Thuật Ngữ Cảnh](https://docs.magic-claude-mem.ai/context-engineering)** - Các nguyên tắc tối ưu hóa ngữ cảnh cho AI agent
- **[Tiết Lộ Tuần Tự](https://docs.magic-claude-mem.ai/progressive-disclosure)** - Triết lý đằng sau chiến lược chuẩn bị ngữ cảnh của Magic-Claude-Mem

### Kiến Trúc

- **[Tổng Quan](https://docs.magic-claude-mem.ai/architecture/overview)** - Các thành phần hệ thống & luồng dữ liệu
- **[Phát Triển Kiến Trúc](https://docs.magic-claude-mem.ai/architecture-evolution)** - Hành trình từ v3 đến v5
- **[Kiến Trúc Hooks](https://docs.magic-claude-mem.ai/hooks-architecture)** - Cách Magic-Claude-Mem sử dụng lifecycle hooks
- **[Tham Chiếu Hooks](https://docs.magic-claude-mem.ai/architecture/hooks)** - Giải thích 7 hook scripts
- **[Worker Service](https://docs.magic-claude-mem.ai/architecture/worker-service)** - HTTP API & quản lý Node.js
- **[Cơ Sở Dữ Liệu](https://docs.magic-claude-mem.ai/architecture/database)** - Schema SQLite & tìm kiếm FTS5
- **[Kiến Trúc Tìm Kiếm](https://docs.magic-claude-mem.ai/architecture/search-architecture)** - Tìm kiếm kết hợp với cơ sở dữ liệu vector Chroma

### Cấu Hình & Phát Triển

- **[Cấu Hình](https://docs.magic-claude-mem.ai/configuration)** - Biến môi trường & cài đặt
- **[Phát Triển](https://docs.magic-claude-mem.ai/development)** - Xây dựng, kiểm thử, đóng góp
- **[Khắc Phục Sự Cố](https://docs.magic-claude-mem.ai/troubleshooting)** - Các vấn đề thường gặp & giải pháp
...
Xem [Tổng Quan Kiến Trúc](https://docs.magic-claude-mem.ai/architecture/overview) để biết chi tiết.

---

## mem-search Skill

Magic-Claude-Mem cung cấp tìm kiếm thông minh thông qua kỹ năng mem-search tự động kích hoạt khi bạn hỏi về công việc trước đây:
...
Xem [Hướng Dẫn Công Cụ Tìm Kiếm](https://docs.magic-claude-mem.ai/usage/search-tools) để biết các ví dụ chi tiết.
...
Cài đặt được quản lý trong `~/.magic-claude-mem/settings.json` (tự động tạo với giá trị mặc định khi chạy lần đầu). Cấu hình mô hình AI, cổng worker, thư mục dữ liệu, mức độ log và cài đặt chèn ngữ cảnh.

Xem **[Hướng Dẫn Cấu Hình](https://docs.magic-claude-mem.ai/configuration)** để biết tất cả các cài đặt và ví dụ có sẵn.

---

## Phát Triển

Xem **[Hướng Dẫn Phát Triển](https://docs.magic-claude-mem.ai/development)** để biết hướng dẫn xây dựng, kiểm thử và quy trình đóng góp.
...
Xem **[Hướng Dẫn Khắc Phục Sự Cố](https://docs.magic-claude-mem.ai/troubleshooting)** để biết các vấn đề thường gặp và giải pháp.
...
Xem [Hướng Dẫn Phát Triển](https://docs.magic-claude-mem.ai/development) để biết quy trình đóng góp.
...
Copyright (C) 2026 Frederic Thomas (fthomas@apache.org). Bảo lưu mọi quyền.
...
- **Tài Liệu**: [docs/](docs/)
- **Vấn Đề**: [GitHub Issues](https://github.com/doublefx/magic-claude-mem/issues)
- **Repository**: [github.com/doublefx/magic-claude-mem](https://github.com/doublefx/magic-claude-mem)
- **Tác Giả**: Frederic Thomas ([fthomas@apache.org](https://github.com/doublefx))
