...
As of v8.x, the project has migrated from Bun to Node.js + better-sqlite3 for improved Windows compatibility. This document is preserved for historical reference only. See the current architecture documentation for up-to-date information.
</Note>
