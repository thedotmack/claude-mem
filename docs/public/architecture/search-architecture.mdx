...
- **Chroma semantic search**: When a text query is provided, the search API triggers Chroma vector similarity search alongside FTS5, respecting the user's date range filters (not a hardcoded 90-day window)
