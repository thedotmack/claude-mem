...
| `CLAUDE_MEM_PROVIDER`         | `claude`                        | AI provider: `claude`, `gemini`, `openrouter`, or `openai-compatible` |
...
See [OpenAI-Compatible Provider](usage/openai-compatible-provider) for setup guides.
