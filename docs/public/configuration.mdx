...
| `CLAUDE_MEM_PG_URL` | — | Postgres connection string. Falls back to `CLAUDE_MEM_SERVER_DATABASE_URL`. |
| `CLAUDE_MEM_PG_VECTOR_DIMENSIONS` | `1536` | Vector dimension used when bootstrapping the Postgres vector column. |
