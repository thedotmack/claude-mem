...
| `CLAUDE_MEM_CLAUDE_MAX_TOKENS` | `150000`                       | Proactive Claude observer context threshold; the worker rolls over to a fresh SDK session after the current memory is saved |
