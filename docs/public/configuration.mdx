...
| `CLAUDE_MEM_PROVIDER`         | `claude`                        | AI provider: `claude`, `gemini`, `openrouter`, or `docker-model-runner` |
...
| Setting                                              | Default       | Description                           |
|------------------------------------------------------|---------------|---------------------------------------|
| `CLAUDE_MEM_DOCKER_MODEL_RUNNER_MODEL`               | `ai/gemma4`   | Local model identifier                |
| `CLAUDE_MEM_DOCKER_MODEL_RUNNER_PORT`                | `12434`       | Docker Model Runner port              |
...
See [Docker Model Runner Provider](usage/docker-model-runner-provider) for setup instructions and model recommendations.
