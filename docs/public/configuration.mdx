...
| Setting                                      | Default                     | Description                           |
|----------------------------------------------|-----------------------------|---------------------------------------|
| `CLAUDE_MEM_OBSERVER_CONTEXT_WINDOW`         | —                           | Observer model context window in tokens. Empty = auto-resolve from the OpenRouter models catalogue (custom gateways fall back to `131072`). Set a positive integer to override |
