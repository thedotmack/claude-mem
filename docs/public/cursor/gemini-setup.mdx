...
description: "Use Magic-Claude-Mem in Cursor with Google's free Gemini API"
---

# Cursor + Gemini Setup

This guide walks you through setting up Magic-Claude-Mem in Cursor using Google's Gemini API. Gemini offers a generous free tier that handles typical individual usage.
...
## Step 2: Clone and Build Magic-Claude-Mem
...
{
  "MAGIC_CLAUDE_MEM_PROVIDER": "gemini",
  "MAGIC_CLAUDE_MEM_GEMINI_API_KEY": "your-key",
  "MAGIC_CLAUDE_MEM_GEMINI_MODEL": "gemini-2.5-flash"
}
```
...
{
  "MAGIC_CLAUDE_MEM_PROVIDER": "gemini",
  "MAGIC_CLAUDE_MEM_GEMINI_API_KEY": "AIza..."
}
```
...
3. Switch to an OpenAI-compatible endpoint for higher volume needs
...
You can switch between Gemini, OpenAI-compatible, and Claude SDK at any time by updating your settings. No restart required - changes take effect on the next observation.
...
- [OpenAI-Compatible Setup](/cursor/openai-compat-setup) - Alternative provider with 100+ models
