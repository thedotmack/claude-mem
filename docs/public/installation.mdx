...
- Detect your installed IDEs (Claude Code, Cursor, Windsurf, OpenCode, Codex CLI) and let you multi-select which ones to wire up
...
- **Claude Code** or another supported IDE (Cursor, Windsurf, OpenCode, Codex CLI, OpenClaw)
