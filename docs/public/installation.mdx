...
Claude-mem works across multiple AI coding platforms with a shared database:

| Platform | Installation | Status |
|----------|--------------|--------|
| Claude Code | Plugin marketplace | Primary |
| Cursor | Hooks integration | Supported |
| OpenCode | Plugin system | Supported |

See [Cursor Integration](cursor/index) and [OpenCode Integration](opencode/index) for platform-specific setup.
