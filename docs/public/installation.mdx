...
- Detect your installed IDEs (Claude Code, Cursor, Kiro CLI, Windsurf, OpenCode, Codex CLI, Antigravity CLI) and let you multi-select which ones to wire up
...
- **Claude Code** or another supported IDE (Cursor, Kiro CLI, Windsurf, OpenCode, Codex CLI, Antigravity CLI, OpenClaw)
