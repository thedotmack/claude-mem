...
- Optional settings: `CLAUDE_MEM_KIRO_MODEL` (pins a model into the observer agent at install), `CLAUDE_MEM_KIRO_CLI_PATH` (non-standard binary location).
