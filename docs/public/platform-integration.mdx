...
<Tabs>
  ...
  <Tab title="Observation">
    ...
    interface ObservationRow {
      ...
      files_read: string;      // JSON array of files read
      files_modified: string;  // JSON array of files modified
...
<CardGroup cols={2}>
  ...
  <Card title="GitHub" icon="github" href="https://github.com/doublefx/claude-mem">
