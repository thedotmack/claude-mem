# Progressive Disclosure: Magic-Claude-Mem's Context Priming Philosophy
...
## Magic-Claude-Mem's Solution: Progressive Disclosure
...
## How It Works in Magic-Claude-Mem
...
```markdown
*Use magic-claude-mem MCP search to access records with the given ID*
```
...
Magic-Claude-Mem implements progressive disclosure through a 3-layer workflow pattern:
...
- [Magic-Claude-Mem Architecture](architecture/overview) - How it all fits together
...
*This philosophy emerged from real-world usage of Magic-Claude-Mem across hundreds of coding sessions. The pattern works because it aligns with both human cognition and LLM attention mechanics.*
