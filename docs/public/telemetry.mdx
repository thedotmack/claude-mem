...
| `consecutive_invalid_outputs` | `0` | How many consecutive schema-drift outputs have occurred without a successful parse; resets to zero on a valid parse or after the third consecutive drift |
