...
This 3-layer approach keeps recall token-efficient by narrowing candidates before fetching full details. A published top-10 recall baseline is still pending (#3442).
