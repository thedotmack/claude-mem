...
- [Auto-Redaction](/usage/auto-redaction) — opt-in regex-based detection for accidental token leaks. Complements `<private>` tags by catching secrets you never typed yourself.
