...
**Returns:** Compact Markdown containing narrative, facts, files, and concepts. Internal storage/sync fields and duplicate legacy text are omitted.
**Cost:** Observation content plus small Markdown framing; no raw JSON metadata overhead
...
**Returns:** Compact Markdown with narrative, facts, files, and concepts—never a raw database row.
...
| get_observations (compact details) | Content size + small Markdown framing |
