"use strict";var It=Object.create;var H=Object.defineProperty;var Lt=Object.getOwnPropertyDescriptor;var Mt=Object.getOwnPropertyNames;var Dt=Object.getPrototypeOf,vt=Object.prototype.hasOwnProperty;var yt=(r,e)=>{for(var t in e)H(r,t,{get:e[t],enumerable:!0})},Te=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Mt(e))!vt.call(r,n)&&n!==t&&H(r,n,{get:()=>e[n],enumerable:!(s=Lt(e,n))||s.enumerable});return r};var y=(r,e,t)=>(t=r!=null?It(Dt(r)):{},Te(e||!r||!r.__esModule?H(t,"default",{value:r,enumerable:!0}):t,r)),Ut=r=>Te(H({},"__esModule",{value:!0}),r);var Zt={};yt(Zt,{generateContext:()=>Ee});module.exports=Ut(Zt);var Ot=y(require("path"),1),Rt=require("os"),Nt=require("fs");var Ce=require("bun:sqlite");var S=require("path"),te=require("os"),X=require("fs");var be=require("url");var L=require("fs"),U=require("path"),Se=require("os"),Z=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(Z||{}),fe=(0,U.join)((0,Se.homedir)(),".claude-mem"),ee=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=(0,U.join)(fe,"logs");(0,L.existsSync)(e)||(0,L.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,U.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=(0,U.join)(fe,"settings.json");if((0,L.existsSync)(e)){let t=(0,L.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=Z[n]??1}else this.level=1}catch{this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`+JSON.stringify(o,null,2):m=" "+this.formatData(o));let E="";if(n){let{sessionId:g,memorySessionId:b,correlationId:h,...l}=n;Object.keys(l).length>0&&(E=` {${Object.entries(l).map(([T,f])=>`${T}=${f}`).join(", ")}}`)}let p=`[${i}] [${a}] [${d}] ${_}${s}${E}${m}`;if(this.logFilePath)try{(0,L.appendFileSync)(this.logFilePath,p+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),m=_?`${_[1].split("/").pop()}:${_[2]}`:"unknown",E={...s,location:m};return this.warn(e,`[HAPPY-PATH] ${t}`,E,n),o}},c=new ee;var Ft={};function xt(){return typeof __dirname<"u"?__dirname:(0,S.dirname)((0,be.fileURLToPath)(Ft.url))}var kt=xt();function $t(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,S.join)((0,te.homedir)(),".claude-mem"),e=(0,S.join)(r,"settings.json");try{if((0,X.existsSync)(e)){let{readFileSync:t}=require("fs"),s=JSON.parse(t(e,"utf-8")),n=s.env??s;if(n.CLAUDE_MEM_DATA_DIR)return n.CLAUDE_MEM_DATA_DIR}}catch{}return r}var C=$t(),D=process.env.CLAUDE_CONFIG_DIR||(0,S.join)((0,te.homedir)(),".claude"),ns=(0,S.join)(D,"plugins","marketplaces","thedotmack"),os=(0,S.join)(C,"archives"),is=(0,S.join)(C,"logs"),as=(0,S.join)(C,"trash"),ds=(0,S.join)(C,"backups"),us=(0,S.join)(C,"modes"),_s=(0,S.join)(C,"settings.json"),he=(0,S.join)(C,"claude-mem.db"),cs=(0,S.join)(C,"vector-db"),ms=(0,S.join)(C,"observer-sessions"),ls=(0,S.join)(D,"settings.json"),ps=(0,S.join)(D,"commands"),Es=(0,S.join)(D,"CLAUDE.md");function Ae(r){(0,X.mkdirSync)(r,{recursive:!0})}function Oe(){return(0,S.join)(kt,"..")}var Re=require("crypto");var wt=3e4;function j(r,e,t){return(0,Re.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function G(r,e,t,s){let n=t-wt;return r.prepare("SELECT id, created_at_epoch FROM observations WHERE content_hash = ? AND created_at_epoch > ? AND (node = ? OR node IS NULL)").get(e,n,s??null)}function se(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[String(e)]}catch{return[r]}}var A="claude";function Pt(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function v(r){if(!r)return A;let e=Pt(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:A}function Ne(r){let e=["claude","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function Ht(r,e){return{customTitle:r,platformSource:e?v(e):void 0}}var B=class{db;_currentNode=null;_currentPlatform=null;_currentInstance=null;_currentLlmSource=null;setLocalProvenance(e,t,s,n){this._currentNode=e,this._currentPlatform=t,this._currentInstance=s,this._currentLlmSource=n??null}constructor(e=he){e!==":memory:"&&Ae(C),this.db=new Ce.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.addObservationProvenanceColumns(),this.addSummaryProvenanceColumns()}initializeSchema(){this.db.run(`
    ...
    `).all(e)}getObservationById(e){return this.db.prepare(`
      ...
      FROM observations
      WHERE id = ?
    `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,type:i,concepts:a,files:d}=t,_=s==="date_asc"?"ASC":"DESC",m=n?`LIMIT ${n}`:"",E=e.map(()=>"?").join(","),p=[...e],g=[];if(o&&(g.push("project = ?"),p.push(o)),i)if(Array.isArray(i)){let l=i.map(()=>"?").join(",");g.push(`type IN (${l})`),p.push(...i)}else g.push("type = ?"),p.push(i);if(a){let l=Array.isArray(a)?a:[a],R=l.map(()=>"EXISTS (SELECT 1 FROM json_each(concepts) WHERE value = ?)");p.push(...l),g.push(`(${R.join(" OR ")})`)}if(d){let l=Array.isArray(d)?d:[d],R=l.map(()=>"(EXISTS (SELECT 1 FROM json_each(files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(files_modified) WHERE value LIKE ?))");l.forEach(T=>{p.push(`%${T}%`,`%${T}%`)}),g.push(`(${R.join(" OR ")})`)}let b=g.length>0?`WHERE id IN (${E}) AND ${g.join(" AND ")}`:`WHERE id IN (${E})`;return this.db.prepare(`
      SELECT *
      FROM observations
      ${b}
    ...
    `).get(e).count}createSDKSession(e,t,s,n,o){let i=new Date,a=i.getTime(),d=Ht(n,o),_=d.platformSource??A,m=this.db.prepare(`
    ...
    `).get(e);if(m){if(t&&this.db.prepare(`
        ...
        `).run(d.customTitle,e),d.platformSource){let p=m.platform_source?.trim()?v(m.platform_source):void 0;if(!p)this.db.prepare(`
    ...
    `).run(e,t,s,o.toISOString(),i,n||(this._currentNode??null),this._currentPlatform??null,this._currentInstance??null,this._currentLlmSource??null).lastInsertRowid}getUserPrompt(e,t){return this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,o=0,i,a,d,_,m,E){let p=i??Date.now(),g=new Date(p).toISOString(),b=j(e,s.title,s.narrative),h=G(this.db,b,p,d);if(h)return{id:h.id,createdAtEpoch:h.created_at_epoch};let R=this.db.prepare(`
      INSERT INTO observations
      (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
       files_read, files_modified, prompt_number, discovery_tokens, content_hash, created_at, created_at_epoch,
       generated_by_model, node, platform, instance, llm_source)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.type,s.title,s.subtitle,JSON.stringify(s.facts),s.narrative,JSON.stringify(s.concepts),JSON.stringify(s.files_read),JSON.stringify(s.files_modified),n||null,o,b,g,p,a||null,d||null,_||null,m||null,E||null);return{id:Number(R.lastInsertRowid),createdAtEpoch:p}}storeSummary(e,t,s,n,o=0,i,a,d,_,m){let E=i??Date.now(),p=new Date(E).toISOString(),b=this.db.prepare(`
      INSERT INTO session_summaries
      (memory_session_id, project, request, investigated, learned, completed,
       next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch,
       node, platform, instance, llm_source)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,p,E,a??null,d??null,_??null,m??null);return{id:Number(b.lastInsertRowid),createdAtEpoch:E}}storeObservations(e,t,s,n,o,i=0,a,d,_,m,E,p){let g=a??Date.now(),b=new Date(g).toISOString();return this.db.transaction(()=>{let l=[],R=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, content_hash, created_at, created_at_epoch,
         generated_by_model, node, platform, instance, llm_source)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let f of s){let M=j(e,f.title,f.narrative),Q=G(this.db,M,g,_);if(Q){l.push(Q.id);continue}let N=R.run(e,t,f.type,f.title,f.subtitle,JSON.stringify(f.facts),f.narrative,JSON.stringify(f.concepts),JSON.stringify(f.files_read),JSON.stringify(f.files_modified),o||null,i,M,b,g,d||null,_??null,m??null,E??null,p??null);l.push(Number(N.lastInsertRowid))}let T=null;if(n){let M=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch,
           node, platform, instance, llm_source)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,o||null,i,b,g,_??null,m??null,E??null,p??null);T=Number(M.lastInsertRowid)}return{observationIds:l,summaryId:T,createdAtEpoch:g}})()}storeObservationsAndMarkComplete(e,t,s,n,o,i,a,d=0,_,m,E,p,g,b){let h=_??Date.now(),l=new Date(h).toISOString();return this.db.transaction(()=>{let T=[],f=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, content_hash, created_at, created_at_epoch,
         generated_by_model, node, platform, instance, llm_source)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let N of s){let P=j(e,N.title,N.narrative),ge=G(this.db,P,h,E);if(ge){T.push(ge.id);continue}let Ct=f.run(e,t,N.type,N.title,N.subtitle,JSON.stringify(N.facts),N.narrative,JSON.stringify(N.concepts),JSON.stringify(N.files_read),JSON.stringify(N.files_modified),a||null,d,P,l,h,m||null,E??null,p??null,g??null,b??null);T.push(Number(Ct.lastInsertRowid))}let M;if(n){let P=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch,
           node, platform, instance, llm_source)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,a||null,d,l,h,E??null,p??null,g??null,b??null);M=Number(P.lastInsertRowid)}return this.db.prepare(`
      ...
      `).run(h,o),{observationIds:T,summaryId:M,createdAtEpoch:h}})()}getSessionSummariesByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o}=t,i=s==="date_asc"?"ASC":"DESC",a=n?`LIMIT ${n}`:"",d=e.map(()=>"?").join(","),_=[...e],m=o?`WHERE id IN (${d}) AND project = ?`:`WHERE id IN (${d})`;return o&&_.push(o),this.db.prepare(`
