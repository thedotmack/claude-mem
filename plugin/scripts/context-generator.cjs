...
`+JSON.stringify(o,null,2):u=" "+this.formatData(o));let m="";if(n){let{sessionId:E,memorySessionId:T,correlationId:h,..._}=n;Object.keys(_).length>0&&(m=` {${Object.entries(_).map(([f,C])=>`${f}=${C}`).join(", ")}}`)}let g=`[${i}] [${a}] [${d}] ${c}${s}${m}${u}`;if(this.logFilePath)try{(0,A.appendFileSync)(this.logFilePath,g+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),u=c?`${c[1].split("/").pop()}:${c[2]}`:"unknown",m={...s,location:u};return this.warn(e,`[HAPPY-PATH] ${t}`,m,n),o}},l=new Y;var yt={};function Ct(){return typeof __dirname<"u"?__dirname:(0,b.dirname)((0,me.fileURLToPath)(yt.url))}var Rt=Ct(),y=N.get("CLAUDE_MEM_DATA_DIR"),V=process.env.CLAUDE_CONFIG_DIR||(0,b.join)((0,le.homedir)(),".claude"),Vt=(0,b.join)(y,"archives"),qt=(0,b.join)(y,"logs"),Kt=(0,b.join)(y,"trash"),Jt=(0,b.join)(y,"backups"),Qt=(0,b.join)(y,"modes"),zt=(0,b.join)(y,"settings.json"),_e=(0,b.join)(y,"claude-mem.db"),Zt=(0,b.join)(y,"vector-db"),es=(0,b.join)(y,"observer-sessions"),ts=(0,b.join)(V,"settings.json"),ss=(0,b.join)(V,"commands"),rs=(0,b.join)(V,"CLAUDE.md");function Ee(r){(0,ue.mkdirSync)(r,{recursive:!0})}function ge(){return(0,b.join)(Rt,"..")}function w(r){return!r.request?.trim()&&!r.investigated?.trim()&&!r.learned?.trim()&&!r.completed?.trim()&&!r.next_steps?.trim()}var P=class{db;constructor(e=_e){e!==":memory:"&&Ee(y),this.db=new U(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn()}initializeSchema(){this.db.run(`
    ...
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,o=0,i){let a=i??Date.now(),d=new Date(a).toISOString(),u=this.db.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.type,s.title,s.subtitle,JSON.stringify(s.facts),s.narrative,JSON.stringify(s.concepts),JSON.stringify(s.files_read),JSON.stringify(s.files_modified),n||null,o,d,a);return{id:Number(u.lastInsertRowid),createdAtEpoch:a}}storeSummary(e,t,s,n,o=0,i){let a=i??Date.now(),d=new Date(a).toISOString();if(w(s))return l.warn("DB","Skipping empty summary insert",{memorySessionId:e}),{id:0,createdAtEpoch:a};let u=this.db.prepare(`
    ...
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,d,a);return{id:Number(u.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a){let d=a??Date.now(),c=new Date(d).toISOString();return this.db.transaction(()=>{let m=[],g=this.db.prepare(`
      ...
      `);for(let T of s){let h=g.run(e,t,T.type,T.title,T.subtitle,JSON.stringify(T.facts),T.narrative,JSON.stringify(T.concepts),JSON.stringify(T.files_read),JSON.stringify(T.files_modified),o||null,i,c,d);m.push(Number(h.lastInsertRowid))}let E=null;if(n)if(w(n))l.warn("DB","Skipping empty summary insert",{memorySessionId:e});else{let h=this.db.prepare(`
        ...
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, created_at, created_at_epoch)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let S of s){let f=T.run(e,t,S.type,S.title,S.subtitle,JSON.stringify(S.facts),S.narrative,JSON.stringify(S.concepts),JSON.stringify(S.files_read),JSON.stringify(S.files_modified),a||null,d,m,u);E.push(Number(f.lastInsertRowid))}let h;if(n)if(w(n))l.warn("DB","Skipping empty summary insert",{memorySessionId:e});else{let f=this.db.prepare(`
            INSERT INTO session_summaries
            (memory_session_id, project, request, investigated, learned, completed,
             next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
...
`}function st(r,e,t,s){let n=[];return s?n.push(...He(r)):n.push(...Me(r)),s?n.push(...Ge()):n.push(...Le()),s?n.push(...We()):n.push(...ve()),s?n.push(...Ye()):n.push(...De()),j(t)&&(s?n.push(...Ve(e,t)):n.push(...xe(e,t))),n}var se=I(require("path"),1);function G(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return l.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e),[]}}function nt(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function ot(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function it(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function rt(r,e){return se.default.isAbsolute(r)?se.default.relative(e,r):r}function at(r,e,t){let s=G(r);if(s.length>0)return rt(s[0],e);if(t){let n=G(t);if(n.length>0)return rt(n[0],e)}return"General"}function Mt(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=it(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function Lt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?G(r.facts).join(`
`):null}function vt(r,e,t,s,n,o){let i=[];o?i.push(...qe(r)):i.push(...ke(r));let a=null,d="",c=!1;for(let u of e)if(u.type==="summary"){c&&(i.push(""),c=!1,a=null,d="");let m=u.data,g=nt(m.displayTime);o?i.push(...ze(m,g)):i.push(...Pe(m,g))}else{let m=u.data,g=at(m.files_modified,n,m.files_read),E=ot(m.created_at),T=E!==d,h=T?E:"";d=E;let _=t.has(m.id);if(g!==a&&(c&&i.push(""),o?i.push(...Ke(g)):i.push(...Ue(g)),a=g,c=!0),_){let S=Lt(m,s);o?i.push(...Qe(m,E,T,S,s)):(c&&!o&&(i.push(""),c=!1),i.push(...we(m,h,S,s)),a=null)}else o?i.push(Je(m,E,T,s)):i.push($e(m,h,s))}return c&&i.push(""),i}function dt(r,e,t,s,n){let o=[],i=Mt(r);for(let[a,d]of i)o.push(...vt(a,d,e,t,s,n));return o}function pt(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function ct(r,e){let t=[];return e?(t.push(...x("Investigated",r.investigated,p.blue)),t.push(...x("Learned",r.learned,p.yellow)),t.push(...x("Completed",r.completed,p.green)),t.push(...x("Next Steps",r.next_steps,p.magenta))):(t.push(...D("Investigated",r.investigated)),t.push(...D("Learned",r.learned)),t.push(...D("Completed",r.completed)),t.push(...D("Next Steps",r.next_steps))),t}function lt(r,e){return e?Ze(r):Fe(r)}function ut(r,e,t){return!j(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?et(r.totalDiscoveryTokens,r.totalReadTokens):je(r.totalDiscoveryTokens,r.totalReadTokens)}var Dt=mt.default.join((0,_t.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function xt(){try{return new P}catch(r){if(r.code==="ERR_DLOPEN_FAILED"){try{(0,Et.unlinkSync)(Dt)}catch(e){l.debug("SYSTEM","Marker file cleanup failed (may not exist)",{},e)}return l.error("SYSTEM","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function kt(r,e){return e?tt(r):Xe(r)}function Ut(r,e,t,s,n,o,i){let a=[],d=Q(e);a.push(...st(r,d,s,i));let c=t.slice(0,s.sessionCount),u=Ae(c,t),m=te(e,u),g=Ie(e,s.fullObservationCount);a.push(...dt(m,g,s,n,i));let E=t[0],T=e[0];pt(s,E,T)&&a.push(...ct(E,i));let h=ee(e,s,o,n);return a.push(...lt(h,i)),a.push(...ut(d,s,i)),a.join(`
`).trimEnd()}async function re(r,e=!1){let t=q(),s=r?.cwd??process.cwd(),n=fe(s),o=r?.projects||[n],i=xt();if(!i)return"";try{let a=o.length>1?Re(i,o,t):z(i,n,t),d=o.length>1?ye(i,o,t):Z(i,n,t);return a.length===0&&d.length===0?kt(n,e):Ut(n,a,d,t,s,r?.session_id,e)}finally{i.close()}}0&&(module.exports={generateContext});
