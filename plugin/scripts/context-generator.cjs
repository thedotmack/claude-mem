"use strict";var Wt=Object.create;var K=Object.defineProperty;var Vt=Object.getOwnPropertyDescriptor;var Kt=Object.getOwnPropertyNames;var qt=Object.getPrototypeOf,Yt=Object.prototype.hasOwnProperty;var Jt=(r,e)=>{for(var t in e)K(r,t,{get:e[t],enumerable:!0})},Ae=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Kt(e))!Yt.call(r,n)&&n!==t&&K(r,n,{get:()=>e[n],enumerable:!(s=Vt(e,n))||s.enumerable});return r};var H=(r,e,t)=>(t=r!=null?Wt(qt(r)):{},Ae(e||!r||!r.__esModule?K(t,"default",{value:r,enumerable:!0}):t,r)),Qt=r=>Ae(K({},"__esModule",{value:!0}),r);var Ps={};Jt(Ps,{generateContext:()=>jt,generateContextWithStats:()=>Ne});module.exports=Qt(Ps);var Gt=H(require("path"),1),Xt=require("os"),Bt=require("fs");var le=require("bun:sqlite");var h=require("path"),ae=require("os"),P=require("fs"),Le=require("url");var R=require("fs"),Ce=require("crypto"),y=require("path");var zt=null;function Zt(r){return(zt??process.stderr.write.bind(process.stderr))(r)}function w(r){Zt(r)}var es=process.platform==="win32";function ts(r){return r.replace(/^\uFEFF/,"")}function k(r){return JSON.parse(ts(r))}function ss(r){(0,R.existsSync)(r)||(0,R.mkdirSync)(r,{recursive:!0})}function ie(r,e){let t=r;try{if((0,R.lstatSync)(r).isSymbolicLink())try{t=(0,R.realpathSync)(r)}catch(_){let E=_ instanceof Error?_:new Error(String(_));w(`claude-mem: realpathSync failed for ${r}, resolving symlink manually: ${E.message}
`);let c=(0,R.readlinkSync)(r);t=(0,y.resolve)((0,y.dirname)(r),c)}}catch(_){let E=_.code;if(E!=="ENOENT"&&E!=="ENOTDIR")throw _}ss((0,y.dirname)(t));let s=(0,y.dirname)(t),n=(0,y.basename)(t),o=(0,y.join)(s,`.${n}.${process.pid}.${(0,Ce.randomBytes)(6).toString("hex")}.tmp`),i=Buffer.from(JSON.stringify(e,null,2)+`
`,"utf-8"),a;try{a=(0,R.statSync)(t).mode&511}catch{}let d;try{d=a!==void 0?(0,R.openSync)(o,"w",a):(0,R.openSync)(o,"w");let _=0;for(;_<i.length;){let E=(0,R.writeSync)(d,i,_,i.length-_);if(E===0)throw new Error(`writeSync stalled at ${_}/${i.length} bytes`);_+=E}if((0,R.fsyncSync)(d),(0,R.closeSync)(d),d=void 0,(0,R.renameSync)(o,t),!es){let E;try{E=(0,R.openSync)(s,"r"),(0,R.fsyncSync)(E)}catch(c){let l=c instanceof Error?c:new Error(String(c));w(`claude-mem: directory fsync failed for ${s}: ${l.message}
`)}finally{if(E!==void 0)try{(0,R.closeSync)(E)}catch{}}}}catch(_){if(d!==void 0)try{(0,R.closeSync)(d)}catch{}try{(0,R.unlinkSync)(o)}catch{}throw _}}var ds={};function rs(){return typeof __dirname<"u"?__dirname:(0,h.dirname)((0,Le.fileURLToPath)(ds.url))}var ns=rs();function os(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,h.join)((0,ae.homedir)(),".claude-mem"),e=(0,h.join)(r,"settings.json");try{if((0,P.existsSync)(e)){let t=k((0,P.readFileSync)(e,"utf-8")),s=t.env??t;if(s.CLAUDE_MEM_DATA_DIR)return s.CLAUDE_MEM_DATA_DIR}}catch{}return r}var A=os(),de=process.env.CLAUDE_CONFIG_DIR||(0,h.join)((0,ae.homedir)(),".claude"),js=(0,h.join)(de,"plugins","marketplaces","thedotmack"),is=(0,h.join)(A,"logs"),Ws=(0,h.join)(A,"settings.json"),De=(0,h.join)(A,"claude-mem.db"),as=(0,h.join)(A,"observer-sessions"),_e=(0,h.basename)(as);function Me(r){(0,P.mkdirSync)(r,{recursive:!0})}function ve(){return(0,h.join)(ns,"..")}var G={dataDir:()=>A,workerPid:()=>(0,h.join)(A,"worker.pid"),serverPid:()=>(0,h.join)(A,".server-beta.pid"),serverPort:()=>(0,h.join)(A,".server-beta.port"),serverRuntime:()=>(0,h.join)(A,".server-beta.runtime.json"),settings:()=>(0,h.join)(A,"settings.json"),database:()=>(0,h.join)(A,"claude-mem.db"),chroma:()=>(0,h.join)(A,"chroma"),combinedCerts:()=>(0,h.join)(A,"combined_certs.pem"),transcriptsConfig:()=>(0,h.join)(A,"transcript-watch.json"),transcriptsState:()=>(0,h.join)(A,"transcript-watch-state.json"),corpora:()=>(0,h.join)(A,"corpora"),supervisorRegistry:()=>(0,h.join)(A,"supervisor.json"),envFile:()=>(0,h.join)(A,".env"),logsDir:()=>is};var U=require("fs"),ye=require("path");var ue=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(ue||{}),Ee=null,me=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=G.logsDir();(0,U.existsSync)(e)||(0,U.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,ye.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=G.settings();if((0,U.existsSync)(e)){let t=(0,U.readFileSync)(e,"utf-8"),n=(k(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=ue[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
${e.stack}`:e.message;if(Array.isArray(e))return`[${e.length} items]`;let t=Object.keys(e);return t.length===0?"{}":t.length<=3?JSON.stringify(e):`{${t.length} keys: ${t.slice(0,3).join(", ")}...}`}return String(e)}formatTool(e,t){if(!t)return e;let s=t;if(typeof t=="string")try{s=JSON.parse(t)}catch{s=t}if(e==="Bash"&&s.command)return`${e}(${s.command})`;if(s.file_path)return`${e}(${s.file_path})`;if(s.notebook_path)return`${e}(${s.notebook_path})`;if(e==="Glob"&&s.pattern)return`${e}(${s.pattern})`;if(e==="Grep"&&s.pattern)return`${e}(${s.pattern})`;if(s.url)return`${e}(${s.url})`;if(s.query)return`${e}(${s.query})`;if(e==="Task"){if(s.subagent_type)return`${e}(${s.subagent_type})`;if(s.description)return`${e}(${s.description})`}return e==="Skill"&&s.skill?`${e}(${s.skill})`:e==="LSP"&&s.operation?`${e}(${s.operation})`:e}formatTimestamp(e){let t=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0"),o=String(e.getHours()).padStart(2,"0"),i=String(e.getMinutes()).padStart(2,"0"),a=String(e.getSeconds()).padStart(2,"0"),d=String(e.getMilliseconds()).padStart(3,"0");return`${t}-${s}-${n} ${o}:${i}:${a}.${d}`}log(e,t,s,n,o){if(e<this.getLevel())return;this.ensureLogFileInitialized();let i=this.formatTimestamp(new Date),a=ue[e].padEnd(5),d=t.padEnd(6),_="";n?.correlationId?_=`[${n.correlationId}] `:n?.sessionId&&(_=`[session-${n.sessionId}] `);let E="";if(o!=null)if(o instanceof Error)E=this.getLevel()===0?`
${o.message}
${o.stack}`:` ${o.message}`;else if(this.getLevel()===0&&typeof o=="object")try{E=`
`+JSON.stringify(o,null,2)}catch{E=" "+this.formatData(o)}else E=" "+this.formatData(o);let c="";if(n){let{sessionId:S,memorySessionId:T,correlationId:b,...f}=n;Object.keys(f).length>0&&(c=` {${Object.entries(f).map(([C,v])=>`${C}=${v}`).join(", ")}}`)}let l=`[${i}] [${a}] [${d}] ${_}${s}${c}${E}`;if(this.logFilePath)try{(0,U.appendFileSync)(this.logFilePath,l+`
`,"utf8")}catch(S){let T=S instanceof Error?S:new Error(String(S));w(`[LOGGER] Failed to write to log file: ${T.message}
${T.stack??""}
`)}else w(l+`
`)}debug(e,t,s,n){this.log(0,e,t,s,n)}info(e,t,s,n){this.log(1,e,t,s,n)}warn(e,t,s,n){this.log(2,e,t,s,n)}setErrorSink(e){Ee=e}error(e,t,s,n){this.log(3,e,t,s,n),this.routeErrorToSink(t,s,n)}routeErrorToSink(e,t,s){try{if(!Ee||!(s instanceof Error))return;Ee(s)}catch{}}dataIn(e,t,s,n){this.info(e,`\u2192 ${t}`,s,n)}dataOut(e,t,s,n){this.info(e,`\u2190 ${t}`,s,n)}success(e,t,s,n){this.info(e,`\u2713 ${t}`,s,n)}failure(e,t,s,n){this.error(e,`\u2717 ${t}`,s,n)}},u=new me;var Ue=require("crypto");function xe(r,e,t){return(0,Ue.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}var p="claude";function _s(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function L(r){if(!r)return p;let e=_s(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:p}function we(r){let e=["claude","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function ke(r,e,t,s,n){let o=Date.now()-s,i=n!==void 0?"up.session_db_id = ?":"up.content_session_id = ?",a=n??e;return r.prepare(`
    SELECT
      up.*,
      s.memory_session_id,
      s.project,
    ...
    LIMIT 1
  `).get(a,t,o)??void 0}var $e=["private","claude-mem-context","system_instruction","system-instruction","persisted-output","system-reminder"],Pe=new RegExp(`<(${$e.join("|")})\\b[^>]*>[\\s\\S]*?</\\1>`,"g"),He=/<system-reminder>[\s\S]*?<\/system-reminder>/g,Fe=100;function Es(r){let e=Object.fromEntries($e.map(n=>[n,0]));Pe.lastIndex=0;let t=0,s=r.replace(Pe,(n,o)=>(e[o]=(e[o]??0)+1,t+=1,""));return t>Fe&&u.warn("SYSTEM","tag count exceeds limit",void 0,{tagCount:t,maxAllowed:Fe,contentLength:r.length}),{stripped:s.trim(),counts:e}}function Ge(r){return Es(r).stripped}var us=["task-notification"],sr=new RegExp(`^\\s*<(${us.join("|")})\\b[^>]*>(?:(?!<\\1\\b|</\\1\\b)[\\s\\S])*</\\1>\\s*$`),rr=256*1024;var ce=4e3;function q(r){let e=r.trim(),s=Ge(r).trim()||e;return s.length<=ce?s:(u.debug("DB","Truncated stored prompt text to the configured cap",{originalLength:s.length,storedLength:ce}),`${s.slice(0,ce-1)}\u2026`)}var ms=require("bun:sqlite");var cs=5e3,ls=4194304;function ps(r){return r.prepare(`
    SELECT name
    FROM sqlite_master
    WHERE type = 'table'
      AND name NOT LIKE 'sqlite_%'
    LIMIT 1
  `).get()!=null}function F(r,e,t){try{r.run(e)}catch(s){let n=s instanceof Error?s:new Error(String(s));throw u.warn("DB",`Failed to apply SQLite pragma ${t}`,{sql:e},n),s}}function Xe(r,e={}){let{enableWal:t=!0,enableIncrementalAutoVacuum:s=!0}=e;F(r,`PRAGMA busy_timeout = ${cs}`,"busy_timeout"),F(r,"PRAGMA foreign_keys = ON","foreign_keys"),F(r,"PRAGMA synchronous = NORMAL","synchronous"),F(r,`PRAGMA journal_size_limit = ${ls}`,"journal_size_limit"),s&&!ps(r)&&F(r,"PRAGMA auto_vacuum = INCREMENTAL","auto_vacuum"),t&&F(r,"PRAGMA journal_mode = WAL","journal_mode")}var Y=class{db;constructor(e=De){e instanceof le.Database?this.db=e:(e!==":memory:"&&Me(A),this.db=new le.Database(e)),Xe(this.db),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn(),this.ensureSDKSessionsPlatformContentIdentity(),this.ensureUserPromptsSessionDbId(),this.ensurePendingMessagesSessionToolUniqueIndex()}getIndexColumns(e){return this.db.query(`PRAGMA index_info(${JSON.stringify(e)})`).all().map(t=>t.name)}hasUniqueIndexOnColumns(e,t){return this.db.query(`PRAGMA index_list(${e})`).all().some(n=>{if(n.unique!==1)return!1;let o=this.getIndexColumns(n.name);return o.length===t.length&&o.every((i,a)=>i===t[a])})}resolvePromptSessionDbId(e,t,s){if(t!==void 0)return t;let n=s?L(s):void 0;return n?this.db.prepare(`
        SELECT id
        FROM sdk_sessions
    ...
    `).get(e);if(!n)throw new Error(`Session ${e} not found in sdk_sessions`);n.memory_session_id!==t&&(this.db.prepare(`
      ...
      WHERE project IS NOT NULL AND project != ''
        AND project != ?
    `,n=[_e];return t&&(s+=" AND COALESCE(platform_source, ?) = ?",n.push(p,t)),s+=" ORDER BY project ASC",this.db.prepare(s).all(...n).map(i=>i.project)}getProjectCatalog(){let e=this.db.prepare(`
      SELECT
    ...
    `).all(_e),t=[],s=new Set,n={};for(let i of e){let a=L(i.platform_source);n[a]||(n[a]=[]),n[a].includes(i.project)||n[a].push(i.project),s.has(i.project)||(s.add(i.project),t.push(i.project))}let o=we(Object.keys(n));return{projects:t,sources:o,projectsBySource:Object.fromEntries(o.map(i=>[i,n[i]||[]]))}}getLatestUserPrompt(e,t){let s=this.resolvePromptSessionDbId(e,t),n=s!==null?"up.session_db_id = ?":"up.content_session_id = ?",o=s!==null?s:e;return this.db.prepare(`
      ...
      ORDER BY up.created_at_epoch DESC
      LIMIT 1
    `).get(o)}findRecentDuplicateUserPrompt(e,t,s,n){return ke(this.db,e,q(t),s,this.resolvePromptSessionDbId(e,n)??void 0)}getRecentSessionsWithStatus(e,t=3,s){let n=[e],o="";return s&&(o=`AND COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`,n.push(L(s))),n.push(t),this.db.prepare(`
      SELECT * FROM (
        SELECT
          s.memory_session_id,
          s.status,
    ...
    `).get(e,L(t))||null:this.db.prepare(`
        ...
        FROM observations
        WHERE id = ?
      `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,platformSource:i,type:a,concepts:d,files:_}=t,E=s==="relevance",c=E?"":`ORDER BY o.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,l=n&&!E?`LIMIT ${n}`:"",S=e.map(()=>"?").join(","),T=[...e],b=[];if(o&&(b.push("o.project = ?"),T.push(o)),i&&(b.push(`COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`),T.push(L(i))),a)if(Array.isArray(a)){let N=a.map(()=>"?").join(",");b.push(`o.type IN (${N})`),T.push(...a)}else b.push("o.type = ?"),T.push(a);if(d){let N=Array.isArray(d)?d:[d],I=N.map(()=>"EXISTS (SELECT 1 FROM json_each(o.concepts) WHERE value = ?)");T.push(...N),b.push(`(${I.join(" OR ")})`)}if(_){let N=Array.isArray(_)?_:[_],I=N.map(()=>"(EXISTS (SELECT 1 FROM json_each(o.files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(o.files_modified) WHERE value LIKE ?))");N.forEach(D=>{T.push(`%${D}%`,`%${D}%`)}),b.push(`(${I.join(" OR ")})`)}let f=b.length>0?`WHERE o.id IN (${S}) AND ${b.join(" AND ")}`:`WHERE o.id IN (${S})`,C=this.db.prepare(`
      SELECT o.*
      FROM observations o
      LEFT JOIN sdk_sessions s ON s.memory_session_id = o.memory_session_id
      ${f}
      ${c}
      ${l}
    `).all(...T);if(!E)return C;let v=new Map(C.map(N=>[N.id,N])),O=e.map(N=>v.get(N)).filter(N=>!!N);return n?O.slice(0,n):O}getSummaryForSession(e,t){let s=[e],n="";return t&&(n=`
        AND EXISTS (
          SELECT 1
    ...
    `).get(e).count}createSDKSession(e,t,s,n,o){let i=new Date,a=i.getTime(),d=o?L(o):p,_=q(s),E=this.db.prepare(`
      SELECT id, platform_source
      FROM sdk_sessions
      WHERE COALESCE(NULLIF(platform_source, ''), ?) = ?
        AND content_session_id = ?
    `).get(p,d,e);if(E)return t&&this.db.prepare(`
          UPDATE sdk_sessions SET project = ?
          WHERE id = ? AND (project IS NULL OR project = '')
        `).run(t,E.id),n&&this.db.prepare(`
          UPDATE sdk_sessions SET custom_title = ?
          WHERE id = ? AND custom_title IS NULL
        `).run(n,E.id),E.id;let c=this.db.prepare(`
    ...
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,o=0,i,a){let d=this.storeObservations(e,t,[s],null,n,o,i,a);return{id:d.observationIds[0],createdAtEpoch:d.createdAtEpoch}}storeSummary(e,t,s,n,o=0,i){let a=i??Date.now(),d=new Date(a).toISOString(),E=this.db.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,d,a);return{id:Number(E.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a,d){let _=a??Date.now(),E=new Date(_).toISOString();return this.db.transaction(()=>{let l=[],S=this.db.prepare(`
        ...
        RETURNING id
      `),T=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let f of s){let g=xe(e,f.title,f.narrative),C=S.get(e,t,f.type,f.title,f.subtitle,JSON.stringify(f.facts),f.narrative,JSON.stringify(f.concepts),JSON.stringify(f.files_read),JSON.stringify(f.files_modified),o||null,i,f.agent_type??null,f.agent_id??null,g,E,_,d||null,f.metadata??null);if(C){l.push(C.id);continue}let v=T.get(e,g);if(!v)throw new Error(`storeObservations: ON CONFLICT without existing row for content_hash=${g}`);l.push(v.id)}let b=null;if(n){let g=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,o||null,i,E,_);b=Number(g.lastInsertRowid)}return{observationIds:l,summaryId:b,createdAtEpoch:_}})()}getSessionSummariesByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,platformSource:i}=t,a=s==="relevance",d=a?"":`ORDER BY ss.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,_=n&&!a?`LIMIT ${n}`:"",E=e.map(()=>"?").join(","),c=[...e],l=[];o&&(l.push("ss.project = ?"),c.push(o)),i&&(l.push(`COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`),c.push(L(i)));let S=l.length>0?`AND ${l.join(" AND ")}`:"",b=this.db.prepare(`
      SELECT ss.*
      ...
      ${d}
      ${_}
    `).all(...c);if(!a)return b;let f=new Map(b.map(C=>[C.id,C])),g=e.map(C=>f.get(C)).filter(C=>!!C);return n?g.slice(0,n):g}getUserPromptsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,platformSource:i}=t,a=s==="relevance",d=a?"":`ORDER BY up.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,_=n?`LIMIT ${n}`:"",E=e.map(()=>"?").join(","),c=[...e],l=[];o&&(l.push("s.project = ?"),c.push(o)),i&&(l.push(`COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`),c.push(L(i)));let S=l.length>0?`AND ${l.join(" AND ")}`:"",b=this.db.prepare(`
      SELECT
        up.*,
        s.project,
        s.memory_session_id,
      ...
      ${d}
      ${_}
    `).all(...c);if(!a)return b;let f=new Map(b.map(g=>[g.id,g]));return e.map(g=>f.get(g)).filter(g=>!!g)}getTimelineAroundTimestamp(e,t=10,s=10,n,o){return this.getTimelineAroundObservation(null,e,t,s,n,o)}getTimelineAroundObservation(e,t,s=10,n=10,o,i){let a=i?L(i):void 0,d=(O,N)=>{let I=[],D=[];return o&&(I.push(`${O}.project = ?`),D.push(o)),a&&(I.push(`COALESCE(NULLIF(${N}.platform_source, ''), '${p}') = ?`),D.push(a)),{clause:I.length>0?`AND ${I.join(" AND ")}`:"",params:D}},_=d("o","src"),E=d("ss","src"),c=d("s","s"),l,S;if(e!==null){let O=`
      ...
      `,N=`
        ...
        ORDER BY o.id ASC
        LIMIT ?
      `;try{let I=this.db.prepare(O).all(e,..._.params,s+1),D=this.db.prepare(N).all(e,..._.params,n+1);if(I.length===0&&D.length===0)return{observations:[],sessions:[],prompts:[]};l=I.length>0?I[I.length-1].created_at_epoch:t,S=D.length>0?D[D.length-1].created_at_epoch:t}catch(I){return I instanceof Error?u.error("DB","Error getting boundary observations",{project:o},I):u.error("DB","Error getting boundary observations with non-Error",{},new Error(String(I))),{observations:[],sessions:[],prompts:[]}}}else{let O=`
      ...
      `,N=`
        ...
        LIMIT ?
      `;try{let I=this.db.prepare(O).all(t,..._.params,s),D=this.db.prepare(N).all(t,..._.params,n+1);if(I.length===0&&D.length===0)return{observations:[],sessions:[],prompts:[]};l=I.length>0?I[I.length-1].created_at_epoch:t,S=D.length>0?D[D.length-1].created_at_epoch:t}catch(I){return I instanceof Error?u.error("DB","Error getting boundary timestamps",{project:o},I):u.error("DB","Error getting boundary timestamps with non-Error",{},new Error(String(I))),{observations:[],sessions:[],prompts:[]}}}let T=`
      SELECT o.*
      FROM observations o
      LEFT JOIN sdk_sessions src ON src.memory_session_id = o.memory_session_id
    ...
    `,g=this.db.prepare(T).all(l,S,..._.params),C=this.db.prepare(b).all(l,S,...E.params),v=this.db.prepare(f).all(l,S,...c.params);return{observations:g,sessions:C.map(O=>({id:O.id,memory_session_id:O.memory_session_id,project:O.project,request:O.request,completed:O.completed,next_steps:O.next_steps,created_at:O.created_at,created_at_epoch:O.created_at_epoch})),prompts:v.map(O=>({id:O.id,content_session_id:O.content_session_id,prompt_number:O.prompt_number,prompt_text:O.prompt_text,project:O.project,platform_source:O.platform_source,created_at:O.created_at,created_at_epoch:O.created_at_epoch}))}}getOrCreateManualSession(e){let t=`manual-${e}`,s=`manual-content-${e}`;if(this.db.prepare("SELECT memory_session_id FROM sdk_sessions WHERE memory_session_id = ?").get(t))return t;let o=new Date;return this.db.prepare(`
  ...
  `).all(...e,...e,s??null,s??null,...n,...i,t.totalObservationCount)}function et(r,e,t,s){let n=e.map(()=>"?").join(",");return r.db.prepare(`
    ...
    LIMIT ?
  `).all(...e,...e,s??null,s??null,t.sessionCount+Je)}function hs(r){return r.replace(/[/.]/g,"-")}function Is(r){if(!r.includes('"type":"assistant"'))return null;let e=JSON.parse(r);if(e.type==="assistant"&&e.message?.content&&Array.isArray(e.message.content)){let t="";for(let s of e.message.content)s.type==="text"&&(t+=s.text);if(t=t.replace(He,"").trim(),t)return t}return null}function Ns(r){for(let e=r.length-1;e>=0;e--)try{let t=Is(r[e]);if(t)return t}catch(t){t instanceof Error?u.debug("WORKER","Skipping malformed transcript line",{lineIndex:e},t):u.debug("WORKER","Skipping malformed transcript line",{lineIndex:e,error:String(t)});continue}return""}function As(r){try{if(!(0,se.existsSync)(r))return{assistantMessage:""};let e=(0,se.readFileSync)(r,"utf-8").trim();if(!e)return{assistantMessage:""};let t=e.split(`
`).filter(n=>n.trim());return{assistantMessage:Ns(t)}}catch(e){return e instanceof Error?u.failure("WORKER","Failed to extract prior messages from transcript",{transcriptPath:r},e):u.warn("WORKER","Failed to extract prior messages from transcript",{transcriptPath:r,error:String(e)}),{assistantMessage:""}}}function tt(r,e,t,s){if(!e.showLastMessage||r.length===0)return{assistantMessage:""};let n=r.find(d=>d.memory_session_id!==t);if(!n)return{assistantMessage:""};let o=n.memory_session_id,i=hs(s),a=ze.default.join(de,"projects",i,`${o}.jsonl`);return As(a)}function st(r,e){let t=e[0]?.id;return r.map((s,n)=>{let o=n===0?null:e[n+1];return{...s,displayEpoch:o?o.created_at_epoch:s.created_at_epoch,displayTime:o?o.created_at:s.created_at,shouldShowLink:s.id!==t}})}function rt(r,e){let t=[...r.map(s=>({type:"observation",data:s})),...e.map(s=>({type:"summary",data:s}))];return t.sort((s,n)=>{let o=s.type==="observation"?s.data.created_at_epoch:s.data.displayEpoch,i=n.type==="observation"?n.data.created_at_epoch:n.data.displayEpoch;return o-i}),t}function nt(r,e){return new Set(r.slice(0,e).map(t=>t.id))}function ot(){let r=new Date,e=r.toLocaleDateString("en-CA"),t=r.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),s=r.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${s}`}function it(r){return[`# [${r}] recent context, ${ot()}`,""]}function at(){return[`Legend: \u{1F3AF}session ${M.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji}${t.id}`).join(" ")}`,"Format: ID TIME TYPE TITLE","Fetch details: get_observations([IDs]) | Search: mem-search skill",""]}function dt(r,e){let t=[],s=[`${r.totalObservations} obs (${r.totalReadTokens.toLocaleString()}t read)`,`${r.totalDiscoveryTokens.toLocaleString()}t work`];return r.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)&&(e.showSavingsPercent?s.push(`${r.savingsPercent}% savings`):e.showSavingsAmount&&s.push(`${r.savings.toLocaleString()}t saved`)),t.push(`Stats: ${s.join(" | ")}`),t.push(""),t}function _t(r){return[`### ${r}`]}function Et(r){return r.toLowerCase().replace(" am","a").replace(" pm","p")}function ut(r,e,t){let s=r.title||"Untitled",n=M.getInstance().getTypeIcon(r.type),o=e?Et(e):'"';return`${r.id} ${o} ${n} ${s}`}function mt(r,e,t,s){let n=[],o=r.title||"Untitled",i=M.getInstance().getTypeIcon(r.type),a=e?Et(e):'"',{readTokens:d,discoveryDisplay:_}=j(r,s);n.push(`**${r.id}** ${a} ${i} **${o}**`),t&&n.push(t);let E=[];return s.showReadTokens&&E.push(`~${d}t`),s.showWorkTokens&&E.push(_),E.length>0&&n.push(E.join(" ")),n.push(""),n}function ct(r,e){return[`S${r.id} ${r.request||"Session started"} (${e})`]}function W(r,e){return e?[`**${r}**: ${e}`,""]:[]}function lt(r){return r.assistantMessage?["","---","","**Previously**","",`A: ${r.assistantMessage}`,""]:[]}function pt(r,e){return["",`Access ${Math.round(r/1e3)}k tokens of past work via get_observations([IDs]) or mem-search skill.`]}function Tt(r){return`# [${r}] recent context, ${ot()}

No previous sessions found.`}function gt(){let r=new Date,e=r.toLocaleDateString("en-CA"),t=r.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),s=r.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${s}`}function St(r){return["",`${m.bright}${m.cyan}[${r}] recent context, ${gt()}${m.reset}`,`${m.gray}${"\u2500".repeat(60)}${m.reset}`,""]}function ft(){let e=M.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji} ${t.id}`).join(" | ");return[`${m.dim}Legend: session-request | ${e}${m.reset}`,""]}function Rt(){return[`${m.bright}Column Key${m.reset}`,`${m.dim}  Read: Tokens to read this observation (cost to learn it now)${m.reset}`,`${m.dim}  Work: Tokens spent on work that produced this record ( research, building, deciding)${m.reset}`,""]}function Ot(){return[`${m.dim}Context Index: This semantic index (titles, types, files, tokens) is usually sufficient to understand past work.${m.reset}`,"",`${m.dim}When you need implementation details, rationale, or debugging context:${m.reset}`,`${m.dim}  - Fetch by ID: get_observations([IDs]) for observations visible in this index${m.reset}`,`${m.dim}  - Search history: Use the mem-search skill for past decisions, bugs, and deeper research${m.reset}`,`${m.dim}  - Trust this index over re-reading code for past decisions and learnings${m.reset}`,""]}function bt(r,e){let t=[];if(t.push(`${m.bright}${m.cyan}Context Economics${m.reset}`),t.push(`${m.dim}  Loading: ${r.totalObservations} observations (${r.totalReadTokens.toLocaleString()} tokens to read)${m.reset}`),t.push(`${m.dim}  Work investment: ${r.totalDiscoveryTokens.toLocaleString()} tokens spent on research, building, and decisions${m.reset}`),r.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)){let s="  Your savings: ";e.showSavingsAmount&&e.showSavingsPercent?s+=`${r.savings.toLocaleString()} tokens (${r.savingsPercent}% reduction from reuse)`:e.showSavingsAmount?s+=`${r.savings.toLocaleString()} tokens`:s+=`${r.savingsPercent}% reduction from reuse`,t.push(`${m.green}${s}${m.reset}`)}return t.push(""),t}function ht(r){return[`${m.bright}${m.cyan}${r}${m.reset}`,""]}function It(r){return[`${m.dim}${r}${m.reset}`]}function Nt(r,e,t,s){let n=r.title||"Untitled",o=M.getInstance().getTypeIcon(r.type),{readTokens:i,discoveryTokens:a,workEmoji:d}=j(r,s),_=t?`${m.dim}${e}${m.reset}`:" ".repeat(e.length),E=s.showReadTokens&&i>0?`${m.dim}(~${i}t)${m.reset}`:"",c=s.showWorkTokens&&a>0?`${m.dim}(${d} ${a.toLocaleString()}t)${m.reset}`:"";return`  ${m.dim}#${r.id}${m.reset}  ${_}  ${o}  ${n} ${E} ${c}`}function At(r,e,t,s,n){let o=[],i=r.title||"Untitled",a=M.getInstance().getTypeIcon(r.type),{readTokens:d,discoveryTokens:_,workEmoji:E}=j(r,n),c=t?`${m.dim}${e}${m.reset}`:" ".repeat(e.length),l=n.showReadTokens&&d>0?`${m.dim}(~${d}t)${m.reset}`:"",S=n.showWorkTokens&&_>0?`${m.dim}(${E} ${_.toLocaleString()}t)${m.reset}`:"";return o.push(`  ${m.dim}#${r.id}${m.reset}  ${c}  ${a}  ${m.bright}${i}${m.reset}`),s&&o.push(`    ${m.dim}${s}${m.reset}`),(l||S)&&o.push(`    ${l} ${S}`),o.push(""),o}function Ct(r,e){let t=`${r.request||"Session started"} (${e})`;return[`${m.yellow}#S${r.id}${m.reset} ${t}`,""]}function V(r,e,t){return e?[`${t}${r}:${m.reset} ${e}`,""]:[]}function Lt(r){return r.assistantMessage?["","---","",`${m.bright}${m.magenta}Previously${m.reset}`,"",`${m.dim}A: ${r.assistantMessage}${m.reset}`,""]:[]}function Dt(r,e){let t=Math.round(r/1e3);return["",`${m.dim}Access ${t}k tokens of past research & decisions for just ${e.toLocaleString()}t. Use the claude-mem skill to access memories by ID.${m.reset}`]}function Mt(r){return`
${m.bright}${m.cyan}[${r}] recent context, ${gt()}${m.reset}
${m.gray}${"\u2500".repeat(60)}${m.reset}

${m.dim}No previous sessions found for this project yet.${m.reset}
`}function vt(r,e,t,s){let n=[];return s?n.push(...St(r)):n.push(...it(r)),s?n.push(...ft()):n.push(...at()),s&&(n.push(...Rt()),n.push(...Ot())),te(t)&&(s?n.push(...bt(e,t)):n.push(...dt(e,t))),n}var be=H(require("path"),1);function oe(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return u.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e instanceof Error?e:new Error(String(e))),[]}}function he(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function Ie(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function Ut(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function yt(r,e){return be.default.isAbsolute(r)?be.default.relative(e,r):r}function xt(r,e,t){let s=oe(r);if(s.length>0)return yt(s[0],e);if(t){let n=oe(t);if(n.length>0)return yt(n[0],e)}return"General"}function Cs(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=Ut(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function wt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?oe(r.facts).join(`
`):null}function Ls(r,e,t,s){let n=[];n.push(..._t(r));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=he(a.displayTime);n.push(...ct(a,d))}else{let a=i.data,d=Ie(a.created_at),E=d!==o?d:"";if(o=d,t.has(a.id)){let l=wt(a,s);n.push(...mt(a,E,l,s))}else n.push(ut(a,E,s))}return n}function Ds(r,e,t,s,n){let o=[];o.push(...ht(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let _=d.data,E=he(_.displayTime);o.push(...Ct(_,E))}else{let _=d.data,E=xt(_.files_modified,n,_.files_read),c=Ie(_.created_at),l=c!==a;a=c;let S=t.has(_.id);if(E!==i&&(o.push(...It(E)),i=E),S){let T=wt(_,s);o.push(...At(_,c,l,T,s))}else o.push(Nt(_,c,l,s))}return o.push(""),o}function Ms(r,e,t,s,n,o){return o?Ds(r,e,t,s,n):Ls(r,e,t,s)}function kt(r,e,t,s,n){let o=[],i=Cs(r);for(let[a,d]of i)o.push(...Ms(a,d,e,t,s,n));return o}function Pt(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function Ft(r,e){let t=[];return e?(t.push(...V("Investigated",r.investigated,m.blue)),t.push(...V("Learned",r.learned,m.yellow)),t.push(...V("Completed",r.completed,m.green)),t.push(...V("Next Steps",r.next_steps,m.magenta))):(t.push(...W("Investigated",r.investigated)),t.push(...W("Learned",r.learned)),t.push(...W("Completed",r.completed)),t.push(...W("Next Steps",r.next_steps))),t}function $t(r,e){return e?Lt(r):lt(r)}function Ht(r,e,t){return!te(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?Dt(r.totalDiscoveryTokens,r.totalReadTokens):pt(r.totalDiscoveryTokens,r.totalReadTokens)}var vs=Gt.default.join((0,Xt.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function ys(){try{return new Y}catch(r){if(r instanceof Error&&r.code==="ERR_DLOPEN_FAILED"){try{(0,Bt.unlinkSync)(vs)}catch(e){e instanceof Error?u.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):u.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return u.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function Us(r,e){return e?Mt(r):Tt(r)}function xs(r,e,t,s,n,o,i){let a=[],d=Oe(e);a.push(...vt(r,d,s,i));let _=t.slice(0,s.sessionCount),E=st(_,t),c=rt(e,E),l=nt(e,s.fullObservationCount);a.push(...kt(c,l,s,n,i));let S=t[0],T=e[0];Pt(s,S,T)&&a.push(...Ft(S,i));let b=tt(e,s,o,n);return a.push(...$t(b,i)),a.push(...Ht(d,s,i)),a.join(`
`).trimEnd()}var ws=new Set(["bugfix","discovery","decision","refactor"]);function ks(r,e,t){let s=Oe(r),n={bugfix:0,discovery:0,decision:0,refactor:0,other:0},o=new Set,i=Number.POSITIVE_INFINITY;for(let d of r){let _=ws.has(d.type)?d.type:"other";n[_]++,d.memory_session_id&&o.add(d.memory_session_id),d.created_at_epoch&&d.created_at_epoch<i&&(i=d.created_at_epoch)}let a=Number.isFinite(i)?Math.max(0,Math.floor((Date.now()-i)/864e5)):0;return{observation_count:r.length,session_count:o.size,timeline_depth_days:a,has_session_summary:e.length>0,obs_type_bugfix:n.bugfix,obs_type_discovery:n.discovery,obs_type_decision:n.decision,obs_type_refactor:n.refactor,obs_type_other:n.other,tokens_injected:s.totalReadTokens,tokens_saved_vs_naive:s.savings,search_strategy:t?"full":"timeline"}}async function Ne(r,e=!1){let t=qe(),s=r?.cwd??process.cwd(),n=Ve(s),o=r?.projects?.length?r.projects:n.allProjects,i=o[o.length-1]??n.primary;r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let a=ys();if(!a)return{text:"",stats:null};try{let d=r?.platformSource?L(r.platformSource):void 0,_=o.length>1?o:[i],E=Ze(a,_,t,d),c=et(a,_,t,d);return E.length===0&&c.length===0?{text:Us(i,e),stats:null}:{text:xs(i,E,c,t,s,r?.session_id,e),stats:ks(E,c,!!r?.full)}}finally{a.close()}}async function jt(r,e=!1){return(await Ne(r,e)).text}0&&(module.exports={generateContext,generateContextWithStats});
