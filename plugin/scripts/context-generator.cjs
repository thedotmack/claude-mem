"use strict";var cs=Object.create;var q=Object.defineProperty;var _s=Object.getOwnPropertyDescriptor;var us=Object.getOwnPropertyNames;var ls=Object.getPrototypeOf,ps=Object.prototype.hasOwnProperty;var ms=(s,e)=>{for(var t in e)q(s,t,{get:e[t],enumerable:!0})},Xe=(s,e,t,r)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of us(e))!ps.call(s,n)&&n!==t&&q(s,n,{get:()=>e[n],enumerable:!(r=_s(e,n))||r.enumerable});return s};var H=(s,e,t)=>(t=s!=null?cs(ls(s)):{},Xe(e||!s||!s.__esModule?q(t,"default",{value:s,enumerable:!0}):t,s)),Es=s=>Xe(q({},"__esModule",{value:!0}),s);var Zs={};ms(Zs,{generateContext:()=>$e,generateContextWithStats:()=>me});module.exports=Es(Zs);var is=H(require("path"),1),as=require("os"),ds=require("fs");var Ne=require("bun:sqlite");var E=require("path"),be=require("os"),x=require("fs");var We=require("url");var v=require("fs"),Be=require("path");var gs=null;function Ts(s){return(gs??process.stderr.write.bind(process.stderr))(s)}function ge(s){Ts(s)}var Te=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(Te||{}),fe=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=j.logsDir();(0,v.existsSync)(e)||(0,v.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,Be.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=j.settings();if((0,v.existsSync)(e)){let t=(0,v.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=Te[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
