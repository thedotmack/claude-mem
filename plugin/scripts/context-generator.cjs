"use strict";var $t=Object.create;var B=Object.defineProperty;var Ht=Object.getOwnPropertyDescriptor;var Xt=Object.getOwnPropertyNames;var Gt=Object.getPrototypeOf,Bt=Object.prototype.hasOwnProperty;var jt=(n,e)=>{for(var t in e)B(n,t,{get:e[t],enumerable:!0})},fe=(n,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let r of Xt(e))!Bt.call(n,r)&&r!==t&&B(n,r,{get:()=>e[r],enumerable:!(s=Ht(e,r))||s.enumerable});return n};var k=(n,e,t)=>(t=n!=null?$t(Gt(n)):{},fe(e||!n||!n.__esModule?B(t,"default",{value:n,enumerable:!0}):t,n)),Wt=n=>fe(B({},"__esModule",{value:!0}),n);var Ns={};jt(Ns,{generateContext:()=>Pt,generateContextWithStats:()=>Se});module.exports=Wt(Ns);var kt=k(require("path"),1),Ft=require("os"),wt=require("fs");var ue=require("bun:sqlite");var T=require("path"),oe=require("os"),U=require("fs");var Re=require("url");var v=require("fs"),Oe=require("path");var Vt=null;function Yt(n){return(Vt??process.stderr.write.bind(process.stderr))(n)}function te(n){Yt(n)}var re=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(re||{}),se=null,ne=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=F.logsDir();(0,v.existsSync)(e)||(0,v.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,Oe.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=F.settings();if((0,v.existsSync)(e)){let t=(0,v.readFileSync)(e,"utf-8"),r=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=re[r]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),m=_?`${_[1].split("/").pop()}:${_[2]}`:"unknown",l={...s,location:m};return this.warn(e,`[HAPPY-PATH] ${t}`,l,r),o}},E=new ne;var rs={};function qt(){return typeof __dirname<"u"?__dirname:(0,T.dirname)((0,Re.fileURLToPath)(rs.url))}var Kt=qt();function Jt(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let n=(0,T.join)((0,oe.homedir)(),".claude-mem"),e=(0,T.join)(n,"settings.json");try{if((0,U.existsSync)(e)){let t=JSON.parse((0,U.readFileSync)(e,"utf-8")),s=t.env??t;if(s.CLAUDE_MEM_DATA_DIR)return s.CLAUDE_MEM_DATA_DIR}}catch{}return n}var b=Jt(),x=process.env.CLAUDE_CONFIG_DIR||(0,T.join)((0,oe.homedir)(),".claude"),Us=(0,T.join)(x,"plugins","marketplaces","thedotmack"),Qt=(0,T.join)(b,"archives"),zt=(0,T.join)(b,"logs"),Zt=(0,T.join)(b,"trash"),es=(0,T.join)(b,"backups"),ts=(0,T.join)(b,"modes"),xs=(0,T.join)(b,"settings.json"),be=(0,T.join)(b,"claude-mem.db"),ss=(0,T.join)(b,"vector-db"),he=(0,T.join)(b,"observer-sessions"),ie=(0,T.basename)(he),ks=(0,T.join)(x,"settings.json"),Fs=(0,T.join)(x,"commands"),ws=(0,T.join)(x,"CLAUDE.md");function Ae(n){(0,U.mkdirSync)(n,{recursive:!0})}function Ne(){return(0,T.join)(Kt,"..")}var F={dataDir:()=>b,workerPid:()=>(0,T.join)(b,"worker.pid"),serverBetaPid:()=>(0,T.join)(b,".server-beta.pid"),serverBetaPort:()=>(0,T.join)(b,".server-beta.port"),serverBetaRuntime:()=>(0,T.join)(b,".server-beta.runtime.json"),settings:()=>(0,T.join)(b,"settings.json"),database:()=>(0,T.join)(b,"claude-mem.db"),chroma:()=>(0,T.join)(b,"chroma"),combinedCerts:()=>(0,T.join)(b,"combined_certs.pem"),transcriptsConfig:()=>(0,T.join)(b,"transcript-watch.json"),transcriptsState:()=>(0,T.join)(b,"transcript-watch-state.json"),corpora:()=>(0,T.join)(b,"corpora"),supervisorRegistry:()=>(0,T.join)(b,"supervisor.json"),envFile:()=>(0,T.join)(b,".env"),logsDir:()=>zt,archives:()=>Qt,trash:()=>Zt,backups:()=>es,modes:()=>ts,vectorDb:()=>ss,observerSessions:()=>he};var Ie=require("crypto");function ae(n,e,t){return(0,Ie.createHash)("sha256").update([n||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function de(n){if(!n)return[];try{let e=JSON.parse(n);return Array.isArray(e)?e:[String(e)]}catch{return[n]}}var c="claude";function ns(n){return n.trim().toLowerCase().replace(/\s+/g,"-")}function I(n){if(!n)return c;let e=ns(n);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:c}function Ce(n){let e=["claude","codex","cursor"];return[...n].sort((t,s)=>{let r=e.indexOf(t),o=e.indexOf(s);return r!==-1||o!==-1?r===-1?1:o===-1?-1:r-o:t.localeCompare(s)})}function Le(n,e,t,s,r){let o=Date.now()-s,i=r!==void 0?"up.session_db_id = ?":"up.content_session_id = ?",a=r??e;return n.prepare(`
  ...
  `).get(a,t,o)??void 0}var ve=["private","claude-mem-context","system_instruction","system-instruction","persisted-output","system-reminder"],De=new RegExp(`<(${ve.join("|")})\\b[^>]*>[\\s\\S]*?</\\1>`,"g"),ye=/<system-reminder>[\s\S]*?<\/system-reminder>/g,Me=100;function os(n){let e=Object.fromEntries(ve.map(r=>[r,0]));De.lastIndex=0;let t=0,s=n.replace(De,(r,o)=>(e[o]=(e[o]??0)+1,t+=1,""));return t>Me&&E.warn("SYSTEM","tag count exceeds limit",void 0,{tagCount:t,maxAllowed:Me,contentLength:n.length}),{stripped:s.trim(),counts:e}}function Ue(n){return os(n).stripped}var is=["task-notification"],Ws=new RegExp(`^\\s*<(${is.join("|")})\\b[^>]*>(?:(?!<\\1\\b|</\\1\\b)[\\s\\S])*</\\1>\\s*$`),Vs=256*1024;var _e=4e3;function j(n){let e=n.trim(),s=Ue(n).trim()||e;return s.length<=_e?s:(E.debug("DB","Truncated stored prompt text to the configured cap",{originalLength:s.length,storedLength:_e}),`${s.slice(0,_e-1)}\u2026`)}function as(n,e){return{customTitle:n,platformSource:e?I(e):void 0}}var W=class{db;constructor(e=be){e instanceof ue.Database?this.db=e:(e!==":memory:"&&Ae(b),this.db=new ue.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.db.run("PRAGMA journal_size_limit = 4194304")),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn(),this.ensureSDKSessionsPlatformContentIdentity(),this.ensureUserPromptsSessionDbId(),this.ensurePendingMessagesSessionToolUniqueIndex()}getIndexColumns(e){return this.db.query(`PRAGMA index_info(${JSON.stringify(e)})`).all().map(t=>t.name)}hasUniqueIndexOnColumns(e,t){return this.db.query(`PRAGMA index_list(${e})`).all().some(r=>{if(r.unique!==1)return!1;let o=this.getIndexColumns(r.name);return o.length===t.length&&o.every((i,a)=>i===t[a])})}resolvePromptSessionDbId(e,t,s){if(t!==void 0)return t;let r=s?I(s):void 0;return r?this.db.prepare(`
    ...
    `).all(ie),t=[],s=new Set,r={};for(let i of e){let a=I(i.platform_source);r[a]||(r[a]=[]),r[a].includes(i.project)||r[a].push(i.project),s.has(i.project)||(s.add(i.project),t.push(i.project))}let o=Ce(Object.keys(r));return{projects:t,sources:o,projectsBySource:Object.fromEntries(o.map(i=>[i,r[i]||[]]))}}getLatestUserPrompt(e,t){let s=this.resolvePromptSessionDbId(e,t),r=s!==null?"up.session_db_id = ?":"up.content_session_id = ?",o=s!==null?s:e;return this.db.prepare(`
      ...
      ORDER BY up.created_at_epoch DESC
      LIMIT 1
    `).get(o)}findRecentDuplicateUserPrompt(e,t,s,r){return Le(this.db,e,j(t),s,this.resolvePromptSessionDbId(e,r)??void 0)}getRecentSessionsWithStatus(e,t=3,s){let r=[e],o="";return s&&(o=`AND COALESCE(NULLIF(s.platform_source, ''), '${c}') = ?`,r.push(I(s))),r.push(t),this.db.prepare(`
      SELECT * FROM (
        SELECT
          s.memory_session_id,
          s.status,
    ...
    `).get(e,I(t))||null:this.db.prepare(`
        ...
        FROM observations
        WHERE id = ?
      `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:r,project:o,platformSource:i,type:a,concepts:d,files:_}=t,m=s==="relevance",l=m?"":`ORDER BY o.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,p=r&&!m?`LIMIT ${r}`:"",g=e.map(()=>"?").join(","),A=[...e],h=[];if(o&&(h.push("o.project = ?"),A.push(o)),i&&(h.push(`COALESCE(NULLIF(s.platform_source, ''), '${c}') = ?`),A.push(I(i))),a)if(Array.isArray(a)){let N=a.map(()=>"?").join(",");h.push(`o.type IN (${N})`),A.push(...a)}else h.push("o.type = ?"),A.push(a);if(d){let N=Array.isArray(d)?d:[d],R=N.map(()=>"EXISTS (SELECT 1 FROM json_each(o.concepts) WHERE value = ?)");A.push(...N),h.push(`(${R.join(" OR ")})`)}if(_){let N=Array.isArray(_)?_:[_],R=N.map(()=>"(EXISTS (SELECT 1 FROM json_each(o.files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(o.files_modified) WHERE value LIKE ?))");N.forEach(L=>{A.push(`%${L}%`,`%${L}%`)}),h.push(`(${R.join(" OR ")})`)}let f=h.length>0?`WHERE o.id IN (${g}) AND ${h.join(" AND ")}`:`WHERE o.id IN (${g})`,C=this.db.prepare(`
      SELECT o.*
      FROM observations o
      LEFT JOIN sdk_sessions s ON s.memory_session_id = o.memory_session_id
      ${f}
    ...
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,r||null,o,d,a);return{id:Number(m.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,r,o,i=0,a,d){let _=a??Date.now(),m=new Date(_).toISOString();return this.db.transaction(()=>{let p=[],g=this.db.prepare(`
      ...
      ${d}
      ${_}
    `).all(...l);if(!a)return h;let f=new Map(h.map(C=>[C.id,C])),S=e.map(C=>f.get(C)).filter(C=>!!C);return r?S.slice(0,r):S}getUserPromptsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:r,project:o,platformSource:i}=t,a=s==="relevance",d=a?"":`ORDER BY up.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,_=r?`LIMIT ${r}`:"",m=e.map(()=>"?").join(","),l=[...e],p=[];o&&(p.push("s.project = ?"),l.push(o)),i&&(p.push(`COALESCE(NULLIF(s.platform_source, ''), '${c}') = ?`),l.push(I(i)));let g=p.length>0?`AND ${p.join(" AND ")}`:"",h=this.db.prepare(`
      SELECT
        up.*,
        s.project,
        s.memory_session_id,
      ...
      ${d}
      ${_}
    `).all(...l);if(!a)return h;let f=new Map(h.map(S=>[S.id,S]));return e.map(S=>f.get(S)).filter(S=>!!S)}getTimelineAroundTimestamp(e,t=10,s=10,r,o){return this.getTimelineAroundObservation(null,e,t,s,r,o)}getTimelineAroundObservation(e,t,s=10,r=10,o,i){let a=i?I(i):void 0,d=(O,N)=>{let R=[],L=[];return o&&(R.push(`${O}.project = ?`),L.push(o)),a&&(R.push(`COALESCE(NULLIF(${N}.platform_source, ''), '${c}') = ?`),L.push(a)),{clause:R.length>0?`AND ${R.join(" AND ")}`:"",params:L}},_=d("o","src"),m=d("ss","src"),l=d("s","s"),p,g;if(e!==null){let O=`
      ...
      `,N=`
        ...
        LIMIT ?
      `;try{let R=this.db.prepare(O).all(t,..._.params,s),L=this.db.prepare(N).all(t,..._.params,r+1);if(R.length===0&&L.length===0)return{observations:[],sessions:[],prompts:[]};p=R.length>0?R[R.length-1].created_at_epoch:t,g=L.length>0?L[L.length-1].created_at_epoch:t}catch(R){return R instanceof Error?E.error("DB","Error getting boundary timestamps",{project:o},R):E.error("DB","Error getting boundary timestamps with non-Error",{},new Error(String(R))),{observations:[],sessions:[],prompts:[]}}}let A=`
      SELECT o.*
      FROM observations o
      LEFT JOIN sdk_sessions src ON src.memory_session_id = o.memory_session_id
...
`):null}function Ts(n,e,t,s){let r=[];r.push(...rt(n));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=Te(a.displayTime);r.push(...at(a,d))}else{let a=i.data,d=ge(a.created_at),m=d!==o?d:"";if(o=d,t.has(a.id)){let p=Dt(a,s);r.push(...it(a,m,p,s))}else r.push(ot(a,m,s))}return r}function gs(n,e,t,s,r){let o=[];o.push(...gt(n));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let _=d.data,m=Te(_.displayTime);o.push(...Rt(_,m))}else{let _=d.data,m=Lt(_.files_modified,r,_.files_read),l=ge(_.created_at),p=l!==a;a=l;let g=t.has(_.id);if(m!==i&&(o.push(...St(m)),i=m),g){let A=Dt(_,s);o.push(...Ot(_,l,p,A,s))}else o.push(ft(_,l,p,s))}return o.push(""),o}function Ss(n,e,t,s,r,o){return o?gs(n,e,t,s,r):Ts(n,e,t,s)}function Mt(n,e,t,s,r){let o=[],i=ls(n);for(let[a,d]of i)o.push(...Ss(a,d,e,t,s,r));return o}function vt(n,e,t){return!(!n.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function yt(n,e){let t=[];return e?(t.push(...G("Investigated",n.investigated,u.blue)),t.push(...G("Learned",n.learned,u.yellow)),t.push(...G("Completed",n.completed,u.green)),t.push(...G("Next Steps",n.next_steps,u.magenta))):(t.push(...X("Investigated",n.investigated)),t.push(...X("Learned",n.learned)),t.push(...X("Completed",n.completed)),t.push(...X("Next Steps",n.next_steps))),t}function Ut(n,e){return e?bt(n):dt(n)}function xt(n,e,t){return!J(e)||n.totalDiscoveryTokens<=0||n.savings<=0?[]:t?ht(n.totalDiscoveryTokens,n.totalReadTokens):_t(n.totalDiscoveryTokens,n.totalReadTokens)}var fs=kt.default.join((0,Ft.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function Os(){try{return new W}catch(n){if(n instanceof Error&&n.code==="ERR_DLOPEN_FAILED"){try{(0,wt.unlinkSync)(fs)}catch(e){e instanceof Error?E.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):E.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return E.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw n}}function Rs(n,e){return e?At(n):ut(n)}function bs(n,e,t,s,r,o,i){let a=[],d=ce(e);a.push(...Nt(n,d,s,i));let _=t.slice(0,s.sessionCount),m=Je(_,t),l=Qe(e,m),p=ze(e,s.fullObservationCount);a.push(...Mt(l,p,s,r,i));let g=t[0],A=e[0];vt(s,g,A)&&a.push(...yt(g,i));let h=Ke(e,s,o,r);return a.push(...Ut(h,i)),a.push(...xt(d,s,i)),a.join(`
`).trimEnd()}var hs=new Set(["bugfix","discovery","decision","refactor"]);function As(n,e,t){let s=ce(n),r={bugfix:0,discovery:0,decision:0,refactor:0,other:0},o=new Set,i=Number.POSITIVE_INFINITY;for(let d of n){let _=hs.has(d.type)?d.type:"other";r[_]++,d.memory_session_id&&o.add(d.memory_session_id),d.created_at_epoch&&d.created_at_epoch<i&&(i=d.created_at_epoch)}let a=Number.isFinite(i)?Math.max(0,Math.floor((Date.now()-i)/864e5)):0;return{observation_count:n.length,session_count:o.size,timeline_depth_days:a,has_session_summary:e.length>0,obs_type_bugfix:r.bugfix,obs_type_discovery:r.discovery,obs_type_decision:r.decision,obs_type_refactor:r.refactor,obs_type_other:r.other,tokens_injected:s.totalReadTokens,tokens_saved_vs_naive:s.savings,search_strategy:t?"full":"timeline"}}async function Se(n,e=!1){let t=Xe(),s=n?.cwd??process.cwd(),r=$e(s),o=n?.projects?.length?n.projects:r.allProjects,i=o[o.length-1]??r.primary;n?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let a=Os();if(!a)return{text:"",stats:null};try{let d=n?.platformSource?I(n.platformSource):void 0,_=o.length>1?Ye(a,o,t,d):We(a,i,t,d),m=o.length>1?qe(a,o,t,d):Ve(a,i,t,d);return _.length===0&&m.length===0?{text:Rs(i,e),stats:null}:{text:bs(i,_,m,t,s,n?.session_id,e),stats:As(_,m,!!n?.full)}}finally{a.close()}}async function Pt(n,e=!1){return(await Se(n,e)).text}0&&(module.exports={generateContext,generateContextWithStats});
