"use strict";var Hs=Object.create;var V=Object.defineProperty;var Bs=Object.getOwnPropertyDescriptor;var js=Object.getOwnPropertyNames;var Ws=Object.getPrototypeOf,Vs=Object.prototype.hasOwnProperty;var Ks=(n,e)=>{for(var s in e)V(n,s,{get:e[s],enumerable:!0})},Oe=(n,e,s,t)=>{if(e&&typeof e=="object"||typeof e=="function")for(let r of js(e))!Vs.call(n,r)&&r!==s&&V(n,r,{get:()=>e[r],enumerable:!(t=Bs(e,r))||t.enumerable});return n};var w=(n,e,s)=>(s=n!=null?Hs(Ws(n)):{},Oe(e||!n||!n.__esModule?V(s,"default",{value:n,enumerable:!0}):s,n)),Ys=n=>Oe(V({},"__esModule",{value:!0}),n);var yt={};Ks(yt,{generateContext:()=>Gs,generateContextWithStats:()=>fe});module.exports=Ys(yt);var Ps=w(require("path"),1),$s=require("os"),Xs=require("fs");var Ee=require("bun:sqlite");var f=require("path"),re=require("os"),x=require("fs"),Re=require("url"),et={};function qs(){return typeof __dirname<"u"?__dirname:(0,f.dirname)((0,Re.fileURLToPath)(et.url))}var Js=qs();function Qs(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let n=(0,f.join)((0,re.homedir)(),".claude-mem"),e=(0,f.join)(n,"settings.json");try{if((0,x.existsSync)(e)){let s=JSON.parse((0,x.readFileSync)(e,"utf-8")),t=s.env??s;if(t.CLAUDE_MEM_DATA_DIR)return t.CLAUDE_MEM_DATA_DIR}}catch{}return n}var N=Qs(),ne=process.env.CLAUDE_CONFIG_DIR||(0,f.join)((0,re.homedir)(),".claude"),kt=(0,f.join)(ne,"plugins","marketplaces","thedotmack"),zs=(0,f.join)(N,"logs"),Ft=(0,f.join)(N,"settings.json"),be=(0,f.join)(N,"claude-mem.db"),Zs=(0,f.join)(N,"observer-sessions"),oe=(0,f.basename)(Zs);function he(n){(0,x.mkdirSync)(n,{recursive:!0})}function Ae(){return(0,f.join)(Js,"..")}var P={dataDir:()=>N,workerPid:()=>(0,f.join)(N,"worker.pid"),serverPid:()=>(0,f.join)(N,".server-beta.pid"),serverPort:()=>(0,f.join)(N,".server-beta.port"),serverRuntime:()=>(0,f.join)(N,".server-beta.runtime.json"),settings:()=>(0,f.join)(N,"settings.json"),database:()=>(0,f.join)(N,"claude-mem.db"),chroma:()=>(0,f.join)(N,"chroma"),combinedCerts:()=>(0,f.join)(N,"combined_certs.pem"),transcriptsConfig:()=>(0,f.join)(N,"transcript-watch.json"),transcriptsState:()=>(0,f.join)(N,"transcript-watch-state.json"),corpora:()=>(0,f.join)(N,"corpora"),supervisorRegistry:()=>(0,f.join)(N,"supervisor.json"),envFile:()=>(0,f.join)(N,".env"),logsDir:()=>zs};var y=require("fs"),Ne=require("path");var st=null;function tt(n){return(st??process.stderr.write.bind(process.stderr))(n)}function v(n){tt(n)}var ae=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(ae||{}),ie=null,de=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=P.logsDir();(0,y.existsSync)(e)||(0,y.mkdirSync)(e,{recursive:!0});let s=new Date().toISOString().split("T")[0];this.logFilePath=(0,Ne.join)(e,`claude-mem-${s}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=P.settings();if((0,y.existsSync)(e)){let s=(0,y.readFileSync)(e,"utf-8"),r=(JSON.parse(s).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=ae[r]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`+JSON.stringify(o,null,2)}catch{m=" "+this.formatData(o)}else m=" "+this.formatData(o);let l="";if(r){let{sessionId:T,memorySessionId:h,correlationId:b,...g}=r;Object.keys(g).length>0&&(l=` {${Object.entries(g).map(([C,U])=>`${C}=${U}`).join(", ")}}`)}let p=`[${i}] [${a}] [${d}] ${_}${t}${l}${m}`;if(this.logFilePath)try{(0,y.appendFileSync)(this.logFilePath,p+`
`,"utf8")}catch(T){let h=T instanceof Error?T:new Error(String(T));v(`[LOGGER] Failed to write to log file: ${h.message}
${h.stack??""}
`)}else v(p+`
`)}debug(e,s,t,r){this.log(0,e,s,t,r)}info(e,s,t,r){this.log(1,e,s,t,r)}warn(e,s,t,r){this.log(2,e,s,t,r)}setErrorSink(e){ie=e}error(e,s,t,r){this.log(3,e,s,t,r),this.routeErrorToSink(s,t,r)}routeErrorToSink(e,s,t){try{if(!ie||!(t instanceof Error))return;ie(t)}catch{}}dataIn(e,s,t,r){this.info(e,`\u2192 ${s}`,t,r)}dataOut(e,s,t,r){this.info(e,`\u2190 ${s}`,t,r)}success(e,s,t,r){this.info(e,`\u2713 ${s}`,t,r)}failure(e,s,t,r){this.error(e,`\u2717 ${s}`,t,r)}},E=new de;var Ie=require("crypto");function Ce(n,e,s){return(0,Ie.createHash)("sha256").update([n||"",e||"",s||""].join("\0")).digest("hex").slice(0,16)}var c="claude";function rt(n){return n.trim().toLowerCase().replace(/\s+/g,"-")}function I(n){if(!n)return c;let e=rt(n);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:c}function Le(n){let e=["claude","codex","cursor"];return[...n].sort((s,t)=>{let r=e.indexOf(s),o=e.indexOf(t);return r!==-1||o!==-1?r===-1?1:o===-1?-1:r-o:s.localeCompare(t)})}function Me(n,e,s,t,r){let o=Date.now()-t,i=r!==void 0?"up.session_db_id = ?":"up.content_session_id = ?",a=r??e;return n.prepare(`
    SELECT
      up.*,
      s.memory_session_id,
      s.project,
  ...
  `).get(a,s,o)??void 0}var ye=["private","claude-mem-context","system_instruction","system-instruction","persisted-output","system-reminder"],De=new RegExp(`<(${ye.join("|")})\\b[^>]*>[\\s\\S]*?</\\1>`,"g"),Ue=/<system-reminder>[\s\S]*?<\/system-reminder>/g,ve=100;function nt(n){let e=Object.fromEntries(ye.map(r=>[r,0]));De.lastIndex=0;let s=0,t=n.replace(De,(r,o)=>(e[o]=(e[o]??0)+1,s+=1,""));return s>ve&&E.warn("SYSTEM","tag count exceeds limit",void 0,{tagCount:s,maxAllowed:ve,contentLength:n.length}),{stripped:t.trim(),counts:e}}function xe(n){return nt(n).stripped}var ot=["task-notification"],Kt=new RegExp(`^\\s*<(${ot.join("|")})\\b[^>]*>(?:(?!<\\1\\b|</\\1\\b)[\\s\\S])*</\\1>\\s*$`),Yt=256*1024;var _e=4e3;function K(n){let e=n.trim(),t=xe(n).trim()||e;return t.length<=_e?t:(E.debug("DB","Truncated stored prompt text to the configured cap",{originalLength:t.length,storedLength:_e}),`${t.slice(0,_e-1)}\u2026`)}var Y=class{db;constructor(e=be){e instanceof Ee.Database?this.db=e:(e!==":memory:"&&he(N),this.db=new Ee.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.db.run("PRAGMA journal_size_limit = 4194304")),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn(),this.ensureSDKSessionsPlatformContentIdentity(),this.ensureUserPromptsSessionDbId(),this.ensurePendingMessagesSessionToolUniqueIndex()}getIndexColumns(e){return this.db.query(`PRAGMA index_info(${JSON.stringify(e)})`).all().map(s=>s.name)}hasUniqueIndexOnColumns(e,s){return this.db.query(`PRAGMA index_list(${e})`).all().some(r=>{if(r.unique!==1)return!1;let o=this.getIndexColumns(r.name);return o.length===s.length&&o.every((i,a)=>i===s[a])})}resolvePromptSessionDbId(e,s,t){if(s!==void 0)return s;let r=t?I(t):void 0;return r?this.db.prepare(`
    ...
    `).get(e);if(!r)throw new Error(`Session ${e} not found in sdk_sessions`);r.memory_session_id!==s&&(this.db.prepare(`
      ...
      WHERE project IS NOT NULL AND project != ''
        AND project != ?
    `,r=[oe];return s&&(t+=" AND COALESCE(platform_source, ?) = ?",r.push(c,s)),t+=" ORDER BY project ASC",this.db.prepare(t).all(...r).map(i=>i.project)}getProjectCatalog(){let e=this.db.prepare(`
      SELECT
    ...
    `).all(oe),s=[],t=new Set,r={};for(let i of e){let a=I(i.platform_source);r[a]||(r[a]=[]),r[a].includes(i.project)||r[a].push(i.project),t.has(i.project)||(t.add(i.project),s.push(i.project))}let o=Le(Object.keys(r));return{projects:s,sources:o,projectsBySource:Object.fromEntries(o.map(i=>[i,r[i]||[]]))}}getLatestUserPrompt(e,s){let t=this.resolvePromptSessionDbId(e,s),r=t!==null?"up.session_db_id = ?":"up.content_session_id = ?",o=t!==null?t:e;return this.db.prepare(`
      ...
      ORDER BY up.created_at_epoch DESC
      LIMIT 1
    `).get(o)}findRecentDuplicateUserPrompt(e,s,t,r){return Me(this.db,e,K(s),t,this.resolvePromptSessionDbId(e,r)??void 0)}getRecentSessionsWithStatus(e,s=3,t){let r=[e],o="";return t&&(o=`AND COALESCE(NULLIF(s.platform_source, ''), '${c}') = ?`,r.push(I(t))),r.push(s),this.db.prepare(`
      SELECT * FROM (
        SELECT
          s.memory_session_id,
          s.status,
    ...
    `).get(e,I(s))||null:this.db.prepare(`
        ...
        FROM observations
        WHERE id = ?
      `).get(e)||null}getObservationsByIds(e,s={}){if(e.length===0)return[];let{orderBy:t="date_desc",limit:r,project:o,platformSource:i,type:a,concepts:d,files:_}=s,m=t==="relevance",l=m?"":`ORDER BY o.created_at_epoch ${t==="date_asc"?"ASC":"DESC"}`,p=r&&!m?`LIMIT ${r}`:"",T=e.map(()=>"?").join(","),h=[...e],b=[];if(o&&(b.push("o.project = ?"),h.push(o)),i&&(b.push(`COALESCE(NULLIF(s.platform_source, ''), '${c}') = ?`),h.push(I(i))),a)if(Array.isArray(a)){let A=a.map(()=>"?").join(",");b.push(`o.type IN (${A})`),h.push(...a)}else b.push("o.type = ?"),h.push(a);if(d){let A=Array.isArray(d)?d:[d],R=A.map(()=>"EXISTS (SELECT 1 FROM json_each(o.concepts) WHERE value = ?)");h.push(...A),b.push(`(${R.join(" OR ")})`)}if(_){let A=Array.isArray(_)?_:[_],R=A.map(()=>"(EXISTS (SELECT 1 FROM json_each(o.files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(o.files_modified) WHERE value LIKE ?))");A.forEach(L=>{h.push(`%${L}%`,`%${L}%`)}),b.push(`(${R.join(" OR ")})`)}let g=b.length>0?`WHERE o.id IN (${T}) AND ${b.join(" AND ")}`:`WHERE o.id IN (${T})`,C=this.db.prepare(`
      SELECT o.*
      FROM observations o
      LEFT JOIN sdk_sessions s ON s.memory_session_id = o.memory_session_id
      ${g}
      ${l}
      ${p}
    `).all(...h);if(!m)return C;let U=new Map(C.map(A=>[A.id,A])),O=e.map(A=>U.get(A)).filter(A=>!!A);return r?O.slice(0,r):O}getSummaryForSession(e,s){let t=[e],r="";return s&&(r=`
        AND EXISTS (
          SELECT 1
    ...
    `).get(e).count}createSDKSession(e,s,t,r,o){let i=new Date,a=i.getTime(),d=o?I(o):c,_=K(t),m=this.db.prepare(`
      SELECT id, platform_source
      FROM sdk_sessions
      WHERE COALESCE(NULLIF(platform_source, ''), ?) = ?
        AND content_session_id = ?
    `).get(c,d,e);if(m)return s&&this.db.prepare(`
      ...
      VALUES (?, NULL, ?, ?, ?, ?, ?, ?, 'active')
    `).run(e,s,d,_,r||null,i.toISOString(),a);return Number(l.lastInsertRowid)}saveUserPrompt(e,s,t,r){let o=new Date,i=o.getTime(),a=K(t),d=this.resolvePromptSessionDbId(e,r);return this.db.prepare(`
    ...
    `).get(e,s)?.prompt_text??null}storeObservation(e,s,t,r,o=0,i,a){let d=this.storeObservations(e,s,[t],null,r,o,i,a);return{id:d.observationIds[0],createdAtEpoch:d.createdAtEpoch}}storeSummary(e,s,t,r,o=0,i){let a=i??Date.now(),d=new Date(a).toISOString(),m=this.db.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,s,t.request,t.investigated,t.learned,t.completed,t.next_steps,t.notes,r||null,o,d,a);return{id:Number(m.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,s,t,r,o,i=0,a,d){let _=a??Date.now(),m=new Date(_).toISOString();return this.db.transaction(()=>{let p=[],T=this.db.prepare(`
        ...
        RETURNING id
      `),h=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let g of t){let S=Ce(e,g.title,g.narrative),C=T.get(e,s,g.type,g.title,g.subtitle,JSON.stringify(g.facts),g.narrative,JSON.stringify(g.concepts),JSON.stringify(g.files_read),JSON.stringify(g.files_modified),o||null,i,g.agent_type??null,g.agent_id??null,S,m,_,d||null,g.metadata??null);if(C){p.push(C.id);continue}let U=h.get(e,S);if(!U)throw new Error(`storeObservations: ON CONFLICT without existing row for content_hash=${S}`);p.push(U.id)}let b=null;if(r){let S=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,s,r.request,r.investigated,r.learned,r.completed,r.next_steps,r.notes,o||null,i,m,_);b=Number(S.lastInsertRowid)}return{observationIds:p,summaryId:b,createdAtEpoch:_}})()}getSessionSummariesByIds(e,s={}){if(e.length===0)return[];let{orderBy:t="date_desc",limit:r,project:o,platformSource:i}=s,a=t==="relevance",d=a?"":`ORDER BY ss.created_at_epoch ${t==="date_asc"?"ASC":"DESC"}`,_=r&&!a?`LIMIT ${r}`:"",m=e.map(()=>"?").join(","),l=[...e],p=[];o&&(p.push("ss.project = ?"),l.push(o)),i&&(p.push(`COALESCE(NULLIF(s.platform_source, ''), '${c}') = ?`),l.push(I(i)));let T=p.length>0?`AND ${p.join(" AND ")}`:"",b=this.db.prepare(`
      SELECT ss.*
      ...
      ${d}
      ${_}
    `).all(...l);if(!a)return b;let g=new Map(b.map(C=>[C.id,C])),S=e.map(C=>g.get(C)).filter(C=>!!C);return r?S.slice(0,r):S}getUserPromptsByIds(e,s={}){if(e.length===0)return[];let{orderBy:t="date_desc",limit:r,project:o,platformSource:i}=s,a=t==="relevance",d=a?"":`ORDER BY up.created_at_epoch ${t==="date_asc"?"ASC":"DESC"}`,_=r?`LIMIT ${r}`:"",m=e.map(()=>"?").join(","),l=[...e],p=[];o&&(p.push("s.project = ?"),l.push(o)),i&&(p.push(`COALESCE(NULLIF(s.platform_source, ''), '${c}') = ?`),l.push(I(i)));let T=p.length>0?`AND ${p.join(" AND ")}`:"",b=this.db.prepare(`
      SELECT
        up.*,
        s.project,
        s.memory_session_id,
      ...
      ${d}
      ${_}
    `).all(...l);if(!a)return b;let g=new Map(b.map(S=>[S.id,S]));return e.map(S=>g.get(S)).filter(S=>!!S)}getTimelineAroundTimestamp(e,s=10,t=10,r,o){return this.getTimelineAroundObservation(null,e,s,t,r,o)}getTimelineAroundObservation(e,s,t=10,r=10,o,i){let a=i?I(i):void 0,d=(O,A)=>{let R=[],L=[];return o&&(R.push(`${O}.project = ?`),L.push(o)),a&&(R.push(`COALESCE(NULLIF(${A}.platform_source, ''), '${c}') = ?`),L.push(a)),{clause:R.length>0?`AND ${R.join(" AND ")}`:"",params:L}},_=d("o","src"),m=d("ss","src"),l=d("s","s"),p,T;if(e!==null){let O=`
      ...
      `,A=`
        ...
        LIMIT ?
      `;try{let R=this.db.prepare(O).all(s,..._.params,t),L=this.db.prepare(A).all(s,..._.params,r+1);if(R.length===0&&L.length===0)return{observations:[],sessions:[],prompts:[]};p=R.length>0?R[R.length-1].created_at_epoch:s,T=L.length>0?L[L.length-1].created_at_epoch:s}catch(R){return R instanceof Error?E.error("DB","Error getting boundary timestamps",{project:o},R):E.error("DB","Error getting boundary timestamps with non-Error",{},new Error(String(R))),{observations:[],sessions:[],prompts:[]}}}let h=`
      SELECT o.*
      FROM observations o
      LEFT JOIN sdk_sessions src ON src.memory_session_id = o.memory_session_id
...
`);let r=this.getAllDefaults();return s?this.applyEnvOverrides(r):r}}};var H=require("fs"),z=require("path");var M=class n{static instance=null;activeMode=null;modesDir;constructor(){let e=Ae(),s=[...process.env.CLAUDE_MEM_MODES_DIR?[process.env.CLAUDE_MEM_MODES_DIR]:[],(0,z.join)(e,"modes"),(0,z.join)(e,"..","plugin","modes")],t=s.find(r=>(0,H.existsSync)(r));this.modesDir=t||s[0]}static getInstance(){return n.instance||(n.instance=new n),n.instance}parseInheritance(e){let s=e.split("--");if(s.length===1)return{hasParent:!1,parentId:"",overrideId:""};if(s.length>2)throw new Error(`Invalid mode inheritance: ${e}. Only one level of inheritance supported (parent--override)`);return{hasParent:!0,parentId:s[0],overrideId:e}}isPlainObject(e){return e!==null&&typeof e=="object"&&!Array.isArray(e)}deepMerge(e,s){let t={...e};for(let r in s){let o=s[r],i=e[r];this.isPlainObject(o)&&this.isPlainObject(i)?t[r]=this.deepMerge(i,o):t[r]=o}return t}loadModeFile(e){let s=(0,z.join)(this.modesDir,`${e}.json`);if(!(0,H.existsSync)(s))throw new Error(`Mode file not found: ${s}`);let t=(0,H.readFileSync)(s,"utf-8");return JSON.parse(t)}loadMode(e){let s=this.parseInheritance(e);if(!s.hasParent)try{let d=this.loadModeFile(e);return this.activeMode=d,E.debug("SYSTEM",`Loaded mode: ${d.name} (${e})`,void 0,{types:d.observation_types.map(_=>_.id),concepts:d.observation_concepts.map(_=>_.id)}),d}catch(d){if(d instanceof Error?E.warn("WORKER",`Mode file not found: ${e}, falling back to 'code'`,{message:d.message}):E.warn("WORKER",`Mode file not found: ${e}, falling back to 'code'`,{error:String(d)}),e==="code")throw new Error("Critical: code.json mode file missing");return this.loadMode("code")}let{parentId:t,overrideId:r}=s,o;try{o=this.loadMode(t)}catch(d){d instanceof Error?E.warn("WORKER",`Parent mode '${t}' not found for ${e}, falling back to 'code'`,{message:d.message}):E.warn("WORKER",`Parent mode '${t}' not found for ${e}, falling back to 'code'`,{error:String(d)}),o=this.loadMode("code")}let i;try{i=this.loadModeFile(r),E.debug("SYSTEM",`Loaded override file: ${r} for parent ${t}`)}catch(d){return d instanceof Error?E.warn("WORKER",`Override file '${r}' not found, using parent mode '${t}' only`,{message:d.message}):E.warn("WORKER",`Override file '${r}' not found, using parent mode '${t}' only`,{error:String(d)}),this.activeMode=o,o}if(!i)return E.warn("SYSTEM",`Invalid override file: ${r}, using parent mode '${t}' only`),this.activeMode=o,o;let a=this.deepMerge(o,i);return this.activeMode=a,E.debug("SYSTEM",`Loaded mode with inheritance: ${a.name} (${e} = ${t} + ${r})`,void 0,{parent:t,override:r,types:a.observation_types.map(d=>d.id),concepts:a.observation_concepts.map(d=>d.id)}),a}getActiveMode(){if(!this.activeMode)throw new Error("No mode loaded. Call loadMode() first.");return this.activeMode}getObservationTypes(){return this.getActiveMode().observation_types}getTypeIcon(e){return this.getObservationTypes().find(t=>t.id===e)?.emoji||"\u{1F4DD}"}getWorkEmoji(e){return this.getObservationTypes().find(t=>t.id===e)?.work_emoji||"\u{1F4DD}"}};var Et=50,ut=0,mt=10;function pe(n,e){let s=parseInt(String(n??""),10);return Number.isFinite(s)&&s>=0?s:e}function We(){let n=P.settings(),e=Q.loadFromFile(n),s=M.getInstance().getActiveMode(),t=new Set(s.observation_types.map(o=>o.id)),r=new Set(s.observation_concepts.map(o=>o.id));return{totalObservationCount:pe(e.CLAUDE_MEM_CONTEXT_OBSERVATIONS,Et),fullObservationCount:pe(e.CLAUDE_MEM_CONTEXT_FULL_COUNT,ut),sessionCount:pe(e.CLAUDE_MEM_CONTEXT_SESSION_COUNT,mt),showReadTokens:e.CLAUDE_MEM_CONTEXT_SHOW_READ_TOKENS==="true",showWorkTokens:e.CLAUDE_MEM_CONTEXT_SHOW_WORK_TOKENS==="true",showSavingsAmount:e.CLAUDE_MEM_CONTEXT_SHOW_SAVINGS_AMOUNT==="true",showSavingsPercent:e.CLAUDE_MEM_CONTEXT_SHOW_SAVINGS_PERCENT==="true",observationTypes:t,observationConcepts:r,fullObservationField:e.CLAUDE_MEM_CONTEXT_FULL_FIELD,showLastSummary:e.CLAUDE_MEM_CONTEXT_SHOW_LAST_SUMMARY==="true",showLastMessage:e.CLAUDE_MEM_CONTEXT_SHOW_LAST_MESSAGE==="true",mermaidContext:e.CLAUDE_MEM_MERMAID_CONTEXT==="true"}}var u={reset:"\x1B[0m",bright:"\x1B[1m",dim:"\x1B[2m",cyan:"\x1B[36m",green:"\x1B[32m",yellow:"\x1B[33m",blue:"\x1B[34m",magenta:"\x1B[35m",gray:"\x1B[90m",red:"\x1B[31m"},Ve=4,Ke=1;function Ye(n){let e=(n.title?.length||0)+(n.subtitle?.length||0)+(n.narrative?.length||0)+JSON.stringify(n.facts||[]).length;return Math.ceil(e/Ve)}function le(n){let e=n.length,s=n.reduce((i,a)=>i+Ye(a),0),t=n.reduce((i,a)=>i+(a.discovery_tokens||0),0),r=t-s,o=t>0?Math.round(r/t*100):0;return{totalObservations:e,totalReadTokens:s,totalDiscoveryTokens:t,savings:r,savingsPercent:o}}function ct(n){return M.getInstance().getWorkEmoji(n)}function B(n,e){let s=Ye(n),t=n.discovery_tokens||0,r=ct(n.type),o=t>0?`${r} ${t.toLocaleString()}`:"-";return{readTokens:s,discoveryTokens:t,discoveryDisplay:o,workEmoji:r}}function Z(n){return n.showReadTokens||n.showWorkTokens||n.showSavingsAmount||n.showSavingsPercent}var qe=w(require("path"),1),ee=require("fs");function Je(n,e,s,t){let r=Array.from(s.observationTypes),o=r.map(()=>"?").join(","),i=Array.from(s.observationConcepts),a=i.map(()=>"?").join(","),d=e.map(()=>"?").join(",");return n.db.prepare(`
    ...
    ORDER BY o.created_at_epoch DESC
    LIMIT ?
  `).all(...e,...e,t??null,t??null,...r,...i,s.totalObservationCount)}function Qe(n,e,s,t){let r=e.map(()=>"?").join(",");return n.db.prepare(`
    SELECT
      ss.id,
    ...
    LIMIT ?
  `).all(...e,...e,t??null,t??null,s.sessionCount+Ke)}function pt(n){return n.replace(/[/.]/g,"-")}function lt(n){if(!n.includes('"type":"assistant"'))return null;let e=JSON.parse(n);if(e.type==="assistant"&&e.message?.content&&Array.isArray(e.message.content)){let s="";for(let t of e.message.content)t.type==="text"&&(s+=t.text);if(s=s.replace(Ue,"").trim(),s)return s}return null}function Tt(n){for(let e=n.length-1;e>=0;e--)try{let s=lt(n[e]);if(s)return s}catch(s){s instanceof Error?E.debug("WORKER","Skipping malformed transcript line",{lineIndex:e},s):E.debug("WORKER","Skipping malformed transcript line",{lineIndex:e,error:String(s)});continue}return""}function gt(n){try{if(!(0,ee.existsSync)(n))return{assistantMessage:""};let e=(0,ee.readFileSync)(n,"utf-8").trim();if(!e)return{assistantMessage:""};let s=e.split(`
`).filter(r=>r.trim());return{assistantMessage:Tt(s)}}catch(e){return e instanceof Error?E.failure("WORKER","Failed to extract prior messages from transcript",{transcriptPath:n},e):E.warn("WORKER","Failed to extract prior messages from transcript",{transcriptPath:n,error:String(e)}),{assistantMessage:""}}}function ze(n,e,s,t){if(!e.showLastMessage||n.length===0)return{assistantMessage:""};let r=n.find(d=>d.memory_session_id!==s);if(!r)return{assistantMessage:""};let o=r.memory_session_id,i=pt(t),a=qe.default.join(ne,"projects",i,`${o}.jsonl`);return gt(a)}function Ze(n,e){let s=e[0]?.id;return n.map((t,r)=>{let o=null;for(let i=r+1;i<e.length;i++)if(e[i].project===t.project){o=e[i];break}return{...t,displayEpoch:o?o.created_at_epoch:t.created_at_epoch,displayTime:o?o.created_at:t.created_at,shouldShowLink:t.id!==s}})}function es(n,e){let s=[...n.map(t=>({type:"observation",data:t})),...e.map(t=>({type:"summary",data:t}))];return s.sort((t,r)=>{let o=t.type==="observation"?t.data.created_at_epoch:t.data.displayEpoch,i=r.type==="observation"?r.data.created_at_epoch:r.data.displayEpoch;return o-i}),s}function ss(n,e){return new Set(n.slice(0,e).map(s=>s.id))}var Te=w(require("path"),1);function k(n){if(!n)return[];try{let e=JSON.parse(n);return Array.isArray(e)?e:[]}catch(e){return E.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:n?.substring(0,50)},e instanceof Error?e:new Error(String(e))),[]}}function ge(n){return new Date(n).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function Se(n){return new Date(n).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function F(n=new Date){return n.toLocaleDateString("en-CA")}function rs(n){return new Date(n).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function ts(n,e){return Te.default.isAbsolute(n)?Te.default.relative(e,n):n}function ns(n,e,s){let t=k(n);if(t.length>0)return ts(t[0],e);if(s){let r=k(s);if(r.length>0)return ts(r[0],e)}return"General"}function os(n){let e=F();return[`# [${n}] recent context, ${e}`,""]}function is(){return[`Legend: \u{1F3AF}session ${M.getInstance().getActiveMode().observation_types.map(s=>`${s.emoji}${s.id}`).join(" ")}`,"Format: ID TIME TYPE TITLE","Fetch details: get_observations([IDs]) | Search: mem-search skill",""]}function as(n,e){let s=[],t=[`${n.totalObservations} obs (${n.totalReadTokens.toLocaleString()}t read)`,`${n.totalDiscoveryTokens.toLocaleString()}t work`];return n.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)&&(e.showSavingsPercent?t.push(`${n.savingsPercent}% savings`):e.showSavingsAmount&&t.push(`${n.savings.toLocaleString()}t saved`)),s.push(`Stats: ${t.join(" | ")}`),s.push(""),s}function ds(n){return[`### ${n}`]}function _s(n){return n.toLowerCase().replace(" am","a").replace(" pm","p")}function Es(n,e,s){let t=n.title||"Untitled",r=M.getInstance().getTypeIcon(n.type),o=e?_s(e):'"';return`${n.id} ${o} ${r} ${t}`}function us(n,e,s,t){let r=[],o=n.title||"Untitled",i=M.getInstance().getTypeIcon(n.type),a=e?_s(e):'"',{readTokens:d,discoveryDisplay:_}=B(n,t);r.push(`**${n.id}** ${a} ${i} **${o}**`),s&&r.push(s);let m=[];return t.showReadTokens&&m.push(`~${d}t`),t.showWorkTokens&&m.push(_),m.length>0&&r.push(m.join(" ")),r.push(""),r}function ms(n,e){return[`S${n.id} ${n.request||"Session started"} (${e})`]}function j(n,e){return e?[`**${n}**: ${e}`,""]:[]}function cs(n){return n.assistantMessage?["","---","","**Previously**","",`A: ${n.assistantMessage}`,""]:[]}function ps(n,e){return["",`Access ${Math.round(n/1e3)}k tokens of past work via get_observations([IDs]) or mem-search skill.`]}function ls(n){let e=F();return`# [${n}] recent context, ${e}

No previous sessions found.`}function Ts(n){let e=F();return["",`${u.bright}${u.cyan}[${n}] recent context, ${e}${u.reset}`,`${u.gray}${"\u2500".repeat(60)}${u.reset}`,""]}function gs(){let e=M.getInstance().getActiveMode().observation_types.map(s=>`${s.emoji} ${s.id}`).join(" | ");return[`${u.dim}Legend: session-request | ${e}${u.reset}`,""]}function Ss(){return[`${u.bright}Column Key${u.reset}`,`${u.dim}  Read: Tokens to read this observation (cost to learn it now)${u.reset}`,`${u.dim}  Work: Tokens spent on work that produced this record ( research, building, deciding)${u.reset}`,""]}function fs(){return[`${u.dim}Context Index: This semantic index (titles, types, files, tokens) is usually sufficient to understand past work.${u.reset}`,"",`${u.dim}When you need implementation details, rationale, or debugging context:${u.reset}`,`${u.dim}  - Fetch by ID: get_observations([IDs]) for observations visible in this index${u.reset}`,`${u.dim}  - Search history: Use the mem-search skill for past decisions, bugs, and deeper research${u.reset}`,`${u.dim}  - Trust this index over re-reading code for past decisions and learnings${u.reset}`,""]}function Os(n,e){let s=[];if(s.push(`${u.bright}${u.cyan}Context Economics${u.reset}`),s.push(`${u.dim}  Loading: ${n.totalObservations} observations (${n.totalReadTokens.toLocaleString()} tokens to read)${u.reset}`),s.push(`${u.dim}  Work investment: ${n.totalDiscoveryTokens.toLocaleString()} tokens spent on research, building, and decisions${u.reset}`),n.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)){let t="  Your savings: ";e.showSavingsAmount&&e.showSavingsPercent?t+=`${n.savings.toLocaleString()} tokens (${n.savingsPercent}% reduction from reuse)`:e.showSavingsAmount?t+=`${n.savings.toLocaleString()} tokens`:t+=`${n.savingsPercent}% reduction from reuse`,s.push(`${u.green}${t}${u.reset}`)}return s.push(""),s}function Rs(n){return[`${u.bright}${u.cyan}${n}${u.reset}`,""]}function bs(n){return[`${u.dim}${n}${u.reset}`]}function hs(n,e,s,t){let r=n.title||"Untitled",o=M.getInstance().getTypeIcon(n.type),{readTokens:i,discoveryTokens:a,workEmoji:d}=B(n,t),_=s?`${u.dim}${e}${u.reset}`:" ".repeat(e.length),m=t.showReadTokens&&i>0?`${u.dim}(~${i}t)${u.reset}`:"",l=t.showWorkTokens&&a>0?`${u.dim}(${d} ${a.toLocaleString()}t)${u.reset}`:"";return`  ${u.dim}#${n.id}${u.reset}  ${_}  ${o}  ${r} ${m} ${l}`}function As(n,e,s,t,r){let o=[],i=n.title||"Untitled",a=M.getInstance().getTypeIcon(n.type),{readTokens:d,discoveryTokens:_,workEmoji:m}=B(n,r),l=s?`${u.dim}${e}${u.reset}`:" ".repeat(e.length),p=r.showReadTokens&&d>0?`${u.dim}(~${d}t)${u.reset}`:"",T=r.showWorkTokens&&_>0?`${u.dim}(${m} ${_.toLocaleString()}t)${u.reset}`:"";return o.push(`  ${u.dim}#${n.id}${u.reset}  ${l}  ${a}  ${u.bright}${i}${u.reset}`),t&&o.push(`    ${u.dim}${t}${u.reset}`),(p||T)&&o.push(`    ${p} ${T}`),o.push(""),o}function Ns(n,e){let s=`${n.request||"Session started"} (${e})`;return[`${u.yellow}#S${n.id}${u.reset} ${s}`,""]}function W(n,e,s){return e?[`${s}${n}:${u.reset} ${e}`,""]:[]}function Is(n){return n.assistantMessage?["","---","",`${u.bright}${u.magenta}Previously${u.reset}`,"",`${u.dim}A: ${n.assistantMessage}${u.reset}`,""]:[]}function Cs(n,e){let s=Math.round(n/1e3);return["",`${u.dim}Access ${s}k tokens of past research & decisions for just ${e.toLocaleString()}t. Use the claude-mem skill to access memories by ID.${u.reset}`]}function Ls(n){let e=F();return`
...
`}function Ms(n,e,s,t){let r=[];return t?r.push(...Ts(n)):r.push(...os(n)),t?r.push(...gs()):r.push(...is()),t&&(r.push(...Ss()),r.push(...fs())),Z(s)&&(t?r.push(...Os(e,s)):r.push(...as(e,s))),r}function St(n){let e=new Map;for(let t of n){let r=t.type==="observation"?t.data.created_at:t.data.displayTime,o=rs(r);e.has(o)||e.set(o,[]),e.get(o).push(t)}let s=Array.from(e.entries()).sort((t,r)=>{let o=new Date(t[0]).getTime(),i=new Date(r[0]).getTime();return o-i});return new Map(s)}function Ds(n,e){return e.fullObservationField==="narrative"?n.narrative:n.facts?k(n.facts).join(`
`):null}function ft(n,e,s,t){let r=[];r.push(...ds(n));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=ge(a.displayTime);r.push(...ms(a,d))}else{let a=i.data,d=Se(a.created_at),m=d!==o?d:"";if(o=d,s.has(a.id)){let p=Ds(a,t);r.push(...us(a,m,p,t))}else r.push(Es(a,m,t))}return r}function Ot(n,e,s,t,r){let o=[];o.push(...Rs(n));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let _=d.data,m=ge(_.displayTime);o.push(...Ns(_,m))}else{let _=d.data,m=ns(_.files_modified,r,_.files_read),l=Se(_.created_at),p=l!==a;a=l;let T=s.has(_.id);if(m!==i&&(o.push(...bs(m)),i=m),T){let h=Ds(_,t);o.push(...As(_,l,p,h,t))}else o.push(hs(_,l,p,t))}return o.push(""),o}function Rt(n,e,s,t,r,o){return o?Ot(n,e,s,t,r):ft(n,e,s,t)}function vs(n,e,s,t,r){let o=[],i=St(n);for(let[a,d]of i)o.push(...Rt(a,d,e,s,t,r));return o}function ys(n,e,s){return!(!n.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||s&&e.created_at_epoch<=s.created_at_epoch)}function Us(n,e){let s=[];return e?(s.push(...W("Investigated",n.investigated,u.blue)),s.push(...W("Learned",n.learned,u.yellow)),s.push(...W("Completed",n.completed,u.green)),s.push(...W("Next Steps",n.next_steps,u.magenta))):(s.push(...j("Investigated",n.investigated)),s.push(...j("Learned",n.learned)),s.push(...j("Completed",n.completed)),s.push(...j("Next Steps",n.next_steps))),s}function xs(n,e){return e?Is(n):cs(n)}function ks(n,e,s){return!Z(e)||n.totalDiscoveryTokens<=0||n.savings<=0?[]:s?Cs(n.totalDiscoveryTokens,n.totalReadTokens):ps(n.totalDiscoveryTokens,n.totalReadTokens)}var bt={bugfix:{fill:"#fed7d7",color:"#1a202c",emoji:"\u{1F534}"},feature:{fill:"#e9d8fd",color:"#1a202c",emoji:"\u{1F7E3}"},refactor:{fill:"#fef9c3",color:"#1a202c",emoji:"\u{1F504}"},change:{fill:"#dcfce7",color:"#1a202c",emoji:"\u2705"},discovery:{fill:"#dbeafe",color:"#1a202c",emoji:"\u{1F535}"},decision:{fill:"#ffedd5",color:"#1a202c",emoji:"\u2696\uFE0F"}},ht={fill:"#f1f5f9",color:"#1a202c",emoji:"\u{1F4CC}"};function Fs(n){return n.replace(/"/g,"'").replace(/\n/g," ").replace(/[<>{}|[\]]/g," ").trim().slice(0,60)}function At(n){if(!n)return"";try{let e=k(n);return e.length===0?"":e[0].split("/").slice(-2).join("/")}catch{return""}}function Nt(n,e){let s=bt[n.type]??ht,t=`N${e}`,r=Fs(n.title??n.subtitle??n.type),o=At(n.files_modified??n.files_read),i=o?`${s.emoji} ${r} \xB7 ${o}`:`${s.emoji} ${r}`;return{id:t,line:`    ${t}["${i}"]`,style:`    style ${t} fill:${s.fill},color:${s.color}`}}function ws(n,e){if(n.length===0)return[];let s=n[0].memory_session_id,t=n.filter(a=>a.memory_session_id===s).reverse();if(t.length===0)return[];let r=e?.memory_session_id===s?e:void 0,o=t.map((a,d)=>Nt(a,d)),i=[];i.push("## Task Flow (Last Session)"),i.push(""),i.push("```mermaid"),i.push("graph LR");for(let a of o)i.push(a.line);for(let a=0;a<o.length-1;a++)i.push(`    ${o[a].id} --> ${o[a+1].id}`);if(r?.next_steps&&r.next_steps.trim()){let a=Fs(r.next_steps);i.push(`    NEXT(["Next: ${a}"])`),i.push(`    ${o[o.length-1].id} --> NEXT`),i.push("    style NEXT fill:#bee3f8,color:#1a202c")}for(let a of o)i.push(a.style);return i.push("```"),i.push(""),i}var It=Ps.default.join((0,$s.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function Ct(){try{return new Y}catch(n){if(n instanceof Error&&n.code==="ERR_DLOPEN_FAILED"){try{(0,Xs.unlinkSync)(It)}catch(e){e instanceof Error?E.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):E.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return E.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw n}}function Lt(n,e){return e?Ls(n):ls(n)}function Mt(n,e,s,t,r,o,i){let a=[],d=le(e),_=s[0];a.push(...Ms(n,d,t,i)),t.mermaidContext&&!i&&a.push(...ws(e,_));let m=s.slice(0,t.sessionCount),l=Ze(m,s),p=es(e,l),T=ss(e,t.fullObservationCount);a.push(...vs(p,T,t,r,i));let h=e[0];ys(t,_,h)&&a.push(...Us(_,i));let b=ze(e,t,o,r);return a.push(...xs(b,i)),a.push(...ks(d,t,i)),a.join(`
`).trimEnd()}var Dt=new Set(["bugfix","discovery","decision","refactor"]);function vt(n,e,s){let t=le(n),r={bugfix:0,discovery:0,decision:0,refactor:0,other:0},o=new Set,i=Number.POSITIVE_INFINITY;for(let d of n){let _=Dt.has(d.type)?d.type:"other";r[_]++,d.memory_session_id&&o.add(d.memory_session_id),d.created_at_epoch&&d.created_at_epoch<i&&(i=d.created_at_epoch)}let a=Number.isFinite(i)?Math.max(0,Math.floor((Date.now()-i)/864e5)):0;return{observation_count:n.length,session_count:o.size,timeline_depth_days:a,has_session_summary:e.length>0,obs_type_bugfix:r.bugfix,obs_type_discovery:r.discovery,obs_type_decision:r.decision,obs_type_refactor:r.refactor,obs_type_other:r.other,tokens_injected:t.totalReadTokens,tokens_saved_vs_naive:t.savings,search_strategy:s?"full":"timeline"}}async function fe(n,e=!1){let s=We(),t=n?.cwd??process.cwd(),r=Xe(t),o=n?.projects?.length?n.projects:r.allProjects,i=o[o.length-1]??r.primary;n?.full&&(s.totalObservationCount=999999,s.sessionCount=999999);let a=Ct();if(!a)return{text:"",stats:null};try{let d=n?.platformSource?I(n.platformSource):void 0,_=o.length>1?o:[i],m=Je(a,_,s,d),l=Qe(a,_,s,d);return m.length===0&&l.length===0?{text:Lt(i,e),stats:null}:{text:Mt(i,m,l,s,t,n?.session_id,e),stats:vt(m,l,!!n?.full)}}finally{a.close()}}async function Gs(n,e=!1){return(await fe(n,e)).text}0&&(module.exports={generateContext,generateContextWithStats});
