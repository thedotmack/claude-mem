...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),u=c?`${c[1].split("/").pop()}:${c[2]}`:"unknown",l={...s,location:u};return this.warn(e,`[HAPPY-PATH] ${t}`,l,n),o}},m=new W;var Ot={};function ht(){return typeof __dirname<"u"?__dirname:(0,h.dirname)((0,ce.fileURLToPath)(Ot.url))}var bt=ht(),N=y.get("CLAUDE_MEM_DATA_DIR"),A=process.env.CLAUDE_CONFIG_DIR||(0,h.join)((0,de.homedir)(),".claude"),Gt=(0,h.join)(A,"plugins","marketplaces","thedotmack"),Ht=(0,h.join)(N,"archives"),Wt=(0,h.join)(N,"logs"),Yt=(0,h.join)(N,"trash"),Vt=(0,h.join)(N,"backups"),qt=(0,h.join)(N,"modes"),Kt=(0,h.join)(N,"settings.json"),me=(0,h.join)(N,"claude-mem.db"),Jt=(0,h.join)(N,"vector-db"),zt=(0,h.join)(A,"settings.json"),Qt=(0,h.join)(A,"commands"),Zt=(0,h.join)(A,"CLAUDE.md");function ue(r){(0,pe.mkdirSync)(r,{recursive:!0})}function le(){return(0,h.join)(bt,"..")}var w=class{db;constructor(e=me){e!==":memory:"&&ue(N),this.db=new _e.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn()}initializeSchema(){this.db.run(`
...
`}function Ze(r,e,t,s){let n=[];return s?n.push(...je(r)):n.push(...Ie(r)),s?n.push(...Xe()):n.push(...ye()),s?n.push(...Be()):n.push(...Ae()),s?n.push(...Ge()):n.push(...ve()),F(t)&&(s?n.push(...He(e,t)):n.push(...Me(e,t))),n}var ee=M(require("path"),1);function G(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return m.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e),[]}}function tt(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function st(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function rt(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function et(r,e){return ee.default.isAbsolute(r)?ee.default.relative(e,r):r}function nt(r,e,t){let s=G(r);if(s.length>0)return et(s[0],e);if(t){let n=G(t);if(n.length>0)return et(n[0],e)}return"General"}function It(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=rt(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function yt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?G(r.facts).join(`
`):null}function At(r,e,t,s,n,o){let i=[];o?i.push(...We(r)):i.push(...Le(r));let a=null,d="",c=!1;for(let u of e)if(u.type==="summary"){c&&(i.push(""),c=!1,a=null,d="");let l=u.data,g=tt(l.displayTime);o?i.push(...Ke(l,g)):i.push(...$e(l,g))}else{let l=u.data,g=nt(l.files_modified,n,l.files_read),E=st(l.created_at),T=E!==d,b=T?E:"";d=E;let _=t.has(l.id);if(g!==a&&(c&&i.push(""),o?i.push(...Ye(g)):i.push(...De(g)),a=g,c=!0),_){let S=yt(l,s);o?i.push(...qe(l,E,T,S,s)):(c&&!o&&(i.push(""),c=!1),i.push(...ke(l,b,S,s)),a=null)}else o?i.push(Ve(l,E,T,s)):i.push(xe(l,b,s))}return c&&i.push(""),i}function ot(r,e,t,s,n){let o=[],i=It(r);for(let[a,d]of i)o.push(...At(a,d,e,t,s,n));return o}function it(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function at(r,e){let t=[];return e?(t.push(...k("Investigated",r.investigated,p.blue)),t.push(...k("Learned",r.learned,p.yellow)),t.push(...k("Completed",r.completed,p.green)),t.push(...k("Next Steps",r.next_steps,p.magenta))):(t.push(...x("Investigated",r.investigated)),t.push(...x("Learned",r.learned)),t.push(...x("Completed",r.completed)),t.push(...x("Next Steps",r.next_steps))),t}function dt(r,e){return e?Je(r):Ue(r)}function pt(r,e,t){return!F(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?ze(r.totalDiscoveryTokens,r.totalReadTokens):we(r.totalDiscoveryTokens,r.totalReadTokens)}var vt=ct.default.join((0,mt.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function Mt(){try{return new w}catch(r){if(r.code==="ERR_DLOPEN_FAILED"){try{(0,ut.unlinkSync)(vt)}catch(e){m.debug("SYSTEM","Marker file cleanup failed (may not exist)",{},e)}return m.error("SYSTEM","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function Lt(r,e){return e?Qe(r):Pe(r)}function Dt(r,e,t,s,n,o,i){let a=[],d=K(e);a.push(...Ze(r,d,s,i));let c=t.slice(0,s.sessionCount),u=Ce(c,t),l=Z(e,u),g=Re(e,s.fullObservationCount);a.push(...ot(l,g,s,n,i));let E=t[0],T=e[0];it(s,E,T)&&a.push(...at(E,i));let b=Q(e,s,o,n);return a.push(...dt(b,i)),a.push(...pt(d,s,i)),a.join(`
`).trimEnd()}async function te(r,e=!1){let t=Y(),s=r?.cwd??process.cwd(),n=ge(s),o=r?.projects||[n],i=Mt();if(!i)return"";try{let a=o.length>1?be(i,o,t):J(i,n,t),d=o.length>1?Oe(i,o,t):z(i,n,t);return a.length===0&&d.length===0?Lt(n,e):Dt(n,a,d,t,s,r?.session_id,e)}finally{i.close()}}0&&(module.exports={generateContext});
