"use strict";var Ht=Object.create;var H=Object.defineProperty;var Gt=Object.getOwnPropertyDescriptor;var Xt=Object.getOwnPropertyNames;var jt=Object.getPrototypeOf,Bt=Object.prototype.hasOwnProperty;var Wt=(r,e)=>{for(var t in e)H(r,t,{get:e[t],enumerable:!0})},Se=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Xt(e))!Bt.call(r,n)&&n!==t&&H(r,n,{get:()=>e[n],enumerable:!(s=Gt(e,n))||s.enumerable});return r};var U=(r,e,t)=>(t=r!=null?Ht(jt(r)):{},Se(e||!r||!r.__esModule?H(t,"default",{value:r,enumerable:!0}):t,r)),Yt=r=>Se(H({},"__esModule",{value:!0}),r);var Rs={};Wt(Rs,{generateContext:()=>$t,generateContextWithStats:()=>Te});module.exports=Yt(Rs);var kt=U(require("path"),1),Pt=require("os"),Ft=require("fs");var _e=require("bun:sqlite");var b=require("path"),re=require("os"),D=require("fs");var Re=require("url");var N=require("fs"),be=require("path");var Vt=null;function Kt(r){return(Vt??process.stderr.write.bind(process.stderr))(r)}function Z(r){Kt(r)}var te=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(te||{}),ee=null,se=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=M.logsDir();(0,N.existsSync)(e)||(0,N.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,be.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=M.settings();if((0,N.existsSync)(e)){let t=(0,N.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=te[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`+JSON.stringify(o,null,2)}catch{m=" "+this.formatData(o)}else m=" "+this.formatData(o);let l="";if(n){let{sessionId:E,memorySessionId:R,correlationId:f,...p}=n;Object.keys(p).length>0&&(l=` {${Object.entries(p).map(([S,T])=>`${S}=${T}`).join(", ")}}`)}let g=`[${i}] [${a}] [${d}] ${c}${s}${l}${m}`;if(this.logFilePath)try{(0,N.appendFileSync)(this.logFilePath,g+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),m=c?`${c[1].split("/").pop()}:${c[2]}`:"unknown",l={...s,location:m};return this.warn(e,`[HAPPY-PATH] ${t}`,l,n),o}},u=new se;var zt={};function qt(){return typeof __dirname<"u"?__dirname:(0,b.dirname)((0,Re.fileURLToPath)(zt.url))}var Jt=qt();function ne(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,b.join)((0,re.homedir)(),".claude-mem"),e=(0,b.join)(r,"settings.json");try{if((0,D.existsSync)(e)){let t=JSON.parse((0,D.readFileSync)(e,"utf-8")),s=t.env??t;if(s.CLAUDE_MEM_DATA_DIR)return s.CLAUDE_MEM_DATA_DIR}}catch{}return r}var L=ne(),v=process.env.CLAUDE_CONFIG_DIR||(0,b.join)((0,re.homedir)(),".claude"),Ms=(0,b.join)(v,"plugins","marketplaces","thedotmack"),Ds=(0,b.join)(L,"archives"),vs=(0,b.join)(L,"logs"),ys=(0,b.join)(L,"trash"),Us=(0,b.join)(L,"backups"),xs=(0,b.join)(L,"modes"),ws=(0,b.join)(L,"settings.json"),ks=(0,b.join)(L,"claude-mem.db"),Ps=(0,b.join)(L,"vector-db"),Qt=(0,b.join)(L,"observer-sessions"),oe=(0,b.basename)(Qt),Fs=(0,b.join)(v,"settings.json"),$s=(0,b.join)(v,"commands"),Hs=(0,b.join)(v,"CLAUDE.md");function he(r){(0,D.mkdirSync)(r,{recursive:!0})}function Oe(){return(0,b.join)(Jt,"..")}function O(...r){return(0,b.join)(ne(),...r)}var M={dataDir:()=>ne(),workerPid:()=>O("worker.pid"),serverBetaPid:()=>O(".server-beta.pid"),serverBetaPort:()=>O(".server-beta.port"),serverBetaRuntime:()=>O(".server-beta.runtime.json"),settings:()=>O("settings.json"),database:()=>O("claude-mem.db"),chroma:()=>O("chroma"),combinedCerts:()=>O("combined_certs.pem"),transcriptsConfig:()=>O("transcript-watch.json"),transcriptsState:()=>O("transcript-watch-state.json"),corpora:()=>O("corpora"),supervisorRegistry:()=>O("supervisor.json"),envFile:()=>O(".env"),logsDir:()=>O("logs"),archives:()=>O("archives"),trash:()=>O("trash"),backups:()=>O("backups"),modes:()=>O("modes"),vectorDb:()=>O("vector-db"),observerSessions:()=>O("observer-sessions")};var Ae=require("crypto");function ie(r,e,t){return(0,Ae.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function ae(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[String(e)]}catch{return[r]}}var A="claude";function Zt(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function y(r){if(!r)return A;let e=Zt(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:A}function Ie(r){let e=["claude","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function Ce(r,e,t,s){let n=Date.now()-s;return r.prepare(`
    SELECT
      up.*,
      s.memory_session_id,
      s.project,
  ...
  `).get(e,t,n)??void 0}var Me=["private","claude-mem-context","system_instruction","system-instruction","persisted-output","system-reminder"],Ne=new RegExp(`<(${Me.join("|")})\\b[^>]*>[\\s\\S]*?</\\1>`,"g"),De=/<system-reminder>[\s\S]*?<\/system-reminder>/g,Le=100;function es(r){let e=Object.fromEntries(Me.map(n=>[n,0]));Ne.lastIndex=0;let t=0,s=r.replace(Ne,(n,o)=>(e[o]=(e[o]??0)+1,t+=1,""));return t>Le&&u.warn("SYSTEM","tag count exceeds limit",void 0,{tagCount:t,maxAllowed:Le,contentLength:r.length}),{stripped:s.trim(),counts:e}}function ve(r){return es(r).stripped}var ts=["task-notification"],Ks=new RegExp(`^\\s*<(${ts.join("|")})\\b[^>]*>(?:(?!<\\1\\b|</\\1\\b)[\\s\\S])*</\\1>\\s*$`),qs=256*1024;var de=4e3;function G(r){let e=r.trim(),s=ve(r).trim()||e;return s.length<=de?s:(u.debug("DB","Truncated stored prompt text to the configured cap",{originalLength:s.length,storedLength:de}),`${s.slice(0,de-1)}\u2026`)}var ye=require("path");var ss=5e3;function Ue(r){return r.run(`PRAGMA busy_timeout = ${ss}`),r}function xe(r){if(r===":memory:")return;let e=(0,ye.dirname)(r);e===""||e==="."||he(e)}function rs(r,e){return{customTitle:r,platformSource:e?y(e):void 0}}var X=class{db;constructor(e=M.database()){e instanceof _e.Database?this.db=e:(xe(e),this.db=new _e.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.db.run("PRAGMA journal_size_limit = 4194304")),Ue(this.db),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn()}dropWorkerPidColumn(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(32),s=this.db.query("PRAGMA table_info(pending_messages)").all().some(n=>n.name==="worker_pid");if(!(e&&!s)){if(s)try{this.db.run("DROP INDEX IF EXISTS idx_pending_messages_worker_pid"),this.db.run("ALTER TABLE pending_messages DROP COLUMN worker_pid"),u.debug("DB","Dropped worker_pid column and its index from pending_messages")}catch(n){u.warn("DB","Failed to drop worker_pid column from pending_messages",{},n instanceof Error?n:new Error(String(n)));return}e||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(32,new Date().toISOString())}}dropDeadPendingMessagesColumns(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(31),t=this.db.query("PRAGMA table_info(pending_messages)").all(),s=new Set(t.map(i=>i.name)),o=["retry_count","failed_at_epoch","completed_at_epoch"].filter(i=>s.has(i));if(!(e&&o.length===0)){if(o.length>0){this.db.run("BEGIN TRANSACTION");try{this.db.run("DELETE FROM pending_messages WHERE status NOT IN ('pending', 'processing')");for(let i of o)this.db.run(`ALTER TABLE pending_messages DROP COLUMN ${i}`),u.debug("DB",`Dropped dead column ${i} from pending_messages`);e||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(31,new Date().toISOString()),this.db.run("COMMIT")}catch(i){this.db.run("ROLLBACK"),u.warn("DB","Failed to drop dead columns from pending_messages",{},i instanceof Error?i:new Error(String(i)));return}return}e||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(31,new Date().toISOString())}}initializeSchema(){this.db.run(`
    ...
    `).all(e)}getAllProjects(e){let t=e?y(e):void 0,s=`
      ...
      WHERE project IS NOT NULL AND project != ''
        AND project != ?
    `,n=[oe];return t&&(s+=" AND COALESCE(platform_source, ?) = ?",n.push(A,t)),s+=" ORDER BY project ASC",this.db.prepare(s).all(...n).map(i=>i.project)}getProjectCatalog(){let e=this.db.prepare(`
      SELECT
    ...
    `).all(oe),t=[],s=new Set,n={};for(let i of e){let a=y(i.platform_source);n[a]||(n[a]=[]),n[a].includes(i.project)||n[a].push(i.project),s.has(i.project)||(s.add(i.project),t.push(i.project))}let o=Ie(Object.keys(n));return{projects:t,sources:o,projectsBySource:Object.fromEntries(o.map(i=>[i,n[i]||[]]))}}getLatestUserPrompt(e){return this.db.prepare(`
      ...
      ORDER BY up.created_at_epoch DESC
      LIMIT 1
    `).get(e)}findRecentDuplicateUserPrompt(e,t,s){return Ce(this.db,e,G(t),s)}getRecentSessionsWithStatus(e,t=3){return this.db.prepare(`
      SELECT * FROM (
        SELECT
          s.memory_session_id,
          s.status,
    ...
    `).all(e)}getObservationById(e){return this.db.prepare(`
      ...
      FROM observations
      WHERE id = ?
    `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,type:i,concepts:a,files:d}=t,c=s==="relevance",m=c?"":`ORDER BY created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,l=n?`LIMIT ${n}`:"",g=e.map(()=>"?").join(","),E=[...e],R=[];if(o&&(R.push("project = ?"),E.push(o)),i)if(Array.isArray(i)){let T=i.map(()=>"?").join(",");R.push(`type IN (${T})`),E.push(...i)}else R.push("type = ?"),E.push(i);if(a){let T=Array.isArray(a)?a:[a],z=T.map(()=>"EXISTS (SELECT 1 FROM json_each(concepts) WHERE value = ?)");E.push(...T),R.push(`(${z.join(" OR ")})`)}if(d){let T=Array.isArray(d)?d:[d],z=T.map(()=>"(EXISTS (SELECT 1 FROM json_each(files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(files_modified) WHERE value LIKE ?))");T.forEach(fe=>{E.push(`%${fe}%`,`%${fe}%`)}),R.push(`(${z.join(" OR ")})`)}let f=R.length>0?`WHERE id IN (${g}) AND ${R.join(" AND ")}`:`WHERE id IN (${g})`,h=this.db.prepare(`
      SELECT *
      FROM observations
      ${f}
      ${m}
      ${l}
    `).all(...E);if(!c)return h;let S=new Map(h.map(T=>[T.id,T]));return e.map(T=>S.get(T)).filter(T=>!!T)}getSummaryForSession(e){return this.db.prepare(`
      SELECT
        request, investigated, learned, completed, next_steps,
        files_read, files_edited, notes, prompt_number, created_at,
        created_at_epoch
    ...
    `).get(e).count}createSDKSession(e,t,s,n,o){let i=new Date,a=i.getTime(),d=rs(n,o),c=d.platformSource??A,m=G(s),l=this.db.prepare(`
    ...
    `).run(e,t,i,n.toISOString(),o).lastInsertRowid}getUserPrompt(e,t){return this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,o=0,i,a){let d=i??Date.now(),c=new Date(d).toISOString(),m=ie(e,s.title,s.narrative),g=this.db.prepare(`
    ...
    `).get(e,t,s.type,s.title,s.subtitle,JSON.stringify(s.facts),s.narrative,JSON.stringify(s.concepts),JSON.stringify(s.files_read),JSON.stringify(s.files_modified),n||null,o,s.agent_type??null,s.agent_id??null,m,c,d,a||null,s.metadata??null);if(g)return{id:g.id,createdAtEpoch:g.created_at_epoch};let E=this.db.prepare("SELECT id, created_at_epoch FROM observations WHERE memory_session_id = ? AND content_hash = ?").get(e,m);if(!E)throw new Error(`storeObservation: ON CONFLICT without existing row for content_hash=${m}`);return{id:E.id,createdAtEpoch:E.created_at_epoch}}storeSummary(e,t,s,n,o=0,i){let a=i??Date.now(),d=new Date(a).toISOString(),m=this.db.prepare(`
      INSERT INTO session_summaries
      (memory_session_id, project, request, investigated, learned, completed,
       next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,d,a);return{id:Number(m.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a,d){let c=a??Date.now(),m=new Date(c).toISOString();return this.db.transaction(()=>{let g=[],E=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, agent_type, agent_id, content_hash, created_at, created_at_epoch,
         generated_by_model)
        ...
        ON CONFLICT(memory_session_id, content_hash) DO NOTHING
        RETURNING id
      `),R=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let p of s){let h=ie(e,p.title,p.narrative),S=E.get(e,t,p.type,p.title,p.subtitle,JSON.stringify(p.facts),p.narrative,JSON.stringify(p.concepts),JSON.stringify(p.files_read),JSON.stringify(p.files_modified),o||null,i,p.agent_type??null,p.agent_id??null,h,m,c,d||null);if(S){g.push(S.id);continue}let T=R.get(e,h);if(!T)throw new Error(`storeObservations: ON CONFLICT without existing row for content_hash=${h}`);g.push(T.id)}let f=null;if(n){let h=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,o||null,i,m,c);f=Number(h.lastInsertRowid)}return{observationIds:g,summaryId:f,createdAtEpoch:c}})()}getSessionSummariesByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o}=t,i=s==="relevance",a=i?"":`ORDER BY created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,d=n?`LIMIT ${n}`:"",c=e.map(()=>"?").join(","),m=[...e],l=o?`WHERE id IN (${c}) AND project = ?`:`WHERE id IN (${c})`;o&&m.push(o);let E=this.db.prepare(`
      SELECT * FROM session_summaries
      ${l}
      ${a}
      ${d}
    `).all(...m);if(!i)return E;let R=new Map(E.map(f=>[f.id,f]));return e.map(f=>R.get(f)).filter(f=>!!f)}getUserPromptsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o}=t,i=s==="relevance",a=i?"":`ORDER BY up.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,d=n?`LIMIT ${n}`:"",c=e.map(()=>"?").join(","),m=[...e],l=o?"AND s.project = ?":"";o&&m.push(o);let E=this.db.prepare(`
      SELECT
        up.*,
        s.project,
        s.memory_session_id
      ...
      ${a}
      ${d}
    `).all(...m);if(!i)return E;let R=new Map(E.map(f=>[f.id,f]));return e.map(f=>R.get(f)).filter(f=>!!f)}getTimelineAroundTimestamp(e,t=10,s=10,n){return this.getTimelineAroundObservation(null,e,t,s,n)}getTimelineAroundObservation(e,t,s=10,n=10,o){let i=o?"AND project = ?":"",a=o?[o]:[],d,c;if(e!==null){let p=`
      ...
      `,h=`
        ...
        ORDER BY id ASC
        LIMIT ?
      `;try{let S=this.db.prepare(p).all(e,...a,s+1),T=this.db.prepare(h).all(e,...a,n+1);if(S.length===0&&T.length===0)return{observations:[],sessions:[],prompts:[]};d=S.length>0?S[S.length-1].created_at_epoch:t,c=T.length>0?T[T.length-1].created_at_epoch:t}catch(S){return S instanceof Error?u.error("DB","Error getting boundary observations",{project:o},S):u.error("DB","Error getting boundary observations with non-Error",{},new Error(String(S))),{observations:[],sessions:[],prompts:[]}}}else{let p=`
      ...
      `,h=`
        ...
        ORDER BY created_at_epoch ASC
        LIMIT ?
      `;try{let S=this.db.prepare(p).all(t,...a,s),T=this.db.prepare(h).all(t,...a,n+1);if(S.length===0&&T.length===0)return{observations:[],sessions:[],prompts:[]};d=S.length>0?S[S.length-1].created_at_epoch:t,c=T.length>0?T[T.length-1].created_at_epoch:t}catch(S){return S instanceof Error?u.error("DB","Error getting boundary timestamps",{project:o},S):u.error("DB","Error getting boundary timestamps with non-Error",{},new Error(String(S))),{observations:[],sessions:[],prompts:[]}}}let m=`
      SELECT *
      FROM observations
    ...
    ORDER BY o.created_at_epoch DESC
    LIMIT ?
  `).all(e,e,...s,...o,t.totalObservationCount)}function Ve(r,e,t){return r.db.prepare(`
    SELECT
      ss.id,
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(e,e,t.sessionCount+me)}function Ke(r,e,t){let s=Array.from(t.observationTypes),n=s.map(()=>"?").join(","),o=Array.from(t.observationConcepts),i=o.map(()=>"?").join(","),a=e.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
      o.id,
      o.memory_session_id,
      COALESCE(s.platform_source, 'claude') as platform_source,
    ...
    ORDER BY o.created_at_epoch DESC
    LIMIT ?
  `).all(...e,...e,...s,...o,t.totalObservationCount)}function qe(r,e,t){let s=e.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
      ss.id,
      ss.memory_session_id,
      COALESCE(s.platform_source, 'claude') as platform_source,
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(...e,...e,t.sessionCount+me)}function as(r){return r.replace(/[/.]/g,"-")}function ds(r){if(!r.includes('"type":"assistant"'))return null;let e=JSON.parse(r);if(e.type==="assistant"&&e.message?.content&&Array.isArray(e.message.content)){let t="";for(let s of e.message.content)s.type==="text"&&(t+=s.text);if(t=t.replace(De,"").trim(),t)return t}return null}function _s(r){for(let e=r.length-1;e>=0;e--)try{let t=ds(r[e]);if(t)return t}catch(t){t instanceof Error?u.debug("WORKER","Skipping malformed transcript line",{lineIndex:e},t):u.debug("WORKER","Skipping malformed transcript line",{lineIndex:e,error:String(t)});continue}return""}function us(r){try{if(!(0,K.existsSync)(r))return{assistantMessage:""};let e=(0,K.readFileSync)(r,"utf-8").trim();if(!e)return{assistantMessage:""};let t=e.split(`
`).filter(n=>n.trim());return{assistantMessage:_s(t)}}catch(e){return e instanceof Error?u.failure("WORKER","Failed to extract prior messages from transcript",{transcriptPath:r},e):u.warn("WORKER","Failed to extract prior messages from transcript",{transcriptPath:r,error:String(e)}),{assistantMessage:""}}}function Je(r,e,t,s){if(!e.showLastMessage||r.length===0)return{assistantMessage:""};let n=r.find(d=>d.memory_session_id!==t);if(!n)return{assistantMessage:""};let o=n.memory_session_id,i=as(s),a=We.default.join(v,"projects",i,`${o}.jsonl`);return us(a)}function Qe(r,e){let t=e[0]?.id;return r.map((s,n)=>{let o=n===0?null:e[n+1];return{...s,displayEpoch:o?o.created_at_epoch:s.created_at_epoch,displayTime:o?o.created_at:s.created_at,shouldShowLink:s.id!==t}})}function ze(r,e){let t=[...r.map(s=>({type:"observation",data:s})),...e.map(s=>({type:"summary",data:s}))];return t.sort((s,n)=>{let o=s.type==="observation"?s.data.created_at_epoch:s.data.displayEpoch,i=n.type==="observation"?n.data.created_at_epoch:n.data.displayEpoch;return o-i}),t}function Ze(r,e){return new Set(r.slice(0,e).map(t=>t.id))}function et(){let r=new Date,e=r.toLocaleDateString("en-CA"),t=r.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),s=r.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${s}`}function tt(r){return[`# [${r}] recent context, ${et()}`,""]}function st(){return[`Legend: \u{1F3AF}session ${I.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji}${t.id}`).join(" ")}`,"Format: ID TIME TYPE TITLE","Fetch details: get_observations([IDs]) | Search: mem-search skill",""]}function rt(r,e){let t=[],s=[`${r.totalObservations} obs (${r.totalReadTokens.toLocaleString()}t read)`,`${r.totalDiscoveryTokens.toLocaleString()}t work`];return r.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)&&(e.showSavingsPercent?s.push(`${r.savingsPercent}% savings`):e.showSavingsAmount&&s.push(`${r.savings.toLocaleString()}t saved`)),t.push(`Stats: ${s.join(" | ")}`),t.push(""),t}function nt(r){return[`### ${r}`]}function ot(r){return r.toLowerCase().replace(" am","a").replace(" pm","p")}function it(r,e,t){let s=r.title||"Untitled",n=I.getInstance().getTypeIcon(r.type),o=e?ot(e):'"';return`${r.id} ${o} ${n} ${s}`}function at(r,e,t,s){let n=[],o=r.title||"Untitled",i=I.getInstance().getTypeIcon(r.type),a=e?ot(e):'"',{readTokens:d,discoveryDisplay:c}=P(r,s);n.push(`**${r.id}** ${a} ${i} **${o}**`),t&&n.push(t);let m=[];return s.showReadTokens&&m.push(`~${d}t`),s.showWorkTokens&&m.push(c),m.length>0&&n.push(m.join(" ")),n.push(""),n}function dt(r,e){return[`S${r.id} ${r.request||"Session started"} (${e})`]}function F(r,e){return e?[`**${r}**: ${e}`,""]:[]}function _t(r){return r.assistantMessage?["","---","","**Previously**","",`A: ${r.assistantMessage}`,""]:[]}function ut(r,e){return["",`Access ${Math.round(r/1e3)}k tokens of past work via get_observations([IDs]) or mem-search skill.`]}function ct(r){return`# [${r}] recent context, ${et()}

No previous sessions found.`}function mt(){let r=new Date,e=r.toLocaleDateString("en-CA"),t=r.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),s=r.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${s}`}function pt(r){return["",`${_.bright}${_.cyan}[${r}] recent context, ${mt()}${_.reset}`,`${_.gray}${"\u2500".repeat(60)}${_.reset}`,""]}function Et(){let e=I.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji} ${t.id}`).join(" | ");return[`${_.dim}Legend: session-request | ${e}${_.reset}`,""]}function lt(){return[`${_.bright}Column Key${_.reset}`,`${_.dim}  Read: Tokens to read this observation (cost to learn it now)${_.reset}`,`${_.dim}  Work: Tokens spent on work that produced this record ( research, building, deciding)${_.reset}`,""]}function gt(){return[`${_.dim}Context Index: This semantic index (titles, types, files, tokens) is usually sufficient to understand past work.${_.reset}`,"",`${_.dim}When you need implementation details, rationale, or debugging context:${_.reset}`,`${_.dim}  - Fetch by ID: get_observations([IDs]) for observations visible in this index${_.reset}`,`${_.dim}  - Search history: Use the mem-search skill for past decisions, bugs, and deeper research${_.reset}`,`${_.dim}  - Trust this index over re-reading code for past decisions and learnings${_.reset}`,""]}function Tt(r,e){let t=[];if(t.push(`${_.bright}${_.cyan}Context Economics${_.reset}`),t.push(`${_.dim}  Loading: ${r.totalObservations} observations (${r.totalReadTokens.toLocaleString()} tokens to read)${_.reset}`),t.push(`${_.dim}  Work investment: ${r.totalDiscoveryTokens.toLocaleString()} tokens spent on research, building, and decisions${_.reset}`),r.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)){let s="  Your savings: ";e.showSavingsAmount&&e.showSavingsPercent?s+=`${r.savings.toLocaleString()} tokens (${r.savingsPercent}% reduction from reuse)`:e.showSavingsAmount?s+=`${r.savings.toLocaleString()} tokens`:s+=`${r.savingsPercent}% reduction from reuse`,t.push(`${_.green}${s}${_.reset}`)}return t.push(""),t}function ft(r){return[`${_.bright}${_.cyan}${r}${_.reset}`,""]}function St(r){return[`${_.dim}${r}${_.reset}`]}function bt(r,e,t,s){let n=r.title||"Untitled",o=I.getInstance().getTypeIcon(r.type),{readTokens:i,discoveryTokens:a,workEmoji:d}=P(r,s),c=t?`${_.dim}${e}${_.reset}`:" ".repeat(e.length),m=s.showReadTokens&&i>0?`${_.dim}(~${i}t)${_.reset}`:"",l=s.showWorkTokens&&a>0?`${_.dim}(${d} ${a.toLocaleString()}t)${_.reset}`:"";return`  ${_.dim}#${r.id}${_.reset}  ${c}  ${o}  ${n} ${m} ${l}`}function Rt(r,e,t,s,n){let o=[],i=r.title||"Untitled",a=I.getInstance().getTypeIcon(r.type),{readTokens:d,discoveryTokens:c,workEmoji:m}=P(r,n),l=t?`${_.dim}${e}${_.reset}`:" ".repeat(e.length),g=n.showReadTokens&&d>0?`${_.dim}(~${d}t)${_.reset}`:"",E=n.showWorkTokens&&c>0?`${_.dim}(${m} ${c.toLocaleString()}t)${_.reset}`:"";return o.push(`  ${_.dim}#${r.id}${_.reset}  ${l}  ${a}  ${_.bright}${i}${_.reset}`),s&&o.push(`    ${_.dim}${s}${_.reset}`),(g||E)&&o.push(`    ${g} ${E}`),o.push(""),o}function ht(r,e){let t=`${r.request||"Session started"} (${e})`;return[`${_.yellow}#S${r.id}${_.reset} ${t}`,""]}function $(r,e,t){return e?[`${t}${r}:${_.reset} ${e}`,""]:[]}function Ot(r){return r.assistantMessage?["","---","",`${_.bright}${_.magenta}Previously${_.reset}`,"",`${_.dim}A: ${r.assistantMessage}${_.reset}`,""]:[]}function At(r,e){let t=Math.round(r/1e3);return["",`${_.dim}Access ${t}k tokens of past research & decisions for just ${e.toLocaleString()}t. Use the claude-mem skill to access memories by ID.${_.reset}`]}function It(r){return`
...
`}function Ct(r,e,t,s){let n=[];return s?n.push(...pt(r)):n.push(...tt(r)),s?n.push(...Et()):n.push(...st()),s&&(n.push(...lt()),n.push(...gt())),V(t)&&(s?n.push(...Tt(e,t)):n.push(...rt(e,t))),n}var Ee=U(require("path"),1);function Q(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return u.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e instanceof Error?e:new Error(String(e))),[]}}function le(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function ge(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function Lt(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function Nt(r,e){return Ee.default.isAbsolute(r)?Ee.default.relative(e,r):r}function Mt(r,e,t){let s=Q(r);if(s.length>0)return Nt(s[0],e);if(t){let n=Q(t);if(n.length>0)return Nt(n[0],e)}return"General"}function cs(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=Lt(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function Dt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?Q(r.facts).join(`
`):null}function ms(r,e,t,s){let n=[];n.push(...nt(r));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=le(a.displayTime);n.push(...dt(a,d))}else{let a=i.data,d=ge(a.created_at),m=d!==o?d:"";if(o=d,t.has(a.id)){let g=Dt(a,s);n.push(...at(a,m,g,s))}else n.push(it(a,m,s))}return n}function ps(r,e,t,s,n){let o=[];o.push(...ft(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let c=d.data,m=le(c.displayTime);o.push(...ht(c,m))}else{let c=d.data,m=Mt(c.files_modified,n,c.files_read),l=ge(c.created_at),g=l!==a;a=l;let E=t.has(c.id);if(m!==i&&(o.push(...St(m)),i=m),E){let R=Dt(c,s);o.push(...Rt(c,l,g,R,s))}else o.push(bt(c,l,g,s))}return o.push(""),o}function Es(r,e,t,s,n,o){return o?ps(r,e,t,s,n):ms(r,e,t,s)}function vt(r,e,t,s,n){let o=[],i=cs(r);for(let[a,d]of i)o.push(...Es(a,d,e,t,s,n));return o}function yt(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function Ut(r,e){let t=[];return e?(t.push(...$("Investigated",r.investigated,_.blue)),t.push(...$("Learned",r.learned,_.yellow)),t.push(...$("Completed",r.completed,_.green)),t.push(...$("Next Steps",r.next_steps,_.magenta))):(t.push(...F("Investigated",r.investigated)),t.push(...F("Learned",r.learned)),t.push(...F("Completed",r.completed)),t.push(...F("Next Steps",r.next_steps))),t}function xt(r,e){return e?Ot(r):_t(r)}function wt(r,e,t){return!V(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?At(r.totalDiscoveryTokens,r.totalReadTokens):ut(r.totalDiscoveryTokens,r.totalReadTokens)}var ls=kt.default.join((0,Pt.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function gs(){try{return new X}catch(r){if(r instanceof Error&&r.code==="ERR_DLOPEN_FAILED"){try{(0,Ft.unlinkSync)(ls)}catch(e){e instanceof Error?u.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):u.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return u.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function Ts(r,e){return e?It(r):ct(r)}function fs(r,e,t,s,n,o,i){let a=[],d=pe(e);a.push(...Ct(r,d,s,i));let c=t.slice(0,s.sessionCount),m=Qe(c,t),l=ze(e,m),g=Ze(e,s.fullObservationCount);a.push(...vt(l,g,s,n,i));let E=t[0],R=e[0];yt(s,E,R)&&a.push(...Ut(E,i));let f=Je(e,s,o,n);return a.push(...xt(f,i)),a.push(...wt(d,s,i)),a.join(`
`).trimEnd()}var Ss=new Set(["bugfix","discovery","decision","refactor"]);function bs(r,e,t){let s=pe(r),n={bugfix:0,discovery:0,decision:0,refactor:0,other:0},o=new Set,i=Number.POSITIVE_INFINITY;for(let d of r){let c=Ss.has(d.type)?d.type:"other";n[c]++,d.memory_session_id&&o.add(d.memory_session_id),d.created_at_epoch&&d.created_at_epoch<i&&(i=d.created_at_epoch)}let a=Number.isFinite(i)?Math.max(0,Math.floor((Date.now()-i)/864e5)):0;return{observation_count:r.length,session_count:o.size,timeline_depth_days:a,has_session_summary:e.length>0,obs_type_bugfix:n.bugfix,obs_type_discovery:n.discovery,obs_type_decision:n.decision,obs_type_refactor:n.refactor,obs_type_other:n.other,tokens_injected:s.totalReadTokens,tokens_saved_vs_naive:s.savings,search_strategy:t?"full":"timeline"}}async function Te(r,e=!1){let t=Xe(),s=r?.cwd??process.cwd(),n=He(s),o=r?.projects?.length?r.projects:n.allProjects,i=o[o.length-1]??n.primary;r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let a=gs();if(!a)return{text:"",stats:null};try{let d=o.length>1?Ke(a,o,t):Ye(a,i,t),c=o.length>1?qe(a,o,t):Ve(a,i,t);return d.length===0&&c.length===0?{text:Ts(i,e),stats:null}:{text:fs(i,d,c,t,s,r?.session_id,e),stats:bs(d,c,!!r?.full)}}finally{a.close()}}async function $t(r,e=!1){return(await Te(r,e)).text}0&&(module.exports={generateContext,generateContextWithStats});
