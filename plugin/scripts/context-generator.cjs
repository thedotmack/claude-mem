"use strict";var Le=Object.create;var V=Object.defineProperty;var Ce=Object.getOwnPropertyDescriptor;var ke=Object.getOwnPropertyNames;var De=Object.getPrototypeOf,$e=Object.prototype.hasOwnProperty;var xe=(a,e)=>{for(var s in e)V(a,s,{get:e[s],enumerable:!0})},le=(a,e,s,t)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of ke(e))!$e.call(a,n)&&n!==s&&V(a,n,{get:()=>e[n],enumerable:!(t=Ce(e,n))||t.enumerable});return a};var _e=(a,e,s)=>(s=a!=null?Le(De(a)):{},le(e||!a||!a.__esModule?V(s,"default",{value:a,enumerable:!0}):s,a)),Me=a=>le(V({},"__esModule",{value:!0}),a);var Ke={};xe(Ke,{generateContext:()=>Ve});module.exports=Me(Ke);var w=_e(require("path"),1),J=require("os"),x=require("fs");var he=_e(require("better-sqlite3"),1);var h=require("path"),ee=require("os"),se=require("fs");var me=require("url"),Ue={};function we(){return typeof __dirname<"u"?__dirname:(0,h.dirname)((0,me.fileURLToPath)(Ue.url))}var Ze=we(),A=process.env.CLAUDE_MEM_DATA_DIR||(0,h.join)((0,ee.homedir)(),".claude-mem"),te=process.env.CLAUDE_CONFIG_DIR||(0,h.join)((0,ee.homedir)(),".claude"),es=(0,h.join)(A,"archives"),ss=(0,h.join)(A,"logs"),ts=(0,h.join)(A,"trash"),rs=(0,h.join)(A,"backups"),ns=(0,h.join)(A,"settings.json"),Ee=(0,h.join)(A,"claude-mem.db"),os=(0,h.join)(A,"vector-db"),is=(0,h.join)(te,"settings.json"),as=(0,h.join)(te,"commands"),ds=(0,h.join)(te,"CLAUDE.md");function Te(a){(0,se.mkdirSync)(a,{recursive:!0})}var re=(i=>(i[i.DEBUG=0]="DEBUG",i[i.INFO=1]="INFO",i[i.WARN=2]="WARN",i[i.ERROR=3]="ERROR",i[i.SILENT=4]="SILENT",i))(re||{}),ne=class{level;useColor;constructor(){let e=process.env.CLAUDE_MEM_LOG_LEVEL?.toUpperCase()||"INFO";this.level=re[e]??1,this.useColor=process.stdout.isTTY??!1}correlationId(e,s){return`obs-${e}-${s}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.level===0?`${e.message}
...
`+JSON.stringify(i,null,2):T=" "+this.formatData(i));let b="";if(n){let{sessionId:f,sdkSessionId:C,correlationId:_,...r}=n;Object.keys(r).length>0&&(b=` {${Object.entries(r).map(([R,g])=>`${R}=${g}`).join(", ")}}`)}let L=`[${d}] [${c}] [${u}] ${S}${t}${b}${T}`;e===3?console.error(L):console.log(L)}debug(e,s,t,n){this.log(0,e,s,t,n)}info(e,s,t,n){this.log(1,e,s,t,n)}warn(e,s,t,n){this.log(2,e,s,t,n)}error(e,s,t,n){this.log(3,e,s,t,n)}dataIn(e,s,t,n){this.info(e,`\u2192 ${s}`,t,n)}dataOut(e,s,t,n){this.info(e,`\u2190 ${s}`,t,n)}success(e,s,t,n){this.info(e,`\u2713 ${s}`,t,n)}failure(e,s,t,n){this.error(e,`\u2717 ${s}`,t,n)}timing(e,s,t,n){this.info(e,`\u23F1 ${s}`,n,{duration:`${t}ms`})}},W=new ne;var K=class{db;constructor(){Te(A),this.db=new he.default(Ee),this.db.pragma("journal_mode = WAL"),this.db.pragma("synchronous = NORMAL"),this.db.pragma("foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn()}initializeSchema(){try{this.db.exec(`
...
`).filter(n=>n.trim()),t="";for(let n=s.length-1;n>=0;n--)try{let i=s[n];if(!i.includes('"type":"assistant"'))continue;let d=JSON.parse(i);if(d.type==="assistant"&&d.message?.content&&Array.isArray(d.message.content)){let c="";for(let u of d.message.content)u.type==="text"&&(c+=u.text);if(c=c.replace(/<system-reminder>[\s\S]*?<\/system-reminder>/g,"").trim(),c){t=c;break}}}catch{continue}return{userMessage:"",assistantMessage:t}}catch(e){return W.failure("WORKER","Failed to extract prior messages from transcript",{transcriptPath:a},e),{userMessage:"",assistantMessage:""}}}async function Ve(a,e=!1){let s=Xe(),t=a?.cwd??process.cwd(),n=t?w.default.basename(t):"unknown-project",i=null;try{i=new K}catch(y){if(y.code==="ERR_DLOPEN_FAILED"){try{(0,x.unlinkSync)(Fe)}catch{}return console.error("Native module rebuild needed - restart Claude Code to auto-fix"),""}throw y}let d=Array.from(s.observationTypes),c=d.map(()=>"?").join(","),u=Array.from(s.observationConcepts),S=u.map(()=>"?").join(","),T=i.db.prepare(`
  ...
  `).all(n,...d,...u,s.totalObservationCount),b=i.db.prepare(`
    ...
    ORDER BY created_at_epoch DESC
    LIMIT ?
  `).all(n,s.sessionCount+Pe),L="",f="";if(s.showLastMessage&&T.length>0)try{let y=a?.session_id,R=T.find(g=>g.sdk_session_id!==y);if(R){let g=R.sdk_session_id,k=Ge(t),U=w.default.join((0,J.homedir)(),".claude","projects",k,`${g}.jsonl`),B=Ye(U);L=B.userMessage,f=B.assistantMessage}}catch{}if(T.length===0&&b.length===0)return i?.close(),e?`
...
No previous sessions found for this project yet.`;let C=b.slice(0,s.sessionCount),_=T,r=[];if(e?(r.push(""),r.push(`${o.bright}${o.cyan}[${n}] recent context${o.reset}`),r.push(`${o.gray}${"\u2500".repeat(60)}${o.reset}`),r.push("")):(r.push(`# [${n}] recent context`),r.push("")),_.length>0){e?r.push(`${o.dim}Legend: \u{1F3AF} session-request | \u{1F534} bugfix | \u{1F7E3} feature | \u{1F504} refactor | \u2705 change | \u{1F535} discovery | \u2696\uFE0F  decision${o.reset}`):r.push("**Legend:** \u{1F3AF} session-request | \u{1F534} bugfix | \u{1F7E3} feature | \u{1F504} refactor | \u2705 change | \u{1F535} discovery | \u2696\uFE0F  decision"),r.push(""),e?(r.push(`${o.bright}\u{1F4A1} Column Key${o.reset}`),r.push(`${o.dim}  Read: Tokens to read this observation (cost to learn it now)${o.reset}`),r.push(`${o.dim}  Work: Tokens spent on work that produced this record (\u{1F50D} research, \u{1F6E0}\uFE0F building, \u2696\uFE0F  deciding)${o.reset}`)):(r.push("\u{1F4A1} **Column Key**:"),r.push("- **Read**: Tokens to read this observation (cost to learn it now)"),r.push("- **Work**: Tokens spent on work that produced this record (\u{1F50D} research, \u{1F6E0}\uFE0F building, \u2696\uFE0F  deciding)")),r.push(""),e?(r.push(`${o.dim}\u{1F4A1} Context Index: This semantic index (titles, types, files, tokens) is usually sufficient to understand past work.${o.reset}`),r.push(""),r.push(`${o.dim}When you need implementation details, rationale, or debugging context:${o.reset}`),r.push(`${o.dim}  - Use the mem-search skill to fetch full observations on-demand${o.reset}`),r.push(`${o.dim}  - Critical types (\u{1F534} bugfix, \u2696\uFE0F decision) often need detailed fetching${o.reset}`),r.push(`${o.dim}  - Trust this index over re-reading code for past decisions and learnings${o.reset}`)):(r.push("\u{1F4A1} **Context Index:** This semantic index (titles, types, files, tokens) is usually sufficient to understand past work."),r.push(""),r.push("When you need implementation details, rationale, or debugging context:"),r.push("- Use the mem-search skill to fetch full observations on-demand"),r.push("- Critical types (\u{1F534} bugfix, \u2696\uFE0F decision) often need detailed fetching"),r.push("- Trust this index over re-reading code for past decisions and learnings")),r.push("");let y=T.length,R=T.reduce((p,m)=>{let E=(m.title?.length||0)+(m.subtitle?.length||0)+(m.narrative?.length||0)+JSON.stringify(m.facts||[]).length;return p+Math.ceil(E/Re)},0),g=T.reduce((p,m)=>p+(m.discovery_tokens||0),0),k=g-R,U=g>0?Math.round(k/g*100):0,B=s.showReadTokens||s.showWorkTokens||s.showSavingsAmount||s.showSavingsPercent;if(B)if(e){if(r.push(`${o.bright}${o.cyan}\u{1F4CA} Context Economics${o.reset}`),r.push(`${o.dim}  Loading: ${y} observations (${R.toLocaleString()} tokens to read)${o.reset}`),r.push(`${o.dim}  Work investment: ${g.toLocaleString()} tokens spent on research, building, and decisions${o.reset}`),g>0&&(s.showSavingsAmount||s.showSavingsPercent)){let p="  Your savings: ";s.showSavingsAmount&&s.showSavingsPercent?p+=`${k.toLocaleString()} tokens (${U}% reduction from reuse)`:s.showSavingsAmount?p+=`${k.toLocaleString()} tokens`:p+=`${U}% reduction from reuse`,r.push(`${o.green}${p}${o.reset}`)}r.push("")}else{if(r.push("\u{1F4CA} **Context Economics**:"),r.push(`- Loading: ${y} observations (${R.toLocaleString()} tokens to read)`),r.push(`- Work investment: ${g.toLocaleString()} tokens spent on research, building, and decisions`),g>0&&(s.showSavingsAmount||s.showSavingsPercent)){let p="- Your savings: ";s.showSavingsAmount&&s.showSavingsPercent?p+=`${k.toLocaleString()} tokens (${U}% reduction from reuse)`:s.showSavingsAmount?p+=`${k.toLocaleString()} tokens`:p+=`${U}% reduction from reuse`,r.push(p)}r.push("")}let Ne=b[0]?.id,Ie=C.map((p,m)=>{let E=m===0?null:b[m+1];return{...p,displayEpoch:E?E.created_at_epoch:p.created_at_epoch,displayTime:E?E.created_at:p.created_at,shouldShowLink:p.id!==Ne}}),ye=new Set(T.slice(0,s.fullObservationCount).map(p=>p.id)),ae=[..._.map(p=>({type:"observation",data:p})),...Ie.map(p=>({type:"summary",data:p}))];ae.sort((p,m)=>{let E=p.type==="observation"?p.data.created_at_epoch:p.data.displayEpoch,D=m.type==="observation"?m.data.created_at_epoch:m.data.displayEpoch;return E-D});let j=new Map;for(let p of ae){let m=p.type==="observation"?p.data.created_at:p.data.displayTime,E=je(m);j.has(E)||j.set(E,[]),j.get(E).push(p)}let ve=Array.from(j.entries()).sort((p,m)=>{let E=new Date(p[0]).getTime(),D=new Date(m[0]).getTime();return E-D});for(let[p,m]of ve){e?(r.push(`${o.bright}${o.cyan}${p}${o.reset}`),r.push("")):(r.push(`### ${p}`),r.push(""));let E=null,D="",M=!1;for(let Q of m)if(Q.type==="summary"){M&&(r.push(""),M=!1,E=null,D="");let l=Q.data,F=`${l.request||"Session started"} (${Be(l.displayTime)})`,v=l.shouldShowLink?`claude-mem://session-summary/${l.id}`:"";if(e){let O=v?`${o.dim}[${v}]${o.reset}`:"";r.push(`\u{1F3AF} ${o.yellow}#S${l.id}${o.reset} ${F} ${O}`)}else{let O=v?` [\u2192](${v})`:"";r.push(`**\u{1F3AF} #S${l.id}** ${F}${O}`)}r.push("")}else{let l=Q.data,F=Oe(l.files_modified),v=F.length>0&&F[0]?He(F[0],t):"General";v!==E&&(M&&r.push(""),e?r.push(`${o.dim}${v}${o.reset}`):r.push(`**${v}**`),e||(r.push("| ID | Time | T | Title | Read | Work |"),r.push("|----|------|---|-------|------|------|")),E=v,M=!0,D="");let O=We(l.created_at),H=l.title||"Untitled",G=ge[l.type]||"\u2022",Ae=(l.title?.length||0)+(l.subtitle?.length||0)+(l.narrative?.length||0)+JSON.stringify(l.facts||[]).length,X=Math.ceil(Ae/Re),P=l.discovery_tokens||0,z=Se[l.type]||"\u{1F50D}",ce=P>0?`${z} ${P.toLocaleString()}`:"-",Z=O!==D,pe=Z?O:"";if(D=O,ye.has(l.id)){let $=s.fullObservationField==="narrative"?l.narrative:l.facts?Oe(l.facts).join(`
`):null;if(e){let I=Z?`${o.dim}${O}${o.reset}`:" ".repeat(O.length),Y=s.showReadTokens&&X>0?`${o.dim}(~${X}t)${o.reset}`:"",ue=s.showWorkTokens&&P>0?`${o.dim}(${z} ${P.toLocaleString()}t)${o.reset}`:"";r.push(`  ${o.dim}#${l.id}${o.reset}  ${I}  ${G}  ${o.bright}${H}${o.reset}`),$&&r.push(`    ${o.dim}${$}${o.reset}`),(Y||ue)&&r.push(`    ${Y} ${ue}`),r.push("")}else{M&&(r.push(""),M=!1),r.push(`**#${l.id}** ${pe||"\u2033"} ${G} **${H}**`),$&&(r.push(""),r.push($),r.push(""));let I=[];s.showReadTokens&&I.push(`Read: ~${X}`),s.showWorkTokens&&I.push(`Work: ${ce}`),I.length>0&&r.push(I.join(", ")),r.push(""),E=null}}else if(e){let $=Z?`${o.dim}${O}${o.reset}`:" ".repeat(O.length),I=s.showReadTokens&&X>0?`${o.dim}(~${X}t)${o.reset}`:"",Y=s.showWorkTokens&&P>0?`${o.dim}(${z} ${P.toLocaleString()}t)${o.reset}`:"";r.push(`  ${o.dim}#${l.id}${o.reset}  ${$}  ${G}  ${H} ${I} ${Y}`)}else{let $=s.showReadTokens?`~${X}`:"",I=s.showWorkTokens?ce:"";r.push(`| #${l.id} | ${pe||"\u2033"} | ${G} | ${H} | ${$} | ${I} |`)}}M&&r.push("")}let N=b[0],de=T[0];if(s.showLastSummary&&N&&(N.investigated||N.learned||N.completed||N.next_steps)&&(!de||N.created_at_epoch>de.created_at_epoch)&&(r.push(...q("Investigated",N.investigated,o.blue,e)),r.push(...q("Learned",N.learned,o.yellow,e)),r.push(...q("Completed",N.completed,o.green,e)),r.push(...q("Next Steps",N.next_steps,o.magenta,e))),f&&(r.push(""),r.push("---"),r.push(""),e?(r.push(`${o.bright}${o.magenta}\u{1F4CB} Previously${o.reset}`),r.push(""),r.push(`${o.dim}A: ${f}${o.reset}`)):(r.push("**\u{1F4CB} Previously**"),r.push(""),r.push(`A: ${f}`)),r.push("")),B&&g>0&&k>0){let p=Math.round(g/1e3);r.push(""),e?r.push(`${o.dim}\u{1F4B0} Access ${p}k tokens of past research & decisions for just ${R.toLocaleString()}t. Use the mem-search skill to access memories by ID instead of re-reading files.${o.reset}`):r.push(`\u{1F4B0} Access ${p}k tokens of past research & decisions for just ${R.toLocaleString()}t. Use the mem-search skill to access memories by ID instead of re-reading files.`)}}return i?.close(),r.join(`
