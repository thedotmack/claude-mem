"use strict";var Gt=Object.create;var $=Object.defineProperty;var Xt=Object.getOwnPropertyDescriptor;var jt=Object.getOwnPropertyNames;var Bt=Object.getPrototypeOf,Wt=Object.prototype.hasOwnProperty;var Yt=(r,e)=>{for(var t in e)$(r,t,{get:e[t],enumerable:!0})},Te=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of jt(e))!Wt.call(r,n)&&n!==t&&$(r,n,{get:()=>e[n],enumerable:!(s=Xt(e,n))||s.enumerable});return r};var v=(r,e,t)=>(t=r!=null?Gt(Bt(r)):{},Te(e||!r||!r.__esModule?$(t,"default",{value:r,enumerable:!0}):t,r)),Vt=r=>Te($({},"__esModule",{value:!0}),r);var Ns={};Yt(Ns,{generateContext:()=>Ht,generateContextWithStats:()=>le});module.exports=Vt(Ns);var Pt=v(require("path"),1),Ft=require("os"),$t=require("fs");var ae=require("bun:sqlite");var l=require("path"),se=require("os"),L=require("fs");var Se=require("url");var N=require("fs"),fe=require("path");var Kt=null;function qt(r){return(Kt??process.stderr.write.bind(process.stderr))(r)}function z(r){qt(r)}var ee=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(ee||{}),Z=null,te=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=y.logsDir();(0,N.existsSync)(e)||(0,N.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,fe.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=y.settings();if((0,N.existsSync)(e)){let t=(0,N.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=ee[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`+JSON.stringify(o,null,2)}catch{m=" "+this.formatData(o)}else m=" "+this.formatData(o);let g="";if(n){let{sessionId:E,memorySessionId:h,correlationId:S,...p}=n;Object.keys(p).length>0&&(g=` {${Object.entries(p).map(([b,f])=>`${b}=${f}`).join(", ")}}`)}let T=`[${i}] [${a}] [${d}] ${c}${s}${g}${m}`;if(this.logFilePath)try{(0,N.appendFileSync)(this.logFilePath,T+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),m=c?`${c[1].split("/").pop()}:${c[2]}`:"unknown",g={...s,location:m};return this.warn(e,`[HAPPY-PATH] ${t}`,g,n),o}},u=new te;var ns={};function Jt(){return typeof __dirname<"u"?__dirname:(0,l.dirname)((0,Se.fileURLToPath)(ns.url))}var Qt=Jt();function be(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,l.join)((0,se.homedir)(),".claude-mem"),e=(0,l.join)(r,"settings.json");try{if((0,L.existsSync)(e)){let t=JSON.parse((0,L.readFileSync)(e,"utf-8")),s=t.env??t;if(s.CLAUDE_MEM_DATA_DIR)return s.CLAUDE_MEM_DATA_DIR}}catch{}return r}var R=be(),M=process.env.CLAUDE_CONFIG_DIR||(0,l.join)((0,se.homedir)(),".claude"),ws=(0,l.join)(M,"plugins","marketplaces","thedotmack"),zt=(0,l.join)(R,"archives"),Zt=(0,l.join)(R,"logs"),es=(0,l.join)(R,"trash"),ts=(0,l.join)(R,"backups"),ss=(0,l.join)(R,"modes"),ks=(0,l.join)(R,"settings.json"),Ps=(0,l.join)(R,"claude-mem.db"),rs=(0,l.join)(R,"vector-db"),Re=(0,l.join)(R,"observer-sessions"),re=(0,l.basename)(Re),Fs=(0,l.join)(M,"settings.json"),$s=(0,l.join)(M,"commands"),Hs=(0,l.join)(M,"CLAUDE.md");function he(){return(0,l.join)(be(),"claude-mem.db")}function Oe(r){(0,L.mkdirSync)(r,{recursive:!0})}function Ae(){return(0,l.join)(Qt,"..")}var y={dataDir:()=>R,workerPid:()=>(0,l.join)(R,"worker.pid"),serverBetaPid:()=>(0,l.join)(R,".server-beta.pid"),serverBetaPort:()=>(0,l.join)(R,".server-beta.port"),serverBetaRuntime:()=>(0,l.join)(R,".server-beta.runtime.json"),settings:()=>(0,l.join)(R,"settings.json"),database:()=>(0,l.join)(R,"claude-mem.db"),chroma:()=>(0,l.join)(R,"chroma"),combinedCerts:()=>(0,l.join)(R,"combined_certs.pem"),transcriptsConfig:()=>(0,l.join)(R,"transcript-watch.json"),transcriptsState:()=>(0,l.join)(R,"transcript-watch-state.json"),corpora:()=>(0,l.join)(R,"corpora"),supervisorRegistry:()=>(0,l.join)(R,"supervisor.json"),envFile:()=>(0,l.join)(R,".env"),logsDir:()=>Zt,archives:()=>zt,trash:()=>es,backups:()=>ts,modes:()=>ss,vectorDb:()=>rs,observerSessions:()=>Re};var Ie=require("crypto");function ne(r,e,t){return(0,Ie.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function oe(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[String(e)]}catch{return[r]}}var A="claude";function os(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function D(r){if(!r)return A;let e=os(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:A}function Ce(r){let e=["claude","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function Ne(r,e,t,s){let n=Date.now()-s;return r.prepare(`
    SELECT
      up.*,
      s.memory_session_id,
      s.project,
  ...
  `).get(e,t,n)??void 0}var De=["private","claude-mem-context","system_instruction","system-instruction","persisted-output","system-reminder"],Le=new RegExp(`<(${De.join("|")})\\b[^>]*>[\\s\\S]*?</\\1>`,"g"),ve=/<system-reminder>[\s\S]*?<\/system-reminder>/g,Me=100;function is(r){let e=Object.fromEntries(De.map(n=>[n,0]));Le.lastIndex=0;let t=0,s=r.replace(Le,(n,o)=>(e[o]=(e[o]??0)+1,t+=1,""));return t>Me&&u.warn("SYSTEM","tag count exceeds limit",void 0,{tagCount:t,maxAllowed:Me,contentLength:r.length}),{stripped:s.trim(),counts:e}}function ye(r){return is(r).stripped}var as=["task-notification"],Ks=new RegExp(`^\\s*<(${as.join("|")})\\b[^>]*>(?:(?!<\\1\\b|</\\1\\b)[\\s\\S])*</\\1>\\s*$`),qs=256*1024;var ie=4e3;function H(r){let e=r.trim(),s=ye(r).trim()||e;return s.length<=ie?s:(u.debug("DB","Truncated stored prompt text to the configured cap",{originalLength:s.length,storedLength:ie}),`${s.slice(0,ie-1)}\u2026`)}var Ue=require("path");var ds=5e3;function xe(r){return r.run(`PRAGMA busy_timeout = ${ds}`),r}function we(r){if(r===":memory:")return;let e=(0,Ue.dirname)(r);if(!(e===""||e==="."))try{Oe(e)}catch(t){throw u.error("DB","Failed to ensure SQLite parent directory",{dbPath:r,parentDir:e},t instanceof Error?t:new Error(String(t))),t}}function _s(r,e){return{customTitle:r,platformSource:e?D(e):void 0}}var G=class{db;constructor(e=he()){e instanceof ae.Database?this.db=e:(we(e),this.db=new ae.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.db.run("PRAGMA journal_size_limit = 4194304")),xe(this.db),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn()}dropWorkerPidColumn(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(32),s=this.db.query("PRAGMA table_info(pending_messages)").all().some(n=>n.name==="worker_pid");if(!(e&&!s)){if(s)try{this.db.run("DROP INDEX IF EXISTS idx_pending_messages_worker_pid"),this.db.run("ALTER TABLE pending_messages DROP COLUMN worker_pid"),u.debug("DB","Dropped worker_pid column and its index from pending_messages")}catch(n){u.warn("DB","Failed to drop worker_pid column from pending_messages",{},n instanceof Error?n:new Error(String(n)));return}e||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(32,new Date().toISOString())}}dropDeadPendingMessagesColumns(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(31),t=this.db.query("PRAGMA table_info(pending_messages)").all(),s=new Set(t.map(i=>i.name)),o=["retry_count","failed_at_epoch","completed_at_epoch"].filter(i=>s.has(i));if(!(e&&o.length===0)){if(o.length>0){this.db.run("BEGIN TRANSACTION");try{this.db.run("DELETE FROM pending_messages WHERE status NOT IN ('pending', 'processing')");for(let i of o)this.db.run(`ALTER TABLE pending_messages DROP COLUMN ${i}`),u.debug("DB",`Dropped dead column ${i} from pending_messages`);e||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(31,new Date().toISOString()),this.db.run("COMMIT")}catch(i){this.db.run("ROLLBACK"),u.warn("DB","Failed to drop dead columns from pending_messages",{},i instanceof Error?i:new Error(String(i)));return}return}e||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(31,new Date().toISOString())}}initializeSchema(){this.db.run(`
    ...
    `).all(re),t=[],s=new Set,n={};for(let i of e){let a=D(i.platform_source);n[a]||(n[a]=[]),n[a].includes(i.project)||n[a].push(i.project),s.has(i.project)||(s.add(i.project),t.push(i.project))}let o=Ce(Object.keys(n));return{projects:t,sources:o,projectsBySource:Object.fromEntries(o.map(i=>[i,n[i]||[]]))}}getLatestUserPrompt(e){return this.db.prepare(`
      ...
      ORDER BY up.created_at_epoch DESC
      LIMIT 1
    `).get(e)}findRecentDuplicateUserPrompt(e,t,s){return Ne(this.db,e,H(t),s)}getRecentSessionsWithStatus(e,t=3){return this.db.prepare(`
      SELECT * FROM (
        SELECT
          s.memory_session_id,
          s.status,
    ...
    `).get(e).count}createSDKSession(e,t,s,n,o){let i=new Date,a=i.getTime(),d=_s(n,o),c=d.platformSource??A,m=H(s),g=this.db.prepare(`
    ...
    ORDER BY o.created_at_epoch DESC
    LIMIT ?
  `).all(e,e,...s,...o,t.totalObservationCount)}function Ke(r,e,t){return r.db.prepare(`
    SELECT
      ss.id,
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(e,e,t.sessionCount+ue)}function qe(r,e,t){let s=Array.from(t.observationTypes),n=s.map(()=>"?").join(","),o=Array.from(t.observationConcepts),i=o.map(()=>"?").join(","),a=e.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
      o.id,
      o.memory_session_id,
      COALESCE(s.platform_source, 'claude') as platform_source,
...
`}function Nt(r,e,t,s){let n=[];return s?n.push(...Et(r)):n.push(...st(r)),s?n.push(...lt()):n.push(...rt()),s&&(n.push(...gt()),n.push(...Tt())),Y(t)&&(s?n.push(...ft(e,t)):n.push(...nt(e,t))),n}var me=v(require("path"),1);function J(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return u.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e instanceof Error?e:new Error(String(e))),[]}}function pe(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function Ee(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function Mt(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function Lt(r,e){return me.default.isAbsolute(r)?me.default.relative(e,r):r}function Dt(r,e,t){let s=J(r);if(s.length>0)return Lt(s[0],e);if(t){let n=J(t);if(n.length>0)return Lt(n[0],e)}return"General"}function Ts(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=Mt(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function vt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?J(r.facts).join(`
`):null}function fs(r,e,t,s){let n=[];n.push(...ot(r));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=pe(a.displayTime);n.push(..._t(a,d))}else{let a=i.data,d=Ee(a.created_at),m=d!==o?d:"";if(o=d,t.has(a.id)){let T=vt(a,s);n.push(...dt(a,m,T,s))}else n.push(at(a,m,s))}return n}function Ss(r,e,t,s,n){let o=[];o.push(...St(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let c=d.data,m=pe(c.displayTime);o.push(...Ot(c,m))}else{let c=d.data,m=Dt(c.files_modified,n,c.files_read),g=Ee(c.created_at),T=g!==a;a=g;let E=t.has(c.id);if(m!==i&&(o.push(...bt(m)),i=m),E){let h=vt(c,s);o.push(...ht(c,g,T,h,s))}else o.push(Rt(c,g,T,s))}return o.push(""),o}function bs(r,e,t,s,n,o){return o?Ss(r,e,t,s,n):fs(r,e,t,s)}function yt(r,e,t,s,n){let o=[],i=Ts(r);for(let[a,d]of i)o.push(...bs(a,d,e,t,s,n));return o}function Ut(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function xt(r,e){let t=[];return e?(t.push(...F("Investigated",r.investigated,_.blue)),t.push(...F("Learned",r.learned,_.yellow)),t.push(...F("Completed",r.completed,_.green)),t.push(...F("Next Steps",r.next_steps,_.magenta))):(t.push(...P("Investigated",r.investigated)),t.push(...P("Learned",r.learned)),t.push(...P("Completed",r.completed)),t.push(...P("Next Steps",r.next_steps))),t}function wt(r,e){return e?At(r):ut(r)}function kt(r,e,t){return!Y(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?It(r.totalDiscoveryTokens,r.totalReadTokens):ct(r.totalDiscoveryTokens,r.totalReadTokens)}var Rs=Pt.default.join((0,Ft.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function hs(){try{return new G}catch(r){if(r instanceof Error&&r.code==="ERR_DLOPEN_FAILED"){try{(0,$t.unlinkSync)(Rs)}catch(e){e instanceof Error?u.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):u.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return u.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function Os(r,e){return e?Ct(r):mt(r)}function As(r,e,t,s,n,o,i){let a=[],d=ce(e);a.push(...Nt(r,d,s,i));let c=t.slice(0,s.sessionCount),m=ze(c,t),g=Ze(e,m),T=et(e,s.fullObservationCount);a.push(...yt(g,T,s,n,i));let E=t[0],h=e[0];Ut(s,E,h)&&a.push(...xt(E,i));let S=Qe(e,s,o,n);return a.push(...wt(S,i)),a.push(...kt(d,s,i)),a.join(`
`).trimEnd()}var Is=new Set(["bugfix","discovery","decision","refactor"]);function Cs(r,e,t){let s=ce(r),n={bugfix:0,discovery:0,decision:0,refactor:0,other:0},o=new Set,i=Number.POSITIVE_INFINITY;for(let d of r){let c=Is.has(d.type)?d.type:"other";n[c]++,d.memory_session_id&&o.add(d.memory_session_id),d.created_at_epoch&&d.created_at_epoch<i&&(i=d.created_at_epoch)}let a=Number.isFinite(i)?Math.max(0,Math.floor((Date.now()-i)/864e5)):0;return{observation_count:r.length,session_count:o.size,timeline_depth_days:a,has_session_summary:e.length>0,obs_type_bugfix:n.bugfix,obs_type_discovery:n.discovery,obs_type_decision:n.decision,obs_type_refactor:n.refactor,obs_type_other:n.other,tokens_injected:s.totalReadTokens,tokens_saved_vs_naive:s.savings,search_strategy:t?"full":"timeline"}}async function le(r,e=!1){let t=je(),s=r?.cwd??process.cwd(),n=Ge(s),o=r?.projects?.length?r.projects:n.allProjects,i=o[o.length-1]??n.primary;r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let a=hs();if(!a)return{text:"",stats:null};try{let d=o.length>1?qe(a,o,t):Ve(a,i,t),c=o.length>1?Je(a,o,t):Ke(a,i,t);return d.length===0&&c.length===0?{text:Os(i,e),stats:null}:{text:As(i,d,c,t,s,r?.session_id,e),stats:Cs(d,c,!!r?.full)}}finally{a.close()}}async function Ht(r,e=!1){return(await le(r,e)).text}0&&(module.exports={generateContext,generateContextWithStats});
