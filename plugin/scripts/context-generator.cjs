"use strict";var Wt=Object.create;var V=Object.defineProperty;var Vt=Object.getOwnPropertyDescriptor;var Yt=Object.getOwnPropertyNames;var qt=Object.getPrototypeOf,Kt=Object.prototype.hasOwnProperty;var Jt=(r,e)=>{for(var t in e)V(r,t,{get:e[t],enumerable:!0})},Ae=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Yt(e))!Kt.call(r,n)&&n!==t&&V(r,n,{get:()=>e[n],enumerable:!(s=Vt(e,n))||s.enumerable});return r};var P=(r,e,t)=>(t=r!=null?Wt(qt(r)):{},Ae(e||!r||!r.__esModule?V(t,"default",{value:r,enumerable:!0}):t,r)),Qt=r=>Ae(V({},"__esModule",{value:!0}),r);var ws={};Jt(ws,{generateContext:()=>Bt,generateContextWithStats:()=>he});module.exports=Qt(ws);var Xt=P(require("path"),1),Gt=require("os"),jt=require("fs");var pe=require("bun:sqlite");var T=require("path"),de=require("os"),F=require("fs");var Ie=require("url");var U=require("fs"),Ne=require("path");var zt=null;function Zt(r){return(zt??process.stderr.write.bind(process.stderr))(r)}function ne(r){Zt(r)}var ie=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(ie||{}),oe=null,ae=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=$.logsDir();(0,U.existsSync)(e)||(0,U.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,Ne.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=$.settings();if((0,U.existsSync)(e)){let t=(0,U.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=ie[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
${e.stack}`:e.message;if(Array.isArray(e))return`[${e.length} items]`;let t=Object.keys(e);return t.length===0?"{}":t.length<=3?JSON.stringify(e):`{${t.length} keys: ${t.slice(0,3).join(", ")}...}`}return String(e)}formatTool(e,t){if(!t)return e;let s=t;if(typeof t=="string")try{s=JSON.parse(t)}catch{s=t}if(e==="Bash"&&s.command)return`${e}(${s.command})`;if(s.file_path)return`${e}(${s.file_path})`;if(s.notebook_path)return`${e}(${s.notebook_path})`;if(e==="Glob"&&s.pattern)return`${e}(${s.pattern})`;if(e==="Grep"&&s.pattern)return`${e}(${s.pattern})`;if(s.url)return`${e}(${s.url})`;if(s.query)return`${e}(${s.query})`;if(e==="Task"){if(s.subagent_type)return`${e}(${s.subagent_type})`;if(s.description)return`${e}(${s.description})`}return e==="Skill"&&s.skill?`${e}(${s.skill})`:e==="LSP"&&s.operation?`${e}(${s.operation})`:e}formatTimestamp(e){let t=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0"),o=String(e.getHours()).padStart(2,"0"),i=String(e.getMinutes()).padStart(2,"0"),a=String(e.getSeconds()).padStart(2,"0"),d=String(e.getMilliseconds()).padStart(3,"0");return`${t}-${s}-${n} ${o}:${i}:${a}.${d}`}log(e,t,s,n,o){if(e<this.getLevel())return;this.ensureLogFileInitialized();let i=this.formatTimestamp(new Date),a=ie[e].padEnd(5),d=t.padEnd(6),_="";n?.correlationId?_=`[${n.correlationId}] `:n?.sessionId&&(_=`[session-${n.sessionId}] `);let m="";if(o!=null)if(o instanceof Error)m=this.getLevel()===0?`
${o.message}
${o.stack}`:` ${o.message}`;else if(this.getLevel()===0&&typeof o=="object")try{m=`
`+JSON.stringify(o,null,2)}catch{m=" "+this.formatData(o)}else m=" "+this.formatData(o);let l="";if(n){let{sessionId:g,memorySessionId:N,correlationId:h,...f}=n;Object.keys(f).length>0&&(l=` {${Object.entries(f).map(([L,x])=>`${L}=${x}`).join(", ")}}`)}let p=`[${i}] [${a}] [${d}] ${_}${s}${l}${m}`;if(this.logFilePath)try{(0,U.appendFileSync)(this.logFilePath,p+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),m=_?`${_[1].split("/").pop()}:${_[2]}`:"unknown",l={...s,location:m};return this.warn(e,`[HAPPY-PATH] ${t}`,l,n),o}},E=new ae;var _s={};function es(){return typeof __dirname<"u"?__dirname:(0,T.dirname)((0,Ie.fileURLToPath)(_s.url))}var ts=es();function ss(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,T.join)((0,de.homedir)(),".claude-mem"),e=(0,T.join)(r,"settings.json");try{if((0,F.existsSync)(e)){let t=JSON.parse((0,F.readFileSync)(e,"utf-8")),s=t.env??t;if(s.CLAUDE_MEM_DATA_DIR)return s.CLAUDE_MEM_DATA_DIR}}catch{}return r}var O=ss(),w=process.env.CLAUDE_CONFIG_DIR||(0,T.join)((0,de.homedir)(),".claude"),Ws=(0,T.join)(w,"plugins","marketplaces","thedotmack"),rs=(0,T.join)(O,"archives"),ns=(0,T.join)(O,"logs"),os=(0,T.join)(O,"trash"),is=(0,T.join)(O,"backups"),as=(0,T.join)(O,"modes"),Vs=(0,T.join)(O,"settings.json"),Ce=(0,T.join)(O,"claude-mem.db"),ds=(0,T.join)(O,"vector-db"),Le=(0,T.join)(O,"observer-sessions"),_e=(0,T.basename)(Le),Ys=(0,T.join)(w,"settings.json"),qs=(0,T.join)(w,"commands"),Ks=(0,T.join)(w,"CLAUDE.md");function De(r){(0,F.mkdirSync)(r,{recursive:!0})}function Me(){return(0,T.join)(ts,"..")}var $={dataDir:()=>O,workerPid:()=>(0,T.join)(O,"worker.pid"),serverPid:()=>(0,T.join)(O,".server-beta.pid"),serverPort:()=>(0,T.join)(O,".server-beta.port"),serverRuntime:()=>(0,T.join)(O,".server-beta.runtime.json"),settings:()=>(0,T.join)(O,"settings.json"),database:()=>(0,T.join)(O,"claude-mem.db"),chroma:()=>(0,T.join)(O,"chroma"),combinedCerts:()=>(0,T.join)(O,"combined_certs.pem"),transcriptsConfig:()=>(0,T.join)(O,"transcript-watch.json"),transcriptsState:()=>(0,T.join)(O,"transcript-watch-state.json"),corpora:()=>(0,T.join)(O,"corpora"),supervisorRegistry:()=>(0,T.join)(O,"supervisor.json"),envFile:()=>(0,T.join)(O,".env"),logsDir:()=>ns,archives:()=>rs,trash:()=>os,backups:()=>is,modes:()=>as,vectorDb:()=>ds,observerSessions:()=>Le};var ye=require("crypto");function ue(r,e,t){return(0,ye.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function Ee(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[String(e)]}catch{return[r]}}var c="claude";function us(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function C(r){if(!r)return c;let e=us(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:c}function ve(r){let e=["claude","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function Ue(r,e,t,s,n){let o=Date.now()-s,i=n!==void 0?"up.session_db_id = ?":"up.content_session_id = ?",a=n??e;return r.prepare(`
    SELECT
      up.*,
      s.memory_session_id,
      s.project,
  ...
  `).get(a,t,o)??void 0}var Fe=["private","claude-mem-context","system_instruction","system-instruction","persisted-output","system-reminder"],xe=new RegExp(`<(${Fe.join("|")})\\b[^>]*>[\\s\\S]*?</\\1>`,"g"),we=/<system-reminder>[\s\S]*?<\/system-reminder>/g,ke=100;function Es(r){let e=Object.fromEntries(Fe.map(n=>[n,0]));xe.lastIndex=0;let t=0,s=r.replace(xe,(n,o)=>(e[o]=(e[o]??0)+1,t+=1,""));return t>ke&&E.warn("SYSTEM","tag count exceeds limit",void 0,{tagCount:t,maxAllowed:ke,contentLength:r.length}),{stripped:s.trim(),counts:e}}function Pe(r){return Es(r).stripped}var ms=["task-notification"],rr=new RegExp(`^\\s*<(${ms.join("|")})\\b[^>]*>(?:(?!<\\1\\b|</\\1\\b)[\\s\\S])*</\\1>\\s*$`),nr=256*1024;var me=4e3;function Y(r){let e=r.trim(),s=Pe(r).trim()||e;return s.length<=me?s:(E.debug("DB","Truncated stored prompt text to the configured cap",{originalLength:s.length,storedLength:me}),`${s.slice(0,me-1)}\u2026`)}function ps(r,e){return{customTitle:r,platformSource:e?C(e):void 0}}var q=class{db;constructor(e=Ce){e instanceof pe.Database?this.db=e:(e!==":memory:"&&De(O),this.db=new pe.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.db.run("PRAGMA journal_size_limit = 4194304")),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn(),this.ensureSDKSessionsPlatformContentIdentity(),this.ensureUserPromptsSessionDbId(),this.ensurePendingMessagesSessionToolUniqueIndex()}getIndexColumns(e){return this.db.query(`PRAGMA index_info(${JSON.stringify(e)})`).all().map(t=>t.name)}hasUniqueIndexOnColumns(e,t){return this.db.query(`PRAGMA index_list(${e})`).all().some(n=>{if(n.unique!==1)return!1;let o=this.getIndexColumns(n.name);return o.length===t.length&&o.every((i,a)=>i===t[a])})}resolvePromptSessionDbId(e,t,s){if(t!==void 0)return t;let n=s?C(s):void 0;return n?this.db.prepare(`
    ...
    `).all(e)}getAllRecentUserPrompts(e=100){return this.db.prepare(`
      ...
      ORDER BY up.created_at_epoch DESC
      LIMIT ?
    `).all(e)}getAllProjects(e){let t=e?C(e):void 0,s=`
      SELECT DISTINCT project
      FROM sdk_sessions
      WHERE project IS NOT NULL AND project != ''
        AND project != ?
    `,n=[_e];return t&&(s+=" AND COALESCE(platform_source, ?) = ?",n.push(c,t)),s+=" ORDER BY project ASC",this.db.prepare(s).all(...n).map(i=>i.project)}getProjectCatalog(){let e=this.db.prepare(`
      SELECT
    ...
    `).all(_e),t=[],s=new Set,n={};for(let i of e){let a=C(i.platform_source);n[a]||(n[a]=[]),n[a].includes(i.project)||n[a].push(i.project),s.has(i.project)||(s.add(i.project),t.push(i.project))}let o=ve(Object.keys(n));return{projects:t,sources:o,projectsBySource:Object.fromEntries(o.map(i=>[i,n[i]||[]]))}}getLatestUserPrompt(e,t){let s=this.resolvePromptSessionDbId(e,t),n=s!==null?"up.session_db_id = ?":"up.content_session_id = ?",o=s!==null?s:e;return this.db.prepare(`
      ...
      ORDER BY up.created_at_epoch DESC
      LIMIT 1
    `).get(o)}findRecentDuplicateUserPrompt(e,t,s,n){return Ue(this.db,e,Y(t),s,this.resolvePromptSessionDbId(e,n)??void 0)}getRecentSessionsWithStatus(e,t=3,s){let n=[e],o="";return s&&(o=`AND COALESCE(NULLIF(s.platform_source, ''), '${c}') = ?`,n.push(C(s))),n.push(t),this.db.prepare(`
      SELECT * FROM (
        SELECT
          s.memory_session_id,
          s.status,
    ...
    `).get(e,C(t))||null:this.db.prepare(`
      ...
      ${l}
      ${p}
    `).all(...N);if(!m)return L;let x=new Map(L.map(I=>[I.id,I])),R=e.map(I=>x.get(I)).filter(I=>!!I);return n?R.slice(0,n):R}getSummaryForSession(e,t){let s=[e],n="";return t&&(n=`
        AND EXISTS (
          SELECT 1
    ...
    `).get(e).count}createSDKSession(e,t,s,n,o){let i=new Date,a=i.getTime(),d=ps(n,o),_=d.platformSource??c,m=Y(s),l=this.db.prepare(`
    ...
    `).get(c,_,e);if(l)return t&&this.db.prepare(`
      ...
      VALUES (?, NULL, ?, ?, ?, ?, ?, ?, 'active')
    `).run(e,t,_,m,d.customTitle||null,i.toISOString(),a);return Number(p.lastInsertRowid)}saveUserPrompt(e,t,s,n){let o=new Date,i=o.getTime(),a=Y(s),d=this.resolvePromptSessionDbId(e,n);return this.db.prepare(`
    ...
    `).run(d,e,t,a,o.toISOString(),i).lastInsertRowid}getUserPrompt(e,t,s){let n=this.resolvePromptSessionDbId(e,s);return n!==null?this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,o=0,i,a){let d=i??Date.now(),_=new Date(d).toISOString(),m=ue(e,s.title,s.narrative),p=this.db.prepare(`
    ...
    `).get(e,t,s.type,s.title,s.subtitle,JSON.stringify(s.facts),s.narrative,JSON.stringify(s.concepts),JSON.stringify(s.files_read),JSON.stringify(s.files_modified),n||null,o,s.agent_type??null,s.agent_id??null,m,_,d,a||null,s.metadata??null);if(p)return{id:p.id,createdAtEpoch:p.created_at_epoch};let g=this.db.prepare("SELECT id, created_at_epoch FROM observations WHERE memory_session_id = ? AND content_hash = ?").get(e,m);if(!g)throw new Error(`storeObservation: ON CONFLICT without existing row for content_hash=${m}`);return{id:g.id,createdAtEpoch:g.created_at_epoch}}storeSummary(e,t,s,n,o=0,i){let a=i??Date.now(),d=new Date(a).toISOString(),m=this.db.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,d,a);return{id:Number(m.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a,d){let _=a??Date.now(),m=new Date(_).toISOString();return this.db.transaction(()=>{let p=[],g=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, agent_type, agent_id, content_hash, created_at, created_at_epoch,
         generated_by_model)
        ...
        ON CONFLICT(memory_session_id, content_hash) DO NOTHING
        RETURNING id
      `),N=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let f of s){let S=ue(e,f.title,f.narrative),L=g.get(e,t,f.type,f.title,f.subtitle,JSON.stringify(f.facts),f.narrative,JSON.stringify(f.concepts),JSON.stringify(f.files_read),JSON.stringify(f.files_modified),o||null,i,f.agent_type??null,f.agent_id??null,S,m,_,d||null);if(L){p.push(L.id);continue}let x=N.get(e,S);if(!x)throw new Error(`storeObservations: ON CONFLICT without existing row for content_hash=${S}`);p.push(x.id)}let h=null;if(n){let S=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,o||null,i,m,_);h=Number(S.lastInsertRowid)}return{observationIds:p,summaryId:h,createdAtEpoch:_}})()}getSessionSummariesByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,platformSource:i}=t,a=s==="relevance",d=a?"":`ORDER BY ss.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,_=n&&!a?`LIMIT ${n}`:"",m=e.map(()=>"?").join(","),l=[...e],p=[];o&&(p.push("ss.project = ?"),l.push(o)),i&&(p.push(`COALESCE(NULLIF(s.platform_source, ''), '${c}') = ?`),l.push(C(i)));let g=p.length>0?`AND ${p.join(" AND ")}`:"",h=this.db.prepare(`
      SELECT ss.*
      FROM session_summaries ss
      ...
      ${d}
      ${_}
    `).all(...l);if(!a)return h;let f=new Map(h.map(L=>[L.id,L])),S=e.map(L=>f.get(L)).filter(L=>!!L);return n?S.slice(0,n):S}getUserPromptsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,platformSource:i}=t,a=s==="relevance",d=a?"":`ORDER BY up.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,_=n?`LIMIT ${n}`:"",m=e.map(()=>"?").join(","),l=[...e],p=[];o&&(p.push("s.project = ?"),l.push(o)),i&&(p.push(`COALESCE(NULLIF(s.platform_source, ''), '${c}') = ?`),l.push(C(i)));let g=p.length>0?`AND ${p.join(" AND ")}`:"",h=this.db.prepare(`
      SELECT
        up.*,
        s.project,
        s.memory_session_id,
      ...
      ${d}
      ${_}
    `).all(...l);if(!a)return h;let f=new Map(h.map(S=>[S.id,S]));return e.map(S=>f.get(S)).filter(S=>!!S)}getTimelineAroundTimestamp(e,t=10,s=10,n,o){return this.getTimelineAroundObservation(null,e,t,s,n,o)}getTimelineAroundObservation(e,t,s=10,n=10,o,i){let a=i?C(i):void 0,d=(R,I)=>{let b=[],D=[];return o&&(b.push(`${R}.project = ?`),D.push(o)),a&&(b.push(`COALESCE(NULLIF(${I}.platform_source, ''), '${c}') = ?`),D.push(a)),{clause:b.length>0?`AND ${b.join(" AND ")}`:"",params:D}},_=d("o","src"),m=d("ss","src"),l=d("s","s"),p,g;if(e!==null){let R=`
    ...
    `).all(...e)}getOrCreateManualSession(e){let t=`manual-${e}`,s=`manual-content-${e}`;if(this.db.prepare("SELECT memory_session_id FROM sdk_sessions WHERE memory_session_id = ?").get(t))return t;let o=new Date;return this.db.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?, 'active')
    `).run(t,s,e,c,o.toISOString(),o.getTime()),E.info("SESSION","Created manual session",{memorySessionId:t,project:e}),t}close(){this.db.close()}importSdkSession(e){let t=C(e.platform_source),s=this.db.prepare(`SELECT id FROM sdk_sessions
  ...
  `).all(e,e,s??null,s??null,...n,...i,t.totalObservationCount)}function ze(r,e,t,s){return r.db.prepare(`
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(e,e,s??null,s??null,t.sessionCount+Se)}function Ze(r,e,t,s){let n=Array.from(t.observationTypes),o=n.map(()=>"?").join(","),i=Array.from(t.observationConcepts),a=i.map(()=>"?").join(","),d=e.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
      o.id,
      o.memory_session_id,
      COALESCE(s.platform_source, 'claude') as platform_source,
...
`}function yt(r,e,t,s){let n=[];return s?n.push(...St(r)):n.push(...it(r)),s?n.push(...ft()):n.push(...at()),s&&(n.push(...Rt()),n.push(...bt())),Z(t)&&(s?n.push(...Ot(e,t)):n.push(...dt(e,t))),n}var Re=P(require("path"),1);function re(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return E.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e instanceof Error?e:new Error(String(e))),[]}}function be(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function Oe(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function Ut(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function vt(r,e){return Re.default.isAbsolute(r)?Re.default.relative(e,r):r}function xt(r,e,t){let s=re(r);if(s.length>0)return vt(s[0],e);if(t){let n=re(t);if(n.length>0)return vt(n[0],e)}return"General"}function Cs(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=Ut(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function kt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?re(r.facts).join(`
`):null}function Ls(r,e,t,s){let n=[];n.push(..._t(r));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=be(a.displayTime);n.push(...pt(a,d))}else{let a=i.data,d=Oe(a.created_at),m=d!==o?d:"";if(o=d,t.has(a.id)){let p=kt(a,s);n.push(...mt(a,m,p,s))}else n.push(Et(a,m,s))}return n}function Ds(r,e,t,s,n){let o=[];o.push(...ht(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let _=d.data,m=be(_.displayTime);o.push(...Ct(_,m))}else{let _=d.data,m=xt(_.files_modified,n,_.files_read),l=Oe(_.created_at),p=l!==a;a=l;let g=t.has(_.id);if(m!==i&&(o.push(...At(m)),i=m),g){let N=kt(_,s);o.push(...It(_,l,p,N,s))}else o.push(Nt(_,l,p,s))}return o.push(""),o}function Ms(r,e,t,s,n,o){return o?Ds(r,e,t,s,n):Ls(r,e,t,s)}function Ft(r,e,t,s,n){let o=[],i=Cs(r);for(let[a,d]of i)o.push(...Ms(a,d,e,t,s,n));return o}function wt(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function Pt(r,e){let t=[];return e?(t.push(...W("Investigated",r.investigated,u.blue)),t.push(...W("Learned",r.learned,u.yellow)),t.push(...W("Completed",r.completed,u.green)),t.push(...W("Next Steps",r.next_steps,u.magenta))):(t.push(...B("Investigated",r.investigated)),t.push(...B("Learned",r.learned)),t.push(...B("Completed",r.completed)),t.push(...B("Next Steps",r.next_steps))),t}function $t(r,e){return e?Lt(r):ct(r)}function Ht(r,e,t){return!Z(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?Dt(r.totalDiscoveryTokens,r.totalReadTokens):lt(r.totalDiscoveryTokens,r.totalReadTokens)}var ys=Xt.default.join((0,Gt.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function vs(){try{return new q}catch(r){if(r instanceof Error&&r.code==="ERR_DLOPEN_FAILED"){try{(0,jt.unlinkSync)(ys)}catch(e){e instanceof Error?E.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):E.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return E.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function Us(r,e){return e?Mt(r):Tt(r)}function xs(r,e,t,s,n,o,i){let a=[],d=fe(e);a.push(...yt(r,d,s,i));let _=t.slice(0,s.sessionCount),m=st(_,t),l=rt(e,m),p=nt(e,s.fullObservationCount);a.push(...Ft(l,p,s,n,i));let g=t[0],N=e[0];wt(s,g,N)&&a.push(...Pt(g,i));let h=tt(e,s,o,n);return a.push(...$t(h,i)),a.push(...Ht(d,s,i)),a.join(`
`).trimEnd()}var ks=new Set(["bugfix","discovery","decision","refactor"]);function Fs(r,e,t){let s=fe(r),n={bugfix:0,discovery:0,decision:0,refactor:0,other:0},o=new Set,i=Number.POSITIVE_INFINITY;for(let d of r){let _=ks.has(d.type)?d.type:"other";n[_]++,d.memory_session_id&&o.add(d.memory_session_id),d.created_at_epoch&&d.created_at_epoch<i&&(i=d.created_at_epoch)}let a=Number.isFinite(i)?Math.max(0,Math.floor((Date.now()-i)/864e5)):0;return{observation_count:r.length,session_count:o.size,timeline_depth_days:a,has_session_summary:e.length>0,obs_type_bugfix:n.bugfix,obs_type_discovery:n.discovery,obs_type_decision:n.decision,obs_type_refactor:n.refactor,obs_type_other:n.other,tokens_injected:s.totalReadTokens,tokens_saved_vs_naive:s.savings,search_strategy:t?"full":"timeline"}}async function he(r,e=!1){let t=Ye(),s=r?.cwd??process.cwd(),n=We(s),o=r?.projects?.length?r.projects:n.allProjects,i=o[o.length-1]??n.primary;r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let a=vs();if(!a)return{text:"",stats:null};try{let d=r?.platformSource?C(r.platformSource):void 0,_=o.length>1?Ze(a,o,t,d):Qe(a,i,t,d),m=o.length>1?et(a,o,t,d):ze(a,i,t,d);return _.length===0&&m.length===0?{text:Us(i,e),stats:null}:{text:xs(i,_,m,t,s,r?.session_id,e),stats:Fs(_,m,!!r?.full)}}finally{a.close()}}async function Bt(r,e=!1){return(await he(r,e)).text}0&&(module.exports={generateContext,generateContextWithStats});
