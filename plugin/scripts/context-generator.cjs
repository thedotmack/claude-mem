"use strict";var bt=Object.create;var w=Object.defineProperty;var St=Object.getOwnPropertyDescriptor;var ht=Object.getOwnPropertyNames;var Ot=Object.getPrototypeOf,Rt=Object.prototype.hasOwnProperty;var Nt=(r,e)=>{for(var t in e)w(r,t,{get:e[t],enumerable:!0})},le=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of ht(e))!Rt.call(r,n)&&n!==t&&w(r,n,{get:()=>e[n],enumerable:!(s=St(e,n))||s.enumerable});return r};var L=(r,e,t)=>(t=r!=null?bt(Ot(r)):{},le(e||!r||!r.__esModule?w(t,"default",{value:r,enumerable:!0}):t,r)),At=r=>le(w({},"__esModule",{value:!0}),r);var Gt={};Nt(Gt,{generateContext:()=>ce});module.exports=At(Gt);var Et=L(require("path"),1),Tt=require("os"),gt=require("fs");var be=require("bun:sqlite");var b=require("path"),Q=require("os"),$=require("fs");var pe=require("url");var C=require("fs"),v=require("path"),me=require("os"),K=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(K||{}),ue=(0,v.join)((0,me.homedir)(),".claude-mem"),J=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=(0,v.join)(ue,"logs");(0,C.existsSync)(e)||(0,C.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,v.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=(0,v.join)(ue,"settings.json");if((0,C.existsSync)(e)){let t=(0,C.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=K[n]??1}else this.level=1}catch{this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`+JSON.stringify(o,null,2):u=" "+this.formatData(o));let p="";if(n){let{sessionId:T,memorySessionId:S,correlationId:I,...m}=n;Object.keys(m).length>0&&(p=` {${Object.entries(m).map(([g,h])=>`${g}=${h}`).join(", ")}}`)}let E=`[${i}] [${a}] [${d}] ${_}${s}${p}${u}`;if(this.logFilePath)try{(0,C.appendFileSync)(this.logFilePath,E+`
