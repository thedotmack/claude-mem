...
`+JSON.stringify(o,null,2):m=" "+this.formatData(o));let u="";if(n){let{sessionId:E,memorySessionId:g,correlationId:h,...l}=n;Object.keys(l).length>0&&(u=` {${Object.entries(l).map(([f,R])=>`${f}=${R}`).join(", ")}}`)}let T=`[${i}] [${a}] [${_}] ${p}${s}${u}${m}`;if(this.logFilePath)try{(0,A.appendFileSync)(this.logFilePath,T+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),m=p?`${p[1].split("/").pop()}:${p[2]}`:"unknown",u={...s,location:m};return this.warn(e,`[HAPPY-PATH] ${t}`,u,n),o}},c=new W;var Ct={};function Rt(){return typeof __dirname<"u"?__dirname:(0,b.dirname)((0,pe.fileURLToPath)(Ct.url))}var Nt=Rt(),N=I.get("CLAUDE_MEM_DATA_DIR"),y=process.env.CLAUDE_CONFIG_DIR||(0,b.join)((0,de.homedir)(),".claude"),Vt=(0,b.join)(y,"plugins","marketplaces","thedotmack"),qt=(0,b.join)(N,"archives"),Kt=(0,b.join)(N,"logs"),Jt=(0,b.join)(N,"trash"),Qt=(0,b.join)(N,"backups"),zt=(0,b.join)(N,"modes"),Zt=(0,b.join)(N,"settings.json"),ce=(0,b.join)(N,"claude-mem.db"),es=(0,b.join)(N,"vector-db"),ts=(0,b.join)(N,"observer-sessions"),ss=(0,b.join)(y,"settings.json"),rs=(0,b.join)(y,"commands"),ns=(0,b.join)(y,"CLAUDE.md");function me(r){(0,_e.mkdirSync)(r,{recursive:!0})}function ue(){return(0,b.join)(Nt,"..")}var le=require("crypto");var At=3e4;function Ee(r,e,t){return(0,le.createHash)("sha256").update((r||"")+(e||"")+(t||"")).digest("hex").slice(0,16)}function Te(r,e,t){let s=t-At;return r.prepare("SELECT id, created_at_epoch FROM observations WHERE content_hash = ? AND created_at_epoch > ?").get(e,s)}var $=class{db;constructor(e=ce){e!==":memory:"&&me(N),this.db=new ge.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn()}initializeSchema(){this.db.run(`
    ...
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,_,a);return{id:Number(m.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a){let _=a??Date.now(),p=new Date(_).toISOString();return this.db.transaction(()=>{let u=[],T=this.db.prepare(`
      ...
      `);for(let g of s){let h=T.run(e,t,g.type,g.title,g.subtitle,JSON.stringify(g.facts),g.narrative,JSON.stringify(g.concepts),JSON.stringify(g.files_read),JSON.stringify(g.files_modified),o||null,i,p,_);u.push(Number(h.lastInsertRowid))}let E=null;if(n){let h=this.db.prepare(`
        ...
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, created_at, created_at_epoch)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let S of s){let f=g.run(e,t,S.type,S.title,S.subtitle,JSON.stringify(S.facts),S.narrative,JSON.stringify(S.concepts),JSON.stringify(S.files_read),JSON.stringify(S.files_modified),a||null,_,u,m);E.push(Number(f.lastInsertRowid))}let h;if(n){let f=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,a||null,_,u,m);h=Number(f.lastInsertRowid)}return this.db.prepare(`
...
`}function st(r,e,t,s){let n=[];return s?n.push(...He(r)):n.push(...Le(r)),s?n.push(...Be()):n.push(...Me()),s?n.push(...We()):n.push(...ve()),s?n.push(...Ye()):n.push(...De()),P(t)&&(s?n.push(...Ve(e,t)):n.push(...xe(e,t))),n}var ee=M(require("path"),1);function H(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return c.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e),[]}}function nt(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function ot(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function it(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function rt(r,e){return ee.default.isAbsolute(r)?ee.default.relative(e,r):r}function at(r,e,t){let s=H(r);if(s.length>0)return rt(s[0],e);if(t){let n=H(t);if(n.length>0)return rt(n[0],e)}return"General"}function Mt(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=it(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function vt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?H(r.facts).join(`
`):null}function Dt(r,e,t,s,n,o){let i=[];o?i.push(...qe(r)):i.push(...Ue(r));let a=null,_="",p=!1;for(let m of e)if(m.type==="summary"){p&&(i.push(""),p=!1,a=null,_="");let u=m.data,T=nt(u.displayTime);o?i.push(...ze(u,T)):i.push(...Fe(u,T))}else{let u=m.data,T=at(u.files_modified,n,u.files_read),E=ot(u.created_at),g=E!==_,h=g?E:"";_=E;let l=t.has(u.id);if(T!==a&&(p&&i.push(""),o?i.push(...Ke(T)):i.push(...ke(T)),a=T,p=!0),l){let S=vt(u,s);o?i.push(...Qe(u,E,g,S,s)):(p&&!o&&(i.push(""),p=!1),i.push(...$e(u,h,S,s)),a=null)}else o?i.push(Je(u,E,g,s)):i.push(we(u,h,s))}return p&&i.push(""),i}function dt(r,e,t,s,n){let o=[],i=Mt(r);for(let[a,_]of i)o.push(...Dt(a,_,e,t,s,n));return o}function _t(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function pt(r,e){let t=[];return e?(t.push(...U("Investigated",r.investigated,d.blue)),t.push(...U("Learned",r.learned,d.yellow)),t.push(...U("Completed",r.completed,d.green)),t.push(...U("Next Steps",r.next_steps,d.magenta))):(t.push(...x("Investigated",r.investigated)),t.push(...x("Learned",r.learned)),t.push(...x("Completed",r.completed)),t.push(...x("Next Steps",r.next_steps))),t}function ct(r,e){return e?Ze(r):Pe(r)}function mt(r,e,t){return!P(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?et(r.totalDiscoveryTokens,r.totalReadTokens):Xe(r.totalDiscoveryTokens,r.totalReadTokens)}var xt=ut.default.join((0,lt.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function Ut(){try{return new $}catch(r){if(r.code==="ERR_DLOPEN_FAILED"){try{(0,Et.unlinkSync)(xt)}catch(e){c.debug("SYSTEM","Marker file cleanup failed (may not exist)",{},e)}return c.error("SYSTEM","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function kt(r,e){return e?tt(r):je(r)}function wt(r,e,t,s,n,o,i){let a=[],_=K(e);a.push(...st(r,_,s,i));let p=t.slice(0,s.sessionCount),m=Ae(p,t),u=Z(e,m),T=Ie(e,s.fullObservationCount);a.push(...dt(u,T,s,n,i));let E=t[0],g=e[0];_t(s,E,g)&&a.push(...pt(E,i));let h=z(e,s,o,n);return a.push(...ct(h,i)),a.push(...mt(_,s,i)),a.join(`
`).trimEnd()}async function te(r,e=!1){let t=Y(),s=r?.cwd??process.cwd(),n=Se(s),o=r?.projects||[n],i=Ut();if(!i)return"";try{let a=o.length>1?Ne(i,o,t):J(i,n,t),_=o.length>1?Ce(i,o,t):Q(i,n,t);return a.length===0&&_.length===0?kt(n,e):wt(n,a,_,t,s,r?.session_id,e)}finally{i.close()}}0&&(module.exports={generateContext});
