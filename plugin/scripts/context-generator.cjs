"use strict";var cs=Object.create;var K=Object.defineProperty;var _s=Object.getOwnPropertyDescriptor;var us=Object.getOwnPropertyNames;var ls=Object.getPrototypeOf,ps=Object.prototype.hasOwnProperty;var ms=(s,e)=>{for(var t in e)K(s,t,{get:e[t],enumerable:!0})},Xe=(s,e,t,r)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of us(e))!ps.call(s,n)&&n!==t&&K(s,n,{get:()=>e[n],enumerable:!(r=_s(e,n))||r.enumerable});return s};var j=(s,e,t)=>(t=s!=null?cs(ls(s)):{},Xe(e||!s||!s.__esModule?K(t,"default",{value:s,enumerable:!0}):t,s)),Es=s=>Xe(K({},"__esModule",{value:!0}),s);var Qs={};ms(Qs,{generateContext:()=>$e,generateContextWithStats:()=>me});module.exports=Es(Qs);var is=j(require("path"),1),as=require("os"),ds=require("fs");var Ne=require("bun:sqlite");var E=require("path"),be=require("os"),P=require("fs");var We=require("url");var y=require("fs"),Be=require("path");var gs=null;function Ts(s){return(gs??process.stderr.write.bind(process.stderr))(s)}function ge(s){Ts(s)}var Te=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(Te||{}),fe=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=G.logsDir();(0,y.existsSync)(e)||(0,y.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,Be.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=G.settings();if((0,y.existsSync)(e)){let t=(0,y.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=Te[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`+JSON.stringify(o,null,2)}catch{u=" "+this.formatData(o)}else u=" "+this.formatData(o);let p="";if(n){let{sessionId:m,memorySessionId:f,correlationId:b,...S}=n;Object.keys(S).length>0&&(p=` {${Object.entries(S).map(([h,O])=>`${h}=${O}`).join(", ")}}`)}let g=`[${i}] [${a}] [${d}] ${l}${r}${p}${u}`;if(this.logFilePath)try{(0,y.appendFileSync)(this.logFilePath,g+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),u=l?`${l[1].split("/").pop()}:${l[2]}`:"unknown",p={...r,location:u};return this.warn(e,`[HAPPY-PATH] ${t}`,p,n),o}},_=new fe;var Is={};function fs(){return typeof __dirname<"u"?__dirname:(0,E.dirname)((0,We.fileURLToPath)(Is.url))}var bs=fs();function Ss(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let s=(0,E.join)((0,be.homedir)(),".claude-mem"),e=(0,E.join)(s,"settings.json");try{if((0,P.existsSync)(e)){let t=JSON.parse((0,P.readFileSync)(e,"utf-8")),r=t.env??t;if(r.CLAUDE_MEM_DATA_DIR)return r.CLAUDE_MEM_DATA_DIR}}catch{}return s}var R=Ss(),w=process.env.CLAUDE_CONFIG_DIR||(0,E.join)((0,be.homedir)(),".claude"),or=(0,E.join)(w,"plugins","marketplaces","thedotmack"),hs=(0,E.join)(R,"archives"),Os=(0,E.join)(R,"logs"),Rs=(0,E.join)(R,"trash"),As=(0,E.join)(R,"backups"),Ns=(0,E.join)(R,"modes"),ir=(0,E.join)(R,"settings.json"),Ve=(0,E.join)(R,"claude-mem.db"),Cs=(0,E.join)(R,"vector-db"),Ye=(0,E.join)(R,"observer-sessions"),Se=(0,E.basename)(Ye),ar=(0,E.join)(w,"settings.json"),dr=(0,E.join)(w,"commands"),cr=(0,E.join)(w,"CLAUDE.md");function qe(s){(0,P.mkdirSync)(s,{recursive:!0})}function Ke(){return(0,E.join)(bs,"..")}var G={dataDir:()=>R,workerPid:()=>(0,E.join)(R,"worker.pid"),serverBetaPid:()=>(0,E.join)(R,".server-beta.pid"),serverBetaPort:()=>(0,E.join)(R,".server-beta.port"),serverBetaRuntime:()=>(0,E.join)(R,".server-beta.runtime.json"),settings:()=>(0,E.join)(R,"settings.json"),database:()=>(0,E.join)(R,"claude-mem.db"),chroma:()=>(0,E.join)(R,"chroma"),combinedCerts:()=>(0,E.join)(R,"combined_certs.pem"),transcriptsConfig:()=>(0,E.join)(R,"transcript-watch.json"),transcriptsState:()=>(0,E.join)(R,"transcript-watch-state.json"),corpora:()=>(0,E.join)(R,"corpora"),supervisorRegistry:()=>(0,E.join)(R,"supervisor.json"),envFile:()=>(0,E.join)(R,".env"),logsDir:()=>Os,archives:()=>hs,trash:()=>Rs,backups:()=>As,modes:()=>Ns,vectorDb:()=>Cs,observerSessions:()=>Ye};var tt=require("crypto");var Qe=require("os"),ze=j(require("path"),1),Ze=require("child_process");var Q=require("fs"),J=j(require("path"),1);var X={isWorktree:!1,worktreeName:null,parentRepoPath:null,parentProjectName:null};function Je(s){let e=J.default.join(s,".git"),t;try{t=(0,Q.statSync)(e)}catch(u){return u instanceof Error&&u.code!=="ENOENT"&&_.warn("GIT","Unexpected error checking .git",{error:u instanceof Error?u.message:String(u)}),X}if(!t.isFile())return X;let r;try{r=(0,Q.readFileSync)(e,"utf-8").trim()}catch(u){return _.warn("GIT","Failed to read .git file",{error:u instanceof Error?u.message:String(u)}),X}let n=r.match(/^gitdir:\s*(.+)$/);if(!n)return X;let i=n[1].match(/^(.+)[/\\]\.git[/\\]worktrees[/\\]([^/\\]+)$/);if(!i)return X;let a=i[1],d=J.default.basename(s),l=J.default.basename(a);return{isWorktree:!0,worktreeName:d,parentRepoPath:a,parentProjectName:l}}function et(s){return s==="~"||s.startsWith("~/")?s.replace(/^~/,(0,Qe.homedir)()):s}function Ls(s){try{return(0,Ze.execFileSync)("git",["rev-parse","--show-toplevel"],{cwd:s,encoding:"utf-8",stdio:["ignore","pipe","ignore"]}).trim()||null}catch{return null}}function Ms(s){if(!s||s.trim()==="")return _.warn("PROJECT_NAME","Empty cwd provided, using fallback",{cwd:s}),"unknown-project";let e=et(s),r=Ls(e)??e,n=ze.default.basename(r);if(n===""){if(process.platform==="win32"){let i=s.match(/^([A-Z]):\\/i);if(i){let d=`drive-${i[1].toUpperCase()}`;return _.info("PROJECT_NAME","Drive root detected",{cwd:s,projectName:d}),d}}return _.warn("PROJECT_NAME","Root directory detected, using fallback",{cwd:s}),"unknown-project"}return n}function he(s){let e=Ms(s);if(!s)return{primary:e,parent:null,isWorktree:!1,allProjects:[e]};let t=et(s),r=Je(t);if(r.isWorktree&&r.parentProjectName){let n=`${r.parentProjectName}/${e}`;return{primary:n,parent:r.parentProjectName,isWorktree:!0,allProjects:[r.parentProjectName,n]}}return{primary:e,parent:null,isWorktree:!1,allProjects:[e]}}function Oe(s){return(0,tt.createHash)("sha256").update(s.join("\0")).digest("hex").slice(0,16)}function U(s){return JSON.stringify(s??[])}function Ds(s){return!!(s.subtitle||(s.facts?.length??0)>0||(s.concepts?.length??0)>0||(s.files_read?.length??0)>0||(s.files_modified?.length??0)>0)}function D(s){return s||""}function z(s){if(!s)return"[]";try{let e=JSON.parse(s);return JSON.stringify(Array.isArray(e)?e:[])}catch{return s}}function Z(s,e,t){let r=typeof e=="object"&&e!==null?e:{title:e,narrative:t??null};return Oe([s||"",D(r.title),D(r.narrative)])}function ee(s,e){return D(e.title)===D(s.title)&&D(e.narrative)===D(s.narrative)&&D(e.subtitle)===D(s.subtitle)&&z(e.facts)===U(s.facts)&&z(e.concepts)===U(s.concepts)&&z(e.files_read)===U(s.files_read)&&z(e.files_modified)===U(s.files_modified)}function te(s,e,t){let r=typeof e=="object"&&e!==null?e:{title:e,narrative:t??null},n=[s||"",D(r.title),D(r.narrative)];return Ds(r)?Oe([...n,r.subtitle||"",U(r.facts),U(r.concepts),U(r.files_read),U(r.files_modified)]):Oe(n)}function Re(s){if(!s)return[];try{let e=JSON.parse(s);return Array.isArray(e)?e:[String(e)]}catch{return[s]}}var N="claude";function vs(s){return s.trim().toLowerCase().replace(/\s+/g,"-")}function F(s){if(!s)return N;let e=vs(s);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:N}function st(s){let e=["claude","codex","cursor"];return[...s].sort((t,r)=>{let n=e.indexOf(t),o=e.indexOf(r);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(r)})}function rt(s,e,t,r){let n=Date.now()-r;return s.prepare(`
    SELECT
      up.*,
      s.memory_session_id,
      s.project,
  ...
  `).get(e,t,n)??void 0}var it=["private","claude-mem-context","system_instruction","system-instruction","persisted-output","system-reminder"],nt=new RegExp(`<(${it.join("|")})\\b[^>]*>[\\s\\S]*?</\\1>`,"g"),at=/<system-reminder>[\s\S]*?<\/system-reminder>/g,ot=100;function ys(s){let e=Object.fromEntries(it.map(n=>[n,0]));nt.lastIndex=0;let t=0,r=s.replace(nt,(n,o)=>(e[o]=(e[o]??0)+1,t+=1,""));return t>ot&&_.warn("SYSTEM","tag count exceeds limit",void 0,{tagCount:t,maxAllowed:ot,contentLength:s.length}),{stripped:r.trim(),counts:e}}function dt(s){return ys(s).stripped}var Us=["task-notification"],Ar=new RegExp(`^\\s*<(${Us.join("|")})\\b[^>]*>(?:(?!<\\1\\b|</\\1\\b)[\\s\\S])*</\\1>\\s*$`),Nr=256*1024;var Ae=4e3;function se(s){let e=s.trim(),r=dt(s).trim()||e;return r.length<=Ae?r:(_.debug("DB","Truncated stored prompt text to the configured cap",{originalLength:r.length,storedLength:Ae}),`${r.slice(0,Ae-1)}\u2026`)}function xs(s,e){return{customTitle:s,platformSource:e?F(e):void 0}}var re=class{db;constructor(e=Ve){e instanceof Ne.Database?this.db=e:(e!==":memory:"&&qe(R),this.db=new Ne.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.db.run("PRAGMA journal_size_limit = 4194304")),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn()}dropWorkerPidColumn(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(32),r=this.db.query("PRAGMA table_info(pending_messages)").all().some(n=>n.name==="worker_pid");if(!(e&&!r)){if(r)try{this.db.run("DROP INDEX IF EXISTS idx_pending_messages_worker_pid"),this.db.run("ALTER TABLE pending_messages DROP COLUMN worker_pid"),_.debug("DB","Dropped worker_pid column and its index from pending_messages")}catch(n){_.warn("DB","Failed to drop worker_pid column from pending_messages",{},n instanceof Error?n:new Error(String(n)));return}e||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(32,new Date().toISOString())}}dropDeadPendingMessagesColumns(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(31),t=this.db.query("PRAGMA table_info(pending_messages)").all(),r=new Set(t.map(i=>i.name)),o=["retry_count","failed_at_epoch","completed_at_epoch"].filter(i=>r.has(i));if(!(e&&o.length===0)){if(o.length>0){this.db.run("BEGIN TRANSACTION");try{this.db.run("DELETE FROM pending_messages WHERE status NOT IN ('pending', 'processing')");for(let i of o)this.db.run(`ALTER TABLE pending_messages DROP COLUMN ${i}`),_.debug("DB",`Dropped dead column ${i} from pending_messages`);e||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(31,new Date().toISOString()),this.db.run("COMMIT")}catch(i){this.db.run("ROLLBACK"),_.warn("DB","Failed to drop dead columns from pending_messages",{},i instanceof Error?i:new Error(String(i)));return}return}e||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(31,new Date().toISOString())}}initializeSchema(){this.db.run(`
    ...
    `).all(e)}getAllRecentUserPrompts(e=100){return this.db.prepare(`
      ...
      ORDER BY up.created_at_epoch DESC
      LIMIT ?
    `).all(e)}getAllProjects(e){let t=e?F(e):void 0,r=`
    ...
    `).get(e).count}createSDKSession(e,t,r,n,o){let i=new Date,a=i.getTime(),d=xs(n,o),l=d.platformSource??N,u=se(r),p=this.db.prepare(`
    ...
    `).get(e);if(p){if(t&&this.db.prepare(`
        ...
        `).run(d.customTitle,e),d.platformSource){let m=p.platform_source?.trim()?F(p.platform_source):void 0;if(!m)this.db.prepare(`
    ...
    `).run(e,t,r.request,r.investigated,r.learned,r.completed,r.next_steps,r.notes,n||null,o,d,a);return{id:Number(u.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,r,n,o,i=0,a,d){let l=a??Date.now(),u=new Date(l).toISOString();return this.db.transaction(()=>{let g=[],m=this.db.prepare(`
      ...
      `),S=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?"),T=this.db.prepare(`
        ...
        FROM observations
        WHERE memory_session_id = ? AND content_hash = ?
      `);for(let A of r){let M=te(e,A),He=Z(e,A);if(He!==M){let Ee=T.get(e,He);if(Ee&&ee(A,Ee)){f.push(Ee.id);continue}}let je=b.get(e,t,A.type,A.title,A.subtitle,JSON.stringify(A.facts),A.narrative,JSON.stringify(A.concepts),JSON.stringify(A.files_read),JSON.stringify(A.files_modified),a||null,d,A.agent_type??null,A.agent_id??null,M,g,p,u||null);if(je){f.push(je.id);continue}let Ge=S.get(e,M);if(!Ge)throw new Error(`storeObservationsAndMarkComplete: ON CONFLICT without existing row for content_hash=${M}`);f.push(Ge.id)}let h;if(n){let M=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,a||null,d,g,p);h=Number(M.lastInsertRowid)}if(this.db.prepare(`
        DELETE FROM pending_messages
    ...
    `).run(e.content_session_id,e.memory_session_id,e.project,F(e.platform_source),e.user_prompt,e.started_at,e.started_at_epoch,e.completed_at,e.completed_at_epoch,e.status).lastInsertRowid}}importSessionSummary(e){let t=this.db.prepare("SELECT id FROM session_summaries WHERE memory_session_id = ?").get(e.memory_session_id);return t?{imported:!1,id:t.id}:{imported:!0,id:this.db.prepare(`
      INSERT INTO session_summaries (
...
`}function Jt(s,e,t,r){let n=[];return r?n.push(...Ft(s)):n.push(...Rt(s)),r?n.push(...kt()):n.push(...At()),r?n.push(...$t()):n.push(...Nt()),r?n.push(...Ht()):n.push(...Ct()),ae(t)&&(r?n.push(...jt(e,t)):n.push(...It(e,t))),n}var we=j(require("path"),1);function pe(s){if(!s)return[];try{let e=JSON.parse(s);return Array.isArray(e)?e:[]}catch(e){return _.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:s?.substring(0,50)},e instanceof Error?e:new Error(String(e))),[]}}function Fe(s){return new Date(s).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function ke(s){return new Date(s).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function zt(s){return new Date(s).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function Qt(s,e){return we.default.isAbsolute(s)?we.default.relative(e,s):s}function Zt(s,e,t){let r=pe(s);if(r.length>0)return Qt(r[0],e);if(t){let n=pe(t);if(n.length>0)return Qt(n[0],e)}return"General"}function js(s){let e=new Map;for(let r of s){let n=r.type==="observation"?r.data.created_at:r.data.displayTime,o=zt(n);e.has(o)||e.set(o,[]),e.get(o).push(r)}let t=Array.from(e.entries()).sort((r,n)=>{let o=new Date(r[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function es(s,e){return e.fullObservationField==="narrative"?s.narrative:s.facts?pe(s.facts).join(`
`):null}function Gs(s,e,t,r){let n=[];n.push(...Lt(s));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=Fe(a.displayTime);n.push(...yt(a,d))}else{let a=i.data,d=ke(a.created_at),u=d!==o?d:"";if(o=d,t.has(a.id)){let g=es(a,r);n.push(...vt(a,u,g,r))}else n.push(Dt(a,u,r))}return n}function Xs(s,e,t,r,n){let o=[];o.push(...Gt(s));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let l=d.data,u=Fe(l.displayTime);o.push(...Vt(l,u))}else{let l=d.data,u=Zt(l.files_modified,n,l.files_read),p=ke(l.created_at),g=p!==a;a=p;let m=t.has(l.id);if(u!==i&&(o.push(...Xt(u)),i=u),m){let f=es(l,r);o.push(...Wt(l,p,g,f,r))}else o.push(Bt(l,p,g,r))}return o.push(""),o}function Bs(s,e,t,r,n,o){return o?Xs(s,e,t,r,n):Gs(s,e,t,r)}function ts(s,e,t,r,n){let o=[],i=js(s);for(let[a,d]of i)o.push(...Bs(a,d,e,t,r,n));return o}function ss(s,e,t){return!(!s.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function rs(s,e){let t=[];return e?(t.push(...q("Investigated",s.investigated,c.blue)),t.push(...q("Learned",s.learned,c.yellow)),t.push(...q("Completed",s.completed,c.green)),t.push(...q("Next Steps",s.next_steps,c.magenta))):(t.push(...Y("Investigated",s.investigated)),t.push(...Y("Learned",s.learned)),t.push(...Y("Completed",s.completed)),t.push(...Y("Next Steps",s.next_steps))),t}function ns(s,e){return e?Yt(s):Ut(s)}function os(s,e,t){return!ae(e)||s.totalDiscoveryTokens<=0||s.savings<=0?[]:t?qt(s.totalDiscoveryTokens,s.totalReadTokens):xt(s.totalDiscoveryTokens,s.totalReadTokens)}var Ws=is.default.join((0,as.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function Vs(){try{return new re}catch(s){if(s instanceof Error&&s.code==="ERR_DLOPEN_FAILED"){try{(0,ds.unlinkSync)(Ws)}catch(e){e instanceof Error?_.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):_.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return _.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw s}}function Ys(s,e){return e?Kt(s):Pt(s)}function qs(s,e,t,r,n,o,i){let a=[],d=ie(e);a.push(...Jt(s,d,r,i));let l=t.slice(0,r.sessionCount),u=St(l,t),p=Pe(e,u),g=ht(e,r.fullObservationCount);a.push(...ts(p,g,r,n,i));let m=t[0],f=e[0];ss(r,m,f)&&a.push(...rs(m,i));let b=xe(e,r,o,n);return a.push(...ns(b,i)),a.push(...os(d,r,i)),a.join(`
`).trimEnd()}var Ks=new Set(["bugfix","discovery","decision","refactor"]);function Js(s,e,t){let r=ie(s),n={bugfix:0,discovery:0,decision:0,refactor:0,other:0},o=new Set,i=Number.POSITIVE_INFINITY;for(let d of s){let l=Ks.has(d.type)?d.type:"other";n[l]++,d.memory_session_id&&o.add(d.memory_session_id),d.created_at_epoch&&d.created_at_epoch<i&&(i=d.created_at_epoch)}let a=Number.isFinite(i)?Math.max(0,Math.floor((Date.now()-i)/864e5)):0;return{observation_count:s.length,session_count:o.size,timeline_depth_days:a,has_session_summary:e.length>0,obs_type_bugfix:n.bugfix,obs_type_discovery:n.discovery,obs_type_decision:n.decision,obs_type_refactor:n.refactor,obs_type_other:n.other,tokens_injected:r.totalReadTokens,tokens_saved_vs_naive:r.savings,search_strategy:t?"full":"timeline"}}async function me(s,e=!1){let t=Le(),r=s?.cwd??process.cwd(),n=he(r),o=s?.projects?.length?s.projects:n.allProjects,i=o[o.length-1]??n.primary;s?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let a=Vs();if(!a)return{text:"",stats:null};try{let d={...t,totalObservationCount:t.totalObservationCount>=999999?t.totalObservationCount:Math.max(t.totalObservationCount,Math.min(t.totalObservationCount*4,t.totalObservationCount+200))},u=(o.length>1?Tt(a,o,d):ye(a,i,d)).filter(m=>pt(m)).slice(0,t.totalObservationCount),p=o.length>1?ft(a,o,t):Ue(a,i,t);return u.length===0&&p.length===0?{text:Ys(i,e),stats:null}:{text:qs(i,u,p,t,r,s?.session_id,e),stats:Js(u,p,!!s?.full)}}finally{a.close()}}async function $e(s,e=!1){return(await me(s,e)).text}0&&(module.exports={generateContext,generateContextWithStats});
