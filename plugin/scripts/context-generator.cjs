"use strict";var It=Object.create;var X=Object.defineProperty;var Lt=Object.getOwnPropertyDescriptor;var Mt=Object.getOwnPropertyNames;var Dt=Object.getPrototypeOf,vt=Object.prototype.hasOwnProperty;var yt=(r,e)=>{for(var t in e)X(r,t,{get:e[t],enumerable:!0})},Te=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Mt(e))!vt.call(r,n)&&n!==t&&X(r,n,{get:()=>e[n],enumerable:!(s=Lt(e,n))||s.enumerable});return r};var y=(r,e,t)=>(t=r!=null?It(Dt(r)):{},Te(e||!r||!r.__esModule?X(t,"default",{value:r,enumerable:!0}):t,r)),Ut=r=>Te(X({},"__esModule",{value:!0}),r);var Zt={};yt(Zt,{generateContext:()=>Ee});module.exports=Ut(Zt);var Ot=y(require("path"),1),Rt=require("os"),Nt=require("fs");var Ce=require("bun:sqlite");var h=require("path"),te=require("os"),H=require("fs");var he=require("url");var L=require("fs"),U=require("path"),Se=require("os"),Z=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(Z||{}),fe=(0,U.join)((0,Se.homedir)(),".claude-mem"),ee=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=(0,U.join)(fe,"logs");(0,L.existsSync)(e)||(0,L.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,U.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=(0,U.join)(fe,"settings.json");if((0,L.existsSync)(e)){let t=(0,L.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=Z[n]??1}else this.level=1}catch{this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`+JSON.stringify(o,null,2):_=" "+this.formatData(o));let p="";if(n){let{sessionId:g,memorySessionId:S,correlationId:b,...l}=n;Object.keys(l).length>0&&(p=` {${Object.entries(l).map(([T,f])=>`${T}=${f}`).join(", ")}}`)}let E=`[${i}] [${a}] [${d}] ${c}${s}${p}${_}`;if(this.logFilePath)try{(0,L.appendFileSync)(this.logFilePath,E+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),_=c?`${c[1].split("/").pop()}:${c[2]}`:"unknown",p={...s,location:_};return this.warn(e,`[HAPPY-PATH] ${t}`,p,n),o}},m=new ee;var Ft={};function xt(){return typeof __dirname<"u"?__dirname:(0,h.dirname)((0,he.fileURLToPath)(Ft.url))}var kt=xt();function $t(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,h.join)((0,te.homedir)(),".claude-mem"),e=(0,h.join)(r,"settings.json");try{if((0,H.existsSync)(e)){let{readFileSync:t}=require("fs"),s=JSON.parse(t(e,"utf-8")),n=s.env??s;if(n.CLAUDE_MEM_DATA_DIR)return n.CLAUDE_MEM_DATA_DIR}}catch{}return r}var C=$t(),D=process.env.CLAUDE_CONFIG_DIR||(0,h.join)((0,te.homedir)(),".claude"),ns=(0,h.join)(D,"plugins","marketplaces","thedotmack"),os=(0,h.join)(C,"archives"),is=(0,h.join)(C,"logs"),as=(0,h.join)(C,"trash"),ds=(0,h.join)(C,"backups"),us=(0,h.join)(C,"modes"),cs=(0,h.join)(C,"settings.json"),be=(0,h.join)(C,"claude-mem.db"),_s=(0,h.join)(C,"vector-db"),ms=(0,h.join)(C,"observer-sessions"),ls=(0,h.join)(D,"settings.json"),ps=(0,h.join)(D,"commands"),Es=(0,h.join)(D,"CLAUDE.md");function Ae(r){(0,H.mkdirSync)(r,{recursive:!0})}function Oe(){return(0,h.join)(kt,"..")}var Re=require("crypto");var wt=3e4;function j(r,e,t){return(0,Re.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function G(r,e,t,s){let n=t-wt;return r.prepare("SELECT id, created_at_epoch FROM observations WHERE content_hash = ? AND created_at_epoch > ? AND node IS ?").get(e,n,s??null)}function se(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[String(e)]}catch{return[r]}}var A="claude";function Pt(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function v(r){if(!r)return A;let e=Pt(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:A}function Ne(r){let e=["claude","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function Xt(r,e){return{customTitle:r,platformSource:e?v(e):void 0}}var B=class{db;_currentNode=null;_currentPlatform=null;_currentInstance=null;_currentLlmSource=null;setLocalProvenance(e,t,s,n){this._currentNode=e,this._currentPlatform=t,this._currentInstance=s,this._currentLlmSource=n??null}constructor(e=be){e!==":memory:"&&Ae(C),this.db=new Ce.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.addObservationProvenanceColumns(),this.addSummaryProvenanceColumns()}initializeSchema(){this.db.run(`
    ...
    `),this.db.run("CREATE INDEX IF NOT EXISTS idx_pending_messages_session ON pending_messages(session_db_id)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_pending_messages_status ON pending_messages(status)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_pending_messages_claude_session ON pending_messages(content_session_id)"),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(16,new Date().toISOString()),m.debug("DB","pending_messages table created successfully")}renameSessionIdColumns(){if(this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(17))return;m.debug("DB","Checking session ID columns for semantic clarity rename");let t=0,s=(n,o,i)=>{let a=this.db.query(`PRAGMA table_info(${n})`).all(),d=a.some(_=>_.name===o);return a.some(_=>_.name===i)?!1:d?(this.db.run(`ALTER TABLE ${n} RENAME COLUMN ${o} TO ${i}`),m.debug("DB",`Renamed ${n}.${o} to ${i}`),!0):(m.warn("DB",`Column ${o} not found in ${n}, skipping rename`),!1)};s("sdk_sessions","claude_session_id","content_session_id")&&t++,s("sdk_sessions","sdk_session_id","memory_session_id")&&t++,s("pending_messages","claude_session_id","content_session_id")&&t++,s("observations","sdk_session_id","memory_session_id")&&t++,s("session_summaries","sdk_session_id","memory_session_id")&&t++,s("user_prompts","claude_session_id","content_session_id")&&t++,this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(17,new Date().toISOString()),t>0?m.debug("DB",`Successfully renamed ${t} session ID columns`):m.debug("DB","No session ID column renames needed (already up to date)")}repairSessionIdColumnRename(){this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(19)||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(19,new Date().toISOString())}addFailedAtEpochColumn(){if(this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(20))return;this.db.query("PRAGMA table_info(pending_messages)").all().some(n=>n.name==="failed_at_epoch")||(this.db.run("ALTER TABLE pending_messages ADD COLUMN failed_at_epoch INTEGER"),m.debug("DB","Added failed_at_epoch column to pending_messages table")),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(20,new Date().toISOString())}addOnUpdateCascadeToForeignKeys(){if(!this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(21)){m.debug("DB","Adding ON UPDATE CASCADE to FK constraints on observations and session_summaries"),this.db.run("PRAGMA foreign_keys = OFF"),this.db.run("BEGIN TRANSACTION");try{this.db.run("DROP TRIGGER IF EXISTS observations_ai"),this.db.run("DROP TRIGGER IF EXISTS observations_ad"),this.db.run("DROP TRIGGER IF EXISTS observations_au"),this.db.run("DROP TABLE IF EXISTS observations_new");let t=new Set(this.db.prepare("PRAGMA table_info(observations)").all().map(l=>l.name)),s=[],n=[];t.has("content_hash")&&(s.push("content_hash TEXT"),n.push("content_hash")),t.has("node")&&(s.push("node TEXT","platform TEXT","instance TEXT"),n.push("node","platform","instance")),t.has("llm_source")&&(s.push("llm_source TEXT"),n.push("llm_source")),t.has("generated_by_model")&&(s.push("generated_by_model TEXT"),n.push("generated_by_model")),t.has("relevance_count")&&(s.push("relevance_count INTEGER DEFAULT 0"),n.push("relevance_count"));let o=s.length>0?`,
      ...
      `),this.db.prepare("SELECT name FROM sqlite_master WHERE type='table' AND name='observations_fts'").all().length>0&&this.db.run(`
          ...
          CREATE TRIGGER IF NOT EXISTS observations_au AFTER UPDATE ON observations BEGIN
            ...
            VALUES (new.id, new.title, new.subtitle, new.narrative, new.text, new.facts, new.concepts);
          END;
        `),this.db.run("DROP TABLE IF EXISTS session_summaries_new");let c=new Set(this.db.prepare("PRAGMA table_info(session_summaries)").all().map(l=>l.name)),_=[],p=[];c.has("node")&&(_.push("node TEXT","platform TEXT","instance TEXT"),p.push("node","platform","instance")),c.has("llm_source")&&(_.push("llm_source TEXT"),p.push("llm_source"));let E=_.length>0?`,
          ${`,
          `.join(_)}`:"",g="id, memory_session_id, project, request, investigated, learned, completed, next_steps, files_read, files_edited, notes, prompt_number, discovery_tokens, created_at, created_at_epoch",S=p.length>0?`${g}, ${p.join(", ")}`:g;this.db.run(`
        CREATE TABLE session_summaries_new (
          id INTEGER PRIMARY KEY AUTOINCREMENT,
          memory_session_id TEXT NOT NULL,
          project TEXT NOT NULL,
    ...
    `).all(e)}getObservationById(e){return this.db.prepare(`
      ...
      FROM observations
      WHERE id = ?
    `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,type:i,concepts:a,files:d}=t,c=s==="date_asc"?"ASC":"DESC",_=n?`LIMIT ${n}`:"",p=e.map(()=>"?").join(","),E=[...e],g=[];if(o&&(g.push("project = ?"),E.push(o)),i)if(Array.isArray(i)){let l=i.map(()=>"?").join(",");g.push(`type IN (${l})`),E.push(...i)}else g.push("type = ?"),E.push(i);if(a){let l=Array.isArray(a)?a:[a],R=l.map(()=>"EXISTS (SELECT 1 FROM json_each(concepts) WHERE value = ?)");E.push(...l),g.push(`(${R.join(" OR ")})`)}if(d){let l=Array.isArray(d)?d:[d],R=l.map(()=>"(EXISTS (SELECT 1 FROM json_each(files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(files_modified) WHERE value LIKE ?))");l.forEach(T=>{E.push(`%${T}%`,`%${T}%`)}),g.push(`(${R.join(" OR ")})`)}let S=g.length>0?`WHERE id IN (${p}) AND ${g.join(" AND ")}`:`WHERE id IN (${p})`;return this.db.prepare(`
      SELECT *
      FROM observations
      ${S}
    ...
    `).get(e).count}createSDKSession(e,t,s,n,o){let i=new Date,a=i.getTime(),d=Xt(n,o),c=d.platformSource??A,_=this.db.prepare(`
    ...
    `).get(e);if(_){if(t&&this.db.prepare(`
      ...
      VALUES (?, NULL, ?, ?, ?, ?, ?, ?, 'active')
    `).run(e,t,c,s,d.customTitle||null,i.toISOString(),a),this.db.prepare("SELECT id FROM sdk_sessions WHERE content_session_id = ?").get(e).id}saveUserPrompt(e,t,s,n){let o=new Date,i=o.getTime();return this.db.prepare(`
    ...
    `).run(e,t,s,o.toISOString(),i,n||(this._currentNode??null),this._currentPlatform??null,this._currentInstance??null,this._currentLlmSource??null).lastInsertRowid}getUserPrompt(e,t){return this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,o=0,i,a,d,c,_,p){let E=i??Date.now(),g=new Date(E).toISOString(),S=j(e,s.title,s.narrative),b=G(this.db,S,E,d);if(b)return{id:b.id,createdAtEpoch:b.created_at_epoch};let R=this.db.prepare(`
      INSERT INTO observations
      (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
       files_read, files_modified, prompt_number, discovery_tokens, content_hash, created_at, created_at_epoch,
       generated_by_model, node, platform, instance, llm_source)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.type,s.title,s.subtitle,JSON.stringify(s.facts),s.narrative,JSON.stringify(s.concepts),JSON.stringify(s.files_read),JSON.stringify(s.files_modified),n||null,o,S,g,E,a||null,d||null,c||null,_||null,p||null);return{id:Number(R.lastInsertRowid),createdAtEpoch:E}}storeSummary(e,t,s,n,o=0,i,a,d,c,_){let p=i??Date.now(),E=new Date(p).toISOString(),S=this.db.prepare(`
      INSERT INTO session_summaries
      (memory_session_id, project, request, investigated, learned, completed,
       next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch,
       node, platform, instance, llm_source)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,E,p,a??null,d??null,c??null,_??null);return{id:Number(S.lastInsertRowid),createdAtEpoch:p}}storeObservations(e,t,s,n,o,i=0,a,d,c,_,p,E){let g=a??Date.now(),S=new Date(g).toISOString();return this.db.transaction(()=>{let l=[],R=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, content_hash, created_at, created_at_epoch,
         generated_by_model, node, platform, instance, llm_source)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let f of s){let M=j(e,f.title,f.narrative),Q=G(this.db,M,g,c);if(Q){l.push(Q.id);continue}let N=R.run(e,t,f.type,f.title,f.subtitle,JSON.stringify(f.facts),f.narrative,JSON.stringify(f.concepts),JSON.stringify(f.files_read),JSON.stringify(f.files_modified),o||null,i,M,S,g,d||null,c??null,_??null,p??null,E??null);l.push(Number(N.lastInsertRowid))}let T=null;if(n){let M=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch,
           node, platform, instance, llm_source)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,o||null,i,S,g,c??null,_??null,p??null,E??null);T=Number(M.lastInsertRowid)}return{observationIds:l,summaryId:T,createdAtEpoch:g}})()}storeObservationsAndMarkComplete(e,t,s,n,o,i,a,d=0,c,_,p,E,g,S){let b=c??Date.now(),l=new Date(b).toISOString();return this.db.transaction(()=>{let T=[],f=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, content_hash, created_at, created_at_epoch,
         generated_by_model, node, platform, instance, llm_source)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let N of s){let P=j(e,N.title,N.narrative),ge=G(this.db,P,b,p);if(ge){T.push(ge.id);continue}let Ct=f.run(e,t,N.type,N.title,N.subtitle,JSON.stringify(N.facts),N.narrative,JSON.stringify(N.concepts),JSON.stringify(N.files_read),JSON.stringify(N.files_modified),a||null,d,P,l,b,_||null,p??null,E??null,g??null,S??null);T.push(Number(Ct.lastInsertRowid))}let M;if(n){let P=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch,
           node, platform, instance, llm_source)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,a||null,d,l,b,p??null,E??null,g??null,S??null);M=Number(P.lastInsertRowid)}return this.db.prepare(`
      ...
      `).run(b,o),{observationIds:T,summaryId:M,createdAtEpoch:b}})()}getSessionSummariesByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o}=t,i=s==="date_asc"?"ASC":"DESC",a=n?`LIMIT ${n}`:"",d=e.map(()=>"?").join(","),c=[...e],_=o?`WHERE id IN (${d}) AND project = ?`:`WHERE id IN (${d})`;return o&&c.push(o),this.db.prepare(`
    ...
    `).all(...c)}getTimelineAroundTimestamp(e,t=10,s=10,n){return this.getTimelineAroundObservation(null,e,t,s,n)}getTimelineAroundObservation(e,t,s=10,n=10,o){let i=o?"AND project = ?":"",a=o?[o]:[],d,c;if(e!==null){let l=`
      ...
      `,R=`
        ...
        ORDER BY id ASC
        LIMIT ?
      `;try{let T=this.db.prepare(l).all(e,...a,s+1),f=this.db.prepare(R).all(e,...a,n+1);if(T.length===0&&f.length===0)return{observations:[],sessions:[],prompts:[]};d=T.length>0?T[T.length-1].created_at_epoch:t,c=f.length>0?f[f.length-1].created_at_epoch:t}catch(T){return m.error("DB","Error getting boundary observations",void 0,{error:T,project:o}),{observations:[],sessions:[],prompts:[]}}}else{let l=`
      ...
      `,R=`
        ...
        ORDER BY created_at_epoch ASC
        LIMIT ?
      `;try{let T=this.db.prepare(l).all(t,...a,s),f=this.db.prepare(R).all(t,...a,n+1);if(T.length===0&&f.length===0)return{observations:[],sessions:[],prompts:[]};d=T.length>0?T[T.length-1].created_at_epoch:t,c=f.length>0?f[f.length-1].created_at_epoch:t}catch(T){return m.error("DB","Error getting boundary timestamps",void 0,{error:T,project:o}),{observations:[],sessions:[],prompts:[]}}}let _=`
      SELECT *
      FROM observations
  ...
  `).all(e,...n,...i,...s?[s]:[],t.totalObservationCount)}function ue(r,e,t,s){return r.db.prepare(`
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(e,...s?[s]:[],t.sessionCount+oe)}function ke(r,e,t,s){let n=Array.from(t.observationTypes),o=n.map(()=>"?").join(","),i=Array.from(t.observationConcepts),a=i.map(()=>"?").join(","),d=e.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
      o.id,
      o.memory_session_id,
      COALESCE(s.platform_source, 'claude') as platform_source,
    ...
    ORDER BY o.created_at_epoch DESC
    LIMIT ?
  `).all(...e,...n,...i,...s?[s]:[],t.totalObservationCount)}function $e(r,e,t,s){let n=e.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
      ss.id,
      ss.memory_session_id,
      COALESCE(s.platform_source, 'claude') as platform_source,
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(...e,...s?[s]:[],t.sessionCount+oe)}function Gt(r){return r.replace(/\//g,"-")}function Bt(r){try{if(!(0,q.existsSync)(r))return{userMessage:"",assistantMessage:""};let e=(0,q.readFileSync)(r,"utf-8").trim();if(!e)return{userMessage:"",assistantMessage:""};let t=e.split(`
`).filter(n=>n.trim()),s="";for(let n=t.length-1;n>=0;n--)try{let o=t[n];if(!o.includes('"type":"assistant"'))continue;let i=JSON.parse(o);if(i.type==="assistant"&&i.message?.content&&Array.isArray(i.message.content)){let a="";for(let d of i.message.content)d.type==="text"&&(a+=d.text);if(a=a.replace(Ue,"").trim(),a){s=a;break}}}catch(o){m.debug("PARSER","Skipping malformed transcript line",{lineIndex:n},o);continue}return{userMessage:"",assistantMessage:s}}catch(e){return m.failure("WORKER","Failed to extract prior messages from transcript",{transcriptPath:r},e),{userMessage:"",assistantMessage:""}}}function ce(r,e,t,s){if(!e.showLastMessage||r.length===0)return{userMessage:"",assistantMessage:""};let n=r.find(d=>d.memory_session_id!==t);if(!n)return{userMessage:"",assistantMessage:""};let o=n.memory_session_id,i=Gt(s),a=xe.default.join(D,"projects",i,`${o}.jsonl`);return Bt(a)}function Fe(r,e){let t=e[0]?.id;return r.map((s,n)=>{let o=n===0?null:e[n+1];return{...s,displayEpoch:o?o.created_at_epoch:s.created_at_epoch,displayTime:o?o.created_at:s.created_at,shouldShowLink:s.id!==t}})}function _e(r,e){let t=[...r.map(s=>({type:"observation",data:s})),...e.map(s=>({type:"summary",data:s}))];return t.sort((s,n)=>{let o=s.type==="observation"?s.data.created_at_epoch:s.data.displayEpoch,i=n.type==="observation"?n.data.created_at_epoch:n.data.displayEpoch;return o-i}),t}function we(r,e){return new Set(r.slice(0,e).map(t=>t.id))}function Pe(){let r=new Date,e=r.toLocaleDateString("en-CA"),t=r.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),s=r.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${s}`}function Xe(r){return[`# $CMEM ${r} ${Pe()}`,""]}function He(){return[`Legend: \u{1F3AF}session ${O.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji}${t.id}`).join(" ")}`,"Format: ID TIME TYPE TITLE","Fetch details: get_observations([IDs]) | Search: mem-search skill",""]}function je(){return[]}function Ge(){return[]}function Be(r,e){let t=[],s=[`${r.totalObservations} obs (${r.totalReadTokens.toLocaleString()}t read)`,`${r.totalDiscoveryTokens.toLocaleString()}t work`];return r.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)&&(e.showSavingsPercent?s.push(`${r.savingsPercent}% savings`):e.showSavingsAmount&&s.push(`${r.savings.toLocaleString()}t saved`)),t.push(`Stats: ${s.join(" | ")}`),t.push(""),t}function We(r){return[`### ${r}`]}function Ye(r){return r.toLowerCase().replace(" am","a").replace(" pm","p")}function Ve(r,e,t){let s=r.title||"Untitled",n=O.getInstance().getTypeIcon(r.type),o=e?Ye(e):'"';return`${r.id} ${o} ${n} ${s}`}function qe(r,e,t,s){let n=[],o=r.title||"Untitled",i=O.getInstance().getTypeIcon(r.type),a=e?Ye(e):'"',{readTokens:d,discoveryDisplay:c}=$(r,s);n.push(`**${r.id}** ${a} ${i} **${o}**`),t&&n.push(t);let _=[];return s.showReadTokens&&_.push(`~${d}t`),s.showWorkTokens&&_.push(c),_.length>0&&n.push(_.join(" ")),n.push(""),n}function Ke(r,e){return[`S${r.id} ${r.request||"Session started"} (${e})`]}function F(r,e){return e?[`**${r}**: ${e}`,""]:[]}function Je(r){return r.assistantMessage?["","---","","**Previously**","",`A: ${r.assistantMessage}`,""]:[]}function ze(r,e){return["",`Access ${Math.round(r/1e3)}k tokens of past work via get_observations([IDs]) or mem-search skill.`]}function Qe(r){return`# $CMEM ${r} ${Pe()}

No previous sessions found.`}function Ze(){let r=new Date,e=r.toLocaleDateString("en-CA"),t=r.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),s=r.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${s}`}function et(r){return["",`${u.bright}${u.cyan}[${r}] recent context, ${Ze()}${u.reset}`,`${u.gray}${"\u2500".repeat(60)}${u.reset}`,""]}function tt(){let e=O.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji} ${t.id}`).join(" | ");return[`${u.dim}Legend: session-request | ${e}${u.reset}`,""]}function st(){return[`${u.bright}Column Key${u.reset}`,`${u.dim}  Read: Tokens to read this observation (cost to learn it now)${u.reset}`,`${u.dim}  Work: Tokens spent on work that produced this record ( research, building, deciding)${u.reset}`,""]}function rt(){return[`${u.dim}Context Index: This semantic index (titles, types, files, tokens) is usually sufficient to understand past work.${u.reset}`,"",`${u.dim}When you need implementation details, rationale, or debugging context:${u.reset}`,`${u.dim}  - Fetch by ID: get_observations([IDs]) for observations visible in this index${u.reset}`,`${u.dim}  - Search history: Use the mem-search skill for past decisions, bugs, and deeper research${u.reset}`,`${u.dim}  - Trust this index over re-reading code for past decisions and learnings${u.reset}`,""]}function nt(r,e){let t=[];if(t.push(`${u.bright}${u.cyan}Context Economics${u.reset}`),t.push(`${u.dim}  Loading: ${r.totalObservations} observations (${r.totalReadTokens.toLocaleString()} tokens to read)${u.reset}`),t.push(`${u.dim}  Work investment: ${r.totalDiscoveryTokens.toLocaleString()} tokens spent on research, building, and decisions${u.reset}`),r.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)){let s="  Your savings: ";e.showSavingsAmount&&e.showSavingsPercent?s+=`${r.savings.toLocaleString()} tokens (${r.savingsPercent}% reduction from reuse)`:e.showSavingsAmount?s+=`${r.savings.toLocaleString()} tokens`:s+=`${r.savingsPercent}% reduction from reuse`,t.push(`${u.green}${s}${u.reset}`)}return t.push(""),t}function ot(r){return[`${u.bright}${u.cyan}${r}${u.reset}`,""]}function it(r){return[`${u.dim}${r}${u.reset}`]}function at(r,e,t,s){let n=r.title||"Untitled",o=O.getInstance().getTypeIcon(r.type),{readTokens:i,discoveryTokens:a,workEmoji:d}=$(r,s),c=t?`${u.dim}${e}${u.reset}`:" ".repeat(e.length),_=s.showReadTokens&&i>0?`${u.dim}(~${i}t)${u.reset}`:"",p=s.showWorkTokens&&a>0?`${u.dim}(${d} ${a.toLocaleString()}t)${u.reset}`:"";return`  ${u.dim}#${r.id}${u.reset}  ${c}  ${o}  ${n} ${_} ${p}`}function dt(r,e,t,s,n){let o=[],i=r.title||"Untitled",a=O.getInstance().getTypeIcon(r.type),{readTokens:d,discoveryTokens:c,workEmoji:_}=$(r,n),p=t?`${u.dim}${e}${u.reset}`:" ".repeat(e.length),E=n.showReadTokens&&d>0?`${u.dim}(~${d}t)${u.reset}`:"",g=n.showWorkTokens&&c>0?`${u.dim}(${_} ${c.toLocaleString()}t)${u.reset}`:"";return o.push(`  ${u.dim}#${r.id}${u.reset}  ${p}  ${a}  ${u.bright}${i}${u.reset}`),s&&o.push(`    ${u.dim}${s}${u.reset}`),(E||g)&&o.push(`    ${E} ${g}`),o.push(""),o}function ut(r,e){let t=`${r.request||"Session started"} (${e})`;return[`${u.yellow}#S${r.id}${u.reset} ${t}`,""]}function w(r,e,t){return e?[`${t}${r}:${u.reset} ${e}`,""]:[]}function ct(r){return r.assistantMessage?["","---","",`${u.bright}${u.magenta}Previously${u.reset}`,"",`${u.dim}A: ${r.assistantMessage}${u.reset}`,""]:[]}function _t(r,e){let t=Math.round(r/1e3);return["",`${u.dim}Access ${t}k tokens of past research & decisions for just ${e.toLocaleString()}t. Use the claude-mem skill to access memories by ID.${u.reset}`]}function mt(r){return`
${u.bright}${u.cyan}[${r}] recent context, ${Ze()}${u.reset}
${u.gray}${"\u2500".repeat(60)}${u.reset}

${u.dim}No previous sessions found for this project yet.${u.reset}
`}function lt(r,e,t,s){let n=[];return s?n.push(...et(r)):n.push(...Xe(r)),s?n.push(...tt()):n.push(...He()),s?n.push(...st()):n.push(...je()),s?n.push(...rt()):n.push(...Ge()),V(t)&&(s?n.push(...nt(e,t)):n.push(...Be(e,t))),n}var me=y(require("path"),1);function z(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return m.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e),[]}}function le(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function pe(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function Et(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function pt(r,e){return me.default.isAbsolute(r)?me.default.relative(e,r):r}function gt(r,e,t){let s=z(r);if(s.length>0)return pt(s[0],e);if(t){let n=z(t);if(n.length>0)return pt(n[0],e)}return"General"}function Wt(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=Et(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function Tt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?z(r.facts).join(`
`):null}function Yt(r,e,t,s){let n=[];n.push(...We(r));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=le(a.displayTime);n.push(...Ke(a,d))}else{let a=i.data,d=pe(a.created_at),_=d!==o?d:"";if(o=d,t.has(a.id)){let E=Tt(a,s);n.push(...qe(a,_,E,s))}else n.push(Ve(a,_,s))}return n}function Vt(r,e,t,s,n){let o=[];o.push(...ot(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let c=d.data,_=le(c.displayTime);o.push(...ut(c,_))}else{let c=d.data,_=gt(c.files_modified,n,c.files_read),p=pe(c.created_at),E=p!==a;a=p;let g=t.has(c.id);if(_!==i&&(o.push(...it(_)),i=_),g){let S=Tt(c,s);o.push(...dt(c,p,E,S,s))}else o.push(at(c,p,E,s))}return o.push(""),o}function qt(r,e,t,s,n,o){return o?Vt(r,e,t,s,n):Yt(r,e,t,s)}function ft(r,e,t,s,n){let o=[],i=Wt(r);for(let[a,d]of i)o.push(...qt(a,d,e,t,s,n));return o}function St(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function ht(r,e){let t=[];return e?(t.push(...w("Investigated",r.investigated,u.blue)),t.push(...w("Learned",r.learned,u.yellow)),t.push(...w("Completed",r.completed,u.green)),t.push(...w("Next Steps",r.next_steps,u.magenta))):(t.push(...F("Investigated",r.investigated)),t.push(...F("Learned",r.learned)),t.push(...F("Completed",r.completed)),t.push(...F("Next Steps",r.next_steps))),t}function bt(r,e){return e?ct(r):Je(r)}function At(r,e,t){return!V(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?_t(r.totalDiscoveryTokens,r.totalReadTokens):ze(r.totalDiscoveryTokens,r.totalReadTokens)}var Kt=Ot.default.join((0,Rt.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function Jt(){try{return new B}catch(r){if(r.code==="ERR_DLOPEN_FAILED"){try{(0,Nt.unlinkSync)(Kt)}catch(e){m.debug("SYSTEM","Marker file cleanup failed (may not exist)",{},e)}return m.error("SYSTEM","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function zt(r,e){return e?mt(r):Qe(r)}function Qt(r,e,t,s,n,o,i){let a=[],d=ae(e);a.push(...lt(r,d,s,i));let c=t.slice(0,s.sessionCount),_=Fe(c,t),p=_e(e,_),E=we(e,s.fullObservationCount);a.push(...ft(p,E,s,n,i));let g=t[0],S=e[0];St(s,g,S)&&a.push(...ht(g,i));let b=ce(e,s,o,n);return a.push(...bt(b,i)),a.push(...At(d,s,i)),a.join(`
`).trimEnd()}async function Ee(r,e=!1){let t=ne(),s=r?.cwd??process.cwd(),n=Me(s),o=r?.platform_source,i=r?.projects||[n];r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let a=Jt();if(!a)return"";try{let d=i.length>1?ke(a,i,t,o):de(a,n,t,o),c=i.length>1?$e(a,i,t,o):ue(a,n,t,o);return d.length===0&&c.length===0?zt(n,e):Qt(n,d,c,t,s,r?.session_id,e)}finally{a.close()}}0&&(module.exports={generateContext});
