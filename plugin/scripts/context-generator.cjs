...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),m=c?`${c[1].split("/").pop()}:${c[2]}`:"unknown",l={...s,location:m};return this.warn(e,`[HAPPY-PATH] ${t}`,l,n),o}},_=new Y;var Rt={};function ht(){return typeof __dirname<"u"?__dirname:(0,b.dirname)((0,me.fileURLToPath)(Rt.url))}var Ot=ht(),C=y.get("CLAUDE_MEM_DATA_DIR"),M=process.env.CLAUDE_CONFIG_DIR||(0,b.join)((0,ce.homedir)(),".claude"),Wt=(0,b.join)(M,"plugins","marketplaces","thedotmack"),Yt=(0,b.join)(C,"archives"),Vt=(0,b.join)(C,"logs"),qt=(0,b.join)(C,"trash"),Kt=(0,b.join)(C,"backups"),Jt=(0,b.join)(C,"modes"),Qt=(0,b.join)(C,"settings.json"),le=(0,b.join)(C,"claude-mem.db"),zt=(0,b.join)(C,"vector-db"),Zt=(0,b.join)(C,"observer-sessions"),es=(0,b.join)(M,"settings.json"),ts=(0,b.join)(M,"commands"),ss=(0,b.join)(M,"CLAUDE.md");function ue(r){(0,_e.mkdirSync)(r,{recursive:!0})}function Ee(){return(0,b.join)(Ot,"..")}var F=class{db;constructor(e=le){e!==":memory:"&&ue(C),this.db=new w(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys()}initializeSchema(){this.db.run(`
...
`}function et(r,e,t,s){let n=[];return s?n.push(...je(r)):n.push(...Ie(r)),s?n.push(...Ge()):n.push(...ye()),s?n.push(...Be()):n.push(...Me()),s?n.push(...He()):n.push(...Le()),X(t)&&(s?n.push(...We(e,t)):n.push(...ve(e,t))),n}var te=I(require("path"),1);function H(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return _.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e),[]}}function st(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function rt(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function nt(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function tt(r,e){return te.default.isAbsolute(r)?te.default.relative(e,r):r}function ot(r,e,t){let s=H(r);if(s.length>0)return tt(s[0],e);if(t){let n=H(t);if(n.length>0)return tt(n[0],e)}return"General"}function It(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=nt(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function yt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?H(r.facts).join(`
`):null}function Mt(r,e,t,s,n,o){let i=[];o?i.push(...Ye(r)):i.push(...De(r));let a=null,d="",c=!1;for(let m of e)if(m.type==="summary"){c&&(i.push(""),c=!1,a=null,d="");let l=m.data,T=st(l.displayTime);o?i.push(...Je(l,T)):i.push(...we(l,T))}else{let l=m.data,T=ot(l.files_modified,n,l.files_read),E=rt(l.created_at),g=E!==d,h=g?E:"";d=E;let u=t.has(l.id);if(T!==a&&(c&&i.push(""),o?i.push(...Ve(T)):i.push(...xe(T)),a=T,c=!0),u){let S=yt(l,s);o?i.push(...Ke(l,E,g,S,s)):(c&&!o&&(i.push(""),c=!1),i.push(...ke(l,h,S,s)),a=null)}else o?i.push(qe(l,E,g,s)):i.push(Ue(l,h,s))}return c&&i.push(""),i}function it(r,e,t,s,n){let o=[],i=It(r);for(let[a,d]of i)o.push(...Mt(a,d,e,t,s,n));return o}function at(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function dt(r,e){let t=[];return e?(t.push(...U("Investigated",r.investigated,p.blue)),t.push(...U("Learned",r.learned,p.yellow)),t.push(...U("Completed",r.completed,p.green)),t.push(...U("Next Steps",r.next_steps,p.magenta))):(t.push(...x("Investigated",r.investigated)),t.push(...x("Learned",r.learned)),t.push(...x("Completed",r.completed)),t.push(...x("Next Steps",r.next_steps))),t}function pt(r,e){return e?Qe(r):$e(r)}function ct(r,e,t){return!X(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?ze(r.totalDiscoveryTokens,r.totalReadTokens):Fe(r.totalDiscoveryTokens,r.totalReadTokens)}var Lt=_t.default.join((0,mt.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function vt(){try{return new F}catch(r){if(r.code==="ERR_DLOPEN_FAILED"){try{(0,lt.unlinkSync)(Lt)}catch(e){_.debug("SYSTEM","Marker file cleanup failed (may not exist)",{},e)}return _.error("SYSTEM","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function Dt(r,e){return e?Ze(r):Pe(r)}function xt(r,e,t,s,n,o,i){let a=[],d=J(e);a.push(...et(r,d,s,i));let c=t.slice(0,s.sessionCount),m=Ce(c,t),l=ee(e,m),T=Ne(e,s.fullObservationCount);a.push(...it(l,T,s,n,i));let E=t[0],g=e[0];at(s,E,g)&&a.push(...dt(E,i));let h=Z(e,s,o,n);return a.push(...pt(h,i)),a.push(...ct(d,s,i)),a.join(`
`).trimEnd()}async function se(r,e=!1){let t=V(),s=r?.cwd??process.cwd(),n=ge(s),o=r?.projects||[n],i=vt();if(!i)return"";try{let a=o.length>1?Oe(i,o,t):Q(i,n,t),d=o.length>1?Re(i,o,t):z(i,n,t);return a.length===0&&d.length===0?Dt(n,e):xt(n,a,d,t,s,r?.session_id,e)}finally{i.close()}}0&&(module.exports={generateContext});
