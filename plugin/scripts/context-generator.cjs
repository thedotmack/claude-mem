"use strict";var ft=Object.create;var k=Object.defineProperty;var St=Object.getOwnPropertyDescriptor;var bt=Object.getOwnPropertyNames;var ht=Object.getPrototypeOf,Rt=Object.prototype.hasOwnProperty;var Ot=(r,e)=>{for(var t in e)k(r,t,{get:e[t],enumerable:!0})},de=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of bt(e))!Rt.call(r,n)&&n!==t&&k(r,n,{get:()=>e[n],enumerable:!(s=St(e,n))||s.enumerable});return r};var M=(r,e,t)=>(t=r!=null?ft(ht(r)):{},de(e||!r||!r.__esModule?k(t,"default",{value:r,enumerable:!0}):t,r)),Ct=r=>de(k({},"__esModule",{value:!0}),r);var jt={};Ot(jt,{generateContext:()=>ae});module.exports=Ct(jt);var lt=M(require("path"),1),Et=require("os"),Tt=require("fs");var Te=require("bun:sqlite");var b=require("path"),K=require("os"),w=require("fs");var ue=require("url");var N=require("fs"),y=require("path"),pe=require("os"),Y=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(Y||{}),ce=(0,y.join)((0,pe.homedir)(),".claude-mem"),V=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=(0,y.join)(ce,"logs");(0,N.existsSync)(e)||(0,N.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,y.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=(0,y.join)(ce,"settings.json");if((0,N.existsSync)(e)){let t=(0,N.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=Y[n]??1}else this.level=1}catch{this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`+JSON.stringify(o,null,2):_=" "+this.formatData(o));let l="";if(n){let{sessionId:E,memorySessionId:f,correlationId:O,...m}=n;Object.keys(m).length>0&&(l=` {${Object.entries(m).map(([g,h])=>`${g}=${h}`).join(", ")}}`)}let T=`[${i}] [${a}] [${d}] ${p}${s}${l}${_}`;if(this.logFilePath)try{(0,N.appendFileSync)(this.logFilePath,T+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),_=p?`${p[1].split("/").pop()}:${p[2]}`:"unknown",l={...s,location:_};return this.warn(e,`[HAPPY-PATH] ${t}`,l,n),o}},u=new V;var Lt={};function It(){return typeof __dirname<"u"?__dirname:(0,b.dirname)((0,ue.fileURLToPath)(Lt.url))}var Nt=It();function At(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,b.join)((0,K.homedir)(),".claude-mem"),e=(0,b.join)(r,"settings.json");try{if((0,w.existsSync)(e)){let{readFileSync:t}=require("fs"),s=JSON.parse(t(e,"utf-8")),n=s.env??s;if(n.CLAUDE_MEM_DATA_DIR)return n.CLAUDE_MEM_DATA_DIR}}catch{}return r}var C=At(),A=process.env.CLAUDE_CONFIG_DIR||(0,b.join)((0,K.homedir)(),".claude"),qt=(0,b.join)(A,"plugins","marketplaces","thedotmack"),Yt=(0,b.join)(C,"archives"),Vt=(0,b.join)(C,"logs"),Kt=(0,b.join)(C,"trash"),Jt=(0,b.join)(C,"backups"),Qt=(0,b.join)(C,"modes"),zt=(0,b.join)(C,"settings.json"),_e=(0,b.join)(C,"claude-mem.db"),Zt=(0,b.join)(C,"vector-db"),es=(0,b.join)(C,"observer-sessions"),ts=(0,b.join)(A,"settings.json"),ss=(0,b.join)(A,"commands"),rs=(0,b.join)(A,"CLAUDE.md");function me(r){(0,w.mkdirSync)(r,{recursive:!0})}function le(){return(0,b.join)(Nt,"..")}var Ee=require("crypto");var Mt=3e4;function $(r,e,t){return(0,Ee.createHash)("sha256").update((r||"")+(e||"")+(t||"")).digest("hex").slice(0,16)}function P(r,e,t){let s=t-Mt;return r.prepare("SELECT id, created_at_epoch FROM observations WHERE content_hash = ? AND created_at_epoch > ?").get(e,s)}var L=class{db;constructor(e=_e){e!==":memory:"&&me(C),this.db=new Te.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn()}initializeSchema(){this.db.run(`
    ...
    `).all(e)}getObservationById(e){return this.db.prepare(`
      ...
      FROM observations
      WHERE id = ?
    `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,type:i,concepts:a,files:d}=t,p=s==="date_asc"?"ASC":"DESC",_=n?`LIMIT ${n}`:"",l=e.map(()=>"?").join(","),T=[...e],E=[];if(o&&(E.push("project = ?"),T.push(o)),i)if(Array.isArray(i)){let m=i.map(()=>"?").join(",");E.push(`type IN (${m})`),T.push(...i)}else E.push("type = ?"),T.push(i);if(a){let m=Array.isArray(a)?a:[a],S=m.map(()=>"EXISTS (SELECT 1 FROM json_each(concepts) WHERE value = ?)");T.push(...m),E.push(`(${S.join(" OR ")})`)}if(d){let m=Array.isArray(d)?d:[d],S=m.map(()=>"(EXISTS (SELECT 1 FROM json_each(files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(files_modified) WHERE value LIKE ?))");m.forEach(g=>{T.push(`%${g}%`,`%${g}%`)}),E.push(`(${S.join(" OR ")})`)}let f=E.length>0?`WHERE id IN (${l}) AND ${E.join(" AND ")}`:`WHERE id IN (${l})`;return this.db.prepare(`
      SELECT *
      FROM observations
      ${f}
    ...
    `).run(e,t,s,n.toISOString(),o).lastInsertRowid}getUserPrompt(e,t){return this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,o=0,i){let a=i??Date.now(),d=new Date(a).toISOString(),p=$(e,s.title,s.narrative),_=P(this.db,p,a);if(_)return{id:_.id,createdAtEpoch:_.created_at_epoch};let T=this.db.prepare(`
    ...
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,d,a);return{id:Number(_.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a){let d=a??Date.now(),p=new Date(d).toISOString();return this.db.transaction(()=>{let l=[],T=this.db.prepare(`
        ...
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, content_hash, created_at, created_at_epoch)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let f of s){let O=$(e,f.title,f.narrative),m=P(this.db,O,d);if(m){l.push(m.id);continue}let S=T.run(e,t,f.type,f.title,f.subtitle,JSON.stringify(f.facts),f.narrative,JSON.stringify(f.concepts),JSON.stringify(f.files_read),JSON.stringify(f.files_modified),o||null,i,O,p,d);l.push(Number(S.lastInsertRowid))}let E=null;if(n){let O=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,o||null,i,p,d);E=Number(O.lastInsertRowid)}return{observationIds:l,summaryId:E,createdAtEpoch:d}})()}storeObservationsAndMarkComplete(e,t,s,n,o,i,a,d=0,p){let _=p??Date.now(),l=new Date(_).toISOString();return this.db.transaction(()=>{let E=[],f=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, content_hash, created_at, created_at_epoch)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let S of s){let g=$(e,S.title,S.narrative),h=P(this.db,g,_);if(h){E.push(h.id);continue}let gt=f.run(e,t,S.type,S.title,S.subtitle,JSON.stringify(S.facts),S.narrative,JSON.stringify(S.concepts),JSON.stringify(S.files_read),JSON.stringify(S.files_modified),a||null,d,g,l,_);E.push(Number(gt.lastInsertRowid))}let O;if(n){let g=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,a||null,d,l,_);O=Number(g.lastInsertRowid)}return this.db.prepare(`
      ...
      `).run(_,o),{observationIds:E,summaryId:O,createdAtEpoch:_}})()}getSessionSummariesByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o}=t,i=s==="date_asc"?"ASC":"DESC",a=n?`LIMIT ${n}`:"",d=e.map(()=>"?").join(","),p=[...e],_=o?`WHERE id IN (${d}) AND project = ?`:`WHERE id IN (${d})`;return o&&p.push(o),this.db.prepare(`
    ...
    `).all(...p)}getTimelineAroundTimestamp(e,t=10,s=10,n){return this.getTimelineAroundObservation(null,e,t,s,n)}getTimelineAroundObservation(e,t,s=10,n=10,o){let i=o?"AND project = ?":"",a=o?[o]:[],d,p;if(e!==null){let m=`
      ...
      `,S=`
        ...
        ORDER BY id ASC
        LIMIT ?
      `;try{let g=this.db.prepare(m).all(e,...a,s+1),h=this.db.prepare(S).all(e,...a,n+1);if(g.length===0&&h.length===0)return{observations:[],sessions:[],prompts:[]};d=g.length>0?g[g.length-1].created_at_epoch:t,p=h.length>0?h[h.length-1].created_at_epoch:t}catch(g){return u.error("DB","Error getting boundary observations",void 0,{error:g,project:o}),{observations:[],sessions:[],prompts:[]}}}else{let m=`
      ...
      `,S=`
        ...
        ORDER BY created_at_epoch ASC
        LIMIT ?
      `;try{let g=this.db.prepare(m).all(t,...a,s),h=this.db.prepare(S).all(t,...a,n+1);if(g.length===0&&h.length===0)return{observations:[],sessions:[],prompts:[]};d=g.length>0?g[g.length-1].created_at_epoch:t,p=h.length>0?h[h.length-1].created_at_epoch:t}catch(g){return u.error("DB","Error getting boundary timestamps",void 0,{error:g,project:o}),{observations:[],sessions:[],prompts:[]}}}let _=`
      SELECT *
      FROM observations
...
`}function st(r,e,t,s){let n=[];return s?n.push(...Ge(r)):n.push(...Me(r)),s?n.push(...Be()):n.push(...ye()),s?n.push(...We()):n.push(...De()),s?n.push(...qe()):n.push(...ve()),H(t)&&(s?n.push(...Ye(e,t)):n.push(...xe(e,t))),n}var ne=M(require("path"),1);function q(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return u.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e),[]}}function oe(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function ie(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function nt(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function rt(r,e){return ne.default.isAbsolute(r)?ne.default.relative(e,r):r}function ot(r,e,t){let s=q(r);if(s.length>0)return rt(s[0],e);if(t){let n=q(t);if(n.length>0)return rt(n[0],e)}return"General"}function xt(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=nt(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function it(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?q(r.facts).join(`
`):null}function Ut(r,e,t,s){let n=[];n.push(...Ue(r));let o="";for(let i of e)if(i.type==="summary"){o="";let a=i.data,d=oe(a.displayTime);n.push(...Pe(a,d))}else{let a=i.data,d=ie(a.created_at),_=d!==o?d:"";if(o=d,t.has(a.id)){let T=it(a,s);n.push(...$e(a,_,T,s))}else n.push(we(a,_,s))}return n}function kt(r,e,t,s,n){let o=[];o.push(...Ve(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let p=d.data,_=oe(p.displayTime);o.push(...ze(p,_))}else{let p=d.data,_=ot(p.files_modified,n,p.files_read),l=ie(p.created_at),T=l!==a;a=l;let E=t.has(p.id);if(_!==i&&(o.push(...Ke(_)),i=_),E){let f=it(p,s);o.push(...Qe(p,l,T,f,s))}else o.push(Je(p,l,T,s))}return o.push(""),o}function wt(r,e,t,s,n,o){return o?kt(r,e,t,s,n):Ut(r,e,t,s)}function at(r,e,t,s,n){let o=[],i=xt(r);for(let[a,d]of i)o.push(...wt(a,d,e,t,s,n));return o}function dt(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function ct(r,e){let t=[];return e?(t.push(...U("Investigated",r.investigated,c.blue)),t.push(...U("Learned",r.learned,c.yellow)),t.push(...U("Completed",r.completed,c.green)),t.push(...U("Next Steps",r.next_steps,c.magenta))):(t.push(...x("Investigated",r.investigated)),t.push(...x("Learned",r.learned)),t.push(...x("Completed",r.completed)),t.push(...x("Next Steps",r.next_steps))),t}function pt(r,e){return e?Ze(r):Fe(r)}function ut(r,e,t){return!H(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?et(r.totalDiscoveryTokens,r.totalReadTokens):Xe(r.totalDiscoveryTokens,r.totalReadTokens)}function _t(r,e=5){return r.prepare(`SELECT * FROM principles WHERE status IN ('confirmed', 'promoted')
     ORDER BY (confidence * frequency) DESC LIMIT ?`).all(e)}function mt(r,e){if(!r.principlesEnabled)return[];let t=r.principlesMaxInject??5,s=null;try{s=new L;let n=_t(s.db,t);if(n.length===0)return[];let o=[];o.push("### Principles (User-Confirmed Rules)");for(let i of n){let a=i.confidence.toFixed(1);o.push(`- [${i.category}] ${i.rule} (confidence: ${a}, seen ${i.frequency}x)`)}return o.push(""),o}catch(n){return u.debug("PRINCIPLES","Failed to render principles section",{},n),[]}finally{s?.close()}}var $t=lt.default.join((0,Et.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function Pt(){try{return new L}catch(r){if(r.code==="ERR_DLOPEN_FAILED"){try{(0,Tt.unlinkSync)($t)}catch(e){u.debug("SYSTEM","Marker file cleanup failed (may not exist)",{},e)}return u.error("SYSTEM","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function Ft(r,e){return e?tt(r):je(r)}function Xt(r,e,t,s,n,o,i){let a=[],d=Z(e);a.push(...st(r,d,s,i)),a.push(...mt(s,i));let p=t.slice(0,s.sessionCount),_=Ne(p,t),l=re(e,_),T=Ae(e,s.fullObservationCount);a.push(...at(l,T,s,n,i));let E=t[0],f=e[0];dt(s,E,f)&&a.push(...ct(E,i));let O=se(e,s,o,n);return a.push(...pt(O,i)),a.push(...ut(d,s,i)),a.join(`
`).trimEnd()}async function ae(r,e=!1){let t=J(),s=r?.cwd??process.cwd(),n=fe(s),o=r?.projects||[n];r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let i=Pt();if(!i)return"";try{let a=o.length>1?Ce(i,o,t):ee(i,n,t),d=o.length>1?Ie(i,o,t):te(i,n,t);return a.length===0&&d.length===0?Ft(n,e):Xt(n,a,d,t,s,r?.session_id,e)}finally{i.close()}}0&&(module.exports={generateContext});
