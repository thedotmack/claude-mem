"use strict";var xt=Object.create;var B=Object.defineProperty;var wt=Object.getOwnPropertyDescriptor;var kt=Object.getOwnPropertyNames;var Ft=Object.getPrototypeOf,Pt=Object.prototype.hasOwnProperty;var $t=(r,e)=>{for(var t in e)B(r,t,{get:e[t],enumerable:!0})},Ae=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of kt(e))!Pt.call(r,n)&&n!==t&&B(r,n,{get:()=>e[n],enumerable:!(s=wt(e,n))||s.enumerable});return r};var k=(r,e,t)=>(t=r!=null?xt(Ft(r)):{},Ae(e||!r||!r.__esModule?B(t,"default",{value:r,enumerable:!0}):t,r)),Ht=r=>Ae(B({},"__esModule",{value:!0}),r);var fs={};$t(fs,{generateContext:()=>he});module.exports=Ht(fs);var vt=k(require("path"),1),yt=require("os"),Ut=require("fs");var de=require("bun:sqlite");var g=require("path"),ne=require("os"),y=require("fs");var Ce=require("url");var L=require("fs"),Ne=require("path");var se=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(se||{}),re=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=v.logsDir();(0,L.existsSync)(e)||(0,L.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,Ne.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=v.settings();if((0,L.existsSync)(e)){let t=(0,L.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=se[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),c=m?`${m[1].split("/").pop()}:${m[2]}`:"unknown",T={...s,location:c};return this.warn(e,`[HAPPY-PATH] ${t}`,T,n),o}},u=new re;var Jt={};function Gt(){return typeof __dirname<"u"?__dirname:(0,g.dirname)((0,Ce.fileURLToPath)(Jt.url))}var jt=Gt();function Xt(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,g.join)((0,ne.homedir)(),".claude-mem"),e=(0,g.join)(r,"settings.json");try{if((0,y.existsSync)(e)){let t=JSON.parse((0,y.readFileSync)(e,"utf-8")),s=t.env??t;if(s.CLAUDE_MEM_DATA_DIR)return s.CLAUDE_MEM_DATA_DIR}}catch{}return r}var O=Xt(),U=process.env.CLAUDE_CONFIG_DIR||(0,g.join)((0,ne.homedir)(),".claude"),As=(0,g.join)(U,"plugins","marketplaces","thedotmack"),Bt=(0,g.join)(O,"archives"),Wt=(0,g.join)(O,"logs"),Vt=(0,g.join)(O,"trash"),qt=(0,g.join)(O,"backups"),Yt=(0,g.join)(O,"modes"),Ns=(0,g.join)(O,"settings.json"),Ie=(0,g.join)(O,"claude-mem.db"),Kt=(0,g.join)(O,"vector-db"),Le=(0,g.join)(O,"observer-sessions"),oe=(0,g.basename)(Le),Cs=(0,g.join)(U,"settings.json"),Is=(0,g.join)(U,"commands"),Ls=(0,g.join)(U,"CLAUDE.md");function Me(r){(0,y.mkdirSync)(r,{recursive:!0})}function De(){return(0,g.join)(jt,"..")}var v={dataDir:()=>O,workerPid:()=>(0,g.join)(O,"worker.pid"),serverBetaPid:()=>(0,g.join)(O,".server-beta.pid"),serverBetaPort:()=>(0,g.join)(O,".server-beta.port"),serverBetaRuntime:()=>(0,g.join)(O,".server-beta.runtime.json"),settings:()=>(0,g.join)(O,"settings.json"),database:()=>(0,g.join)(O,"claude-mem.db"),chroma:()=>(0,g.join)(O,"chroma"),combinedCerts:()=>(0,g.join)(O,"combined_certs.pem"),transcriptsConfig:()=>(0,g.join)(O,"transcript-watch.json"),transcriptsState:()=>(0,g.join)(O,"transcript-watch-state.json"),corpora:()=>(0,g.join)(O,"corpora"),supervisorRegistry:()=>(0,g.join)(O,"supervisor.json"),envFile:()=>(0,g.join)(O,".env"),logsDir:()=>Wt,archives:()=>Bt,trash:()=>Vt,backups:()=>qt,modes:()=>Yt,vectorDb:()=>Kt,observerSessions:()=>Le};var Pe=require("crypto");var we=require("os"),x=require("fs"),P=k(require("path"),1);var V=require("fs"),W=k(require("path"),1),F={isWorktree:!1,worktreeName:null,parentRepoPath:null,parentProjectName:null};function ve(r){let e=W.default.join(r,".git"),t;try{t=(0,V.statSync)(e)}catch(c){return c instanceof Error&&c.code!=="ENOENT"&&console.warn("[worktree] Unexpected error checking .git:",c),F}if(!t.isFile())return F;let s;try{s=(0,V.readFileSync)(e,"utf-8").trim()}catch(c){return console.warn("[worktree] Failed to read .git file:",c instanceof Error?c.message:String(c)),F}let n=s.match(/^gitdir:\s*(.+)$/);if(!n)return F;let i=n[1].match(/^(.+)[/\\]\.git[/\\]worktrees[/\\]([^/\\]+)$/);if(!i)return F;let a=i[1],d=W.default.basename(r),m=W.default.basename(a);return{isWorktree:!0,worktreeName:d,parentRepoPath:a,parentProjectName:m}}var ye="CLAUDE_MEM_USE_GIT_ROOT",D;function Qt(r){return r==="~"||r.startsWith("~/")?r.replace(/^~/,(0,we.homedir)()):r}function Ue(r){return r!==null&&typeof r=="object"&&!Array.isArray(r)?r:null}function xe(r){return r==="true"||r===!0}function zt(){let r=process.env[ye];if(r!==void 0)return xe(r);if(D!==void 0)return D;try{let e=v.settings();if(!(0,x.existsSync)(e))return D=!1,D;let t=Ue(JSON.parse((0,x.readFileSync)(e,"utf-8")));if(!t)return D=!1,D;let n=Ue(t.env)??t;return D=xe(n[ye]),D}catch(e){return u.debug("PROJECT_NAME","Failed to read git-root project-name setting, using basename mode",{},e instanceof Error?e:new Error(String(e))),!1}}function Zt(r){let e=P.default.resolve(r);for(;;){let t=P.default.join(e,".git");try{let n=(0,x.statSync)(t);if(n.isDirectory()||n.isFile())return e}catch(n){n instanceof Error&&n.code!=="ENOENT"&&u.debug("PROJECT_NAME","Failed checking .git marker while resolving project root",{cwd:r,gitMarker:t},n)}let s=P.default.dirname(e);if(s===e)return null;e=s}}function ke(r){let e=Qt(r);return zt()?Zt(e)??e:e}function Fe(r,e){let t=P.default.basename(r);if(t===""){if(process.platform==="win32"){let n=e.match(/^([A-Z]):\\/i);if(n){let i=`drive-${n[1].toUpperCase()}`;return u.info("PROJECT_NAME","Drive root detected",{cwd:e,projectName:i}),i}}return u.warn("PROJECT_NAME","Root directory detected, using fallback",{cwd:e}),"unknown-project"}return t}function es(r){if(!r||r.trim()==="")return u.warn("PROJECT_NAME","Empty cwd provided, using fallback",{cwd:r}),"unknown-project";let e=ke(r);return Fe(e,r)}function ie(r){if(!r||r.trim()===""){let n=es(r);return{primary:n,parent:null,isWorktree:!1,allProjects:[n]}}let e=ke(r),t=Fe(e,r),s=ve(e);if(s.isWorktree&&s.parentProjectName){let n=`${s.parentProjectName}/${t}`;return{primary:n,parent:s.parentProjectName,isWorktree:!0,allProjects:[s.parentProjectName,n]}}return{primary:t,parent:null,isWorktree:!1,allProjects:[t]}}function q(r,e,t){return(0,Pe.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function ae(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[String(e)]}catch{return[r]}}var N="claude";function ts(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function w(r){if(!r)return N;let e=ts(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:N}function $e(r){let e=["claude","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function ss(r,e){return{customTitle:r,platformSource:e?w(e):void 0}}var Y=class{db;constructor(e=Ie){e instanceof de.Database?this.db=e:(e!==":memory:"&&Me(O),this.db=new de.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.db.run("PRAGMA journal_size_limit = 4194304")),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn()}dropWorkerPidColumn(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(32),s=this.db.query("PRAGMA table_info(pending_messages)").all().some(n=>n.name==="worker_pid");if(!(e&&!s)){if(s)try{this.db.run("DROP INDEX IF EXISTS idx_pending_messages_worker_pid"),this.db.run("ALTER TABLE pending_messages DROP COLUMN worker_pid"),u.debug("DB","Dropped worker_pid column and its index from pending_messages")}catch(n){u.warn("DB","Failed to drop worker_pid column from pending_messages",{},n instanceof Error?n:new Error(String(n)));return}e||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(32,new Date().toISOString())}}dropDeadPendingMessagesColumns(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(31),t=this.db.query("PRAGMA table_info(pending_messages)").all(),s=new Set(t.map(i=>i.name)),o=["retry_count","failed_at_epoch","completed_at_epoch"].filter(i=>s.has(i));if(!(e&&o.length===0)){if(o.length>0){this.db.run("BEGIN TRANSACTION");try{this.db.run("DELETE FROM pending_messages WHERE status NOT IN ('pending', 'processing')");for(let i of o)this.db.run(`ALTER TABLE pending_messages DROP COLUMN ${i}`),u.debug("DB",`Dropped dead column ${i} from pending_messages`);e||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(31,new Date().toISOString()),this.db.run("COMMIT")}catch(i){this.db.run("ROLLBACK"),u.warn("DB","Failed to drop dead columns from pending_messages",{},i instanceof Error?i:new Error(String(i)));return}return}e||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(31,new Date().toISOString())}}initializeSchema(){this.db.run(`
    ...
    `).all(e)}getAllProjects(e){let t=e?w(e):void 0,s=`
      ...
      WHERE project IS NOT NULL AND project != ''
        AND project != ?
    `,n=[oe];return t&&(s+=" AND COALESCE(platform_source, ?) = ?",n.push(N,t)),s+=" ORDER BY project ASC",this.db.prepare(s).all(...n).map(i=>i.project)}getProjectCatalog(){let e=this.db.prepare(`
      SELECT
    ...
    `).get(e).count}createSDKSession(e,t,s,n,o){let i=new Date,a=i.getTime(),d=ss(n,o),m=d.platformSource??N,c=this.db.prepare(`
    ...
    `).get(e);if(c){if(t&&this.db.prepare(`
        ...
        `).run(d.customTitle,e),d.platformSource){let p=c.platform_source?.trim()?w(c.platform_source):void 0;if(!p)this.db.prepare(`
    ...
    `).run(e,t,s,n.toISOString(),o).lastInsertRowid}getUserPrompt(e,t){return this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,o=0,i,a){let d=i??Date.now(),m=new Date(d).toISOString(),c=q(e,s.title,s.narrative),p=this.db.prepare(`
  ...
  `).all(e,e,...s,...o,t.totalObservationCount)}function Ee(r,e,t){return r.db.prepare(`
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(e,e,t.sessionCount+ce)}function Xe(r,e,t){let s=Array.from(t.observationTypes),n=s.map(()=>"?").join(","),o=Array.from(t.observationConcepts),i=o.map(()=>"?").join(","),a=e.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
      o.id,
      o.memory_session_id,
      COALESCE(s.platform_source, 'claude') as platform_source,
    ...
    ORDER BY o.created_at_epoch DESC
    LIMIT ?
  `).all(...e,...e,...s,...o,t.totalObservationCount)}function Be(r,e,t){let s=e.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
      ss.id,
      ss.memory_session_id,
      COALESCE(s.platform_source, 'claude') as platform_source,
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(...e,...e,t.sessionCount+ce)}function is(r){return r.replace(/\//g,"-")}function as(r){if(!r.includes('"type":"assistant"'))return null;let e=JSON.parse(r);if(e.type==="assistant"&&e.message?.content&&Array.isArray(e.message.content)){let t="";for(let s of e.message.content)s.type==="text"&&(t+=s.text);if(t=t.replace(Ge,"").trim(),t)return t}return null}function ds(r){for(let e=r.length-1;e>=0;e--)try{let t=as(r[e]);if(t)return t}catch(t){t instanceof Error?u.debug("WORKER","Skipping malformed transcript line",{lineIndex:e},t):u.debug("WORKER","Skipping malformed transcript line",{lineIndex:e,error:String(t)});continue}return""}function _s(r){try{if(!(0,z.existsSync)(r))return{userMessage:"",assistantMessage:""};let e=(0,z.readFileSync)(r,"utf-8").trim();if(!e)return{userMessage:"",assistantMessage:""};let t=e.split(`
`).filter(n=>n.trim());return{userMessage:"",assistantMessage:ds(t)}}catch(e){return e instanceof Error?u.failure("WORKER","Failed to extract prior messages from transcript",{transcriptPath:r},e):u.warn("WORKER","Failed to extract prior messages from transcript",{transcriptPath:r,error:String(e)}),{userMessage:"",assistantMessage:""}}}function ge(r,e,t,s){if(!e.showLastMessage||r.length===0)return{userMessage:"",assistantMessage:""};let n=r.find(d=>d.memory_session_id!==t);if(!n)return{userMessage:"",assistantMessage:""};let o=n.memory_session_id,i=is(s),a=je.default.join(U,"projects",i,`${o}.jsonl`);return _s(a)}function We(r,e){let t=e[0]?.id;return r.map((s,n)=>{let o=n===0?null:e[n+1];return{...s,displayEpoch:o?o.created_at_epoch:s.created_at_epoch,displayTime:o?o.created_at:s.created_at,shouldShowLink:s.id!==t}})}function Te(r,e){let t=[...r.map(s=>({type:"observation",data:s})),...e.map(s=>({type:"summary",data:s}))];return t.sort((s,n)=>{let o=s.type==="observation"?s.data.created_at_epoch:s.data.displayEpoch,i=n.type==="observation"?n.data.created_at_epoch:n.data.displayEpoch;return o-i}),t}function Ve(r,e){return new Set(r.slice(0,e).map(t=>t.id))}function qe(){let r=new Date,e=r.toLocaleDateString("en-CA"),t=r.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),s=r.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${s}`}function Ye(r){return[`# [${r}] recent context, ${qe()}`,""]}function Ke(){return[`Legend: \u{1F3AF}session ${C.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji}${t.id}`).join(" ")}`,"Format: ID TIME TYPE TITLE","Fetch details: get_observations([IDs]) | Search: mem-search skill",""]}function Je(){return[]}function Qe(){return[]}function ze(r,e){let t=[],s=[`${r.totalObservations} obs (${r.totalReadTokens.toLocaleString()}t read)`,`${r.totalDiscoveryTokens.toLocaleString()}t work`];return r.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)&&(e.showSavingsPercent?s.push(`${r.savingsPercent}% savings`):e.showSavingsAmount&&s.push(`${r.savings.toLocaleString()}t saved`)),t.push(`Stats: ${s.join(" | ")}`),t.push(""),t}function Ze(r){return[`### ${r}`]}function et(r){return r.toLowerCase().replace(" am","a").replace(" pm","p")}function tt(r,e,t){let s=r.title||"Untitled",n=C.getInstance().getTypeIcon(r.type),o=e?et(e):'"';return`${r.id} ${o} ${n} ${s}`}function st(r,e,t,s){let n=[],o=r.title||"Untitled",i=C.getInstance().getTypeIcon(r.type),a=e?et(e):'"',{readTokens:d,discoveryDisplay:m}=G(r,s);n.push(`**${r.id}** ${a} ${i} **${o}**`),t&&n.push(t);let c=[];return s.showReadTokens&&c.push(`~${d}t`),s.showWorkTokens&&c.push(m),c.length>0&&n.push(c.join(" ")),n.push(""),n}function rt(r,e){return[`S${r.id} ${r.request||"Session started"} (${e})`]}function j(r,e){return e?[`**${r}**: ${e}`,""]:[]}function nt(r){return r.assistantMessage?["","---","","**Previously**","",`A: ${r.assistantMessage}`,""]:[]}function ot(r,e){return["",`Access ${Math.round(r/1e3)}k tokens of past work via get_observations([IDs]) or mem-search skill.`]}function it(r){return`# [${r}] recent context, ${qe()}

No previous sessions found.`}function at(){let r=new Date,e=r.toLocaleDateString("en-CA"),t=r.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),s=r.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${s}`}function dt(r){return["",`${_.bright}${_.cyan}[${r}] recent context, ${at()}${_.reset}`,`${_.gray}${"\u2500".repeat(60)}${_.reset}`,""]}function _t(){let e=C.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji} ${t.id}`).join(" | ");return[`${_.dim}Legend: session-request | ${e}${_.reset}`,""]}function ut(){return[`${_.bright}Column Key${_.reset}`,`${_.dim}  Read: Tokens to read this observation (cost to learn it now)${_.reset}`,`${_.dim}  Work: Tokens spent on work that produced this record ( research, building, deciding)${_.reset}`,""]}function ct(){return[`${_.dim}Context Index: This semantic index (titles, types, files, tokens) is usually sufficient to understand past work.${_.reset}`,"",`${_.dim}When you need implementation details, rationale, or debugging context:${_.reset}`,`${_.dim}  - Fetch by ID: get_observations([IDs]) for observations visible in this index${_.reset}`,`${_.dim}  - Search history: Use the mem-search skill for past decisions, bugs, and deeper research${_.reset}`,`${_.dim}  - Trust this index over re-reading code for past decisions and learnings${_.reset}`,""]}function mt(r,e){let t=[];if(t.push(`${_.bright}${_.cyan}Context Economics${_.reset}`),t.push(`${_.dim}  Loading: ${r.totalObservations} observations (${r.totalReadTokens.toLocaleString()} tokens to read)${_.reset}`),t.push(`${_.dim}  Work investment: ${r.totalDiscoveryTokens.toLocaleString()} tokens spent on research, building, and decisions${_.reset}`),r.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)){let s="  Your savings: ";e.showSavingsAmount&&e.showSavingsPercent?s+=`${r.savings.toLocaleString()} tokens (${r.savingsPercent}% reduction from reuse)`:e.showSavingsAmount?s+=`${r.savings.toLocaleString()} tokens`:s+=`${r.savingsPercent}% reduction from reuse`,t.push(`${_.green}${s}${_.reset}`)}return t.push(""),t}function lt(r){return[`${_.bright}${_.cyan}${r}${_.reset}`,""]}function pt(r){return[`${_.dim}${r}${_.reset}`]}function Et(r,e,t,s){let n=r.title||"Untitled",o=C.getInstance().getTypeIcon(r.type),{readTokens:i,discoveryTokens:a,workEmoji:d}=G(r,s),m=t?`${_.dim}${e}${_.reset}`:" ".repeat(e.length),c=s.showReadTokens&&i>0?`${_.dim}(~${i}t)${_.reset}`:"",T=s.showWorkTokens&&a>0?`${_.dim}(${d} ${a.toLocaleString()}t)${_.reset}`:"";return`  ${_.dim}#${r.id}${_.reset}  ${m}  ${o}  ${n} ${c} ${T}`}function gt(r,e,t,s,n){let o=[],i=r.title||"Untitled",a=C.getInstance().getTypeIcon(r.type),{readTokens:d,discoveryTokens:m,workEmoji:c}=G(r,n),T=t?`${_.dim}${e}${_.reset}`:" ".repeat(e.length),p=n.showReadTokens&&d>0?`${_.dim}(~${d}t)${_.reset}`:"",E=n.showWorkTokens&&m>0?`${_.dim}(${c} ${m.toLocaleString()}t)${_.reset}`:"";return o.push(`  ${_.dim}#${r.id}${_.reset}  ${T}  ${a}  ${_.bright}${i}${_.reset}`),s&&o.push(`    ${_.dim}${s}${_.reset}`),(p||E)&&o.push(`    ${p} ${E}`),o.push(""),o}function Tt(r,e){let t=`${r.request||"Session started"} (${e})`;return[`${_.yellow}#S${r.id}${_.reset} ${t}`,""]}function X(r,e,t){return e?[`${t}${r}:${_.reset} ${e}`,""]:[]}function ft(r){return r.assistantMessage?["","---","",`${_.bright}${_.magenta}Previously${_.reset}`,"",`${_.dim}A: ${r.assistantMessage}${_.reset}`,""]:[]}function St(r,e){let t=Math.round(r/1e3);return["",`${_.dim}Access ${t}k tokens of past research & decisions for just ${e.toLocaleString()}t. Use the claude-mem skill to access memories by ID.${_.reset}`]}function bt(r){return`
${_.bright}${_.cyan}[${r}] recent context, ${at()}${_.reset}
${_.gray}${"\u2500".repeat(60)}${_.reset}

${_.dim}No previous sessions found for this project yet.${_.reset}
`}function ht(r,e,t,s){let n=[];return s?n.push(...dt(r)):n.push(...Ye(r)),s?n.push(..._t()):n.push(...Ke()),s?n.push(...ut()):n.push(...Je()),s?n.push(...ct()):n.push(...Qe()),Q(t)&&(s?n.push(...mt(e,t)):n.push(...ze(e,t))),n}var fe=k(require("path"),1);function te(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return u.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e instanceof Error?e:new Error(String(e))),[]}}function Se(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function be(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function Rt(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function Ot(r,e){return fe.default.isAbsolute(r)?fe.default.relative(e,r):r}function At(r,e,t){let s=te(r);if(s.length>0)return Ot(s[0],e);if(t){let n=te(t);if(n.length>0)return Ot(n[0],e)}return"General"}function us(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=Rt(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function Nt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?te(r.facts).join(`
`):null}function cs(r,e,t,s){let n=[];n.push(...Ze(r));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=Se(a.displayTime);n.push(...rt(a,d))}else{let a=i.data,d=be(a.created_at),c=d!==o?d:"";if(o=d,t.has(a.id)){let p=Nt(a,s);n.push(...st(a,c,p,s))}else n.push(tt(a,c,s))}return n}function ms(r,e,t,s,n){let o=[];o.push(...lt(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let m=d.data,c=Se(m.displayTime);o.push(...Tt(m,c))}else{let m=d.data,c=At(m.files_modified,n,m.files_read),T=be(m.created_at),p=T!==a;a=T;let E=t.has(m.id);if(c!==i&&(o.push(...pt(c)),i=c),E){let f=Nt(m,s);o.push(...gt(m,T,p,f,s))}else o.push(Et(m,T,p,s))}return o.push(""),o}function ls(r,e,t,s,n,o){return o?ms(r,e,t,s,n):cs(r,e,t,s)}function Ct(r,e,t,s,n){let o=[],i=us(r);for(let[a,d]of i)o.push(...ls(a,d,e,t,s,n));return o}function It(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function Lt(r,e){let t=[];return e?(t.push(...X("Investigated",r.investigated,_.blue)),t.push(...X("Learned",r.learned,_.yellow)),t.push(...X("Completed",r.completed,_.green)),t.push(...X("Next Steps",r.next_steps,_.magenta))):(t.push(...j("Investigated",r.investigated)),t.push(...j("Learned",r.learned)),t.push(...j("Completed",r.completed)),t.push(...j("Next Steps",r.next_steps))),t}function Mt(r,e){return e?ft(r):nt(r)}function Dt(r,e,t){return!Q(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?St(r.totalDiscoveryTokens,r.totalReadTokens):ot(r.totalDiscoveryTokens,r.totalReadTokens)}var ps=vt.default.join((0,yt.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function Es(){try{return new Y}catch(r){if(r instanceof Error&&r.code==="ERR_DLOPEN_FAILED"){try{(0,Ut.unlinkSync)(ps)}catch(e){e instanceof Error?u.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):u.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return u.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function gs(r,e){return e?bt(r):it(r)}function Ts(r,e,t,s,n,o,i){let a=[],d=le(e);a.push(...ht(r,d,s,i));let m=t.slice(0,s.sessionCount),c=We(m,t),T=Te(e,c),p=Ve(e,s.fullObservationCount);a.push(...Ct(T,p,s,n,i));let E=t[0],f=e[0];It(s,E,f)&&a.push(...Lt(E,i));let b=ge(e,s,o,n);return a.push(...Mt(b,i)),a.push(...Dt(d,s,i)),a.join(`
`).trimEnd()}async function he(r,e=!1){let t=ue(),s=r?.cwd??process.cwd(),n=ie(s),o=r?.projects?.length?r.projects:n.allProjects,i=o[o.length-1]??n.primary;r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let a=Es();if(!a)return"";try{let d=o.length>1?Xe(a,o,t):pe(a,i,t),m=o.length>1?Be(a,o,t):Ee(a,i,t);return d.length===0&&m.length===0?gs(i,e):Ts(i,d,m,t,s,r?.session_id,e)}finally{a.close()}}0&&(module.exports={generateContext});
