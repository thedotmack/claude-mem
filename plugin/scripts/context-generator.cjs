"use strict";var Kt=Object.create;var J=Object.defineProperty;var Jt=Object.getOwnPropertyDescriptor;var Qt=Object.getOwnPropertyNames;var zt=Object.getPrototypeOf,Zt=Object.prototype.hasOwnProperty;var es=(r,e)=>{for(var t in e)J(r,t,{get:e[t],enumerable:!0})},Ae=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Qt(e))!Zt.call(r,n)&&n!==t&&J(r,n,{get:()=>e[n],enumerable:!(s=Jt(e,n))||s.enumerable});return r};var X=(r,e,t)=>(t=r!=null?Kt(zt(r)):{},Ae(e||!r||!r.__esModule?J(t,"default",{value:r,enumerable:!0}):t,r)),ts=r=>Ae(J({},"__esModule",{value:!0}),r);var Hs={};es(Hs,{generateContext:()=>Yt,generateContextWithStats:()=>Ie});module.exports=ts(Hs);var Wt=X(require("path"),1),Vt=require("os"),qt=require("fs");var ge=require("bun:sqlite"),Z=require("fs");var S=require("path"),Ee=require("os"),$=require("fs"),Le=require("url");var T=require("fs"),Ce=require("crypto"),v=require("path");var ss=null;function rs(r){return(ss??process.stderr.write.bind(process.stderr))(r)}function P(r){rs(r)}var ns=process.platform==="win32";function os(r){return r.replace(/^\uFEFF/,"")}function F(r){return JSON.parse(os(r))}function is(r){(0,T.existsSync)(r)||(0,T.mkdirSync)(r,{recursive:!0})}function _e(r,e){let t=r;try{if((0,T.lstatSync)(r).isSymbolicLink())try{t=(0,T.realpathSync)(r)}catch(_){let u=_ instanceof Error?_:new Error(String(_));P(`claude-mem: realpathSync failed for ${r}, resolving symlink manually: ${u.message}
`);let c=(0,T.readlinkSync)(r);t=(0,v.resolve)((0,v.dirname)(r),c)}}catch(_){let u=_.code;if(u!=="ENOENT"&&u!=="ENOTDIR")throw _}is((0,v.dirname)(t));let s=(0,v.dirname)(t),n=(0,v.basename)(t),o=(0,v.join)(s,`.${n}.${process.pid}.${(0,Ce.randomBytes)(6).toString("hex")}.tmp`),i=Buffer.from(JSON.stringify(e,null,2)+`
`,"utf-8"),a;try{a=(0,T.statSync)(t).mode&511}catch{}let d;try{d=a!==void 0?(0,T.openSync)(o,"w",a):(0,T.openSync)(o,"w");let _=0;for(;_<i.length;){let u=(0,T.writeSync)(d,i,_,i.length-_);if(u===0)throw new Error(`writeSync stalled at ${_}/${i.length} bytes`);_+=u}if((0,T.fsyncSync)(d),(0,T.closeSync)(d),d=void 0,(0,T.renameSync)(o,t),!ns){let u;try{u=(0,T.openSync)(s,"r"),(0,T.fsyncSync)(u)}catch(c){let p=c instanceof Error?c:new Error(String(c));P(`claude-mem: directory fsync failed for ${s}: ${p.message}
`)}finally{if(u!==void 0)try{(0,T.closeSync)(u)}catch{}}}}catch(_){if(d!==void 0)try{(0,T.closeSync)(d)}catch{}try{(0,T.unlinkSync)(o)}catch{}throw _}}var ms={};function as(){return typeof __dirname<"u"?__dirname:(0,S.dirname)((0,Le.fileURLToPath)(ms.url))}var ds=as();function _s(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,S.join)((0,Ee.homedir)(),".claude-mem"),e=(0,S.join)(r,"settings.json");try{if((0,$.existsSync)(e)){let t=F((0,$.readFileSync)(e,"utf-8")),s=t.env??t;if(s.CLAUDE_MEM_DATA_DIR)return s.CLAUDE_MEM_DATA_DIR}}catch{}return r}var I=_s(),ue=process.env.CLAUDE_CONFIG_DIR||(0,S.join)((0,Ee.homedir)(),".claude"),qs=(0,S.join)(ue,"plugins","marketplaces","thedotmack"),Es=(0,S.join)(I,"logs"),Ys=(0,S.join)(I,"settings.json"),De=(0,S.join)(I,"claude-mem.db"),us=(0,S.join)(I,"observer-sessions"),me=(0,S.basename)(us);function Me(r){(0,$.mkdirSync)(r,{recursive:!0})}function ye(){return(0,S.join)(ds,"..")}var k={dataDir:()=>I,workerPid:()=>(0,S.join)(I,"worker.pid"),serverPid:()=>(0,S.join)(I,".server-beta.pid"),serverPort:()=>(0,S.join)(I,".server-beta.port"),serverRuntime:()=>(0,S.join)(I,".server-beta.runtime.json"),settings:()=>(0,S.join)(I,"settings.json"),database:()=>(0,S.join)(I,"claude-mem.db"),chroma:()=>(0,S.join)(I,"chroma"),combinedCerts:()=>(0,S.join)(I,"combined_certs.pem"),transcriptsConfig:()=>(0,S.join)(I,"transcript-watch.json"),transcriptsState:()=>(0,S.join)(I,"transcript-watch-state.json"),cloudSyncState:()=>(0,S.join)(I,"cloud-sync-state.json"),corpora:()=>(0,S.join)(I,"corpora"),supervisorRegistry:()=>(0,S.join)(I,"supervisor.json"),envFile:()=>(0,S.join)(I,".env"),logsDir:()=>Es};var U=require("fs"),ve=require("path");var pe=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(pe||{}),ce=null,le=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=k.logsDir();(0,U.existsSync)(e)||(0,U.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,ve.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=k.settings();if((0,U.existsSync)(e)){let t=(0,U.readFileSync)(e,"utf-8"),n=(F(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=pe[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
  ...
  `).get()!=null}function H(r,e,t){try{r.run(e)}catch(s){let n=s instanceof Error?s:new Error(String(s));throw E.warn("DB",`Failed to apply SQLite pragma ${t}`,{sql:e},n),s}}function Xe(r,e={}){let{enableWal:t=!0,enableIncrementalAutoVacuum:s=!0}=e;H(r,`PRAGMA busy_timeout = ${gs}`,"busy_timeout"),H(r,"PRAGMA foreign_keys = ON","foreign_keys"),H(r,"PRAGMA synchronous = NORMAL","synchronous"),H(r,`PRAGMA journal_size_limit = ${Ss}`,"journal_size_limit"),s&&!fs(r)&&H(r,"PRAGMA auto_vacuum = INCREMENTAL","auto_vacuum"),t&&H(r,"PRAGMA journal_mode = WAL","journal_mode")}var z=class{db;constructor(e=De,t={}){e instanceof ge.Database?this.db=e:(e!==":memory:"&&Me(I),this.db=new ge.Database(e)),Xe(this.db),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn(),this.ensureSDKSessionsPlatformContentIdentity(),this.ensureUserPromptsSessionDbId(),this.ensurePendingMessagesSessionToolUniqueIndex(),this.ensureSyncedAtColumns(t.cloudSyncStatePath??k.cloudSyncState()),this.requeuePromptCloudSyncAfterMapperFix()}getIndexColumns(e){return this.db.query(`PRAGMA index_info(${JSON.stringify(e)})`).all().map(t=>t.name)}hasUniqueIndexOnColumns(e,t){return this.db.query(`PRAGMA index_list(${e})`).all().some(n=>{if(n.unique!==1)return!1;let o=this.getIndexColumns(n.name);return o.length===t.length&&o.every((i,a)=>i===t[a])})}resolvePromptSessionDbId(e,t,s){if(t!==void 0)return t;let n=s?C(s):void 0;return n?this.db.prepare(`
    ...
    `).get(e);if(!n)throw new Error(`Session ${e} not found in sdk_sessions`);n.memory_session_id!==t&&(this.db.prepare(`
      ...
      WHERE project IS NOT NULL AND project != ''
        AND project != ?
    `,n=[me];return t&&(s+=" AND COALESCE(platform_source, ?) = ?",n.push(l,t)),s+=" ORDER BY project ASC",this.db.prepare(s).all(...n).map(i=>i.project)}getProjectCatalog(){let e=this.db.prepare(`
      SELECT
...
`}function kt(r,e,t,s){let n=[];return s?n.push(...Ot(r)):n.push(...Et(r)),s?n.push(...ht()):n.push(...ut()),s&&(n.push(...Nt()),n.push(...It())),ne(t)&&(s?n.push(...At(e,t)):n.push(...mt(e,t))),n}var Oe=X(require("path"),1);function de(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return E.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e instanceof Error?e:new Error(String(e))),[]}}function he(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function Ne(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function Pt(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function wt(r,e){return Oe.default.isAbsolute(r)?Oe.default.relative(e,r):r}function Ft(r,e,t){let s=de(r);if(s.length>0)return wt(s[0],e);if(t){let n=de(t);if(n.length>0)return wt(n[0],e)}return"General"}function Ms(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=Pt(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function $t(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?de(r.facts).join(`
`):null}function ys(r,e,t,s){let n=[];n.push(...ct(r));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=he(a.displayTime);n.push(...gt(a,d))}else{let a=i.data,d=Ne(a.created_at),u=d!==o?d:"";if(o=d,t.has(a.id)){let p=$t(a,s);n.push(...Tt(a,u,p,s))}else n.push(lt(a,u,s))}return n}function vs(r,e,t,s,n){let o=[];o.push(...Ct(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let _=d.data,u=he(_.displayTime);o.push(...yt(_,u))}else{let _=d.data,u=Ft(_.files_modified,n,_.files_read),c=Ne(_.created_at),p=c!==a;a=c;let g=t.has(_.id);if(u!==i&&(o.push(...Lt(u)),i=u),g){let N=$t(_,s);o.push(...Mt(_,c,p,N,s))}else o.push(Dt(_,c,p,s))}return o.push(""),o}function Us(r,e,t,s,n,o){return o?vs(r,e,t,s,n):ys(r,e,t,s)}function Ht(r,e,t,s,n){let o=[],i=Ms(r);for(let[a,d]of i)o.push(...Us(a,d,e,t,s,n));return o}function Gt(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function Xt(r,e){let t=[];return e?(t.push(...K("Investigated",r.investigated,m.blue)),t.push(...K("Learned",r.learned,m.yellow)),t.push(...K("Completed",r.completed,m.green)),t.push(...K("Next Steps",r.next_steps,m.magenta))):(t.push(...Y("Investigated",r.investigated)),t.push(...Y("Learned",r.learned)),t.push(...Y("Completed",r.completed)),t.push(...Y("Next Steps",r.next_steps))),t}function Bt(r,e){return e?vt(r):St(r)}function jt(r,e,t){return!ne(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?Ut(r.totalDiscoveryTokens,r.totalReadTokens):ft(r.totalDiscoveryTokens,r.totalReadTokens)}var xs=Wt.default.join((0,Vt.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function ks(){try{return new z}catch(r){if(r instanceof Error&&r.code==="ERR_DLOPEN_FAILED"){try{(0,qt.unlinkSync)(xs)}catch(e){e instanceof Error?E.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):E.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return E.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function ws(r,e){return e?xt(r):Rt(r)}function Ps(r,e,t,s,n,o,i){let a=[],d=be(e);a.push(...kt(r,d,s,i));let _=t.slice(0,s.sessionCount),u=it(_,t),c=at(e,u),p=dt(e,s.fullObservationCount);a.push(...Ht(c,p,s,n,i));let g=t[0],N=e[0];Gt(s,g,N)&&a.push(...Xt(g,i));let h=ot(e,s,o,n);return a.push(...Bt(h,i)),a.push(...jt(d,s,i)),a.join(`
`).trimEnd()}var Fs=new Set(["bugfix","discovery","decision","refactor"]);function $s(r,e,t){let s=be(r),n={bugfix:0,discovery:0,decision:0,refactor:0,other:0},o=new Set,i=Number.POSITIVE_INFINITY;for(let d of r){let _=Fs.has(d.type)?d.type:"other";n[_]++,d.memory_session_id&&o.add(d.memory_session_id),d.created_at_epoch&&d.created_at_epoch<i&&(i=d.created_at_epoch)}let a=Number.isFinite(i)?Math.max(0,Math.floor((Date.now()-i)/864e5)):0;return{observation_count:r.length,session_count:o.size,timeline_depth_days:a,has_session_summary:e.length>0,obs_type_bugfix:n.bugfix,obs_type_discovery:n.discovery,obs_type_decision:n.decision,obs_type_refactor:n.refactor,obs_type_other:n.other,tokens_injected:s.totalReadTokens,tokens_saved_vs_naive:s.savings,search_strategy:t?"full":"timeline"}}async function Ie(r,e=!1){let t=ze(),s=r?.cwd??process.cwd(),n=Je(s),o=r?.projects?.length?r.projects:n.allProjects,i=o[o.length-1]??n.primary;r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let a=ks();if(!a)return{text:"",stats:null};try{let d=r?.platformSource?C(r.platformSource):void 0,_=o.length>1?o:[i],u=rt(a,_,t,d),c=nt(a,_,t,d);return u.length===0&&c.length===0?{text:ws(i,e),stats:null}:{text:Ps(i,u,c,t,s,r?.session_id,e),stats:$s(u,c,!!r?.full)}}finally{a.close()}}async function Yt(r,e=!1){return(await Ie(r,e)).text}0&&(module.exports={generateContext,generateContextWithStats});
