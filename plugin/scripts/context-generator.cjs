...
`+JSON.stringify(o,null,2):u=" "+this.formatData(o));let l="";if(n){let{sessionId:E,memorySessionId:T,correlationId:h,...m}=n;Object.keys(m).length>0&&(l=` {${Object.entries(m).map(([S,I])=>`${S}=${String(I)}`).join(", ")}}`)}let g=`[${i}] [${a}] [${d}] ${c}${s}${l}${u}`;if(this.logFilePath)try{(0,M.appendFileSync)(this.logFilePath,g+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),u=c?`${String(c[1].split("/").pop())}:${c[2]}`:"unknown",l={...s,location:u};return this.warn(e,`[HAPPY-PATH] ${t}`,l,n),o}},_=new K;var Nt={};function Mt(){return typeof __dirname<"u"?__dirname:(0,b.dirname)((0,ge.fileURLToPath)(Nt.url))}var Rt=Mt(),O=N.get("MAGIC_CLAUDE_MEM_DATA_DIR"),J=process.env.CLAUDE_CONFIG_DIR||(0,b.join)((0,me.homedir)(),".claude"),qt=(0,b.join)(O,"archives"),Kt=(0,b.join)(O,"logs"),Jt=(0,b.join)(O,"trash"),Qt=(0,b.join)(O,"backups"),zt=(0,b.join)(O,"modes"),Zt=(0,b.join)(O,"settings.json"),Te=(0,b.join)(O,"magic-claude-mem.db"),es=(0,b.join)(O,"vector-db"),ts=(0,b.join)(O,"observer-sessions"),ss=(0,b.join)(J,"settings.json"),rs=(0,b.join)(J,"commands"),ns=(0,b.join)(J,"CLAUDE.md");function fe(r){(0,Ee.mkdirSync)(r,{recursive:!0})}function Se(){return(0,b.join)(Rt,"..")}function P(r){return!r.request.trim()&&!r.investigated.trim()&&!r.learned.trim()&&!r.completed.trim()&&!r.next_steps.trim()}var Q=R(require("path"),1);function G(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return _.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r.substring(0,50)},e),[]}}function he(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function Ce(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function Ie(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function be(r,e){return Q.default.isAbsolute(r)?Q.default.relative(e,r):r}function Ae(r,e,t){let s=G(r);if(s.length>0)return be(s[0],e);if(t){let n=G(t);if(n.length>0)return be(n[0],e)}return"General"}function v(r){return r?Math.ceil(r.length/4):0}function F(r){return v(r.narrative??null)+v(r.title??null)+v(r.facts??null)+v(r.concepts??null)+v(r.text??null)}var j=class{db;constructor(e=Te){e!==":memory:"&&fe(O),this.db=new w(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addCompositeIndexes(),this.ensureReadTokensColumn(),this.createContextInjectionsTable(),this.ensureSubprocessPidColumn()}initializeSchema(){this.db.run(`
    ...
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,o=0,i){let a=i??Date.now(),d=new Date(a).toISOString(),c=F({narrative:s.narrative,title:s.title,facts:JSON.stringify(s.facts),concepts:JSON.stringify(s.concepts),text:null}),l=this.db.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.type,s.title,s.subtitle,JSON.stringify(s.facts),s.narrative,JSON.stringify(s.concepts),JSON.stringify(s.files_read),JSON.stringify(s.files_modified),n||null,o,c,d,a);return{id:Number(l.lastInsertRowid),createdAtEpoch:a}}storeSummary(e,t,s,n,o=0,i){let a=i??Date.now(),d=new Date(a).toISOString();if(P(s))return _.warn("DB","Skipping empty summary insert",{memorySessionId:e}),{id:0,createdAtEpoch:a};let u=this.db.prepare(`
    ...
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,d,a);return{id:Number(u.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a){let d=a??Date.now(),c=new Date(d).toISOString();return this.db.transaction(()=>{let l=[],g=this.db.prepare(`
      ...
      `).run(u,o),{observationIds:E,summaryId:h,createdAtEpoch:u}})()}getSessionSummariesByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o}=t,i=s==="date_asc"?"ASC":"DESC",a=n?`LIMIT ${String(n)}`:"",d=e.map(()=>"?").join(","),c=[...e],u=o?`WHERE id IN (${d}) AND project = ?`:`WHERE id IN (${d})`;return o&&c.push(o),this.db.prepare(`
