"use strict";var Be=Object.create;var V=Object.defineProperty;var He=Object.getOwnPropertyDescriptor;var je=Object.getOwnPropertyNames;var Ge=Object.getPrototypeOf,Ye=Object.prototype.hasOwnProperty;var Ve=(a,e)=>{for(var s in e)V(a,s,{get:e[s],enumerable:!0})},ge=(a,e,s,t)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of je(e))!Ye.call(a,n)&&n!==s&&V(a,n,{get:()=>e[n],enumerable:!(t=He(e,n))||t.enumerable});return a};var Se=(a,e,s)=>(s=a!=null?Be(Ge(a)):{},ge(e||!a||!a.__esModule?V(s,"default",{value:a,enumerable:!0}):s,a)),Ke=a=>ge(V({},"__esModule",{value:!0}),a);var cs={};Ve(cs,{generateContext:()=>as});module.exports=Ke(cs);var U=Se(require("path"),1),ee=require("os"),P=require("fs");var Ce=Se(require("better-sqlite3"),1);var S=require("path"),oe=require("os"),ie=require("fs");var Ae=require("url");var Re=require("path"),Ne=require("os"),K=require("fs");var he=require("fs"),be=require("os"),fe=require("path"),qe=(0,fe.join)((0,be.homedir)(),".claude-mem","silent.log");function Oe(a,e,s=""){let t=new Date().toISOString(),d=((new Error().stack||"").split(`
...
`;try{(0,he.appendFileSync)(qe,m)}catch(l){console.error("[silent-debug] Failed to write to log:",l)}return s}var ne=(0,Re.join)((0,Ne.homedir)(),".claude-mem","settings.json");function q(a,e){try{if((0,K.existsSync)(ne)){let t=JSON.parse((0,K.readFileSync)(ne,"utf-8")).env?.[a];if(t!==void 0)return t}}catch(s){Oe("Failed to load settings file",{error:s,settingsPath:ne,key:a})}return process.env[a]||e}var Qe={};function Je(){return typeof __dirname<"u"?__dirname:(0,S.dirname)((0,Ae.fileURLToPath)(Qe.url))}var gs=Je(),C=q("CLAUDE_MEM_DATA_DIR",(0,S.join)((0,oe.homedir)(),".claude-mem")),ae=process.env.CLAUDE_CONFIG_DIR||(0,S.join)((0,oe.homedir)(),".claude"),Ss=(0,S.join)(C,"archives"),hs=(0,S.join)(C,"logs"),bs=(0,S.join)(C,"trash"),fs=(0,S.join)(C,"backups"),Os=(0,S.join)(C,"settings.json"),Ie=(0,S.join)(C,"claude-mem.db"),Rs=(0,S.join)(C,"vector-db"),Ns=(0,S.join)(ae,"settings.json"),As=(0,S.join)(ae,"commands"),Is=(0,S.join)(ae,"CLAUDE.md");function Le(a){(0,ie.mkdirSync)(a,{recursive:!0})}var ce=(i=>(i[i.DEBUG=0]="DEBUG",i[i.INFO=1]="INFO",i[i.WARN=2]="WARN",i[i.ERROR=3]="ERROR",i[i.SILENT=4]="SILENT",i))(ce||{}),de=class{level;useColor;constructor(){let e=q("CLAUDE_MEM_LOG_LEVEL","INFO").toUpperCase();this.level=ce[e]??1,this.useColor=process.stdout.isTTY??!1}correlationId(e,s){return`obs-${e}-${s}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.level===0?`${e.message}
${e.stack}`:e.message;if(Array.isArray(e))return`[${e.length} items]`;let s=Object.keys(e);return s.length===0?"{}":s.length<=3?JSON.stringify(e):`{${s.length} keys: ${s.slice(0,3).join(", ")}...}`}return String(e)}formatTool(e,s){if(!s)return e;try{let t=typeof s=="string"?JSON.parse(s):s;if(e==="Bash"&&t.command){let n=t.command.length>50?t.command.substring(0,50)+"...":t.command;return`${e}(${n})`}if(e==="Read"&&t.file_path){let n=t.file_path.split("/").pop()||t.file_path;return`${e}(${n})`}if(e==="Edit"&&t.file_path){let n=t.file_path.split("/").pop()||t.file_path;return`${e}(${n})`}if(e==="Write"&&t.file_path){let n=t.file_path.split("/").pop()||t.file_path;return`${e}(${n})`}return e}catch{return e}}log(e,s,t,n,i){if(e<this.level)return;let c=new Date().toISOString().replace("T"," ").substring(0,23),d=ce[e].padEnd(5),_=s.padEnd(6),m="";n?.correlationId?m=`[${n.correlationId}] `:n?.sessionId&&(m=`[session-${n.sessionId}] `);let l="";i!=null&&(this.level===0&&typeof i=="object"?l=`
`+JSON.stringify(i,null,2):l=" "+this.formatData(i));let b="";if(n){let{sessionId:f,sdkSessionId:y,correlationId:E,...r}=n;Object.keys(r).length>0&&(b=` {${Object.entries(r).map(([O,h])=>`${O}=${h}`).join(", ")}}`)}let v=`[${c}] [${d}] [${_}] ${m}${t}${b}${l}`;e===3?console.error(v):console.log(v)}debug(e,s,t,n){this.log(0,e,s,t,n)}info(e,s,t,n){this.log(1,e,s,t,n)}warn(e,s,t,n){this.log(2,e,s,t,n)}error(e,s,t,n){this.log(3,e,s,t,n)}dataIn(e,s,t,n){this.info(e,`\u2192 ${s}`,t,n)}dataOut(e,s,t,n){this.info(e,`\u2190 ${s}`,t,n)}success(e,s,t,n){this.info(e,`\u2713 ${s}`,t,n)}failure(e,s,t,n){this.error(e,`\u2717 ${s}`,t,n)}timing(e,s,t,n){this.info(e,`\u23F1 ${s}`,n,{duration:`${t}ms`})}},B=new de;var J=class{db;constructor(){Le(C),this.db=new Ce.default(Ie),this.db.pragma("journal_mode = WAL"),this.db.pragma("synchronous = NORMAL"),this.db.pragma("foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn()}initializeSchema(){try{this.db.exec(`
