"use strict";var Kt=Object.create;var J=Object.defineProperty;var Jt=Object.getOwnPropertyDescriptor;var Qt=Object.getOwnPropertyNames;var zt=Object.getPrototypeOf,Zt=Object.prototype.hasOwnProperty;var es=(r,e)=>{for(var t in e)J(r,t,{get:e[t],enumerable:!0})},Ae=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Qt(e))!Zt.call(r,n)&&n!==t&&J(r,n,{get:()=>e[n],enumerable:!(s=Jt(e,n))||s.enumerable});return r};var B=(r,e,t)=>(t=r!=null?Kt(zt(r)):{},Ae(e||!r||!r.__esModule?J(t,"default",{value:r,enumerable:!0}):t,r)),ts=r=>Ae(J({},"__esModule",{value:!0}),r);var Xs={};es(Xs,{generateContext:()=>Yt,generateContextWithStats:()=>Ie});module.exports=ts(Xs);var Wt=B(require("path"),1),Vt=require("os"),qt=require("fs");var ge=require("bun:sqlite"),Z=require("fs");var S=require("path"),Ee=require("os"),H=require("fs"),Ce=require("url");var T=require("fs"),Le=require("crypto"),v=require("path");var ss=null;function rs(r){return(ss??process.stderr.write.bind(process.stderr))(r)}function F(r){rs(r)}var ns=process.platform==="win32";function os(r){return r.replace(/^\uFEFF/,"")}function $(r){return JSON.parse(os(r))}function is(r){(0,T.existsSync)(r)||(0,T.mkdirSync)(r,{recursive:!0})}function _e(r,e){let t=r;try{if((0,T.lstatSync)(r).isSymbolicLink())try{t=(0,T.realpathSync)(r)}catch(_){let u=_ instanceof Error?_:new Error(String(_));F(`claude-mem: realpathSync failed for ${r}, resolving symlink manually: ${u.message}
`);let m=(0,T.readlinkSync)(r);t=(0,v.resolve)((0,v.dirname)(r),m)}}catch(_){let u=_.code;if(u!=="ENOENT"&&u!=="ENOTDIR")throw _}is((0,v.dirname)(t));let s=(0,v.dirname)(t),n=(0,v.basename)(t),o=(0,v.join)(s,`.${n}.${process.pid}.${(0,Le.randomBytes)(6).toString("hex")}.tmp`),i=Buffer.from(JSON.stringify(e,null,2)+`
...
`)}finally{if(u!==void 0)try{(0,T.closeSync)(u)}catch{}}}}catch(_){if(d!==void 0)try{(0,T.closeSync)(d)}catch{}try{(0,T.unlinkSync)(o)}catch{}throw _}}var cs={};function as(){return typeof __dirname<"u"?__dirname:(0,S.dirname)((0,Ce.fileURLToPath)(cs.url))}var ds=as();function _s(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,S.join)((0,Ee.homedir)(),".claude-mem"),e=(0,S.join)(r,"settings.json");try{if((0,H.existsSync)(e)){let t=$((0,H.readFileSync)(e,"utf-8")),s=t.env??t;if(s.CLAUDE_MEM_DATA_DIR)return s.CLAUDE_MEM_DATA_DIR}}catch{}return r}var I=_s(),ue=process.env.CLAUDE_CONFIG_DIR||(0,S.join)((0,Ee.homedir)(),".claude"),Ks=(0,S.join)(ue,"plugins","marketplaces","thedotmack"),Es=(0,S.join)(I,"logs"),Js=(0,S.join)(I,"settings.json"),De=(0,S.join)(I,"claude-mem.db"),us=(0,S.join)(I,"observer-sessions"),ce=(0,S.basename)(us);function Me(r){(0,H.mkdirSync)(r,{recursive:!0})}function ye(){return(0,S.join)(ds,"..")}var w={dataDir:()=>I,workerPid:()=>(0,S.join)(I,"worker.pid"),serverPid:()=>(0,S.join)(I,".server-beta.pid"),serverPort:()=>(0,S.join)(I,".server-beta.port"),serverRuntime:()=>(0,S.join)(I,".server-beta.runtime.json"),settings:()=>(0,S.join)(I,"settings.json"),database:()=>(0,S.join)(I,"claude-mem.db"),chroma:()=>(0,S.join)(I,"chroma"),combinedCerts:()=>(0,S.join)(I,"combined_certs.pem"),transcriptsConfig:()=>(0,S.join)(I,"transcript-watch.json"),transcriptsState:()=>(0,S.join)(I,"transcript-watch-state.json"),cloudSyncState:()=>(0,S.join)(I,"cloud-sync-state.json"),corpora:()=>(0,S.join)(I,"corpora"),supervisorRegistry:()=>(0,S.join)(I,"supervisor.json"),envFile:()=>(0,S.join)(I,".env"),logsDir:()=>Es};var U=require("fs"),ve=require("path");var pe=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(pe||{}),me=null,le=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=w.logsDir();(0,U.existsSync)(e)||(0,U.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,ve.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=w.settings();if((0,U.existsSync)(e)){let t=(0,U.readFileSync)(e,"utf-8"),n=($(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=pe[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`+JSON.stringify(o,null,2)}catch{u=" "+this.formatData(o)}else u=" "+this.formatData(o);let m="";if(n){let{sessionId:g,memorySessionId:N,correlationId:h,...f}=n;Object.keys(f).length>0&&(m=` {${Object.entries(f).map(([D,x])=>`${D}=${x}`).join(", ")}}`)}let p=`[${i}] [${a}] [${d}] ${_}${s}${m}${u}`;if(this.logFilePath)try{(0,U.appendFileSync)(this.logFilePath,p+`
`,"utf8")}catch(g){let N=g instanceof Error?g:new Error(String(g));F(`[LOGGER] Failed to write to log file: ${N.message}
${N.stack??""}
`)}else F(p+`
`)}debug(e,t,s,n){this.log(0,e,t,s,n)}info(e,t,s,n){this.log(1,e,t,s,n)}warn(e,t,s,n){this.log(2,e,t,s,n)}setErrorSink(e){me=e}error(e,t,s,n){this.log(3,e,t,s,n),this.routeErrorToSink(t,s,n)}routeErrorToSink(e,t,s){try{if(!me||!(s instanceof Error))return;me(s)}catch{}}dataIn(e,t,s,n){this.info(e,`\u2192 ${t}`,s,n)}dataOut(e,t,s,n){this.info(e,`\u2190 ${t}`,s,n)}success(e,t,s,n){this.info(e,`\u2713 ${t}`,s,n)}failure(e,t,s,n){this.error(e,`\u2717 ${t}`,s,n)}},E=new le;var Ue=require("crypto");function xe(r,e,t){return(0,Ue.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}var l="claude";function ms(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function C(r){if(!r)return l;let e=ms(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:l}function ke(r){let e=["claude","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function we(r,e,t,s,n){let o=Date.now()-s,i=n!==void 0?"up.session_db_id = ?":"up.content_session_id = ?",a=n??e;return r.prepare(`
    SELECT
      up.*,
      s.memory_session_id,
      s.project,
    ...
    LIMIT 1
  `).get(a,t,o)??void 0}var $e=["private","claude-mem-context","system_instruction","system-instruction","persisted-output","system-reminder"],Pe=new RegExp(`<(${$e.join("|")})\\b[^>]*>[\\s\\S]*?</\\1>`,"g"),He=/<system-reminder>[\s\S]*?<\/system-reminder>/g,Fe=100;function ps(r){let e=Object.fromEntries($e.map(n=>[n,0]));Pe.lastIndex=0;let t=0,s=r.replace(Pe,(n,o)=>(e[o]=(e[o]??0)+1,t+=1,""));return t>Fe&&E.warn("SYSTEM","tag count exceeds limit",void 0,{tagCount:t,maxAllowed:Fe,contentLength:r.length}),{stripped:s.trim(),counts:e}}function Ge(r){return ps(r).stripped}var ls=["task-notification"],ar=new RegExp(`^\\s*<(${ls.join("|")})\\b[^>]*>(?:(?!<\\1\\b|</\\1\\b)[\\s\\S])*</\\1>\\s*$`),dr=256*1024;var Te=4e3;function Q(r){let e=r.trim(),s=Ge(r).trim()||e;return s.length<=Te?s:(E.debug("DB","Truncated stored prompt text to the configured cap",{originalLength:s.length,storedLength:Te}),`${s.slice(0,Te-1)}\u2026`)}var Ts=require("bun:sqlite");var gs=5e3,Ss=4194304;function fs(r){return r.prepare(`
    SELECT name
    FROM sqlite_master
    WHERE type = 'table'
      AND name NOT LIKE 'sqlite_%'
    LIMIT 1
  `).get()!=null}function G(r,e,t){try{r.run(e)}catch(s){let n=s instanceof Error?s:new Error(String(s));throw E.warn("DB",`Failed to apply SQLite pragma ${t}`,{sql:e},n),s}}function Xe(r,e={}){let{enableWal:t=!0,enableIncrementalAutoVacuum:s=!0}=e;G(r,`PRAGMA busy_timeout = ${gs}`,"busy_timeout"),G(r,"PRAGMA foreign_keys = ON","foreign_keys"),G(r,"PRAGMA synchronous = NORMAL","synchronous"),G(r,`PRAGMA journal_size_limit = ${Ss}`,"journal_size_limit"),s&&!fs(r)&&G(r,"PRAGMA auto_vacuum = INCREMENTAL","auto_vacuum"),t&&G(r,"PRAGMA journal_mode = WAL","journal_mode")}var z=class{db;constructor(e=De,t={}){e instanceof ge.Database?this.db=e:(e!==":memory:"&&Me(I),this.db=new ge.Database(e)),Xe(this.db),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn(),this.ensureSDKSessionsPlatformContentIdentity(),this.ensureUserPromptsSessionDbId(),this.ensurePendingMessagesSessionToolUniqueIndex(),this.ensureSyncedAtColumns(t.cloudSyncStatePath??w.cloudSyncState()),this.requeuePromptCloudSyncAfterMapperFix()}getIndexColumns(e){return this.db.query(`PRAGMA index_info(${JSON.stringify(e)})`).all().map(t=>t.name)}hasUniqueIndexOnColumns(e,t){return this.db.query(`PRAGMA index_list(${e})`).all().some(n=>{if(n.unique!==1)return!1;let o=this.getIndexColumns(n.name);return o.length===t.length&&o.every((i,a)=>i===t[a])})}resolvePromptSessionDbId(e,t,s){if(t!==void 0)return t;let n=s?C(s):void 0;return n?this.db.prepare(`
        SELECT id
        FROM sdk_sessions
    ...
    `).all(ce),t=[],s=new Set,n={};for(let i of e){let a=C(i.platform_source);n[a]||(n[a]=[]),n[a].includes(i.project)||n[a].push(i.project),s.has(i.project)||(s.add(i.project),t.push(i.project))}let o=ke(Object.keys(n));return{projects:t,sources:o,projectsBySource:Object.fromEntries(o.map(i=>[i,n[i]||[]]))}}getLatestUserPrompt(e,t){let s=this.resolvePromptSessionDbId(e,t),n=s!==null?"up.session_db_id = ?":"up.content_session_id = ?",o=s!==null?s:e;return this.db.prepare(`
      ...
      ORDER BY up.created_at_epoch DESC
      LIMIT 1
    `).get(o)}findRecentDuplicateUserPrompt(e,t,s,n){return we(this.db,e,Q(t),s,this.resolvePromptSessionDbId(e,n)??void 0)}getRecentSessionsWithStatus(e,t=3,s){let n=[e],o="";return s&&(o=`AND COALESCE(NULLIF(s.platform_source, ''), '${l}') = ?`,n.push(C(s))),n.push(t),this.db.prepare(`
      SELECT * FROM (
        SELECT
          s.memory_session_id,
          s.status,
    ...
    `).get(e,C(t))||null:this.db.prepare(`
        ...
        FROM observations
        WHERE id = ?
      `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,platformSource:i,type:a,concepts:d,files:_}=t,u=s==="relevance",m=u?"":`ORDER BY o.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,p=n&&!u?`LIMIT ${n}`:"",g=e.map(()=>"?").join(","),N=[...e],h=[];if(o&&(h.push("o.project = ?"),N.push(o)),i&&(h.push(`COALESCE(NULLIF(s.platform_source, ''), '${l}') = ?`),N.push(C(i))),a)if(Array.isArray(a)){let A=a.map(()=>"?").join(",");h.push(`o.type IN (${A})`),N.push(...a)}else h.push("o.type = ?"),N.push(a);if(d){let A=Array.isArray(d)?d:[d],O=A.map(()=>"EXISTS (SELECT 1 FROM json_each(o.concepts) WHERE value = ?)");N.push(...A),h.push(`(${O.join(" OR ")})`)}if(_){let A=Array.isArray(_)?_:[_],O=A.map(()=>"(EXISTS (SELECT 1 FROM json_each(o.files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(o.files_modified) WHERE value LIKE ?))");A.forEach(M=>{N.push(`%${M}%`,`%${M}%`)}),h.push(`(${O.join(" OR ")})`)}let f=h.length>0?`WHERE o.id IN (${g}) AND ${h.join(" AND ")}`:`WHERE o.id IN (${g})`,D=this.db.prepare(`
      SELECT o.*
      FROM observations o
      LEFT JOIN sdk_sessions s ON s.memory_session_id = o.memory_session_id
      ${f}
      ${m}
      ${p}
    `).all(...N);if(!u)return D;let x=new Map(D.map(A=>[A.id,A])),b=e.map(A=>x.get(A)).filter(A=>!!A);return n?b.slice(0,n):b}getSummaryForSession(e,t){let s=[e],n="";return t&&(n=`
        AND EXISTS (
          SELECT 1
    ...
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,d,a);return{id:Number(u.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a,d){let _=a??Date.now(),u=new Date(_).toISOString();return this.db.transaction(()=>{let p=[],g=this.db.prepare(`
        ...
        RETURNING id
      `),N=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let f of s){let R=xe(e,f.title,f.narrative),D=g.get(e,t,f.type,f.title,f.subtitle,JSON.stringify(f.facts),f.narrative,JSON.stringify(f.concepts),JSON.stringify(f.files_read),JSON.stringify(f.files_modified),o||null,i,f.agent_type??null,f.agent_id??null,R,u,_,d||null,f.metadata??null);if(D){p.push(D.id);continue}let x=N.get(e,R);if(!x)throw new Error(`storeObservations: ON CONFLICT without existing row for content_hash=${R}`);p.push(x.id)}let h=null;if(n){let R=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,o||null,i,u,_);h=Number(R.lastInsertRowid)}return{observationIds:p,summaryId:h,createdAtEpoch:_}})()}getSessionSummariesByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,platformSource:i}=t,a=s==="relevance",d=a?"":`ORDER BY ss.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,_=n&&!a?`LIMIT ${n}`:"",u=e.map(()=>"?").join(","),m=[...e],p=[];o&&(p.push("ss.project = ?"),m.push(o)),i&&(p.push(`COALESCE(NULLIF(s.platform_source, ''), '${l}') = ?`),m.push(C(i)));let g=p.length>0?`AND ${p.join(" AND ")}`:"",h=this.db.prepare(`
      SELECT ss.*
      ...
      ${d}
      ${_}
    `).all(...m);if(!a)return h;let f=new Map(h.map(D=>[D.id,D])),R=e.map(D=>f.get(D)).filter(D=>!!D);return n?R.slice(0,n):R}getUserPromptsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,platformSource:i}=t,a=s==="relevance",d=a?"":`ORDER BY up.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,_=n?`LIMIT ${n}`:"",u=e.map(()=>"?").join(","),m=[...e],p=[];o&&(p.push("s.project = ?"),m.push(o)),i&&(p.push(`COALESCE(NULLIF(s.platform_source, ''), '${l}') = ?`),m.push(C(i)));let g=p.length>0?`AND ${p.join(" AND ")}`:"",h=this.db.prepare(`
      SELECT
        up.*,
        s.project,
        s.memory_session_id,
      ...
      ${d}
      ${_}
    `).all(...m);if(!a)return h;let f=new Map(h.map(R=>[R.id,R]));return e.map(R=>f.get(R)).filter(R=>!!R)}getTimelineAroundTimestamp(e,t=10,s=10,n,o){return this.getTimelineAroundObservation(null,e,t,s,n,o)}getTimelineAroundObservation(e,t,s=10,n=10,o,i){let a=i?C(i):void 0,d=(b,A)=>{let O=[],M=[];return o&&(O.push(`${b}.project = ?`),M.push(o)),a&&(O.push(`COALESCE(NULLIF(${A}.platform_source, ''), '${l}') = ?`),M.push(a)),{clause:O.length>0?`AND ${O.join(" AND ")}`:"",params:M}},_=d("o","src"),u=d("ss","src"),m=d("s","s"),p,g;if(e!==null){let b=`
      ...
      `,A=`
        ...
        LIMIT ?
      `;try{let O=this.db.prepare(b).all(t,..._.params,s),M=this.db.prepare(A).all(t,..._.params,n+1);if(O.length===0&&M.length===0)return{observations:[],sessions:[],prompts:[]};p=O.length>0?O[O.length-1].created_at_epoch:t,g=M.length>0?M[M.length-1].created_at_epoch:t}catch(O){return O instanceof Error?E.error("DB","Error getting boundary timestamps",{project:o},O):E.error("DB","Error getting boundary timestamps with non-Error",{},new Error(String(O))),{observations:[],sessions:[],prompts:[]}}}let N=`
      SELECT o.*
      FROM observations o
      LEFT JOIN sdk_sessions src ON src.memory_session_id = o.memory_session_id
...
`}function kt(r,e,t,s){let n=[];return s?n.push(...Ot(r)):n.push(...Et(r)),s?n.push(...ht()):n.push(...ut()),s&&(n.push(...Nt()),n.push(...It())),ne(t)&&(s?n.push(...At(e,t)):n.push(...ct(e,t))),n}var Oe=B(require("path"),1);function de(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return E.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e instanceof Error?e:new Error(String(e))),[]}}function he(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function Ne(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function Pt(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function wt(r,e){return Oe.default.isAbsolute(r)?Oe.default.relative(e,r):r}function Ft(r,e,t){let s=de(r);if(s.length>0)return wt(s[0],e);if(t){let n=de(t);if(n.length>0)return wt(n[0],e)}return"General"}function vs(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=Pt(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function $t(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?de(r.facts).join(`
`):null}function Us(r,e,t,s){let n=[];n.push(...mt(r));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=he(a.displayTime);n.push(...gt(a,d))}else{let a=i.data,d=Ne(a.created_at),u=d!==o?d:"";if(o=d,t.has(a.id)){let p=$t(a,s);n.push(...Tt(a,u,p,s))}else n.push(lt(a,u,s))}return n}function xs(r,e,t,s,n){let o=[];o.push(...Lt(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let _=d.data,u=he(_.displayTime);o.push(...yt(_,u))}else{let _=d.data,u=Ft(_.files_modified,n,_.files_read),m=Ne(_.created_at),p=m!==a;a=m;let g=t.has(_.id);if(u!==i&&(o.push(...Ct(u)),i=u),g){let N=$t(_,s);o.push(...Mt(_,m,p,N,s))}else o.push(Dt(_,m,p,s))}return o.push(""),o}function ks(r,e,t,s,n,o){return o?xs(r,e,t,s,n):Us(r,e,t,s)}function Ht(r,e,t,s,n){let o=[],i=vs(r);for(let[a,d]of i)o.push(...ks(a,d,e,t,s,n));return o}function Gt(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function Xt(r,e){let t=[];return e?(t.push(...K("Investigated",r.investigated,c.blue)),t.push(...K("Learned",r.learned,c.yellow)),t.push(...K("Completed",r.completed,c.green)),t.push(...K("Next Steps",r.next_steps,c.magenta))):(t.push(...Y("Investigated",r.investigated)),t.push(...Y("Learned",r.learned)),t.push(...Y("Completed",r.completed)),t.push(...Y("Next Steps",r.next_steps))),t}function Bt(r,e){return e?vt(r):St(r)}function jt(r,e,t){return!ne(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?Ut(r.totalDiscoveryTokens,r.totalReadTokens):ft(r.totalDiscoveryTokens,r.totalReadTokens)}var ws=Wt.default.join((0,Vt.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function Ps(){try{return new z}catch(r){if(r instanceof Error&&r.code==="ERR_DLOPEN_FAILED"){try{(0,qt.unlinkSync)(ws)}catch(e){e instanceof Error?E.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):E.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return E.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function Fs(r,e){return e?xt(r):Rt(r)}function $s(r,e,t,s,n,o,i){let a=[],d=be(e);a.push(...kt(r,d,s,i));let _=t.slice(0,s.sessionCount),u=it(_,t),m=at(e,u),p=dt(e,s.fullObservationCount);a.push(...Ht(m,p,s,n,i));let g=t[0],N=e[0];Gt(s,g,N)&&a.push(...Xt(g,i));let h=ot(e,s,o,n);return a.push(...Bt(h,i)),a.push(...jt(d,s,i)),a.join(`
`).trimEnd()}var Hs=new Set(["bugfix","discovery","decision","refactor"]);function Gs(r,e,t){let s=be(r),n={bugfix:0,discovery:0,decision:0,refactor:0,other:0},o=new Set,i=Number.POSITIVE_INFINITY;for(let d of r){let _=Hs.has(d.type)?d.type:"other";n[_]++,d.memory_session_id&&o.add(d.memory_session_id),d.created_at_epoch&&d.created_at_epoch<i&&(i=d.created_at_epoch)}let a=Number.isFinite(i)?Math.max(0,Math.floor((Date.now()-i)/864e5)):0;return{observation_count:r.length,session_count:o.size,timeline_depth_days:a,has_session_summary:e.length>0,obs_type_bugfix:n.bugfix,obs_type_discovery:n.discovery,obs_type_decision:n.decision,obs_type_refactor:n.refactor,obs_type_other:n.other,tokens_injected:s.totalReadTokens,tokens_saved_vs_naive:s.savings,search_strategy:t?"full":"timeline"}}async function Ie(r,e=!1){let t=ze(),s=r?.cwd??process.cwd(),n=Je(s),o=r?.projects?.length?r.projects:n.allProjects,i=o[o.length-1]??n.primary;r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let a=Ps();if(!a)return{text:"",stats:null};try{let d=r?.platformSource?C(r.platformSource):void 0,_=o.length>1?o:[i],u=rt(a,_,t,d),m=nt(a,_,t,d);return u.length===0&&m.length===0?{text:Fs(i,e),stats:null}:{text:$s(i,u,m,t,s,r?.session_id,e),stats:Gs(u,m,!!r?.full)}}finally{a.close()}}async function Yt(r,e=!1){return(await Ie(r,e)).text}0&&(module.exports={generateContext,generateContextWithStats});
