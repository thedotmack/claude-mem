"use strict";var Ps=Object.create;var H=Object.defineProperty;var $s=Object.getOwnPropertyDescriptor;var Xs=Object.getOwnPropertyNames;var Gs=Object.getPrototypeOf,Hs=Object.prototype.hasOwnProperty;var Bs=(n,e)=>{for(var s in e)H(n,s,{get:e[s],enumerable:!0})},Te=(n,e,s,t)=>{if(e&&typeof e=="object"||typeof e=="function")for(let r of Xs(e))!Hs.call(n,r)&&r!==s&&H(n,r,{get:()=>e[r],enumerable:!(t=$s(e,r))||t.enumerable});return n};var x=(n,e,s)=>(s=n!=null?Ps(Gs(n)):{},Te(e||!n||!n.__esModule?H(s,"default",{value:n,enumerable:!0}):s,n)),js=n=>Te(H({},"__esModule",{value:!0}),n);var ft={};Bs(ft,{generateContext:()=>Fs,generateContextWithStats:()=>le});module.exports=js(ft);var xs=x(require("path"),1),ks=require("os"),ws=require("fs");var de=require("bun:sqlite");var f=require("path"),ee=require("os"),U=require("fs"),ge=require("url"),Js={};function Ws(){return typeof __dirname<"u"?__dirname:(0,f.dirname)((0,ge.fileURLToPath)(Js.url))}var Vs=Ws();function Ks(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let n=(0,f.join)((0,ee.homedir)(),".claude-mem"),e=(0,f.join)(n,"settings.json");try{if((0,U.existsSync)(e)){let s=JSON.parse((0,U.readFileSync)(e,"utf-8")),t=s.env??s;if(t.CLAUDE_MEM_DATA_DIR)return t.CLAUDE_MEM_DATA_DIR}}catch{}return n}var N=Ks(),se=process.env.CLAUDE_CONFIG_DIR||(0,f.join)((0,ee.homedir)(),".claude"),bt=(0,f.join)(se,"plugins","marketplaces","thedotmack"),Ys=(0,f.join)(N,"logs"),ht=(0,f.join)(N,"settings.json"),Se=(0,f.join)(N,"claude-mem.db"),qs=(0,f.join)(N,"observer-sessions"),te=(0,f.basename)(qs);function fe(n){(0,U.mkdirSync)(n,{recursive:!0})}function Oe(){return(0,f.join)(Vs,"..")}var k={dataDir:()=>N,workerPid:()=>(0,f.join)(N,"worker.pid"),serverPid:()=>(0,f.join)(N,".server-beta.pid"),serverPort:()=>(0,f.join)(N,".server-beta.port"),serverRuntime:()=>(0,f.join)(N,".server-beta.runtime.json"),settings:()=>(0,f.join)(N,"settings.json"),database:()=>(0,f.join)(N,"claude-mem.db"),chroma:()=>(0,f.join)(N,"chroma"),combinedCerts:()=>(0,f.join)(N,"combined_certs.pem"),transcriptsConfig:()=>(0,f.join)(N,"transcript-watch.json"),transcriptsState:()=>(0,f.join)(N,"transcript-watch-state.json"),corpora:()=>(0,f.join)(N,"corpora"),supervisorRegistry:()=>(0,f.join)(N,"supervisor.json"),envFile:()=>(0,f.join)(N,".env"),logsDir:()=>Ys};var v=require("fs"),Re=require("path");var Qs=null;function zs(n){return(Qs??process.stderr.write.bind(process.stderr))(n)}function re(n){zs(n)}var oe=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(oe||{}),ne=null,ie=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=k.logsDir();(0,v.existsSync)(e)||(0,v.mkdirSync)(e,{recursive:!0});let s=new Date().toISOString().split("T")[0];this.logFilePath=(0,Re.join)(e,`claude-mem-${s}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=k.settings();if((0,v.existsSync)(e)){let s=(0,v.readFileSync)(e,"utf-8"),r=(JSON.parse(s).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=oe[r]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`)}debug(e,s,t,r){this.log(0,e,s,t,r)}info(e,s,t,r){this.log(1,e,s,t,r)}warn(e,s,t,r){this.log(2,e,s,t,r)}setErrorSink(e){ne=e}error(e,s,t,r){this.log(3,e,s,t,r),this.routeErrorToSink(s,t,r)}routeErrorToSink(e,s,t){try{if(!ne||!(t instanceof Error))return;ne(t)}catch{}}dataIn(e,s,t,r){this.info(e,`\u2192 ${s}`,t,r)}dataOut(e,s,t,r){this.info(e,`\u2190 ${s}`,t,r)}success(e,s,t,r){this.info(e,`\u2713 ${s}`,t,r)}failure(e,s,t,r){this.error(e,`\u2717 ${s}`,t,r)}},_=new ie;var be=require("crypto");function he(n,e,s){return(0,be.createHash)("sha256").update([n||"",e||"",s||""].join("\0")).digest("hex").slice(0,16)}var p="claude";function Zs(n){return n.trim().toLowerCase().replace(/\s+/g,"-")}function I(n){if(!n)return p;let e=Zs(n);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:p}function Ae(n){let e=["claude","codex","cursor"];return[...n].sort((s,t)=>{let r=e.indexOf(s),o=e.indexOf(t);return r!==-1||o!==-1?r===-1?1:o===-1?-1:r-o:s.localeCompare(t)})}function Ne(n,e,s,t,r){let o=Date.now()-t,i=r!==void 0?"up.session_db_id = ?":"up.content_session_id = ?",a=r??e;return n.prepare(`
  ...
  `).get(a,s,o)??void 0}var Le=["private","claude-mem-context","system_instruction","system-instruction","persisted-output","system-reminder"],Ie=new RegExp(`<(${Le.join("|")})\\b[^>]*>[\\s\\S]*?</\\1>`,"g"),De=/<system-reminder>[\s\S]*?<\/system-reminder>/g,Ce=100;function et(n){let e=Object.fromEntries(Le.map(r=>[r,0]));Ie.lastIndex=0;let s=0,t=n.replace(Ie,(r,o)=>(e[o]=(e[o]??0)+1,s+=1,""));return s>Ce&&_.warn("SYSTEM","tag count exceeds limit",void 0,{tagCount:s,maxAllowed:Ce,contentLength:n.length}),{stripped:t.trim(),counts:e}}function Me(n){return et(n).stripped}var st=["task-notification"],xt=new RegExp(`^\\s*<(${st.join("|")})\\b[^>]*>(?:(?!<\\1\\b|</\\1\\b)[\\s\\S])*</\\1>\\s*$`),kt=256*1024;var ae=4e3;function B(n){let e=n.trim(),t=Me(n).trim()||e;return t.length<=ae?t:(_.debug("DB","Truncated stored prompt text to the configured cap",{originalLength:t.length,storedLength:ae}),`${t.slice(0,ae-1)}\u2026`)}var j=class{db;constructor(e=Se){e instanceof de.Database?this.db=e:(e!==":memory:"&&fe(N),this.db=new de.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.db.run("PRAGMA journal_size_limit = 4194304")),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn(),this.ensureSDKSessionsPlatformContentIdentity(),this.ensureUserPromptsSessionDbId(),this.ensurePendingMessagesSessionToolUniqueIndex()}getIndexColumns(e){return this.db.query(`PRAGMA index_info(${JSON.stringify(e)})`).all().map(s=>s.name)}hasUniqueIndexOnColumns(e,s){return this.db.query(`PRAGMA index_list(${e})`).all().some(r=>{if(r.unique!==1)return!1;let o=this.getIndexColumns(r.name);return o.length===s.length&&o.every((i,a)=>i===s[a])})}resolvePromptSessionDbId(e,s,t){if(s!==void 0)return s;let r=t?I(t):void 0;return r?this.db.prepare(`
    ...
    `).all(te),s=[],t=new Set,r={};for(let i of e){let a=I(i.platform_source);r[a]||(r[a]=[]),r[a].includes(i.project)||r[a].push(i.project),t.has(i.project)||(t.add(i.project),s.push(i.project))}let o=Ae(Object.keys(r));return{projects:s,sources:o,projectsBySource:Object.fromEntries(o.map(i=>[i,r[i]||[]]))}}getLatestUserPrompt(e,s){let t=this.resolvePromptSessionDbId(e,s),r=t!==null?"up.session_db_id = ?":"up.content_session_id = ?",o=t!==null?t:e;return this.db.prepare(`
      ...
      ORDER BY up.created_at_epoch DESC
      LIMIT 1
    `).get(o)}findRecentDuplicateUserPrompt(e,s,t,r){return Ne(this.db,e,B(s),t,this.resolvePromptSessionDbId(e,r)??void 0)}getRecentSessionsWithStatus(e,s=3,t){let r=[e],o="";return t&&(o=`AND COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`,r.push(I(t))),r.push(s),this.db.prepare(`
      SELECT * FROM (
        SELECT
          s.memory_session_id,
          s.status,
    ...
    `).get(e,I(s))||null:this.db.prepare(`
      ...
      ${l}
      ${c}
    `).all(...h);if(!m)return C;let y=new Map(C.map(A=>[A.id,A])),O=e.map(A=>y.get(A)).filter(A=>!!A);return r?O.slice(0,r):O}getSummaryForSession(e,s){let t=[e],r="";return s&&(r=`
        AND EXISTS (
          SELECT 1
    ...
    `).get(e).count}createSDKSession(e,s,t,r,o){let i=new Date,a=i.getTime(),d=o?I(o):p,u=B(t),m=this.db.prepare(`
    ...
    `).run(e,s,t.request,t.investigated,t.learned,t.completed,t.next_steps,t.notes,r||null,o,d,a);return{id:Number(m.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,s,t,r,o,i=0,a,d){let u=a??Date.now(),m=new Date(u).toISOString();return this.db.transaction(()=>{let c=[],T=this.db.prepare(`
      ...
      ${d}
      ${u}
    `).all(...l);if(!a)return b;let g=new Map(b.map(C=>[C.id,C])),S=e.map(C=>g.get(C)).filter(C=>!!C);return r?S.slice(0,r):S}getUserPromptsByIds(e,s={}){if(e.length===0)return[];let{orderBy:t="date_desc",limit:r,project:o,platformSource:i}=s,a=t==="relevance",d=a?"":`ORDER BY up.created_at_epoch ${t==="date_asc"?"ASC":"DESC"}`,u=r?`LIMIT ${r}`:"",m=e.map(()=>"?").join(","),l=[...e],c=[];o&&(c.push("s.project = ?"),l.push(o)),i&&(c.push(`COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`),l.push(I(i)));let T=c.length>0?`AND ${c.join(" AND ")}`:"",b=this.db.prepare(`
      SELECT
        up.*,
        s.project,
        s.memory_session_id,
      ...
      ${d}
      ${u}
    `).all(...l);if(!a)return b;let g=new Map(b.map(S=>[S.id,S]));return e.map(S=>g.get(S)).filter(S=>!!S)}getTimelineAroundTimestamp(e,s=10,t=10,r,o){return this.getTimelineAroundObservation(null,e,s,t,r,o)}getTimelineAroundObservation(e,s,t=10,r=10,o,i){let a=i?I(i):void 0,d=(O,A)=>{let R=[],L=[];return o&&(R.push(`${O}.project = ?`),L.push(o)),a&&(R.push(`COALESCE(NULLIF(${A}.platform_source, ''), '${p}') = ?`),L.push(a)),{clause:R.length>0?`AND ${R.join(" AND ")}`:"",params:L}},u=d("o","src"),m=d("ss","src"),l=d("s","s"),c,T;if(e!==null){let O=`
      ...
      `,A=`
        ...
        ORDER BY o.id ASC
        LIMIT ?
      `;try{let R=this.db.prepare(O).all(e,...u.params,t+1),L=this.db.prepare(A).all(e,...u.params,r+1);if(R.length===0&&L.length===0)return{observations:[],sessions:[],prompts:[]};c=R.length>0?R[R.length-1].created_at_epoch:s,T=L.length>0?L[L.length-1].created_at_epoch:s}catch(R){return R instanceof Error?_.error("DB","Error getting boundary observations",{project:o},R):_.error("DB","Error getting boundary observations with non-Error",{},new Error(String(R))),{observations:[],sessions:[],prompts:[]}}}else{let O=`
    ...
    ORDER BY o.created_at_epoch DESC
    LIMIT ?
  `).all(...e,...e,t??null,t??null,...r,...i,s.totalObservationCount)}function Ke(n,e,s,t){let r=e.map(()=>"?").join(",");return n.db.prepare(`
    SELECT
      ss.id,
    ...
    LIMIT ?
  `).all(...e,...e,t??null,t??null,s.sessionCount+Be)}function ot(n){return n.replace(/[/.]/g,"-")}function it(n){if(!n.includes('"type":"assistant"'))return null;let e=JSON.parse(n);if(e.type==="assistant"&&e.message?.content&&Array.isArray(e.message.content)){let s="";for(let t of e.message.content)t.type==="text"&&(s+=t.text);if(s=s.replace(De,"").trim(),s)return s}return null}function at(n){for(let e=n.length-1;e>=0;e--)try{let s=it(n[e]);if(s)return s}catch(s){s instanceof Error?_.debug("WORKER","Skipping malformed transcript line",{lineIndex:e},s):_.debug("WORKER","Skipping malformed transcript line",{lineIndex:e,error:String(s)});continue}return""}function dt(n){try{if(!(0,J.existsSync)(n))return{assistantMessage:""};let e=(0,J.readFileSync)(n,"utf-8").trim();if(!e)return{assistantMessage:""};let s=e.split(`
`).filter(r=>r.trim());return{assistantMessage:at(s)}}catch(e){return e instanceof Error?_.failure("WORKER","Failed to extract prior messages from transcript",{transcriptPath:n},e):_.warn("WORKER","Failed to extract prior messages from transcript",{transcriptPath:n,error:String(e)}),{assistantMessage:""}}}function Ye(n,e,s,t){if(!e.showLastMessage||n.length===0)return{assistantMessage:""};let r=n.find(d=>d.memory_session_id!==s);if(!r)return{assistantMessage:""};let o=r.memory_session_id,i=ot(t),a=We.default.join(se,"projects",i,`${o}.jsonl`);return dt(a)}function qe(n,e){let s=e[0]?.id;return n.map((t,r)=>{let o=r===0?null:e[r+1];return{...t,displayEpoch:o?o.created_at_epoch:t.created_at_epoch,displayTime:o?o.created_at:t.created_at,shouldShowLink:t.id!==s}})}function Je(n,e){let s=[...n.map(t=>({type:"observation",data:t})),...e.map(t=>({type:"summary",data:t}))];return s.sort((t,r)=>{let o=t.type==="observation"?t.data.created_at_epoch:t.data.displayEpoch,i=r.type==="observation"?r.data.created_at_epoch:r.data.displayEpoch;return o-i}),s}function Qe(n,e){return new Set(n.slice(0,e).map(s=>s.id))}function ze(){let n=new Date,e=n.toLocaleDateString("en-CA"),s=n.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),t=n.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${s} ${t}`}function Ze(n){return[`# [${n}] recent context, ${ze()}`,""]}function es(){return[`Legend: \u{1F3AF}session ${D.getInstance().getActiveMode().observation_types.map(s=>`${s.emoji}${s.id}`).join(" ")}`,"Format: ID TIME TYPE TITLE","Fetch details: get_observations([IDs]) | Search: mem-search skill",""]}function ss(n,e){let s=[],t=[`${n.totalObservations} obs (${n.totalReadTokens.toLocaleString()}t read)`,`${n.totalDiscoveryTokens.toLocaleString()}t work`];return n.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)&&(e.showSavingsPercent?t.push(`${n.savingsPercent}% savings`):e.showSavingsAmount&&t.push(`${n.savings.toLocaleString()}t saved`)),s.push(`Stats: ${t.join(" | ")}`),s.push(""),s}function ts(n){return[`### ${n}`]}function rs(n){return n.toLowerCase().replace(" am","a").replace(" pm","p")}function ns(n,e,s){let t=n.title||"Untitled",r=D.getInstance().getTypeIcon(n.type),o=e?rs(e):'"';return`${n.id} ${o} ${r} ${t}`}function os(n,e,s,t){let r=[],o=n.title||"Untitled",i=D.getInstance().getTypeIcon(n.type),a=e?rs(e):'"',{readTokens:d,discoveryDisplay:u}=$(n,t);r.push(`**${n.id}** ${a} ${i} **${o}**`),s&&r.push(s);let m=[];return t.showReadTokens&&m.push(`~${d}t`),t.showWorkTokens&&m.push(u),m.length>0&&r.push(m.join(" ")),r.push(""),r}function is(n,e){return[`S${n.id} ${n.request||"Session started"} (${e})`]}function X(n,e){return e?[`**${n}**: ${e}`,""]:[]}function as(n){return n.assistantMessage?["","---","","**Previously**","",`A: ${n.assistantMessage}`,""]:[]}function ds(n,e){return["",`Access ${Math.round(n/1e3)}k tokens of past work via get_observations([IDs]) or mem-search skill.`]}function _s(n){return`# [${n}] recent context, ${ze()}

No previous sessions found.`}function Es(){let n=new Date,e=n.toLocaleDateString("en-CA"),s=n.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),t=n.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${s} ${t}`}function us(n){return["",`${E.bright}${E.cyan}[${n}] recent context, ${Es()}${E.reset}`,`${E.gray}${"\u2500".repeat(60)}${E.reset}`,""]}function ms(){let e=D.getInstance().getActiveMode().observation_types.map(s=>`${s.emoji} ${s.id}`).join(" | ");return[`${E.dim}Legend: session-request | ${e}${E.reset}`,""]}function ps(){return[`${E.bright}Column Key${E.reset}`,`${E.dim}  Read: Tokens to read this observation (cost to learn it now)${E.reset}`,`${E.dim}  Work: Tokens spent on work that produced this record ( research, building, deciding)${E.reset}`,""]}function cs(){return[`${E.dim}Context Index: This semantic index (titles, types, files, tokens) is usually sufficient to understand past work.${E.reset}`,"",`${E.dim}When you need implementation details, rationale, or debugging context:${E.reset}`,`${E.dim}  - Fetch by ID: get_observations([IDs]) for observations visible in this index${E.reset}`,`${E.dim}  - Search history: Use the mem-search skill for past decisions, bugs, and deeper research${E.reset}`,`${E.dim}  - Trust this index over re-reading code for past decisions and learnings${E.reset}`,""]}function ls(n,e){let s=[];if(s.push(`${E.bright}${E.cyan}Context Economics${E.reset}`),s.push(`${E.dim}  Loading: ${n.totalObservations} observations (${n.totalReadTokens.toLocaleString()} tokens to read)${E.reset}`),s.push(`${E.dim}  Work investment: ${n.totalDiscoveryTokens.toLocaleString()} tokens spent on research, building, and decisions${E.reset}`),n.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)){let t="  Your savings: ";e.showSavingsAmount&&e.showSavingsPercent?t+=`${n.savings.toLocaleString()} tokens (${n.savingsPercent}% reduction from reuse)`:e.showSavingsAmount?t+=`${n.savings.toLocaleString()} tokens`:t+=`${n.savingsPercent}% reduction from reuse`,s.push(`${E.green}${t}${E.reset}`)}return s.push(""),s}function Ts(n){return[`${E.bright}${E.cyan}${n}${E.reset}`,""]}function gs(n){return[`${E.dim}${n}${E.reset}`]}function Ss(n,e,s,t){let r=n.title||"Untitled",o=D.getInstance().getTypeIcon(n.type),{readTokens:i,discoveryTokens:a,workEmoji:d}=$(n,t),u=s?`${E.dim}${e}${E.reset}`:" ".repeat(e.length),m=t.showReadTokens&&i>0?`${E.dim}(~${i}t)${E.reset}`:"",l=t.showWorkTokens&&a>0?`${E.dim}(${d} ${a.toLocaleString()}t)${E.reset}`:"";return`  ${E.dim}#${n.id}${E.reset}  ${u}  ${o}  ${r} ${m} ${l}`}function fs(n,e,s,t,r){let o=[],i=n.title||"Untitled",a=D.getInstance().getTypeIcon(n.type),{readTokens:d,discoveryTokens:u,workEmoji:m}=$(n,r),l=s?`${E.dim}${e}${E.reset}`:" ".repeat(e.length),c=r.showReadTokens&&d>0?`${E.dim}(~${d}t)${E.reset}`:"",T=r.showWorkTokens&&u>0?`${E.dim}(${m} ${u.toLocaleString()}t)${E.reset}`:"";return o.push(`  ${E.dim}#${n.id}${E.reset}  ${l}  ${a}  ${E.bright}${i}${E.reset}`),t&&o.push(`    ${E.dim}${t}${E.reset}`),(c||T)&&o.push(`    ${c} ${T}`),o.push(""),o}function Os(n,e){let s=`${n.request||"Session started"} (${e})`;return[`${E.yellow}#S${n.id}${E.reset} ${s}`,""]}function G(n,e,s){return e?[`${s}${n}:${E.reset} ${e}`,""]:[]}function Rs(n){return n.assistantMessage?["","---","",`${E.bright}${E.magenta}Previously${E.reset}`,"",`${E.dim}A: ${n.assistantMessage}${E.reset}`,""]:[]}function bs(n,e){let s=Math.round(n/1e3);return["",`${E.dim}Access ${s}k tokens of past research & decisions for just ${e.toLocaleString()}t. Use the claude-mem skill to access memories by ID.${E.reset}`]}function hs(n){return`
${E.bright}${E.cyan}[${n}] recent context, ${Es()}${E.reset}
${E.gray}${"\u2500".repeat(60)}${E.reset}

${E.dim}No previous sessions found for this project yet.${E.reset}
`}function As(n,e,s,t){let r=[];return t?r.push(...us(n)):r.push(...Ze(n)),t?r.push(...ms()):r.push(...es()),t&&(r.push(...ps()),r.push(...cs())),q(s)&&(t?r.push(...ls(e,s)):r.push(...ss(e,s))),r}var me=x(require("path"),1);function Z(n){if(!n)return[];try{let e=JSON.parse(n);return Array.isArray(e)?e:[]}catch(e){return _.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:n?.substring(0,50)},e instanceof Error?e:new Error(String(e))),[]}}function pe(n){return new Date(n).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function ce(n){return new Date(n).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function Is(n){return new Date(n).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function Ns(n,e){return me.default.isAbsolute(n)?me.default.relative(e,n):n}function Cs(n,e,s){let t=Z(n);if(t.length>0)return Ns(t[0],e);if(s){let r=Z(s);if(r.length>0)return Ns(r[0],e)}return"General"}function _t(n){let e=new Map;for(let t of n){let r=t.type==="observation"?t.data.created_at:t.data.displayTime,o=Is(r);e.has(o)||e.set(o,[]),e.get(o).push(t)}let s=Array.from(e.entries()).sort((t,r)=>{let o=new Date(t[0]).getTime(),i=new Date(r[0]).getTime();return o-i});return new Map(s)}function Ls(n,e){return e.fullObservationField==="narrative"?n.narrative:n.facts?Z(n.facts).join(`
`):null}function Et(n,e,s,t){let r=[];r.push(...ts(n));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=pe(a.displayTime);r.push(...is(a,d))}else{let a=i.data,d=ce(a.created_at),m=d!==o?d:"";if(o=d,s.has(a.id)){let c=Ls(a,t);r.push(...os(a,m,c,t))}else r.push(ns(a,m,t))}return r}function ut(n,e,s,t,r){let o=[];o.push(...Ts(n));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let u=d.data,m=pe(u.displayTime);o.push(...Os(u,m))}else{let u=d.data,m=Cs(u.files_modified,r,u.files_read),l=ce(u.created_at),c=l!==a;a=l;let T=s.has(u.id);if(m!==i&&(o.push(...gs(m)),i=m),T){let h=Ls(u,t);o.push(...fs(u,l,c,h,t))}else o.push(Ss(u,l,c,t))}return o.push(""),o}function mt(n,e,s,t,r,o){return o?ut(n,e,s,t,r):Et(n,e,s,t)}function Ds(n,e,s,t,r){let o=[],i=_t(n);for(let[a,d]of i)o.push(...mt(a,d,e,s,t,r));return o}function Ms(n,e,s){return!(!n.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||s&&e.created_at_epoch<=s.created_at_epoch)}function vs(n,e){let s=[];return e?(s.push(...G("Investigated",n.investigated,E.blue)),s.push(...G("Learned",n.learned,E.yellow)),s.push(...G("Completed",n.completed,E.green)),s.push(...G("Next Steps",n.next_steps,E.magenta))):(s.push(...X("Investigated",n.investigated)),s.push(...X("Learned",n.learned)),s.push(...X("Completed",n.completed)),s.push(...X("Next Steps",n.next_steps))),s}function ys(n,e){return e?Rs(n):as(n)}function Us(n,e,s){return!q(e)||n.totalDiscoveryTokens<=0||n.savings<=0?[]:s?bs(n.totalDiscoveryTokens,n.totalReadTokens):ds(n.totalDiscoveryTokens,n.totalReadTokens)}var pt=xs.default.join((0,ks.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function ct(){try{return new j}catch(n){if(n instanceof Error&&n.code==="ERR_DLOPEN_FAILED"){try{(0,ws.unlinkSync)(pt)}catch(e){e instanceof Error?_.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):_.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return _.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw n}}function lt(n,e){return e?hs(n):_s(n)}function Tt(n,e,s,t,r,o,i){let a=[],d=ue(e);a.push(...As(n,d,t,i));let u=s.slice(0,t.sessionCount),m=qe(u,s),l=Je(e,m),c=Qe(e,t.fullObservationCount);a.push(...Ds(l,c,t,r,i));let T=s[0],h=e[0];Ms(t,T,h)&&a.push(...vs(T,i));let b=Ye(e,t,o,r);return a.push(...ys(b,i)),a.push(...Us(d,t,i)),a.join(`
`).trimEnd()}var gt=new Set(["bugfix","discovery","decision","refactor"]);function St(n,e,s){let t=ue(n),r={bugfix:0,discovery:0,decision:0,refactor:0,other:0},o=new Set,i=Number.POSITIVE_INFINITY;for(let d of n){let u=gt.has(d.type)?d.type:"other";r[u]++,d.memory_session_id&&o.add(d.memory_session_id),d.created_at_epoch&&d.created_at_epoch<i&&(i=d.created_at_epoch)}let a=Number.isFinite(i)?Math.max(0,Math.floor((Date.now()-i)/864e5)):0;return{observation_count:n.length,session_count:o.size,timeline_depth_days:a,has_session_summary:e.length>0,obs_type_bugfix:r.bugfix,obs_type_discovery:r.discovery,obs_type_decision:r.decision,obs_type_refactor:r.refactor,obs_type_other:r.other,tokens_injected:t.totalReadTokens,tokens_saved_vs_naive:t.savings,search_strategy:s?"full":"timeline"}}async function le(n,e=!1){let s=Ge(),t=n?.cwd??process.cwd(),r=we(t),o=n?.projects?.length?n.projects:r.allProjects,i=o[o.length-1]??r.primary;n?.full&&(s.totalObservationCount=999999,s.sessionCount=999999);let a=ct();if(!a)return{text:"",stats:null};try{let d=n?.platformSource?I(n.platformSource):void 0,u=o.length>1?o:[i],m=Ve(a,u,s,d),l=Ke(a,u,s,d);return m.length===0&&l.length===0?{text:lt(i,e),stats:null}:{text:Tt(i,m,l,s,t,n?.session_id,e),stats:St(m,l,!!n?.full)}}finally{a.close()}}async function Fs(n,e=!1){return(await le(n,e)).text}0&&(module.exports={generateContext,generateContextWithStats});
