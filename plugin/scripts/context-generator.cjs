...
`)}finally{if(u!==void 0)try{(0,f.closeSync)(u)}catch{}}}}catch(_){if(d!==void 0)try{(0,f.closeSync)(d)}catch{}try{(0,f.unlinkSync)(o)}catch{}throw _}}var ps={};function us(){return typeof __dirname<"u"?__dirname:(0,b.dirname)((0,ye.fileURLToPath)(ps.url))}var cs=us();function Es(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let n=(0,b.join)((0,ce.homedir)(),".claude-mem"),e=(0,b.join)(n,"settings.json");try{if((0,F.existsSync)(e)){let t=$((0,F.readFileSync)(e,"utf-8")),s=t.env??t;if(s.CLAUDE_MEM_DATA_DIR)return s.CLAUDE_MEM_DATA_DIR}}catch{}return n}var A=Es(),Ee=process.env.CLAUDE_CONFIG_DIR||(0,b.join)((0,ce.homedir)(),".claude"),Qs=(0,b.join)(Ee,"plugins","marketplaces","thedotmack"),ls=(0,b.join)(A,"logs"),zs=(0,b.join)(A,"settings.json"),De=(0,b.join)(A,"claude-mem.db"),ms=(0,b.join)(A,"observer-sessions"),le=(0,b.basename)(ms);function Me(n){(0,F.mkdirSync)(n,{recursive:!0})}function ve(){return(0,b.join)(cs,"..")}var G={dataDir:()=>A,workerPid:()=>(0,b.join)(A,"worker.pid"),serverPid:()=>(0,b.join)(A,".server-beta.pid"),serverPort:()=>(0,b.join)(A,".server-beta.port"),serverRuntime:()=>(0,b.join)(A,".server-beta.runtime.json"),settings:()=>(0,b.join)(A,"settings.json"),database:()=>(0,b.join)(A,"claude-mem.db"),chroma:()=>(0,b.join)(A,"chroma"),combinedCerts:()=>(0,b.join)(A,"combined_certs.pem"),transcriptsConfig:()=>(0,b.join)(A,"transcript-watch.json"),transcriptsState:()=>(0,b.join)(A,"transcript-watch-state.json"),corpora:()=>(0,b.join)(A,"corpora"),supervisorRegistry:()=>(0,b.join)(A,"supervisor.json"),envFile:()=>(0,b.join)(A,".env"),logsDir:()=>ls};var U=require("fs"),Ue=require("path");var pe=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(pe||{}),me=null,Te=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=G.logsDir();(0,U.existsSync)(e)||(0,U.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,Ue.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=G.settings();if((0,U.existsSync)(e)){let t=(0,U.readFileSync)(e,"utf-8"),r=($(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=pe[r]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
