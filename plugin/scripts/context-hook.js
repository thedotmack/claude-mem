...
No previous summaries found for this project yet.`;let n=[];e?(n.push(""),n.push(`${o.bright}${o.cyan}\u{1F4DD} [${r}] recent context${o.reset}`),n.push(`${o.gray}${"\u2500".repeat(60)}${o.reset}`)):(n.push(`# [${r}] recent context`),n.push(""));let c=null,_=!0;for(let a of d){c!==null&&a.sdk_session_id!==c?e?(n.push(""),n.push(`${o.dim}${"\u2500".repeat(23)} New Summary ${"\u2500".repeat(24)}${o.reset}`),n.push("")):(n.push(""),n.push("---"),n.push("")):_?e&&n.push(""):e?(n.push(`${o.gray}${"\u2500".repeat(60)}${o.reset}`),n.push("")):(n.push("---"),n.push("")),_=!1,a.request&&(e?(n.push(`${o.bright}${o.yellow}Request:${o.reset} ${a.request}`),n.push("")):(n.push(`**Request:** ${a.request}`),n.push(""))),a.learned&&(e?(n.push(`${o.bright}${o.blue}Learned:${o.reset} ${a.learned}`),n.push("")):(n.push(`**Learned:** ${a.learned}`),n.push(""))),a.completed&&(e?(n.push(`${o.bright}${o.green}Completed:${o.reset} ${a.completed}`),n.push("")):(n.push(`**Completed:** ${a.completed}`),n.push(""))),a.next_steps&&(e?(n.push(`${o.bright}${o.magenta}Next Steps:${o.reset} ${a.next_steps}`),n.push("")):(n.push(`**Next Steps:** ${a.next_steps}`),n.push("")));let S=i.db.prepare(`
        ...
        FROM observations
        WHERE sdk_session_id = ?
      `).all(a.sdk_session_id),T=new Set,f=new Set;for(let u of S){if(u.files_read)try{let l=JSON.parse(u.files_read);Array.isArray(l)&&l.forEach(g=>T.add(g))}catch{}if(u.files_modified)try{let l=JSON.parse(u.files_modified);Array.isArray(l)&&l.forEach(g=>f.add(g))}catch{}}T.size>0&&(e?n.push(`${o.dim}Files Read: ${Array.from(T).join(", ")}${o.reset}`):n.push(`**Files Read:** ${Array.from(T).join(", ")}`)),f.size>0&&(e?n.push(`${o.dim}Files Modified: ${Array.from(f).join(", ")}${o.reset}`):n.push(`**Files Modified:** ${Array.from(f).join(", ")}`));let N=new Date(a.created_at).toLocaleString();e?n.push(`${o.dim}Date: ${N}${o.reset}`):n.push(`**Date:** ${N}`),e||n.push(""),c=a.sdk_session_id}return e&&(n.push(""),n.push(`${o.gray}${"\u2500".repeat(60)}${o.reset}`)),n.join(`
