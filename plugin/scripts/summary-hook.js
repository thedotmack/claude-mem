#!/usr/bin/env node
import P from"better-sqlite3";import{join as p,basename as q}from"path";import{homedir as O}from"os";import{existsSync as Z,mkdirSync as w}from"fs";function X(){return __dirname}var M=X(),c=process.env.CLAUDE_MEM_DATA_DIR||p(O(),".claude-mem"),l=process.env.CLAUDE_CONFIG_DIR||p(O(),".claude"),ee=p(c,"archives"),se=p(c,"logs"),te=p(c,"trash"),re=p(c,"backups"),oe=p(c,"settings.json"),I=p(c,"claude-mem.db"),ne=p(l,"settings.json"),ie=p(l,"commands"),ae=p(l,"CLAUDE.md");function L(n){w(n,{recursive:!0})}function A(){return p(M,"..","..")}var T=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(T||{}),S=class{level;useColor;constructor(){let e=process.env.CLAUDE_MEM_LOG_LEVEL?.toUpperCase()||"INFO";this.level=T[e]??1,this.useColor=process.stdout.isTTY??!1}correlationId(e,s){return`obs-${e}-${s}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.level===0?`${e.message}
