...
"use strict";var B=Object.defineProperty;var me=Object.getOwnPropertyDescriptor;var Ee=Object.getOwnPropertyNames;var Te=Object.prototype.hasOwnProperty;var be=(i,e)=>{for(var t in e)B(i,t,{get:e[t],enumerable:!0})},fe=(i,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Ee(e))!Te.call(i,n)&&n!==t&&B(i,n,{get:()=>e[n],enumerable:!(s=me(e,n))||s.enumerable});return i};var ge=i=>fe(B({},"__esModule",{value:!0}),i);var Be={};be(Be,{SessionStore:()=>J});module.exports=ge(Be);var K=require("bun:sqlite"),le=require("crypto");var T=require("path"),G=require("os"),U=require("fs"),Q=require("url");var Ne=null;function Se(i){return(Ne??process.stderr.write.bind(process.stderr))(i)}function x(i){Se(i)}var He=process.platform==="win32";function he(i){return i.replace(/^\uFEFF/,"")}function F(i){return JSON.parse(he(i))}function Re(){return typeof __dirname<"u"?__dirname:(0,T.dirname)((0,Q.fileURLToPath)(__IMPORT_META_URL__))}var Ye=Re();function Ie(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let i=(0,T.join)((0,G.homedir)(),".claude-mem"),e=(0,T.join)(i,"settings.json");try{if((0,U.existsSync)(e)){let t=F((0,U.readFileSync)(e,"utf-8")),s=t.env??t;if(s.CLAUDE_MEM_DATA_DIR)return s.CLAUDE_MEM_DATA_DIR}}catch{}return i}var h=Ie(),Oe=process.env.CLAUDE_CONFIG_DIR||(0,T.join)((0,G.homedir)(),".claude"),Ae=(0,T.join)(Oe,"plugins","marketplaces","thedotmack"),Ke=process.env.CLAUDE_PLUGIN_ROOT||(0,T.join)(Ae,"plugin"),Le=(0,T.join)(h,"logs"),Je=(0,T.join)(h,"settings.json"),z=(0,T.join)(h,"claude-mem.db"),ye=(0,T.join)(h,"observer-sessions"),$=(0,T.basename)(ye);function Z(i){(0,U.mkdirSync)(i,{recursive:!0})}var j={dataDir:()=>h,workerPid:()=>(0,T.join)(h,"worker.pid"),serverPid:()=>(0,T.join)(h,".server-beta.pid"),serverPort:()=>(0,T.join)(h,".server-beta.port"),serverRuntime:()=>(0,T.join)(h,".server-beta.runtime.json"),settings:()=>(0,T.join)(h,"settings.json"),database:()=>(0,T.join)(h,"claude-mem.db"),chroma:()=>(0,T.join)(h,"chroma"),combinedCerts:()=>(0,T.join)(h,"combined_certs.pem"),transcriptsConfig:()=>(0,T.join)(h,"transcript-watch.json"),transcriptsState:()=>(0,T.join)(h,"transcript-watch-state.json"),corpora:()=>(0,T.join)(h,"corpora"),supervisorRegistry:()=>(0,T.join)(h,"supervisor.json"),envFile:()=>(0,T.join)(h,".env"),logsDir:()=>Le};var C=require("fs"),ee=require("path");var W=(r=>(r[r.DEBUG=0]="DEBUG",r[r.INFO=1]="INFO",r[r.WARN=2]="WARN",r[r.ERROR=3]="ERROR",r[r.SILENT=4]="SILENT",r))(W||{}),H=null,q=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=j.logsDir();(0,C.existsSync)(e)||(0,C.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,ee.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=j.settings();if((0,C.existsSync)(e)){let t=(0,C.readFileSync)(e,"utf-8"),n=(F(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=W[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`+JSON.stringify(r,null,2)}catch{c=" "+this.formatData(r)}else c=" "+this.formatData(r);let m="";if(n){let{sessionId:g,memorySessionId:R,correlationId:N,...y}=n;Object.keys(y).length>0&&(m=` {${Object.entries(y).map(([I,v])=>`${I}=${v}`).join(", ")}}`)}let b=`[${o}] [${a}] [${_}] ${u}${s}${m}${c}`;if(this.logFilePath)try{(0,C.appendFileSync)(this.logFilePath,b+`
`,"utf8")}catch(g){let R=g instanceof Error?g:new Error(String(g));x(`[LOGGER] Failed to write to log file: ${R.message}
${R.stack??""}
`)}else x(b+`
`)}debug(e,t,s,n){this.log(0,e,t,s,n)}info(e,t,s,n){this.log(1,e,t,s,n)}warn(e,t,s,n){this.log(2,e,t,s,n)}setErrorSink(e){H=e}error(e,t,s,n){this.log(3,e,t,s,n),this.routeErrorToSink(t,s,n)}routeErrorToSink(e,t,s){try{if(!H||!(s instanceof Error))return;H(s)}catch{}}dataIn(e,t,s,n){this.info(e,`\u2192 ${t}`,s,n)}dataOut(e,t,s,n){this.info(e,`\u2190 ${t}`,s,n)}success(e,t,s,n){this.info(e,`\u2713 ${t}`,s,n)}failure(e,t,s,n){this.error(e,`\u2717 ${t}`,s,n)}},d=new q;var se=require("crypto");function te(i,e,t){return(0,se.createHash)("sha256").update([i||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}var l="claude";function Ce(i){return i.trim().toLowerCase().replace(/\s+/g,"-")}function A(i){if(!i)return l;let e=Ce(i);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:l}function ne(i){let e=["claude","codex","cursor"];return[...i].sort((t,s)=>{let n=e.indexOf(t),r=e.indexOf(s);return n!==-1||r!==-1?n===-1?1:r===-1?-1:n-r:t.localeCompare(s)})}function re(i,e,t,s,n){let r=Date.now()-s,o=n!==void 0?"up.session_db_id = ?":"up.content_session_id = ?",a=n??e;return i.prepare(`
    SELECT
      up.*,
      s.memory_session_id,
      s.project,
    ...
    LIMIT 1
  `).get(a,t,r)??void 0}var ae=["private","claude-mem-context","system_instruction","system-instruction","persisted-output","system-reminder"],oe=new RegExp(`<(${ae.join("|")})\\b[^>]*>[\\s\\S]*?</\\1>`,"g");var ie=100;function ve(i){let e=Object.fromEntries(ae.map(n=>[n,0]));oe.lastIndex=0;let t=0,s=i.replace(oe,(n,r)=>(e[r]=(e[r]??0)+1,t+=1,""));return t>ie&&d.warn("SYSTEM","tag count exceeds limit",void 0,{tagCount:t,maxAllowed:ie,contentLength:i.length}),{stripped:s.trim(),counts:e}}function de(i){return ve(i).stripped}var De=["task-notification"],as=new RegExp(`^\\s*<(${De.join("|")})\\b[^>]*>(?:(?!<\\1\\b|</\\1\\b)[\\s\\S])*</\\1>\\s*$`),ds=256*1024;var V=4e3;function k(i){let e=i.trim(),s=de(i).trim()||e;return s.length<=V?s:(d.debug("DB","Truncated stored prompt text to the configured cap",{originalLength:s.length,storedLength:V}),`${s.slice(0,V-1)}\u2026`)}var Ue=require("bun:sqlite");var we=5e3,Me=4194304;function xe(i){return i.prepare(`
    SELECT name
    FROM sqlite_master
    WHERE type = 'table'
      AND name NOT LIKE 'sqlite_%'
    LIMIT 1
  `).get()!=null}function w(i,e,t){try{i.run(e)}catch(s){let n=s instanceof Error?s:new Error(String(s));throw d.warn("DB",`Failed to apply SQLite pragma ${t}`,{sql:e},n),s}}function _e(i,e={}){let{enableWal:t=!0,enableIncrementalAutoVacuum:s=!0}=e;w(i,`PRAGMA busy_timeout = ${we}`,"busy_timeout"),w(i,"PRAGMA foreign_keys = ON","foreign_keys"),w(i,"PRAGMA synchronous = NORMAL","synchronous"),w(i,`PRAGMA journal_size_limit = ${Me}`,"journal_size_limit"),s&&!xe(i)&&w(i,"PRAGMA auto_vacuum = INCREMENTAL","auto_vacuum"),t&&w(i,"PRAGMA journal_mode = WAL","journal_mode")}var ue=4096;var Fe=new Set(["set_title","set_prompt_session","remap_project"]),ke=/^(?:0|[1-9][0-9]*)$/,ce=18446744073709551615n;function L(i){throw d.debug("CLOUD_SYNC","Rejected invalid canonical content",{reason:i}),new Error(`canonical content: ${i}`)}function P(i,e={}){return typeof i!="string"||!ke.test(i)?L("decimal values must be unsigned base-10 strings without leading zeroes"):(BigInt(i)>ce&&L("decimal value exceeds uint64"),e.positive&&i==="0"&&L("decimal value must be positive"),i)}function pe(i){let e=P(i);return BigInt(e)===ce&&L("uint64 sequence overflow"),(BigInt(e)+1n).toString(10)}function Xe(i){(i===null||typeof i!="object"||Array.isArray(i))&&L("mutation must be an object");let e=i;if((typeof e.op!="string"||!Fe.has(e.op))&&L("unsupported mutation op"),e.op==="set_title"){let r=M(e,["fields","op","target"],"set_title"),o=X(r.target,["content_session_id","memory_session_id","platform_source"],"set_title.target");o.memory_session_id===void 0&&o.content_session_id===void 0&&L("set_title target requires a session identifier");for(let _ of["memory_session_id","content_session_id","platform_source"])o[_]!==void 0&&D(o[_],_);let a=M(r.fields,["custom_title"],"set_title.fields");D(a.custom_title,"custom_title");return}if(e.op==="set_prompt_session"){let r=M(e,["fields","op","target"],"set_prompt_session"),o=M(r.target,["origin_device_id","origin_local_id"],"set_prompt_session.target");Pe(o.origin_device_id),P(o.origin_local_id);let a=X(r.fields,["content_session_id","memory_session_id","platform_source","project"],"set_prompt_session.fields");D(a.memory_session_id,"memory_session_id");for(let _ of["content_session_id","platform_source","project"])a[_]!==void 0&&D(a[_],_);return}let t=M(e,["fields","op","where"],"remap_project"),s=X(t.where,["memory_session_id","merged_into_project_is_null","project"],"remap_project.where");s.project!==void 0&&D(s.project,"project"),s.memory_session_id!==void 0&&D(s.memory_session_id,"memory_session_id"),s.merged_into_project_is_null!==void 0&&s.merged_into_project_is_null!==!0&&L("merged_into_project_is_null may only be true"),Object.keys(s).length===0&&L("remap_project where is empty");let n=X(t.fields,["merged_into_project","project"],"remap_project.fields");n.project!==void 0&&D(n.project,"project"),n.merged_into_project!==void 0&&D(n.merged_into_project,"merged_into_project"),Object.keys(n).length===0&&L("remap_project fields are empty")}function Y(i){Xe(i)}function Pe(i){return typeof i!="string"||i.length===0||Buffer.byteLength(i,"utf8")>128?L("origin_device_id must be a non-empty string of at most 128 UTF-8 bytes"):i}function D(i,e){return typeof i!="string"||i.length===0||i.trim().length===0||Buffer.byteLength(i,"utf8")>ue?L(`${e} must be a non-blank string of at most ${ue} UTF-8 bytes`):i}function M(i,e,t){if(i===null||typeof i!="object"||Array.isArray(i))return L(`${t} must be an object`);let s=i,n=Object.keys(s).sort(),r=[...e].sort();return(n.length!==r.length||n.some((o,a)=>o!==r[a]))&&L(`${t} must contain exactly: ${r.join(", ")}`),s}function X(i,e,t){if(i===null||typeof i!="object"||Array.isArray(i))return L(`${t} must be an object`);let s=i,n=new Set(e),r=Object.keys(s).find(o=>!n.has(o));return r&&L(`${t} contains unknown field ${r}`),s}var J=class{db;constructor(e=z){e instanceof K.Database?this.db=e:(e!==":memory:"&&Z(h),this.db=new K.Database(e)),_e(this.db),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn(),this.ensureSDKSessionsPlatformContentIdentity(),this.ensureUserPromptsSessionDbId(),this.ensurePendingMessagesSessionToolUniqueIndex(),this.ensureSyncedAtColumns(),this.ensureSyncOriginColumns(),this.ensureSyncOutbox(),this.ensureSyncEntityLedger(),this.ensureSyncRevisionTextAffinity(),this.initializeSyncHubLaunchBaseline()}getIndexColumns(e){return this.db.query(`PRAGMA index_info(${JSON.stringify(e)})`).all().map(t=>t.name)}hasUniqueIndexOnColumns(e,t){return this.db.query(`PRAGMA index_list(${e})`).all().some(n=>{if(n.unique!==1)return!1;let r=this.getIndexColumns(n.name);return r.length===t.length&&r.every((o,a)=>o===t[a])})}resolvePromptSessionDbId(e,t,s){if(t!==void 0)return t;let n=s?A(s):void 0;return n?this.db.prepare(`
        SELECT id
        FROM sdk_sessions
    ...
    `);let e=new Set(this.db.query("PRAGMA table_info(sync_outbox)").all().map(t=>t.name));e.has("canonical_body")||this.db.run("ALTER TABLE sync_outbox ADD COLUMN canonical_body TEXT"),e.has("operation_sha256")||this.db.run("ALTER TABLE sync_outbox ADD COLUMN operation_sha256 TEXT"),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(42,new Date().toISOString())}ensureSyncRevisionTextAffinity(){let e=[{table:"observations",column:"sync_rev",temporary:"sync_rev_text_v46"},{table:"session_summaries",column:"sync_rev",temporary:"sync_rev_text_v46"},{table:"user_prompts",column:"sync_rev",temporary:"sync_rev_text_v46"},{table:"sync_outbox",column:"rev",temporary:"rev_text_v46"}],t=(o,a)=>this.db.query(`PRAGMA table_info(${o})`).all().find(_=>_.name===a),s=o=>o?.type.trim().toUpperCase()==="TEXT";if(this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(46)&&e.every(o=>s(t(o.table,o.column))))return;this.db.transaction(()=>{for(let o of e){let a=this.db.query(`PRAGMA table_info(${o.table})`).all(),_=a.find(c=>c.name===o.column);if(!_)throw new Error(`schema v46: missing ${o.table}.${o.column}`);for(let c of this.db.query(`
          ...
          FROM ${o.table}
        `).iterate()){let m=c;if(m.storage_type==="real")throw new Error(`schema v46: ${o.table}.${o.column} row ${m.row_id} is REAL and unrecoverably rounded`);if(m.storage_type!=="integer"&&m.storage_type!=="text")throw new Error(`schema v46: ${o.table}.${o.column} row ${m.row_id} has unsupported ${m.storage_type} storage`);try{P(m.revision,{positive:!0})}catch{throw new Error(`schema v46: ${o.table}.${o.column} row ${m.row_id} is not a positive canonical uint64 revision`)}}if(s(_))continue;if(a.some(c=>c.name===o.temporary))throw new Error(`schema v46: unexpected temporary column ${o.table}.${o.temporary}`);this.db.run(`ALTER TABLE ${o.table} ADD COLUMN ${o.temporary} TEXT NOT NULL DEFAULT '1'`),this.db.run(`UPDATE ${o.table} SET ${o.temporary} = CAST(${o.column} AS TEXT)`);let u=this.db.prepare(`
          SELECT CAST(id AS TEXT) AS row_id
          FROM ${o.table}
    ...
    `);let s=this.db.prepare("SELECT version, applied_at FROM schema_versions WHERE version = ?").get(47);if(!s){let a=Date.now();this.db.transaction(()=>{this.db.run("DELETE FROM sync_launch_exclusions");for(let{table:c,kind:m}of e)this.db.prepare(`
    ...
    `).get(e);if(!n)throw new Error(`Session ${e} not found in sdk_sessions`);n.memory_session_id!==t&&(this.db.prepare(`
      ...
      WHERE project IS NOT NULL AND project != ''
        AND project != ?
    `,n=[$];return t&&(s+=" AND COALESCE(platform_source, ?) = ?",n.push(l,t)),s+=" ORDER BY project ASC",this.db.prepare(s).all(...n).map(o=>o.project)}getProjectCatalog(){let e=this.db.prepare(`
      SELECT
    ...
    `).all($),t=[],s=new Set,n={};for(let o of e){let a=A(o.platform_source);n[a]||(n[a]=[]),n[a].includes(o.project)||n[a].push(o.project),s.has(o.project)||(s.add(o.project),t.push(o.project))}let r=ne(Object.keys(n));return{projects:t,sources:r,projectsBySource:Object.fromEntries(r.map(o=>[o,n[o]||[]]))}}getLatestUserPrompt(e,t){let s=this.resolvePromptSessionDbId(e,t),n=s!==null?"up.session_db_id = ?":"up.content_session_id = ?",r=s!==null?s:e;return this.db.prepare(`
      ...
      ORDER BY up.created_at_epoch DESC
      LIMIT 1
    `).get(r)}findRecentDuplicateUserPrompt(e,t,s,n){return re(this.db,e,k(t),s,this.resolvePromptSessionDbId(e,n)??void 0)}getRecentSessionsWithStatus(e,t=3,s){let n=[e],r="";return s&&(r=`AND COALESCE(NULLIF(s.platform_source, ''), '${l}') = ?`,n.push(A(s))),n.push(t),this.db.prepare(`
      SELECT * FROM (
        SELECT
          s.memory_session_id,
          s.status,
    ...
    `).get(e,A(t))||null:this.db.prepare(`
        ...
        FROM observations
        WHERE id = ?
      `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:r,platformSource:o,type:a,concepts:_,files:u}=t,c=s==="relevance",m=c?"":`ORDER BY o.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,b=n&&!c?`LIMIT ${n}`:"",g=e.map(()=>"?").join(","),R=[...e],N=[];if(r&&(N.push("o.project = ?"),R.push(r)),o&&(N.push(`COALESCE(NULLIF(s.platform_source, ''), '${l}') = ?`),R.push(A(o))),a)if(Array.isArray(a)){let S=a.map(()=>"?").join(",");N.push(`o.type IN (${S})`),R.push(...a)}else N.push("o.type = ?"),R.push(a);if(_){let S=Array.isArray(_)?_:[_],f=S.map(()=>"EXISTS (SELECT 1 FROM json_each(o.concepts) WHERE value = ?)");R.push(...S),N.push(`(${f.join(" OR ")})`)}if(u){let S=Array.isArray(u)?u:[u],f=S.map(()=>"(EXISTS (SELECT 1 FROM json_each(o.files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(o.files_modified) WHERE value LIKE ?))");S.forEach(O=>{R.push(`%${O}%`,`%${O}%`)}),N.push(`(${f.join(" OR ")})`)}let y=N.length>0?`WHERE o.id IN (${g}) AND ${N.join(" AND ")}`:`WHERE o.id IN (${g})`,I=this.db.prepare(`
      SELECT o.*
      FROM observations o
      LEFT JOIN sdk_sessions s ON s.memory_session_id = o.memory_session_id
      ${y}
      ${m}
      ${b}
    `).all(...R);if(!c)return I;let v=new Map(I.map(S=>[S.id,S])),E=e.map(S=>v.get(S)).filter(S=>!!S);return n?E.slice(0,n):E}getSummaryForSession(e,t){let s=[e],n="";return t&&(n=`
        AND EXISTS (
          SELECT 1
    ...
    `).get(e).count}createSDKSession(e,t,s,n,r){let o=new Date,a=o.getTime(),_=r?A(r):l,u=k(s);n&&this.validateSetTitleMutation(e,_,n);let c=this.db.prepare(`
      SELECT id, platform_source
      FROM sdk_sessions
      WHERE COALESCE(NULLIF(platform_source, ''), ?) = ?
        AND content_session_id = ?
    `).get(l,_,e);if(c){if(t&&this.db.prepare(`
          UPDATE sdk_sessions SET project = ?
          WHERE id = ? AND (project IS NULL OR project = '')
        `).run(t,c.id),n){let b=this.db.prepare("SELECT custom_title FROM sdk_sessions WHERE id = ?").get(c.id);b&&b.custom_title===null&&(this.db.prepare(`
            UPDATE sdk_sessions SET custom_title = ?
            WHERE id = ? AND custom_title IS NULL
          `).run(n,c.id),this.enqueueSetTitleOp(e,_,n))}return c.id}let m=this.db.prepare(`
      INSERT INTO sdk_sessions
      (content_session_id, memory_session_id, project, platform_source, user_prompt, custom_title, started_at, started_at_epoch, status)
      VALUES (?, NULL, ?, ?, ?, ?, ?, ?, 'active')
    `).run(e,t,_,u,n||null,o.toISOString(),a);return n&&this.enqueueSetTitleOp(e,_,n),Number(m.lastInsertRowid)}enqueueSetTitleOp(e,t,s){let n=this.validateSetTitleMutation(e,t,s);this.enqueueMutationOp("1",n)}validateSetTitleMutation(e,t,s){let n={op:"set_title",target:{content_session_id:e,platform_source:t},fields:{custom_title:s}};return Y(n),n}saveUserPrompt(e,t,s,n){let r=new Date,o=r.getTime(),a=k(s),_=this.resolvePromptSessionDbId(e,n);return this.db.prepare(`
    ...
    `).run(_,e,t,a,r.toISOString(),o).lastInsertRowid}getUserPrompt(e,t,s){let n=this.resolvePromptSessionDbId(e,s);return n!==null?this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,r=0,o,a,_=[]){let u=this.storeObservations(e,t,[s],null,n,r,o,a,_);return{id:u.observationIds[0],createdAtEpoch:u.createdAtEpoch}}storeSummary(e,t,s,n,r=0,o){let a=o??Date.now(),_=new Date(a).toISOString(),c=this.db.prepare(`
      INSERT INTO session_summaries
      (memory_session_id, project, request, investigated, learned, completed,
       next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,r,_,a);return{id:Number(c.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,r,o=0,a,_,u=[]){let c=a??Date.now(),m=new Date(c).toISOString();return this.db.transaction(()=>{let g=[],R=this.db.prepare(`
        ...
        RETURNING id
      `),N=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let p of s){let I=te(e,p.title,p.narrative),v=R.get(e,t,p.type,p.title,p.subtitle,JSON.stringify(p.facts),p.narrative,JSON.stringify(p.concepts),JSON.stringify(p.files_read),JSON.stringify(p.files_modified),r||null,o,p.agent_type??null,p.agent_id??null,I,m,c,_||null,p.metadata??null);if(v){g.push(v.id);continue}let E=N.get(e,I);if(!E)throw new Error(`storeObservations: ON CONFLICT without existing row for content_hash=${I}`);g.push(E.id)}let y=null;if(n){let I=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,r||null,o,m,c);y=Number(I.lastInsertRowid)}if(u.length>0){let p=u.map(()=>"?").join(", ");this.db.prepare(`
          UPDATE observer_jobs
          SET state = 'settled', updated_at_epoch = ?
          WHERE id IN (${p}) AND state = 'claimed'
        `).run(Date.now(),...u)}return{observationIds:g,summaryId:y,createdAtEpoch:c}})()}getSessionSummariesByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:r,platformSource:o}=t,a=s==="relevance",_=a?"":`ORDER BY ss.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,u=n&&!a?`LIMIT ${n}`:"",c=e.map(()=>"?").join(","),m=[...e],b=[];r&&(b.push("ss.project = ?"),m.push(r)),o&&(b.push(`COALESCE(NULLIF(s.platform_source, ''), '${l}') = ?`),m.push(A(o)));let g=b.length>0?`AND ${b.join(" AND ")}`:"",N=this.db.prepare(`
      SELECT ss.*
      ...
      ${_}
      ${u}
    `).all(...m);if(!a)return N;let y=new Map(N.map(I=>[I.id,I])),p=e.map(I=>y.get(I)).filter(I=>!!I);return n?p.slice(0,n):p}getUserPromptsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:r,platformSource:o}=t,a=s==="relevance",_=a?"":`ORDER BY up.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,u=n?`LIMIT ${n}`:"",c=e.map(()=>"?").join(","),m=[...e],b=[];r&&(b.push("s.project = ?"),m.push(r)),o&&(b.push(`COALESCE(NULLIF(s.platform_source, ''), '${l}') = ?`),m.push(A(o)));let g=b.length>0?`AND ${b.join(" AND ")}`:"",N=this.db.prepare(`
      SELECT
        up.*,
        s.project,
        s.memory_session_id,
      ...
      ${_}
      ${u}
    `).all(...m);if(!a)return N;let y=new Map(N.map(p=>[p.id,p]));return e.map(p=>y.get(p)).filter(p=>!!p)}getTimelineAroundTimestamp(e,t=10,s=10,n,r){return this.getTimelineAroundObservation(null,e,t,s,n,r)}getTimelineAroundObservation(e,t,s=10,n=10,r,o){let a=o?A(o):void 0,_=(E,S)=>{let f=[],O=[];return r&&(f.push(`${E}.project = ?`),O.push(r)),a&&(f.push(`COALESCE(NULLIF(${S}.platform_source, ''), '${l}') = ?`),O.push(a)),{clause:f.length>0?`AND ${f.join(" AND ")}`:"",params:O}},u=_("o","src"),c=_("ss","src"),m=_("s","s"),b,g;if(e!==null){let E=`
      ...
      `,S=`
        ...
        ORDER BY o.id ASC
        LIMIT ?
      `;try{let f=this.db.prepare(E).all(e,...u.params,s+1),O=this.db.prepare(S).all(e,...u.params,n+1);if(f.length===0&&O.length===0)return{observations:[],sessions:[],prompts:[]};b=f.length>0?f[f.length-1].created_at_epoch:t,g=O.length>0?O[O.length-1].created_at_epoch:t}catch(f){return f instanceof Error?d.error("DB","Error getting boundary observations",{project:r},f):d.error("DB","Error getting boundary observations with non-Error",{},new Error(String(f))),{observations:[],sessions:[],prompts:[]}}}else{let E=`
      ...
      `,S=`
        ...
        LIMIT ?
      `;try{let f=this.db.prepare(E).all(t,...u.params,s),O=this.db.prepare(S).all(t,...u.params,n+1);if(f.length===0&&O.length===0)return{observations:[],sessions:[],prompts:[]};b=f.length>0?f[f.length-1].created_at_epoch:t,g=O.length>0?O[O.length-1].created_at_epoch:t}catch(f){return f instanceof Error?d.error("DB","Error getting boundary timestamps",{project:r},f):d.error("DB","Error getting boundary timestamps with non-Error",{},new Error(String(f))),{observations:[],sessions:[],prompts:[]}}}let R=`
      SELECT o.*
      FROM observations o
      LEFT JOIN sdk_sessions src ON src.memory_session_id = o.memory_session_id
