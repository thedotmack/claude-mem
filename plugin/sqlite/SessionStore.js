...
"use strict";var G=Object.defineProperty;var ve=Object.getOwnPropertyDescriptor;var De=Object.getOwnPropertyNames;var Ue=Object.prototype.hasOwnProperty;var we=(i,e)=>{for(var s in e)G(i,s,{get:e[s],enumerable:!0})},xe=(i,e,s,t)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of De(e))!Ue.call(i,n)&&n!==s&&G(i,n,{get:()=>e[n],enumerable:!(t=ve(e,n))||t.enumerable});return i};var Me=i=>xe(G({},"__esModule",{value:!0}),i);var as={};we(as,{SessionStore:()=>Z,rollupObservationFileLists:()=>Ce});module.exports=Me(as);var z=require("bun:sqlite"),ye=require("crypto");var b=require("path"),j=require("os"),U=require("fs"),te=require("url");var Fe=null;function ke(i){return(Fe??process.stderr.write.bind(process.stderr))(i)}function F(i){ke(i)}var ls=process.platform==="win32";function Xe(i){return i.replace(/^\uFEFF/,"")}function k(i){return JSON.parse(Xe(i))}var ee=require("os"),se=require("path");function X(i,e=process.platform,s=(0,ee.homedir)()){return typeof i!="string"||i.length===0?i:i==="~"?s:i.startsWith("~/")||e==="win32"&&i.startsWith("~\\")?(0,se.join)(s,i.slice(2)):i}function $e(){return typeof __CM_DIRNAME__<"u"?__CM_DIRNAME__:(0,b.dirname)((0,te.fileURLToPath)(__IMPORT_META_URL__))}var bs=$e();function Pe(){if(process.env.CLAUDE_MEM_DATA_DIR)return X(process.env.CLAUDE_MEM_DATA_DIR);let i=(0,b.join)((0,j.homedir)(),".claude-mem"),e=(0,b.join)(i,"settings.json");try{if((0,U.existsSync)(e)){let s=k((0,U.readFileSync)(e,"utf-8")),t=s.env??s;if(t.CLAUDE_MEM_DATA_DIR)return X(t.CLAUDE_MEM_DATA_DIR)}}catch{}return i}var h=Pe(),Be=(0,b.join)((0,j.homedir)(),".claude"),Ge=process.env.CLAUDE_CONFIG_DIR||Be,gs=(0,b.join)(Ge,"plugins","marketplaces","thedotmack"),je=(0,b.join)(h,"logs"),fs=(0,b.join)(h,"settings.json"),ne="claude-mem.db";var oe=(0,b.join)(h,ne),He=(0,b.join)(h,"observer-sessions"),H=(0,b.basename)(He);function re(i){(0,U.mkdirSync)(i,{recursive:!0})}var W={dataDir:()=>h,workerPid:()=>(0,b.join)(h,"worker.pid"),serverPid:()=>(0,b.join)(h,".server-beta.pid"),serverPort:()=>(0,b.join)(h,".server-beta.port"),serverRuntime:()=>(0,b.join)(h,".server-beta.runtime.json"),settings:()=>(0,b.join)(h,"settings.json"),database:()=>(0,b.join)(h,ne),chroma:()=>(0,b.join)(h,"chroma"),combinedCerts:()=>(0,b.join)(h,"combined_certs.pem"),transcriptsConfig:()=>(0,b.join)(h,"transcript-watch.json"),transcriptsState:()=>(0,b.join)(h,"transcript-watch-state.json"),corpora:()=>(0,b.join)(h,"corpora"),supervisorRegistry:()=>(0,b.join)(h,"supervisor.json"),envFile:()=>(0,b.join)(h,".env"),logsDir:()=>je};var v=require("fs"),ie=require("path");var V=(r=>(r[r.DEBUG=0]="DEBUG",r[r.INFO=1]="INFO",r[r.WARN=2]="WARN",r[r.ERROR=3]="ERROR",r[r.SILENT=4]="SILENT",r))(V||{}),q=null,Y=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;logFileDate=null;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){let e=new Date().toISOString().split("T")[0];if(!(this.logFileInitialized&&this.logFileDate===e)){this.logFileInitialized=!0,this.logFileDate=e;try{let s=W.logsDir();(0,v.existsSync)(s)||(0,v.mkdirSync)(s,{recursive:!0}),this.logFilePath=(0,ie.join)(s,`claude-mem-${e}.log`)}catch(s){console.error("[LOGGER] Failed to initialize log file:",s instanceof Error?s.message:String(s)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=W.settings();if((0,v.existsSync)(e)){let s=(0,v.readFileSync)(e,"utf-8"),n=(k(s).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=V[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
