...
"use strict";var M=Object.defineProperty;var ie=Object.getOwnPropertyDescriptor;var ae=Object.getOwnPropertyNames;var de=Object.prototype.hasOwnProperty;var _e=(a,e)=>{for(var s in e)M(a,s,{get:e[s],enumerable:!0})},pe=(a,e,s,t)=>{if(e&&typeof e=="object"||typeof e=="function")for(let r of ae(e))!de.call(a,r)&&r!==s&&M(a,r,{get:()=>e[r],enumerable:!(t=ie(e,r))||t.enumerable});return a};var ue=a=>pe(M({},"__esModule",{value:!0}),a);var Ae={};_e(Ae,{SessionStore:()=>$});module.exports=ue(Ae);var oe=require("bun:sqlite");var R=require("path"),F=require("os"),D=require("fs"),W=require("url");function y(a){return a.charCodeAt(0)===65279?a.slice(1):a}function Ee(){return typeof __dirname<"u"?__dirname:(0,R.dirname)((0,W.fileURLToPath)(__IMPORT_META_URL__))}var ye=Ee();function me(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let a=(0,R.join)((0,F.homedir)(),".claude-mem"),e=(0,R.join)(a,"settings.json");try{if((0,D.existsSync)(e)){let s=JSON.parse(y((0,D.readFileSync)(e,"utf-8"))),t=s.env??s;if(t.CLAUDE_MEM_DATA_DIR)return t.CLAUDE_MEM_DATA_DIR}}catch{}return a}var O=me(),le=process.env.CLAUDE_CONFIG_DIR||(0,R.join)((0,F.homedir)(),".claude"),Ue=(0,R.join)(le,"plugins","marketplaces","thedotmack"),ce=(0,R.join)(O,"logs"),Me=(0,R.join)(O,"settings.json"),j=(0,R.join)(O,"claude-mem.db"),Te=(0,R.join)(O,"observer-sessions"),w=(0,R.basename)(Te);function q(a){(0,D.mkdirSync)(a,{recursive:!0})}var x={dataDir:()=>O,workerPid:()=>(0,R.join)(O,"worker.pid"),serverPid:()=>(0,R.join)(O,".server-beta.pid"),serverPort:()=>(0,R.join)(O,".server-beta.port"),serverRuntime:()=>(0,R.join)(O,".server-beta.runtime.json"),settings:()=>(0,R.join)(O,"settings.json"),database:()=>(0,R.join)(O,"claude-mem.db"),chroma:()=>(0,R.join)(O,"chroma"),combinedCerts:()=>(0,R.join)(O,"combined_certs.pem"),transcriptsConfig:()=>(0,R.join)(O,"transcript-watch.json"),transcriptsState:()=>(0,R.join)(O,"transcript-watch-state.json"),corpora:()=>(0,R.join)(O,"corpora"),supervisorRegistry:()=>(0,R.join)(O,"supervisor.json"),envFile:()=>(0,R.join)(O,".env"),logsDir:()=>ce};var C=require("fs"),V=require("path");var be=null;function Re(a){return(be??process.stderr.write.bind(process.stderr))(a)}function k(a){Re(a)}var G=(n=>(n[n.DEBUG=0]="DEBUG",n[n.INFO=1]="INFO",n[n.WARN=2]="WARN",n[n.ERROR=3]="ERROR",n[n.SILENT=4]="SILENT",n))(G||{}),X=null,P=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=x.logsDir();(0,C.existsSync)(e)||(0,C.mkdirSync)(e,{recursive:!0});let s=new Date().toISOString().split("T")[0];this.logFilePath=(0,V.join)(e,`claude-mem-${s}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=x.settings();if((0,C.existsSync)(e)){let s=(0,C.readFileSync)(e,"utf-8"),r=(JSON.parse(y(s)).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=G[r]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
${e.stack}`:e.message;if(Array.isArray(e))return`[${e.length} items]`;let s=Object.keys(e);return s.length===0?"{}":s.length<=3?JSON.stringify(e):`{${s.length} keys: ${s.slice(0,3).join(", ")}...}`}return String(e)}formatTool(e,s){if(!s)return e;let t=s;if(typeof s=="string")try{t=JSON.parse(s)}catch{t=s}if(e==="Bash"&&t.command)return`${e}(${t.command})`;if(t.file_path)return`${e}(${t.file_path})`;if(t.notebook_path)return`${e}(${t.notebook_path})`;if(e==="Glob"&&t.pattern)return`${e}(${t.pattern})`;if(e==="Grep"&&t.pattern)return`${e}(${t.pattern})`;if(t.url)return`${e}(${t.url})`;if(t.query)return`${e}(${t.query})`;if(e==="Task"){if(t.subagent_type)return`${e}(${t.subagent_type})`;if(t.description)return`${e}(${t.description})`}return e==="Skill"&&t.skill?`${e}(${t.skill})`:e==="LSP"&&t.operation?`${e}(${t.operation})`:e}formatTimestamp(e){let s=e.getFullYear(),t=String(e.getMonth()+1).padStart(2,"0"),r=String(e.getDate()).padStart(2,"0"),n=String(e.getHours()).padStart(2,"0"),o=String(e.getMinutes()).padStart(2,"0"),i=String(e.getSeconds()).padStart(2,"0"),p=String(e.getMilliseconds()).padStart(3,"0");return`${s}-${t}-${r} ${n}:${o}:${i}.${p}`}log(e,s,t,r,n){if(e<this.getLevel())return;this.ensureLogFileInitialized();let o=this.formatTimestamp(new Date),i=G[e].padEnd(5),p=s.padEnd(6),_="";r?.correlationId?_=`[${r.correlationId}] `:r?.sessionId&&(_=`[session-${r.sessionId}] `);let E="";if(n!=null)if(n instanceof Error)E=this.getLevel()===0?`
${n.message}
  ...
  `).get(i,s,n)??void 0}var ee=["private","claude-mem-context","system_instruction","system-instruction","persisted-output","system-reminder"],z=new RegExp(`<(${ee.join("|")})\\b[^>]*>[\\s\\S]*?</\\1>`,"g");var Z=100;function Se(a){let e=Object.fromEntries(ee.map(r=>[r,0]));z.lastIndex=0;let s=0,t=a.replace(z,(r,n)=>(e[n]=(e[n]??0)+1,s+=1,""));return s>Z&&d.warn("SYSTEM","tag count exceeds limit",void 0,{tagCount:s,maxAllowed:Z,contentLength:a.length}),{stripped:t.trim(),counts:e}}function se(a){return Se(a).stripped}var Ie=["task-notification"],je=new RegExp(`^\\s*<(${Ie.join("|")})\\b[^>]*>(?:(?!<\\1\\b|</\\1\\b)[\\s\\S])*</\\1>\\s*$`),qe=256*1024;var B=4e3;function U(a){let e=a.trim(),t=se(a).trim()||e;return t.length<=B?t:(d.debug("DB","Truncated stored prompt text to the configured cap",{originalLength:t.length,storedLength:B}),`${t.slice(0,B-1)}\u2026`)}var te=require("bun:sqlite"),re=require("node:path");var he=5e3;function ge(a){a!==":memory:"&&q((0,re.dirname)(a))}function H(a){a.run(`PRAGMA busy_timeout = ${he}`)}function Oe(a){let{tableCount:e}=a.query("SELECT COUNT(*) AS tableCount FROM sqlite_master WHERE type = 'table'").get(),{page_count:s}=a.query("PRAGMA page_count").get();return e>0||s>1?!1:(a.run("PRAGMA auto_vacuum = INCREMENTAL"),!0)}function fe(a){H(a),a.run("PRAGMA journal_mode = WAL"),a.run("PRAGMA synchronous = NORMAL"),a.run("PRAGMA foreign_keys = ON"),a.run("PRAGMA journal_size_limit = 4194304")}function ne(a){ge(a);let e=new te.Database(a);return Oe(e),fe(e),e}var $=class{db;constructor(e=j){e instanceof oe.Database?(this.db=e,H(this.db)):this.db=ne(e),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn(),this.ensureSDKSessionsPlatformContentIdentity(),this.ensureUserPromptsSessionDbId(),this.ensurePendingMessagesSessionToolUniqueIndex()}getIndexColumns(e){return this.db.query(`PRAGMA index_info(${JSON.stringify(e)})`).all().map(s=>s.name)}hasUniqueIndexOnColumns(e,s){return this.db.query(`PRAGMA index_list(${e})`).all().some(r=>{if(r.unique!==1)return!1;let n=this.getIndexColumns(r.name);return n.length===s.length&&n.every((o,i)=>o===s[i])})}resolvePromptSessionDbId(e,s,t){if(s!==void 0)return s;let r=t?L(t):void 0;return r?this.db.prepare(`
    ...
    `).get(e);if(!r)throw new Error(`Session ${e} not found in sdk_sessions`);r.memory_session_id!==s&&(this.db.prepare(`
      ...
      WHERE project IS NOT NULL AND project != ''
        AND project != ?
    `,r=[w];return s&&(t+=" AND COALESCE(platform_source, ?) = ?",r.push(u,s)),t+=" ORDER BY project ASC",this.db.prepare(t).all(...r).map(o=>o.project)}getProjectCatalog(){let e=this.db.prepare(`
      SELECT
    ...
    `).all(w),s=[],t=new Set,r={};for(let o of e){let i=L(o.platform_source);r[i]||(r[i]=[]),r[i].includes(o.project)||r[i].push(o.project),t.has(o.project)||(t.add(o.project),s.push(o.project))}let n=Q(Object.keys(r));return{projects:s,sources:n,projectsBySource:Object.fromEntries(n.map(o=>[o,r[o]||[]]))}}getLatestUserPrompt(e,s){let t=this.resolvePromptSessionDbId(e,s),r=t!==null?"up.session_db_id = ?":"up.content_session_id = ?",n=t!==null?t:e;return this.db.prepare(`
      ...
      ORDER BY up.created_at_epoch DESC
      LIMIT 1
    `).get(n)}findRecentDuplicateUserPrompt(e,s,t,r){return J(this.db,e,U(s),t,this.resolvePromptSessionDbId(e,r)??void 0)}getRecentSessionsWithStatus(e,s=3,t){let r=[e],n="";return t&&(n=`AND COALESCE(NULLIF(s.platform_source, ''), '${u}') = ?`,r.push(L(t))),r.push(s),this.db.prepare(`
      SELECT * FROM (
        SELECT
          s.memory_session_id,
          s.status,
    ...
    `).get(e).count}createSDKSession(e,s,t,r,n){let o=new Date,i=o.getTime(),p=n?L(n):u,_=U(t),E=this.db.prepare(`
    ...
    `).get(u,p,e);if(E)return s&&this.db.prepare(`
      ...
      VALUES (?, NULL, ?, ?, ?, ?, ?, ?, 'active')
    `).run(e,s,p,_,r||null,o.toISOString(),i);return Number(I.lastInsertRowid)}saveUserPrompt(e,s,t,r){let n=new Date,o=n.getTime(),i=U(t),p=this.resolvePromptSessionDbId(e,r);return this.db.prepare(`
