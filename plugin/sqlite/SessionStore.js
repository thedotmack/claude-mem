...
"use strict";var $=Object.defineProperty;var Re=Object.getOwnPropertyDescriptor;var Oe=Object.getOwnPropertyNames;var Ie=Object.prototype.hasOwnProperty;var Ae=(i,e)=>{for(var t in e)$(i,t,{get:e[t],enumerable:!0})},Le=(i,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Oe(e))!Ie.call(i,n)&&n!==t&&$(i,n,{get:()=>e[n],enumerable:!(s=Re(e,n))||s.enumerable});return i};var ve=i=>Le($({},"__esModule",{value:!0}),i);var Ye={};Ae(Ye,{SessionStore:()=>Z});module.exports=ve(Ye);var z=require("bun:sqlite"),ge=require("crypto");var T=require("path"),w=require("os"),U=require("fs"),te=require("url");var ye=null;function Ce(i){return(ye??process.stderr.write.bind(process.stderr))(i)}function X(i){Ce(i)}var ze=process.platform==="win32";function De(i){return i.replace(/^\uFEFF/,"")}function k(i){return JSON.parse(De(i))}function Ue(){return typeof __dirname<"u"?__dirname:(0,T.dirname)((0,te.fileURLToPath)(__IMPORT_META_URL__))}var ts=Ue();function ee(i){return typeof i!="string"||i.length===0?i:i==="~"?(0,w.homedir)():i.startsWith("~/")?(0,T.join)((0,w.homedir)(),i.slice(2)):i}function Me(){if(process.env.CLAUDE_MEM_DATA_DIR)return ee(process.env.CLAUDE_MEM_DATA_DIR);let i=(0,T.join)((0,w.homedir)(),".claude-mem"),e=(0,T.join)(i,"settings.json");try{if((0,U.existsSync)(e)){let t=k((0,U.readFileSync)(e,"utf-8")),s=t.env??t;if(s.CLAUDE_MEM_DATA_DIR)return ee(s.CLAUDE_MEM_DATA_DIR)}}catch{}return i}var R=Me(),we=process.env.CLAUDE_CONFIG_DIR||(0,T.join)((0,w.homedir)(),".claude"),ns=(0,T.join)(we,"plugins","marketplaces","thedotmack"),xe=(0,T.join)(R,"logs"),rs=(0,T.join)(R,"settings.json"),ne=(0,T.join)(R,"claude-mem.db"),Fe=(0,T.join)(R,"observer-sessions"),j=(0,T.basename)(Fe);function re(i){(0,U.mkdirSync)(i,{recursive:!0})}function se(){let i=process.env.CLAUDE_MEM_WORKER_PORT;return i?`-${i}`:""}var H={dataDir:()=>R,workerPid:()=>(0,T.join)(R,`worker${se()}.pid`),serverPid:()=>(0,T.join)(R,".server-beta.pid"),serverPort:()=>(0,T.join)(R,".server-beta.port"),serverRuntime:()=>(0,T.join)(R,".server-beta.runtime.json"),settings:()=>(0,T.join)(R,"settings.json"),database:()=>(0,T.join)(R,"claude-mem.db"),chroma:()=>(0,T.join)(R,"chroma"),combinedCerts:()=>(0,T.join)(R,"combined_certs.pem"),transcriptsConfig:()=>(0,T.join)(R,"transcript-watch.json"),transcriptsState:()=>(0,T.join)(R,"transcript-watch-state.json"),corpora:()=>(0,T.join)(R,"corpora"),supervisorRegistry:()=>(0,T.join)(R,`supervisor${se()}.json`),envFile:()=>(0,T.join)(R,".env"),logsDir:()=>xe};var y=require("fs"),oe=require("path");var q=(r=>(r[r.DEBUG=0]="DEBUG",r[r.INFO=1]="INFO",r[r.WARN=2]="WARN",r[r.ERROR=3]="ERROR",r[r.SILENT=4]="SILENT",r))(q||{}),W=null,V=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=H.logsDir();(0,y.existsSync)(e)||(0,y.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,oe.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=H.settings();if((0,y.existsSync)(e)){let t=(0,y.readFileSync)(e,"utf-8"),n=(k(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=q[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`)}debug(e,t,s,n){this.log(0,e,t,s,n)}info(e,t,s,n){this.log(1,e,t,s,n)}warn(e,t,s,n){this.log(2,e,t,s,n)}setErrorSink(e){W=e}error(e,t,s,n){this.log(3,e,t,s,n),this.routeErrorToSink(t,s,n)}routeErrorToSink(e,t,s){try{if(!W||!(s instanceof Error))return;W(s)}catch{}}dataIn(e,t,s,n){this.info(e,`\u2192 ${t}`,s,n)}dataOut(e,t,s,n){this.info(e,`\u2190 ${t}`,s,n)}success(e,t,s,n){this.info(e,`\u2713 ${t}`,s,n)}failure(e,t,s,n){this.error(e,`\u2717 ${t}`,s,n)}},d=new V;var ie=require("crypto");function ae(i,e,t){return(0,ie.createHash)("sha256").update([i||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function de(i){if(!i)return[];try{let e=JSON.parse(i);return Array.isArray(e)?e.filter(t=>typeof t=="string"&&t.length>0):[]}catch{return[]}}function Y(i=new Date){return i.toISOString().slice(0,10)}var _e=10;function ce(i,e=new Date,t=_e){let s=Y(e);if(i.length>0&&i[i.length-1]===s)return i;let n=[...i,s];return n.length>t?n.slice(n.length-t):n}function ue(i){let e=Y(new Date(i));return{dates:JSON.stringify([e]),lastReinforced:e}}function pe(i,e,t=new Date){let s=i.prepare("SELECT reinforcement_dates FROM observations WHERE id = ?").get(e);if(!s)return!1;let n=de(s.reinforcement_dates),r=ce(n,t);return r===n||r.length===n.length&&r[r.length-1]===n[n.length-1]?!1:(i.prepare("UPDATE observations SET reinforcement_dates = ?, last_reinforced = ? WHERE id = ?").run(JSON.stringify(r),r[r.length-1],e),!0)}var p="claude";function Xe(i){return i.trim().toLowerCase().replace(/\s+/g,"-")}function A(i){if(!i)return p;let e=Xe(i);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:p}function le(i){let e=["claude","codex","cursor"];return[...i].sort((t,s)=>{let n=e.indexOf(t),r=e.indexOf(s);return n!==-1||r!==-1?n===-1?1:r===-1?-1:n-r:t.localeCompare(s)})}function Ee(i,e,t,s,n){let r=Date.now()-s,o=n!==void 0?"up.session_db_id = ?":"up.content_session_id = ?",a=n??e;return i.prepare(`
  ...
  `).get()!=null}function M(i,e,t){try{i.run(e)}catch(s){let n=s instanceof Error?s:new Error(String(s));throw d.warn("DB",`Failed to apply SQLite pragma ${t}`,{sql:e},n),s}}function Ne(i,e={}){let{enableWal:t=!0,enableIncrementalAutoVacuum:s=!0}=e;M(i,`PRAGMA busy_timeout = ${Ge}`,"busy_timeout"),M(i,"PRAGMA foreign_keys = ON","foreign_keys"),M(i,"PRAGMA synchronous = NORMAL","synchronous"),M(i,`PRAGMA journal_size_limit = ${$e}`,"journal_size_limit"),s&&!je(i)&&M(i,"PRAGMA auto_vacuum = INCREMENTAL","auto_vacuum"),t&&M(i,"PRAGMA journal_mode = WAL","journal_mode")}var Se=4096;var He=new Set(["set_title","set_prompt_session","remap_project"]),We=/^(?:0|[1-9][0-9]*)$/,he=18446744073709551615n;function L(i){throw d.debug("CLOUD_SYNC","Rejected invalid canonical content",{reason:i}),new Error(`canonical content: ${i}`)}function G(i,e={}){return typeof i!="string"||!We.test(i)?L("decimal values must be unsigned base-10 strings without leading zeroes"):(BigInt(i)>he&&L("decimal value exceeds uint64"),e.positive&&i==="0"&&L("decimal value must be positive"),i)}function J(i){let e=G(i);return BigInt(e)===he&&L("uint64 sequence overflow"),(BigInt(e)+1n).toString(10)}function qe(i){(i===null||typeof i!="object"||Array.isArray(i))&&L("mutation must be an object");let e=i;if((typeof e.op!="string"||!He.has(e.op))&&L("unsupported mutation op"),e.op==="set_title"){let r=x(e,["fields","op","target"],"set_title"),o=B(r.target,["content_session_id","memory_session_id","platform_source"],"set_title.target");o.memory_session_id===void 0&&o.content_session_id===void 0&&L("set_title target requires a session identifier");for(let _ of["memory_session_id","content_session_id","platform_source"])o[_]!==void 0&&D(o[_],_);let a=x(r.fields,["custom_title"],"set_title.fields");D(a.custom_title,"custom_title");return}if(e.op==="set_prompt_session"){let r=x(e,["fields","op","target"],"set_prompt_session"),o=x(r.target,["origin_device_id","origin_local_id"],"set_prompt_session.target");Ve(o.origin_device_id),G(o.origin_local_id);let a=B(r.fields,["content_session_id","memory_session_id","platform_source","project"],"set_prompt_session.fields");D(a.memory_session_id,"memory_session_id");for(let _ of["content_session_id","platform_source","project"])a[_]!==void 0&&D(a[_],_);return}let t=x(e,["fields","op","where"],"remap_project"),s=B(t.where,["memory_session_id","merged_into_project_is_null","project"],"remap_project.where");s.project!==void 0&&D(s.project,"project"),s.memory_session_id!==void 0&&D(s.memory_session_id,"memory_session_id"),s.merged_into_project_is_null!==void 0&&s.merged_into_project_is_null!==!0&&L("merged_into_project_is_null may only be true"),Object.keys(s).length===0&&L("remap_project where is empty");let n=B(t.fields,["merged_into_project","project"],"remap_project.fields");n.project!==void 0&&D(n.project,"project"),n.merged_into_project!==void 0&&D(n.merged_into_project,"merged_into_project"),Object.keys(n).length===0&&L("remap_project fields are empty")}function Q(i){qe(i)}function Ve(i){return typeof i!="string"||i.length===0||Buffer.byteLength(i,"utf8")>128?L("origin_device_id must be a non-empty string of at most 128 UTF-8 bytes"):i}function D(i,e){return typeof i!="string"||i.length===0||i.trim().length===0||Buffer.byteLength(i,"utf8")>Se?L(`${e} must be a non-blank string of at most ${Se} UTF-8 bytes`):i}function x(i,e,t){if(i===null||typeof i!="object"||Array.isArray(i))return L(`${t} must be an object`);let s=i,n=Object.keys(s).sort(),r=[...e].sort();return(n.length!==r.length||n.some((o,a)=>o!==r[a]))&&L(`${t} must contain exactly: ${r.join(", ")}`),s}function B(i,e,t){if(i===null||typeof i!="object"||Array.isArray(i))return L(`${t} must be an object`);let s=i,n=new Set(e),r=Object.keys(s).find(o=>!n.has(o));return r&&L(`${t} contains unknown field ${r}`),s}var Z=class{db;constructor(e=ne){e instanceof z.Database?this.db=e:(e!==":memory:"&&re(R),this.db=new z.Database(e)),Ne(this.db),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn(),this.ensureSDKSessionsPlatformContentIdentity(),this.ensureUserPromptsSessionDbId(),this.ensurePendingMessagesSessionToolUniqueIndex(),this.ensureSyncedAtColumns(),this.ensureSyncOriginColumns(),this.ensureSyncOutbox(),this.ensureSyncEntityLedger(),this.ensureSyncRevisionTextAffinity(),this.initializeSyncHubLaunchBaseline(),this.normalizeConceptTags(),this.addObservationReinforcementColumns(),this.ensureObservationRelevanceCountColumn(),this.ensureObservationSupersededByColumn(),this.ensureSemanticFactsTable(),this.ensureDeletedObservationsTable()}addObservationReinforcementColumns(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(50),t=this.db.query("PRAGMA table_info(observations)").all(),s=t.some(r=>r.name==="reinforcement_dates"),n=t.some(r=>r.name==="last_reinforced");e&&s&&n||(s||(this.db.run("ALTER TABLE observations ADD COLUMN reinforcement_dates TEXT"),d.debug("DB","Added reinforcement_dates column to observations table")),n||(this.db.run("ALTER TABLE observations ADD COLUMN last_reinforced TEXT"),d.debug("DB","Added last_reinforced column to observations table")),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(50,new Date().toISOString()))}ensureObservationRelevanceCountColumn(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(51),s=this.db.query("PRAGMA table_info(observations)").all().some(n=>n.name==="relevance_count");e&&s||(s||(this.db.run("ALTER TABLE observations ADD COLUMN relevance_count INTEGER DEFAULT 0"),d.debug("DB","Added relevance_count column to observations table")),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(51,new Date().toISOString()))}ensureObservationSupersededByColumn(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(52),s=this.db.query("PRAGMA table_info(observations)").all().some(n=>n.name==="superseded_by");e&&s||(s||(this.db.run("ALTER TABLE observations ADD COLUMN superseded_by INTEGER"),d.debug("DB","Added superseded_by column to observations table")),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(52,new Date().toISOString()))}ensureSemanticFactsTable(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(53),s=this.db.query("SELECT name FROM sqlite_master WHERE type = 'table' AND name = 'semantic_facts'").all().length>0;e&&s||(s||(this.db.run(`
    ...
    `).run(t,e),t&&this.requeuePromptSync(e)}enqueueMutationOp(e,t){let s=JSON.parse(JSON.stringify(t));if(s.op==="set_prompt_session"){let n=s.target;n?.origin_device_id===null&&(n.origin_device_id="self")}Q(s),this.db.prepare(`
      ...
      VALUES (?, ?, ?, ?)
    `).run((0,ge.randomUUID)(),String(e),JSON.stringify(t),Date.now())}requeuePromptSync(e){let t=this.db.prepare(`
    ...
    `).all(j),t=[],s=new Set,n={};for(let o of e){let a=A(o.platform_source);n[a]||(n[a]=[]),n[a].includes(o.project)||n[a].push(o.project),s.has(o.project)||(s.add(o.project),t.push(o.project))}let r=le(Object.keys(n));return{projects:t,sources:r,projectsBySource:Object.fromEntries(r.map(o=>[o,n[o]||[]]))}}getLatestUserPrompt(e,t){let s=this.resolvePromptSessionDbId(e,t),n=s!==null?"up.session_db_id = ?":"up.content_session_id = ?",r=s!==null?s:e;return this.db.prepare(`
      ...
      ORDER BY up.created_at_epoch DESC
      LIMIT 1
    `).get(r)}findRecentDuplicateUserPrompt(e,t,s,n){return Ee(this.db,e,P(t),s,this.resolvePromptSessionDbId(e,n)??void 0)}getRecentSessionsWithStatus(e,t=3,s){let n=[e],r="";return s&&(r=`AND COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`,n.push(A(s))),n.push(t),this.db.prepare(`
      SELECT * FROM (
        SELECT
          s.memory_session_id,
          s.status,
    ...
    `).get(e,A(t))||null:this.db.prepare(`
        ...
        FROM observations
        WHERE id = ?
      `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:r,platformSource:o,type:a,concepts:_,files:c}=t,u=s==="relevance",l=u?"":`ORDER BY o.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,b=n&&!u?`LIMIT ${n}`:"",N=e.map(()=>"?").join(","),O=[...e],h=[];if(r&&(h.push("(o.project = ? OR o.merged_into_project = ?)"),O.push(r,r)),o&&(h.push(`COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`),O.push(A(o))),a)if(Array.isArray(a)){let g=a.map(()=>"?").join(",");h.push(`o.type IN (${g})`),O.push(...a)}else h.push("o.type = ?"),O.push(a);if(_){let g=Array.isArray(_)?_:[_],S=g.map(()=>"EXISTS (SELECT 1 FROM json_each(o.concepts) WHERE value = ?)");O.push(...g),h.push(`(${S.join(" OR ")})`)}if(c){let g=Array.isArray(c)?c:[c],S=g.map(()=>"(EXISTS (SELECT 1 FROM json_each(o.files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(o.files_modified) WHERE value LIKE ?))");g.forEach(I=>{O.push(`%${I}%`,`%${I}%`)}),h.push(`(${S.join(" OR ")})`)}let v=h.length>0?`WHERE o.id IN (${N}) AND ${h.join(" AND ")}`:`WHERE o.id IN (${N})`,f=this.db.prepare(`
      SELECT o.*
      FROM observations o
      LEFT JOIN sdk_sessions s ON s.memory_session_id = o.memory_session_id
      ${v}
      ${l}
      ${b}
    `).all(...O);if(!u)return f;let C=new Map(f.map(g=>[g.id,g])),m=e.map(g=>C.get(g)).filter(g=>!!g);return n?m.slice(0,n):m}getSummaryForSession(e,t){let s=[e],n="";return t&&(n=`
        AND EXISTS (
          SELECT 1
    ...
    `).get(e).count}createSDKSession(e,t,s,n,r){let o=new Date,a=o.getTime(),_=r?A(r):p,c=P(s);n&&this.validateSetTitleMutation(e,_,n);let u=this.db.prepare(`
    ...
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,r=0,o,a){let _=this.storeObservations(e,t,[s],null,n,r,o,a);return{id:_.observationIds[0],createdAtEpoch:_.createdAtEpoch}}storeSummary(e,t,s,n,r=0,o){let a=o??Date.now(),_=new Date(a).toISOString(),u=this.db.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,r,_,a);return{id:Number(u.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,r,o=0,a,_){let c=a??Date.now(),u=new Date(c).toISOString(),l=ue(c);return this.db.transaction(()=>{let N=[],O=this.db.prepare(`
        ...
        RETURNING id
      `),h=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let E of s){let f=ae(e,E.title,E.narrative),C=O.get(e,t,E.type,E.title,E.subtitle,JSON.stringify(E.facts),E.narrative,JSON.stringify(E.concepts),JSON.stringify(E.files_read),JSON.stringify(E.files_modified),r||null,o,E.agent_type??null,E.agent_id??null,f,u,c,_||null,E.metadata??null,l.dates,l.lastReinforced);if(C){N.push(C.id);continue}let m=h.get(e,f);if(!m)throw new Error(`storeObservations: ON CONFLICT without existing row for content_hash=${f}`);pe(this.db,m.id,new Date(c)),N.push(m.id)}let v=null;if(n){let f=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,r||null,o,u,c);v=Number(f.lastInsertRowid)}return{observationIds:N,summaryId:v,createdAtEpoch:c}})()}getSessionSummariesByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:r,platformSource:o}=t,a=s==="relevance",_=a?"":`ORDER BY ss.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,c=n&&!a?`LIMIT ${n}`:"",u=e.map(()=>"?").join(","),l=[...e],b=[];r&&(b.push("(ss.project = ? OR ss.merged_into_project = ?)"),l.push(r,r)),o&&(b.push(`COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`),l.push(A(o)));let N=b.length>0?`AND ${b.join(" AND ")}`:"",h=this.db.prepare(`
      SELECT ss.*
      ...
      ${_}
      ${c}
    `).all(...l);if(!a)return h;let v=new Map(h.map(f=>[f.id,f])),E=e.map(f=>v.get(f)).filter(f=>!!f);return n?E.slice(0,n):E}getUserPromptsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:r,platformSource:o}=t,a=s==="relevance",_=a?"":`ORDER BY up.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,c=n&&!a?`LIMIT ${n}`:"",u=e.map(()=>"?").join(","),l=[...e],b=[];r&&(b.push("s.project = ?"),l.push(r)),o&&(b.push(`COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`),l.push(A(o)));let N=b.length>0?`AND ${b.join(" AND ")}`:"",h=this.db.prepare(`
      SELECT
        up.*,
        s.project,
        s.memory_session_id,
      ...
      ${_}
      ${c}
    `).all(...l);if(!a)return h;let v=new Map(h.map(f=>[f.id,f])),E=e.map(f=>v.get(f)).filter(f=>!!f);return n?E.slice(0,n):E}getTimelineAroundTimestamp(e,t=10,s=10,n,r){return this.getTimelineAroundObservation(null,e,t,s,n,r)}getTimelineAroundObservation(e,t,s=10,n=10,r,o){let a=o?A(o):void 0,_=(m,g,S=!1)=>{let I=[],F=[];return r&&(S?(I.push(`(${m}.project = ? OR ${m}.merged_into_project = ?)`),F.push(r,r)):(I.push(`${m}.project = ?`),F.push(r))),a&&(I.push(`COALESCE(NULLIF(${g}.platform_source, ''), '${p}') = ?`),F.push(a)),{clause:I.length>0?`AND ${I.join(" AND ")}`:"",params:F}},c=_("o","src",!0),u=_("ss","src",!0),l=_("s","s"),b,N;if(e!==null){let m=`
      ...
      `,g=`
        ...
        ORDER BY o.id ASC
        LIMIT ?
      `;try{let S=this.db.prepare(m).all(e,...c.params,s+1),I=this.db.prepare(g).all(e,...c.params,n+1);if(S.length===0&&I.length===0)return{observations:[],sessions:[],prompts:[]};b=S.length>0?S[S.length-1].created_at_epoch:t,N=I.length>0?I[I.length-1].created_at_epoch:t}catch(S){return S instanceof Error?d.error("DB","Error getting boundary observations",{project:r},S):d.error("DB","Error getting boundary observations with non-Error",{},new Error(String(S))),{observations:[],sessions:[],prompts:[]}}}else{let m=`
      ...
      `,g=`
        ...
        LIMIT ?
      `;try{let S=this.db.prepare(m).all(t,...c.params,s),I=this.db.prepare(g).all(t,...c.params,n+1);if(S.length===0&&I.length===0)return{observations:[],sessions:[],prompts:[]};b=S.length>0?S[S.length-1].created_at_epoch:t,N=I.length>0?I[I.length-1].created_at_epoch:t}catch(S){return S instanceof Error?d.error("DB","Error getting boundary timestamps",{project:r},S):d.error("DB","Error getting boundary timestamps with non-Error",{},new Error(String(S))),{observations:[],sessions:[],prompts:[]}}}let O=`
      SELECT o.*
      FROM observations o
      LEFT JOIN sdk_sessions src ON src.memory_session_id = o.memory_session_id
