...
"use strict";var $=Object.defineProperty;var be=Object.getOwnPropertyDescriptor;var fe=Object.getOwnPropertyNames;var ge=Object.prototype.hasOwnProperty;var Se=(i,e)=>{for(var s in e)$(i,s,{get:e[s],enumerable:!0})},Ne=(i,e,s,t)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of fe(e))!ge.call(i,n)&&n!==s&&$(i,n,{get:()=>e[n],enumerable:!(t=be(e,n))||t.enumerable});return i};var he=i=>Ne($({},"__esModule",{value:!0}),i);var $e={};Se($e,{SessionStore:()=>z});module.exports=he($e);var Q=require("bun:sqlite"),Ee=require("child_process"),Te=require("crypto");var T=require("path"),M=require("os"),U=require("fs"),ee=require("url");var Re=null;function Ie(i){return(Re??process.stderr.write.bind(process.stderr))(i)}function k(i){Ie(i)}var qe=process.platform==="win32";function Oe(i){return i.replace(/^\uFEFF/,"")}function X(i){return JSON.parse(Oe(i))}function Ae(){return typeof __dirname<"u"?__dirname:(0,T.dirname)((0,ee.fileURLToPath)(__IMPORT_META_URL__))}var Je=Ae();function Z(i){return typeof i!="string"||i.length===0?i:i==="~"?(0,M.homedir)():i.startsWith("~/")?(0,T.join)((0,M.homedir)(),i.slice(2)):i}function Le(){if(process.env.CLAUDE_MEM_DATA_DIR)return Z(process.env.CLAUDE_MEM_DATA_DIR);let i=(0,T.join)((0,M.homedir)(),".claude-mem"),e=(0,T.join)(i,"settings.json");try{if((0,U.existsSync)(e)){let s=X((0,U.readFileSync)(e,"utf-8")),t=s.env??s;if(t.CLAUDE_MEM_DATA_DIR)return Z(t.CLAUDE_MEM_DATA_DIR)}}catch{}return i}var R=Le(),ye=process.env.CLAUDE_CONFIG_DIR||(0,T.join)((0,M.homedir)(),".claude"),Qe=(0,T.join)(ye,"plugins","marketplaces","thedotmack"),ve=(0,T.join)(R,"logs"),ze=(0,T.join)(R,"settings.json"),se=(0,T.join)(R,"claude-mem.db"),Ce=(0,T.join)(R,"observer-sessions"),j=(0,T.basename)(Ce);function te(i){(0,U.mkdirSync)(i,{recursive:!0})}var H={dataDir:()=>R,workerPid:()=>(0,T.join)(R,"worker.pid"),serverPid:()=>(0,T.join)(R,".server-beta.pid"),serverPort:()=>(0,T.join)(R,".server-beta.port"),serverRuntime:()=>(0,T.join)(R,".server-beta.runtime.json"),settings:()=>(0,T.join)(R,"settings.json"),database:()=>(0,T.join)(R,"claude-mem.db"),chroma:()=>(0,T.join)(R,"chroma"),combinedCerts:()=>(0,T.join)(R,"combined_certs.pem"),transcriptsConfig:()=>(0,T.join)(R,"transcript-watch.json"),transcriptsState:()=>(0,T.join)(R,"transcript-watch-state.json"),corpora:()=>(0,T.join)(R,"corpora"),supervisorRegistry:()=>(0,T.join)(R,"supervisor.json"),envFile:()=>(0,T.join)(R,".env"),logsDir:()=>ve};var v=require("fs"),ne=require("path");var q=(r=>(r[r.DEBUG=0]="DEBUG",r[r.INFO=1]="INFO",r[r.WARN=2]="WARN",r[r.ERROR=3]="ERROR",r[r.SILENT=4]="SILENT",r))(q||{}),W=null,V=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=H.logsDir();(0,v.existsSync)(e)||(0,v.mkdirSync)(e,{recursive:!0});let s=new Date().toISOString().split("T")[0];this.logFilePath=(0,ne.join)(e,`claude-mem-${s}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=H.settings();if((0,v.existsSync)(e)){let s=(0,v.readFileSync)(e,"utf-8"),n=(X(s).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=q[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
${e.stack}`:e.message;if(Array.isArray(e))return`[${e.length} items]`;let s=Object.keys(e);return s.length===0?"{}":s.length<=3?JSON.stringify(e):`{${s.length} keys: ${s.slice(0,3).join(", ")}...}`}return String(e)}formatTool(e,s){if(!s)return e;let t=s;if(typeof s=="string")try{t=JSON.parse(s)}catch{t=s}if(e==="Bash"&&t.command)return`${e}(${t.command})`;if(t.file_path)return`${e}(${t.file_path})`;if(t.notebook_path)return`${e}(${t.notebook_path})`;if(e==="Glob"&&t.pattern)return`${e}(${t.pattern})`;if(e==="Grep"&&t.pattern)return`${e}(${t.pattern})`;if(t.url)return`${e}(${t.url})`;if(t.query)return`${e}(${t.query})`;if(e==="Task"){if(t.subagent_type)return`${e}(${t.subagent_type})`;if(t.description)return`${e}(${t.description})`}return e==="Skill"&&t.skill?`${e}(${t.skill})`:e==="LSP"&&t.operation?`${e}(${t.operation})`:e}formatTimestamp(e){let s=e.getFullYear(),t=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0"),r=String(e.getHours()).padStart(2,"0"),o=String(e.getMinutes()).padStart(2,"0"),a=String(e.getSeconds()).padStart(2,"0"),_=String(e.getMilliseconds()).padStart(3,"0");return`${s}-${t}-${n} ${r}:${o}:${a}.${_}`}log(e,s,t,n,r){if(e<this.getLevel())return;this.ensureLogFileInitialized();let o=this.formatTimestamp(new Date),a=q[e].padEnd(5),_=s.padEnd(6),c="";n?.correlationId?c=`[${n.correlationId}] `:n?.sessionId&&(c=`[session-${n.sessionId}] `);let u="";if(r!=null)if(r instanceof Error)u=this.getLevel()===0?`
${r.message}
${r.stack}`:` ${r.message}`;else if(this.getLevel()===0&&typeof r=="object")try{u=`
`+JSON.stringify(r,null,2)}catch{u=" "+this.formatData(r)}else u=" "+this.formatData(r);let l="";if(n){let{sessionId:f,memorySessionId:I,correlationId:N,...y}=n;Object.keys(y).length>0&&(l=` {${Object.entries(y).map(([g,C])=>`${g}=${C}`).join(", ")}}`)}let b=`[${o}] [${a}] [${_}] ${c}${t}${l}${u}`;if(this.logFilePath)try{(0,v.appendFileSync)(this.logFilePath,b+`
`,"utf8")}catch(f){let I=f instanceof Error?f:new Error(String(f));k(`[LOGGER] Failed to write to log file: ${I.message}
${I.stack??""}
`)}else k(b+`
`)}debug(e,s,t,n){this.log(0,e,s,t,n)}info(e,s,t,n){this.log(1,e,s,t,n)}warn(e,s,t,n){this.log(2,e,s,t,n)}setErrorSink(e){W=e}error(e,s,t,n){this.log(3,e,s,t,n),this.routeErrorToSink(s,t,n)}routeErrorToSink(e,s,t){try{if(!W||!(t instanceof Error))return;W(t)}catch{}}dataIn(e,s,t,n){this.info(e,`\u2192 ${s}`,t,n)}dataOut(e,s,t,n){this.info(e,`\u2190 ${s}`,t,n)}success(e,s,t,n){this.info(e,`\u2713 ${s}`,t,n)}failure(e,s,t,n){this.error(e,`\u2717 ${s}`,t,n)}},d=new V;var re=require("crypto");function oe(i,e,s){return(0,re.createHash)("sha256").update([i||"",e||"",s||""].join("\0")).digest("hex").slice(0,16)}var p="claude";function De(i){return i.trim().toLowerCase().replace(/\s+/g,"-")}function A(i){if(!i)return p;let e=De(i);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:p}function ie(i){let e=["claude","codex","cursor"];return[...i].sort((s,t)=>{let n=e.indexOf(s),r=e.indexOf(t);return n!==-1||r!==-1?n===-1?1:r===-1?-1:n-r:s.localeCompare(t)})}function ae(i,e,s,t,n){let r=Date.now()-t,o=n!==void 0?"up.session_db_id = ?":"up.content_session_id = ?",a=n??e;return i.prepare(`
    SELECT
      up.*,
      s.memory_session_id,
      s.project,
    ...
    LIMIT 1
  `).get(a,s,r)??void 0}var ce=["private","claude-mem-context","system_instruction","system-instruction","persisted-output","system-reminder"],de=new RegExp(`<(${ce.join("|")})\\b[^>]*>[\\s\\S]*?</\\1>`,"g");var _e=100;function Ue(i){let e=Object.fromEntries(ce.map(n=>[n,0]));de.lastIndex=0;let s=0,t=i.replace(de,(n,r)=>(e[r]=(e[r]??0)+1,s+=1,""));return s>_e&&d.warn("SYSTEM","tag count exceeds limit",void 0,{tagCount:s,maxAllowed:_e,contentLength:i.length}),{stripped:t.trim(),counts:e}}function ue(i){return Ue(i).stripped}var we=["task-notification"],_s=new RegExp(`^\\s*<(${we.join("|")})\\b[^>]*>(?:(?!<\\1\\b|</\\1\\b)[\\s\\S])*</\\1>\\s*$`),cs=256*1024;var Y=4e3;function P(i){let e=i.trim(),t=ue(i).trim()||e;return t.length<=Y?t:(d.debug("DB","Truncated stored prompt text to the configured cap",{originalLength:t.length,storedLength:Y}),`${t.slice(0,Y-1)}\u2026`)}var Me=require("bun:sqlite");var xe=5e3,Fe=4194304;function ke(i){return i.prepare(`
    SELECT name
    FROM sqlite_master
    WHERE type = 'table'
      AND name NOT LIKE 'sqlite_%'
    LIMIT 1
  `).get()!=null}function w(i,e,s){try{i.run(e)}catch(t){let n=t instanceof Error?t:new Error(String(t));throw d.warn("DB",`Failed to apply SQLite pragma ${s}`,{sql:e},n),t}}function pe(i,e={}){let{enableWal:s=!0,enableIncrementalAutoVacuum:t=!0}=e;w(i,`PRAGMA busy_timeout = ${xe}`,"busy_timeout"),w(i,"PRAGMA foreign_keys = ON","foreign_keys"),w(i,"PRAGMA synchronous = NORMAL","synchronous"),w(i,`PRAGMA journal_size_limit = ${Fe}`,"journal_size_limit"),t&&!ke(i)&&w(i,"PRAGMA auto_vacuum = INCREMENTAL","auto_vacuum"),s&&w(i,"PRAGMA journal_mode = WAL","journal_mode")}var le=4096;var Xe=new Set(["set_title","set_prompt_session","remap_project"]),Pe=/^(?:0|[1-9][0-9]*)$/,me=18446744073709551615n;function L(i){throw d.debug("CLOUD_SYNC","Rejected invalid canonical content",{reason:i}),new Error(`canonical content: ${i}`)}function G(i,e={}){return typeof i!="string"||!Pe.test(i)?L("decimal values must be unsigned base-10 strings without leading zeroes"):(BigInt(i)>me&&L("decimal value exceeds uint64"),e.positive&&i==="0"&&L("decimal value must be positive"),i)}function K(i){let e=G(i);return BigInt(e)===me&&L("uint64 sequence overflow"),(BigInt(e)+1n).toString(10)}function Be(i){(i===null||typeof i!="object"||Array.isArray(i))&&L("mutation must be an object");let e=i;if((typeof e.op!="string"||!Xe.has(e.op))&&L("unsupported mutation op"),e.op==="set_title"){let r=x(e,["fields","op","target"],"set_title"),o=B(r.target,["content_session_id","memory_session_id","platform_source"],"set_title.target");o.memory_session_id===void 0&&o.content_session_id===void 0&&L("set_title target requires a session identifier");for(let _ of["memory_session_id","content_session_id","platform_source"])o[_]!==void 0&&D(o[_],_);let a=x(r.fields,["custom_title"],"set_title.fields");D(a.custom_title,"custom_title");return}if(e.op==="set_prompt_session"){let r=x(e,["fields","op","target"],"set_prompt_session"),o=x(r.target,["origin_device_id","origin_local_id"],"set_prompt_session.target");Ge(o.origin_device_id),G(o.origin_local_id);let a=B(r.fields,["content_session_id","memory_session_id","platform_source","project"],"set_prompt_session.fields");D(a.memory_session_id,"memory_session_id");for(let _ of["content_session_id","platform_source","project"])a[_]!==void 0&&D(a[_],_);return}let s=x(e,["fields","op","where"],"remap_project"),t=B(s.where,["memory_session_id","merged_into_project_is_null","project"],"remap_project.where");t.project!==void 0&&D(t.project,"project"),t.memory_session_id!==void 0&&D(t.memory_session_id,"memory_session_id"),t.merged_into_project_is_null!==void 0&&t.merged_into_project_is_null!==!0&&L("merged_into_project_is_null may only be true"),Object.keys(t).length===0&&L("remap_project where is empty");let n=B(s.fields,["merged_into_project","project"],"remap_project.fields");n.project!==void 0&&D(n.project,"project"),n.merged_into_project!==void 0&&D(n.merged_into_project,"merged_into_project"),Object.keys(n).length===0&&L("remap_project fields are empty")}function J(i){Be(i)}function Ge(i){return typeof i!="string"||i.length===0||Buffer.byteLength(i,"utf8")>128?L("origin_device_id must be a non-empty string of at most 128 UTF-8 bytes"):i}function D(i,e){return typeof i!="string"||i.length===0||i.trim().length===0||Buffer.byteLength(i,"utf8")>le?L(`${e} must be a non-blank string of at most ${le} UTF-8 bytes`):i}function x(i,e,s){if(i===null||typeof i!="object"||Array.isArray(i))return L(`${s} must be an object`);let t=i,n=Object.keys(t).sort(),r=[...e].sort();return(n.length!==r.length||n.some((o,a)=>o!==r[a]))&&L(`${s} must contain exactly: ${r.join(", ")}`),t}function B(i,e,s){if(i===null||typeof i!="object"||Array.isArray(i))return L(`${s} must be an object`);let t=i,n=new Set(e),r=Object.keys(t).find(o=>!n.has(o));return r&&L(`${s} contains unknown field ${r}`),t}var z=class{db;constructor(e=se){e instanceof Q.Database?this.db=e:(e!==":memory:"&&te(R),this.db=new Q.Database(e)),pe(this.db),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn(),this.ensureSDKSessionsPlatformContentIdentity(),this.ensureUserPromptsSessionDbId(),this.ensurePendingMessagesSessionToolUniqueIndex(),this.ensureSyncedAtColumns(),this.ensureSyncOriginColumns(),this.ensureSyncOutbox(),this.ensureSyncEntityLedger(),this.ensureSyncRevisionTextAffinity(),this.initializeSyncHubLaunchBaseline(),this.normalizeConceptTags()}getIndexColumns(e){return this.db.query(`PRAGMA index_info(${JSON.stringify(e)})`).all().map(s=>s.name)}hasUniqueIndexOnColumns(e,s){return this.db.query(`PRAGMA index_list(${e})`).all().some(n=>{if(n.unique!==1)return!1;let r=this.getIndexColumns(n.name);return r.length===s.length&&r.every((o,a)=>o===s[a])})}resolvePromptSessionDbId(e,s,t){if(s!==void 0)return s;let n=t?A(t):void 0;return n?this.db.prepare(`
        SELECT id
        FROM sdk_sessions
    ...
    `).get(e);if(!n)throw new Error(`Session ${e} not found in sdk_sessions`);n.memory_session_id!==s&&(this.db.prepare(`
      ...
      WHERE project IS NOT NULL AND project != ''
        AND project != ?
    `,n=[j];return s&&(t+=" AND COALESCE(platform_source, ?) = ?",n.push(p,s)),t+=" ORDER BY project ASC",this.db.prepare(t).all(...n).map(o=>o.project)}getProjectCatalog(){let e=this.db.prepare(`
      SELECT
    ...
    `).all(j),s=[],t=new Set,n={};for(let o of e){let a=A(o.platform_source);n[a]||(n[a]=[]),n[a].includes(o.project)||n[a].push(o.project),t.has(o.project)||(t.add(o.project),s.push(o.project))}let r=ie(Object.keys(n));return{projects:s,sources:r,projectsBySource:Object.fromEntries(r.map(o=>[o,n[o]||[]]))}}getLatestUserPrompt(e,s){let t=this.resolvePromptSessionDbId(e,s),n=t!==null?"up.session_db_id = ?":"up.content_session_id = ?",r=t!==null?t:e;return this.db.prepare(`
      ...
      ORDER BY up.created_at_epoch DESC
      LIMIT 1
    `).get(r)}findRecentDuplicateUserPrompt(e,s,t,n){return ae(this.db,e,P(s),t,this.resolvePromptSessionDbId(e,n)??void 0)}getRecentSessionsWithStatus(e,s=3,t){let n=[e],r="";return t&&(r=`AND COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`,n.push(A(t))),n.push(s),this.db.prepare(`
      SELECT * FROM (
        SELECT
          s.memory_session_id,
          s.status,
    ...
    `).get(e,A(s))||null:this.db.prepare(`
        ...
        FROM observations
        WHERE id = ?
      `).get(e)||null}getObservationsByIds(e,s={}){if(e.length===0)return[];let{orderBy:t="date_desc",limit:n,project:r,platformSource:o,type:a,concepts:_,files:c}=s,u=t==="relevance",l=u?"":`ORDER BY o.created_at_epoch ${t==="date_asc"?"ASC":"DESC"}`,b=n&&!u?`LIMIT ${n}`:"",f=e.map(()=>"?").join(","),I=[...e],N=[];if(r&&(N.push("(o.project = ? OR o.merged_into_project = ?)"),I.push(r,r)),o&&(N.push(`COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`),I.push(A(o))),a)if(Array.isArray(a)){let h=a.map(()=>"?").join(",");N.push(`o.type IN (${h})`),I.push(...a)}else N.push("o.type = ?"),I.push(a);if(_){let h=Array.isArray(_)?_:[_],S=h.map(()=>"EXISTS (SELECT 1 FROM json_each(o.concepts) WHERE value = ?)");I.push(...h),N.push(`(${S.join(" OR ")})`)}if(c){let h=Array.isArray(c)?c:[c],S=h.map(()=>"(EXISTS (SELECT 1 FROM json_each(o.files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(o.files_modified) WHERE value LIKE ?))");h.forEach(O=>{I.push(`%${O}%`,`%${O}%`)}),N.push(`(${S.join(" OR ")})`)}let y=N.length>0?`WHERE o.id IN (${f}) AND ${N.join(" AND ")}`:`WHERE o.id IN (${f})`,g=this.db.prepare(`
      SELECT o.*
      FROM observations o
      LEFT JOIN sdk_sessions s ON s.memory_session_id = o.memory_session_id
      ${y}
      ${l}
      ${b}
    `).all(...I);if(!u)return g;let C=new Map(g.map(h=>[h.id,h])),E=e.map(h=>C.get(h)).filter(h=>!!h);return n?E.slice(0,n):E}getSummaryForSession(e,s){let t=[e],n="";return s&&(n=`
        AND EXISTS (
          SELECT 1
    ...
    `).get(e).count}createSDKSession(e,s,t,n,r){let o=new Date,a=o.getTime(),_=r?A(r):p,c=P(t);n&&this.validateSetTitleMutation(e,_,n);let u=this.db.prepare(`
    ...
    `).get(p,_,e);if(u){if(s&&this.db.prepare(`
        ...
        `).run(s,u.id),n){let b=this.db.prepare("SELECT custom_title FROM sdk_sessions WHERE id = ?").get(u.id);b&&b.custom_title===null&&(this.db.prepare(`
      ...
      VALUES (?, NULL, ?, ?, ?, ?, ?, ?, 'active')
    `).run(e,s,_,c,n||null,o.toISOString(),a);return n&&this.enqueueSetTitleOp(e,_,n),Number(l.lastInsertRowid)}enqueueSetTitleOp(e,s,t){let n=this.validateSetTitleMutation(e,s,t);this.enqueueMutationOp("1",n)}validateSetTitleMutation(e,s,t){let n={op:"set_title",target:{content_session_id:e,platform_source:s},fields:{custom_title:t}};return J(n),n}saveUserPrompt(e,s,t,n){let r=new Date,o=r.getTime(),a=P(t),_=this.resolvePromptSessionDbId(e,n);return this.db.prepare(`
    ...
    `).get(e,s)?.prompt_text??null}storeObservation(e,s,t,n,r=0,o,a){let _=this.storeObservations(e,s,[t],null,n,r,o,a);return{id:_.observationIds[0],createdAtEpoch:_.createdAtEpoch}}storeSummary(e,s,t,n,r=0,o){let a=o??Date.now(),_=new Date(a).toISOString(),u=this.db.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,s,t.request,t.investigated,t.learned,t.completed,t.next_steps,t.notes,n||null,r,_,a);return{id:Number(u.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,s,t,n,r,o=0,a,_){let c=a??Date.now(),u=new Date(c).toISOString(),l=null;try{let f=(0,Ee.execSync)(`git -C "${s}" rev-parse --abbrev-ref HEAD`,{encoding:"utf8",timeout:5e3,stdio:["pipe","pipe","pipe"]}).trim();l=f==="HEAD"?null:f}catch{l=null}return this.db.transaction(()=>{let f=[],I=this.db.prepare(`
        ...
        RETURNING id
      `),N=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let m of t){let g=oe(e,m.title,m.narrative),C=I.get(e,s,m.type,m.title,m.subtitle,JSON.stringify(m.facts),m.narrative,JSON.stringify(m.concepts),JSON.stringify(m.files_read),JSON.stringify(m.files_modified),r||null,o,m.agent_type??null,m.agent_id??null,l,g,u,c,_||null,m.metadata??null);if(C){f.push(C.id);continue}let E=N.get(e,g);if(!E)throw new Error(`storeObservations: ON CONFLICT without existing row for content_hash=${g}`);f.push(E.id)}let y=null;if(n){let g=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,s,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,r||null,o,u,c);y=Number(g.lastInsertRowid)}return{observationIds:f,summaryId:y,createdAtEpoch:c}})()}getSessionSummariesByIds(e,s={}){if(e.length===0)return[];let{orderBy:t="date_desc",limit:n,project:r,platformSource:o}=s,a=t==="relevance",_=a?"":`ORDER BY ss.created_at_epoch ${t==="date_asc"?"ASC":"DESC"}`,c=n&&!a?`LIMIT ${n}`:"",u=e.map(()=>"?").join(","),l=[...e],b=[];r&&(b.push("(ss.project = ? OR ss.merged_into_project = ?)"),l.push(r,r)),o&&(b.push(`COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`),l.push(A(o)));let f=b.length>0?`AND ${b.join(" AND ")}`:"",N=this.db.prepare(`
      SELECT ss.*
      ...
      ${_}
      ${c}
    `).all(...l);if(!a)return N;let y=new Map(N.map(g=>[g.id,g])),m=e.map(g=>y.get(g)).filter(g=>!!g);return n?m.slice(0,n):m}getUserPromptsByIds(e,s={}){if(e.length===0)return[];let{orderBy:t="date_desc",limit:n,project:r,platformSource:o}=s,a=t==="relevance",_=a?"":`ORDER BY up.created_at_epoch ${t==="date_asc"?"ASC":"DESC"}`,c=n&&!a?`LIMIT ${n}`:"",u=e.map(()=>"?").join(","),l=[...e],b=[];r&&(b.push("s.project = ?"),l.push(r)),o&&(b.push(`COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`),l.push(A(o)));let f=b.length>0?`AND ${b.join(" AND ")}`:"",N=this.db.prepare(`
      SELECT
        up.*,
        s.project,
        s.memory_session_id,
      ...
      ${_}
      ${c}
    `).all(...l);if(!a)return N;let y=new Map(N.map(g=>[g.id,g])),m=e.map(g=>y.get(g)).filter(g=>!!g);return n?m.slice(0,n):m}getTimelineAroundTimestamp(e,s=10,t=10,n,r){return this.getTimelineAroundObservation(null,e,s,t,n,r)}getTimelineAroundObservation(e,s,t=10,n=10,r,o){let a=o?A(o):void 0,_=(E,h,S=!1)=>{let O=[],F=[];return r&&(S?(O.push(`(${E}.project = ? OR ${E}.merged_into_project = ?)`),F.push(r,r)):(O.push(`${E}.project = ?`),F.push(r))),a&&(O.push(`COALESCE(NULLIF(${h}.platform_source, ''), '${p}') = ?`),F.push(a)),{clause:O.length>0?`AND ${O.join(" AND ")}`:"",params:F}},c=_("o","src",!0),u=_("ss","src",!0),l=_("s","s"),b,f;if(e!==null){let E=`
