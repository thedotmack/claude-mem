...
"use strict";var x=Object.defineProperty;var ne=Object.getOwnPropertyDescriptor;var oe=Object.getOwnPropertyNames;var ie=Object.prototype.hasOwnProperty;var ae=(d,e)=>{for(var t in e)x(d,t,{get:e[t],enumerable:!0})},de=(d,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let r of oe(e))!ie.call(d,r)&&r!==t&&x(d,r,{get:()=>e[r],enumerable:!(s=ne(e,r))||s.enumerable});return d};var _e=d=>de(x({},"__esModule",{value:!0}),d);var fe={};ae(fe,{SessionStore:()=>j});module.exports=_e(fe);var H=require("bun:sqlite");var N=require("path"),X=require("os"),D=require("fs"),W=require("url");var Ee=null;function pe(d){return(Ee??process.stderr.write.bind(process.stderr))(d)}function U(d){pe(d)}var ve=process.platform==="win32";function ue(d){return d.replace(/^\uFEFF/,"")}function M(d){return JSON.parse(ue(d))}function me(){return typeof __dirname<"u"?__dirname:(0,N.dirname)((0,W.fileURLToPath)(__IMPORT_META_URL__))}var Me=me();function le(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let d=(0,N.join)((0,X.homedir)(),".claude-mem"),e=(0,N.join)(d,"settings.json");try{if((0,D.existsSync)(e)){let t=M((0,D.readFileSync)(e,"utf-8")),s=t.env??t;if(s.CLAUDE_MEM_DATA_DIR)return s.CLAUDE_MEM_DATA_DIR}}catch{}return d}var g=le(),ce=process.env.CLAUDE_CONFIG_DIR||(0,N.join)((0,X.homedir)(),".claude"),Fe=(0,N.join)(ce,"plugins","marketplaces","thedotmack"),Te=(0,N.join)(g,"logs"),we=(0,N.join)(g,"settings.json"),q=(0,N.join)(g,"claude-mem.db"),be=(0,N.join)(g,"observer-sessions"),F=(0,N.basename)(be);function V(d){(0,D.mkdirSync)(d,{recursive:!0})}var k={dataDir:()=>g,workerPid:()=>(0,N.join)(g,"worker.pid"),serverPid:()=>(0,N.join)(g,".server-beta.pid"),serverPort:()=>(0,N.join)(g,".server-beta.port"),serverRuntime:()=>(0,N.join)(g,".server-beta.runtime.json"),settings:()=>(0,N.join)(g,"settings.json"),database:()=>(0,N.join)(g,"claude-mem.db"),chroma:()=>(0,N.join)(g,"chroma"),combinedCerts:()=>(0,N.join)(g,"combined_certs.pem"),transcriptsConfig:()=>(0,N.join)(g,"transcript-watch.json"),transcriptsState:()=>(0,N.join)(g,"transcript-watch-state.json"),corpora:()=>(0,N.join)(g,"corpora"),supervisorRegistry:()=>(0,N.join)(g,"supervisor.json"),envFile:()=>(0,N.join)(g,".env"),logsDir:()=>Te};var C=require("fs"),Y=require("path");var G=(n=>(n[n.DEBUG=0]="DEBUG",n[n.INFO=1]="INFO",n[n.WARN=2]="WARN",n[n.ERROR=3]="ERROR",n[n.SILENT=4]="SILENT",n))(G||{}),P=null,B=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=k.logsDir();(0,C.existsSync)(e)||(0,C.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,Y.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=k.settings();if((0,C.existsSync)(e)){let t=(0,C.readFileSync)(e,"utf-8"),r=(M(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=G[r]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
${e.stack}`:e.message;if(Array.isArray(e))return`[${e.length} items]`;let t=Object.keys(e);return t.length===0?"{}":t.length<=3?JSON.stringify(e):`{${t.length} keys: ${t.slice(0,3).join(", ")}...}`}return String(e)}formatTool(e,t){if(!t)return e;let s=t;if(typeof t=="string")try{s=JSON.parse(t)}catch{s=t}if(e==="Bash"&&s.command)return`${e}(${s.command})`;if(s.file_path)return`${e}(${s.file_path})`;if(s.notebook_path)return`${e}(${s.notebook_path})`;if(e==="Glob"&&s.pattern)return`${e}(${s.pattern})`;if(e==="Grep"&&s.pattern)return`${e}(${s.pattern})`;if(s.url)return`${e}(${s.url})`;if(s.query)return`${e}(${s.query})`;if(e==="Task"){if(s.subagent_type)return`${e}(${s.subagent_type})`;if(s.description)return`${e}(${s.description})`}return e==="Skill"&&s.skill?`${e}(${s.skill})`:e==="LSP"&&s.operation?`${e}(${s.operation})`:e}formatTimestamp(e){let t=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),r=String(e.getDate()).padStart(2,"0"),n=String(e.getHours()).padStart(2,"0"),o=String(e.getMinutes()).padStart(2,"0"),i=String(e.getSeconds()).padStart(2,"0"),E=String(e.getMilliseconds()).padStart(3,"0");return`${t}-${s}-${r} ${n}:${o}:${i}.${E}`}log(e,t,s,r,n){if(e<this.getLevel())return;this.ensureLogFileInitialized();let o=this.formatTimestamp(new Date),i=G[e].padEnd(5),E=t.padEnd(6),_="";r?.correlationId?_=`[${r.correlationId}] `:r?.sessionId&&(_=`[session-${r.sessionId}] `);let u="";if(n!=null)if(n instanceof Error)u=this.getLevel()===0?`
${n.message}
${n.stack}`:` ${n.message}`;else if(this.getLevel()===0&&typeof n=="object")try{u=`
`+JSON.stringify(n,null,2)}catch{u=" "+this.formatData(n)}else u=" "+this.formatData(n);let I="";if(r){let{sessionId:S,memorySessionId:O,correlationId:R,...m}=r;Object.keys(m).length>0&&(I=` {${Object.entries(m).map(([f,v])=>`${f}=${v}`).join(", ")}}`)}let c=`[${o}] [${i}] [${E}] ${_}${s}${I}${u}`;if(this.logFilePath)try{(0,C.appendFileSync)(this.logFilePath,c+`
`,"utf8")}catch(S){let O=S instanceof Error?S:new Error(String(S));U(`[LOGGER] Failed to write to log file: ${O.message}
${O.stack??""}
`)}else U(c+`
`)}debug(e,t,s,r){this.log(0,e,t,s,r)}info(e,t,s,r){this.log(1,e,t,s,r)}warn(e,t,s,r){this.log(2,e,t,s,r)}setErrorSink(e){P=e}error(e,t,s,r){this.log(3,e,t,s,r),this.routeErrorToSink(t,s,r)}routeErrorToSink(e,t,s){try{if(!P||!(s instanceof Error))return;P(s)}catch{}}dataIn(e,t,s,r){this.info(e,`\u2192 ${t}`,s,r)}dataOut(e,t,s,r){this.info(e,`\u2190 ${t}`,s,r)}success(e,t,s,r){this.info(e,`\u2713 ${t}`,s,r)}failure(e,t,s,r){this.error(e,`\u2717 ${t}`,s,r)}},a=new B;var K=require("crypto");function Q(d,e,t){return(0,K.createHash)("sha256").update([d||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}var p="claude";function Ne(d){return d.trim().toLowerCase().replace(/\s+/g,"-")}function L(d){if(!d)return p;let e=Ne(d);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:p}function J(d){let e=["claude","codex","cursor"];return[...d].sort((t,s)=>{let r=e.indexOf(t),n=e.indexOf(s);return r!==-1||n!==-1?r===-1?1:n===-1?-1:r-n:t.localeCompare(s)})}function z(d,e,t,s,r){let n=Date.now()-s,o=r!==void 0?"up.session_db_id = ?":"up.content_session_id = ?",i=r??e;return d.prepare(`
    SELECT
      up.*,
      s.memory_session_id,
      s.project,
  ...
  `).get()!=null}function y(d,e,t){try{d.run(e)}catch(s){let r=s instanceof Error?s:new Error(String(s));throw a.warn("DB",`Failed to apply SQLite pragma ${t}`,{sql:e},r),s}}function re(d,e={}){let{enableWal:t=!0,enableIncrementalAutoVacuum:s=!0}=e;y(d,`PRAGMA busy_timeout = ${he}`,"busy_timeout"),y(d,"PRAGMA foreign_keys = ON","foreign_keys"),y(d,"PRAGMA synchronous = NORMAL","synchronous"),y(d,`PRAGMA journal_size_limit = ${ge}`,"journal_size_limit"),s&&!Oe(d)&&y(d,"PRAGMA auto_vacuum = INCREMENTAL","auto_vacuum"),t&&y(d,"PRAGMA journal_mode = WAL","journal_mode")}var j=class{db;constructor(e=q){e instanceof H.Database?this.db=e:(e!==":memory:"&&V(g),this.db=new H.Database(e)),re(this.db),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn(),this.ensureSDKSessionsPlatformContentIdentity(),this.ensureUserPromptsSessionDbId(),this.ensurePendingMessagesSessionToolUniqueIndex(),this.createAdvisorCallsTable()}getIndexColumns(e){return this.db.query(`PRAGMA index_info(${JSON.stringify(e)})`).all().map(t=>t.name)}hasUniqueIndexOnColumns(e,t){return this.db.query(`PRAGMA index_list(${e})`).all().some(r=>{if(r.unique!==1)return!1;let n=this.getIndexColumns(r.name);return n.length===t.length&&n.every((o,i)=>o===t[i])})}resolvePromptSessionDbId(e,t,s){if(t!==void 0)return t;let r=s?L(s):void 0;return r?this.db.prepare(`
    ...
    `),this.db.run("CREATE INDEX IF NOT EXISTS idx_pending_messages_session ON pending_messages(session_db_id)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_pending_messages_status ON pending_messages(status)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_pending_messages_claude_session ON pending_messages(content_session_id)"),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(16,new Date().toISOString()),a.debug("DB","pending_messages table created successfully")}createAdvisorCallsTable(){this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(37)||(this.db.run("DROP TABLE IF EXISTS advisor_calls"),a.debug("DB","Creating advisor_calls table"),this.db.run(`
    ...
    `),this.db.run("CREATE UNIQUE INDEX IF NOT EXISTS idx_advisor_calls_tool_use ON advisor_calls(tool_use_id)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_advisor_calls_session ON advisor_calls(session_db_id)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_advisor_calls_project ON advisor_calls(project)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_advisor_calls_occurred ON advisor_calls(occurred_at_epoch DESC)"),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(37,new Date().toISOString()),a.debug("DB","advisor_calls table created successfully"))}recordAdvisorCall(e){let t=new Date,s=this.db.prepare(`
    ...
    `).get(e);if(!r)throw new Error(`Session ${e} not found in sdk_sessions`);r.memory_session_id!==t&&(this.db.prepare(`
      ...
      `).run(t,e),a.info("DB","Registered memory_session_id before storage (FK fix)",{sessionDbId:e,oldId:r.memory_session_id,newId:t})),typeof s=="number"&&r.worker_port!==s&&this.db.prepare(`
      ...
      WHERE project IS NOT NULL AND project != ''
        AND project != ?
    `,r=[F];return t&&(s+=" AND COALESCE(platform_source, ?) = ?",r.push(p,t)),s+=" ORDER BY project ASC",this.db.prepare(s).all(...r).map(o=>o.project)}getProjectCatalog(){let e=this.db.prepare(`
      SELECT
    ...
    `).all(F),t=[],s=new Set,r={};for(let o of e){let i=L(o.platform_source);r[i]||(r[i]=[]),r[i].includes(o.project)||r[i].push(o.project),s.has(o.project)||(s.add(o.project),t.push(o.project))}let n=J(Object.keys(r));return{projects:t,sources:n,projectsBySource:Object.fromEntries(n.map(o=>[o,r[o]||[]]))}}getLatestUserPrompt(e,t){let s=this.resolvePromptSessionDbId(e,t),r=s!==null?"up.session_db_id = ?":"up.content_session_id = ?",n=s!==null?s:e;return this.db.prepare(`
      ...
      ORDER BY up.created_at_epoch DESC
      LIMIT 1
    `).get(n)}findRecentDuplicateUserPrompt(e,t,s,r){return z(this.db,e,w(t),s,this.resolvePromptSessionDbId(e,r)??void 0)}getRecentSessionsWithStatus(e,t=3,s){let r=[e],n="";return s&&(n=`AND COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`,r.push(L(s))),r.push(t),this.db.prepare(`
      SELECT * FROM (
        SELECT
          s.memory_session_id,
          s.status,
    ...
    `).get(e,L(t))||null:this.db.prepare(`
        ...
        FROM observations
        WHERE id = ?
      `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:r,project:n,platformSource:o,type:i,concepts:E,files:_}=t,u=s==="relevance",I=u?"":`ORDER BY o.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,c=r&&!u?`LIMIT ${r}`:"",S=e.map(()=>"?").join(","),O=[...e],R=[];if(n&&(R.push("o.project = ?"),O.push(n)),o&&(R.push(`COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`),O.push(L(o))),i)if(Array.isArray(i)){let h=i.map(()=>"?").join(",");R.push(`o.type IN (${h})`),O.push(...i)}else R.push("o.type = ?"),O.push(i);if(E){let h=Array.isArray(E)?E:[E],b=h.map(()=>"EXISTS (SELECT 1 FROM json_each(o.concepts) WHERE value = ?)");O.push(...h),R.push(`(${b.join(" OR ")})`)}if(_){let h=Array.isArray(_)?_:[_],b=h.map(()=>"(EXISTS (SELECT 1 FROM json_each(o.files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(o.files_modified) WHERE value LIKE ?))");h.forEach(A=>{O.push(`%${A}%`,`%${A}%`)}),R.push(`(${b.join(" OR ")})`)}let m=R.length>0?`WHERE o.id IN (${S}) AND ${R.join(" AND ")}`:`WHERE o.id IN (${S})`,f=this.db.prepare(`
      SELECT o.*
      FROM observations o
      LEFT JOIN sdk_sessions s ON s.memory_session_id = o.memory_session_id
      ${m}
    ...
    `).get(e).count}createSDKSession(e,t,s,r,n){let o=new Date,i=o.getTime(),E=n?L(n):p,_=w(s),u=this.db.prepare(`
      SELECT id, platform_source
      FROM sdk_sessions
      WHERE COALESCE(NULLIF(platform_source, ''), ?) = ?
        AND content_session_id = ?
    `).get(p,E,e);if(u)return t&&this.db.prepare(`
      ...
      VALUES (?, NULL, ?, ?, ?, ?, ?, ?, 'active')
    `).run(e,t,E,_,r||null,o.toISOString(),i);return Number(I.lastInsertRowid)}saveUserPrompt(e,t,s,r){let n=new Date,o=n.getTime(),i=w(s),E=this.resolvePromptSessionDbId(e,r);return this.db.prepare(`
      INSERT INTO user_prompts
      (session_db_id, content_session_id, prompt_number, prompt_text, created_at, created_at_epoch)
      VALUES (?, ?, ?, ?, ?, ?)
    `).run(E,e,t,i,n.toISOString(),o).lastInsertRowid}getUserPrompt(e,t,s){let r=this.resolvePromptSessionDbId(e,s);return r!==null?this.db.prepare(`
        SELECT prompt_text
        FROM user_prompts
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,r,n=0,o,i){let E=this.storeObservations(e,t,[s],null,r,n,o,i);return{id:E.observationIds[0],createdAtEpoch:E.createdAtEpoch}}storeSummary(e,t,s,r,n=0,o){let i=o??Date.now(),E=new Date(i).toISOString(),u=this.db.prepare(`
      INSERT INTO session_summaries
      (memory_session_id, project, request, investigated, learned, completed,
       next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,r||null,n,E,i);return{id:Number(u.lastInsertRowid),createdAtEpoch:i}}storeObservations(e,t,s,r,n,o=0,i,E){let _=i??Date.now(),u=new Date(_).toISOString();return this.db.transaction(()=>{let c=[],S=this.db.prepare(`
      ...
      ${E}
      ${_}
    `).all(...I);if(!i)return R;let m=new Map(R.map(f=>[f.id,f])),l=e.map(f=>m.get(f)).filter(f=>!!f);return r?l.slice(0,r):l}getUserPromptsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:r,project:n,platformSource:o}=t,i=s==="relevance",E=i?"":`ORDER BY up.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,_=r?`LIMIT ${r}`:"",u=e.map(()=>"?").join(","),I=[...e],c=[];n&&(c.push("s.project = ?"),I.push(n)),o&&(c.push(`COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`),I.push(L(o)));let S=c.length>0?`AND ${c.join(" AND ")}`:"",R=this.db.prepare(`
      SELECT
        up.*,
        s.project,
        s.memory_session_id,
      ...
      ${E}
      ${_}
    `).all(...I);if(!i)return R;let m=new Map(R.map(l=>[l.id,l]));return e.map(l=>m.get(l)).filter(l=>!!l)}getTimelineAroundTimestamp(e,t=10,s=10,r,n){return this.getTimelineAroundObservation(null,e,t,s,r,n)}getTimelineAroundObservation(e,t,s=10,r=10,n,o){let i=o?L(o):void 0,E=(T,h)=>{let b=[],A=[];return n&&(b.push(`${T}.project = ?`),A.push(n)),i&&(b.push(`COALESCE(NULLIF(${h}.platform_source, ''), '${p}') = ?`),A.push(i)),{clause:b.length>0?`AND ${b.join(" AND ")}`:"",params:A}},_=E("o","src"),u=E("ss","src"),I=E("s","s"),c,S;if(e!==null){let T=`
