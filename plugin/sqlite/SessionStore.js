...
"use strict";var k=Object.defineProperty;var ie=Object.getOwnPropertyDescriptor;var ae=Object.getOwnPropertyNames;var de=Object.prototype.hasOwnProperty;var _e=(d,e)=>{for(var s in e)k(d,s,{get:e[s],enumerable:!0})},ue=(d,e,s,t)=>{if(e&&typeof e=="object"||typeof e=="function")for(let r of ae(e))!de.call(d,r)&&r!==s&&k(d,r,{get:()=>e[r],enumerable:!(t=ie(e,r))||t.enumerable});return d};var pe=d=>ue(k({},"__esModule",{value:!0}),d);var Le={};_e(Le,{SessionStore:()=>j});module.exports=pe(Le);var W=require("bun:sqlite"),x=require("fs"),oe=require("crypto");var T=require("path"),X=require("os"),D=require("fs"),q=require("url");var Ee=null;function me(d){return(Ee??process.stderr.write.bind(process.stderr))(d)}function M(d){me(d)}var ye=process.platform==="win32";function ce(d){return d.replace(/^\uFEFF/,"")}function F(d){return JSON.parse(ce(d))}function le(){return typeof __dirname<"u"?__dirname:(0,T.dirname)((0,q.fileURLToPath)(__IMPORT_META_URL__))}var we=le();function Te(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let d=(0,T.join)((0,X.homedir)(),".claude-mem"),e=(0,T.join)(d,"settings.json");try{if((0,D.existsSync)(e)){let s=F((0,D.readFileSync)(e,"utf-8")),t=s.env??s;if(t.CLAUDE_MEM_DATA_DIR)return t.CLAUDE_MEM_DATA_DIR}}catch{}return d}var I=Te(),be=process.env.CLAUDE_CONFIG_DIR||(0,T.join)((0,X.homedir)(),".claude"),xe=(0,T.join)(be,"plugins","marketplaces","thedotmack"),Se=(0,T.join)(I,"logs"),ke=(0,T.join)(I,"settings.json"),V=(0,T.join)(I,"claude-mem.db"),Ne=(0,T.join)(I,"observer-sessions"),P=(0,T.basename)(Ne);function Y(d){(0,D.mkdirSync)(d,{recursive:!0})}var U={dataDir:()=>I,workerPid:()=>(0,T.join)(I,"worker.pid"),serverPid:()=>(0,T.join)(I,".server-beta.pid"),serverPort:()=>(0,T.join)(I,".server-beta.port"),serverRuntime:()=>(0,T.join)(I,".server-beta.runtime.json"),settings:()=>(0,T.join)(I,"settings.json"),database:()=>(0,T.join)(I,"claude-mem.db"),chroma:()=>(0,T.join)(I,"chroma"),combinedCerts:()=>(0,T.join)(I,"combined_certs.pem"),transcriptsConfig:()=>(0,T.join)(I,"transcript-watch.json"),transcriptsState:()=>(0,T.join)(I,"transcript-watch-state.json"),cloudSyncState:()=>(0,T.join)(I,"cloud-sync-state.json"),corpora:()=>(0,T.join)(I,"corpora"),supervisorRegistry:()=>(0,T.join)(I,"supervisor.json"),envFile:()=>(0,T.join)(I,".env"),logsDir:()=>Se};var v=require("fs"),K=require("path");var B=(n=>(n[n.DEBUG=0]="DEBUG",n[n.INFO=1]="INFO",n[n.WARN=2]="WARN",n[n.ERROR=3]="ERROR",n[n.SILENT=4]="SILENT",n))(B||{}),G=null,$=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=U.logsDir();(0,v.existsSync)(e)||(0,v.mkdirSync)(e,{recursive:!0});let s=new Date().toISOString().split("T")[0];this.logFilePath=(0,K.join)(e,`claude-mem-${s}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=U.settings();if((0,v.existsSync)(e)){let s=(0,v.readFileSync)(e,"utf-8"),r=(F(s).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=B[r]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
${e.stack}`:e.message;if(Array.isArray(e))return`[${e.length} items]`;let s=Object.keys(e);return s.length===0?"{}":s.length<=3?JSON.stringify(e):`{${s.length} keys: ${s.slice(0,3).join(", ")}...}`}return String(e)}formatTool(e,s){if(!s)return e;let t=s;if(typeof s=="string")try{t=JSON.parse(s)}catch{t=s}if(e==="Bash"&&t.command)return`${e}(${t.command})`;if(t.file_path)return`${e}(${t.file_path})`;if(t.notebook_path)return`${e}(${t.notebook_path})`;if(e==="Glob"&&t.pattern)return`${e}(${t.pattern})`;if(e==="Grep"&&t.pattern)return`${e}(${t.pattern})`;if(t.url)return`${e}(${t.url})`;if(t.query)return`${e}(${t.query})`;if(e==="Task"){if(t.subagent_type)return`${e}(${t.subagent_type})`;if(t.description)return`${e}(${t.description})`}return e==="Skill"&&t.skill?`${e}(${t.skill})`:e==="LSP"&&t.operation?`${e}(${t.operation})`:e}formatTimestamp(e){let s=e.getFullYear(),t=String(e.getMonth()+1).padStart(2,"0"),r=String(e.getDate()).padStart(2,"0"),n=String(e.getHours()).padStart(2,"0"),o=String(e.getMinutes()).padStart(2,"0"),i=String(e.getSeconds()).padStart(2,"0"),u=String(e.getMilliseconds()).padStart(3,"0");return`${s}-${t}-${r} ${n}:${o}:${i}.${u}`}log(e,s,t,r,n){if(e<this.getLevel())return;this.ensureLogFileInitialized();let o=this.formatTimestamp(new Date),i=B[e].padEnd(5),u=s.padEnd(6),_="";r?.correlationId?_=`[${r.correlationId}] `:r?.sessionId&&(_=`[session-${r.sessionId}] `);let E="";if(n!=null)if(n instanceof Error)E=this.getLevel()===0?`
${n.message}
${n.stack}`:` ${n.message}`;else if(this.getLevel()===0&&typeof n=="object")try{E=`
`+JSON.stringify(n,null,2)}catch{E=" "+this.formatData(n)}else E=" "+this.formatData(n);let h="";if(r){let{sessionId:R,memorySessionId:O,correlationId:N,...c}=r;Object.keys(c).length>0&&(h=` {${Object.entries(c).map(([f,C])=>`${f}=${C}`).join(", ")}}`)}let m=`[${o}] [${i}] [${u}] ${_}${t}${h}${E}`;if(this.logFilePath)try{(0,v.appendFileSync)(this.logFilePath,m+`
`,"utf8")}catch(R){let O=R instanceof Error?R:new Error(String(R));M(`[LOGGER] Failed to write to log file: ${O.message}
${O.stack??""}
`)}else M(m+`
`)}debug(e,s,t,r){this.log(0,e,s,t,r)}info(e,s,t,r){this.log(1,e,s,t,r)}warn(e,s,t,r){this.log(2,e,s,t,r)}setErrorSink(e){G=e}error(e,s,t,r){this.log(3,e,s,t,r),this.routeErrorToSink(s,t,r)}routeErrorToSink(e,s,t){try{if(!G||!(t instanceof Error))return;G(t)}catch{}}dataIn(e,s,t,r){this.info(e,`\u2192 ${s}`,t,r)}dataOut(e,s,t,r){this.info(e,`\u2190 ${s}`,t,r)}success(e,s,t,r){this.info(e,`\u2713 ${s}`,t,r)}failure(e,s,t,r){this.error(e,`\u2717 ${s}`,t,r)}},a=new $;var Q=require("crypto");function J(d,e,s){return(0,Q.createHash)("sha256").update([d||"",e||"",s||""].join("\0")).digest("hex").slice(0,16)}var p="claude";function Re(d){return d.trim().toLowerCase().replace(/\s+/g,"-")}function L(d){if(!d)return p;let e=Re(d);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:p}function z(d){let e=["claude","codex","cursor"];return[...d].sort((s,t)=>{let r=e.indexOf(s),n=e.indexOf(t);return r!==-1||n!==-1?r===-1?1:n===-1?-1:r-n:s.localeCompare(t)})}function Z(d,e,s,t,r){let n=Date.now()-t,o=r!==void 0?"up.session_db_id = ?":"up.content_session_id = ?",i=r??e;return d.prepare(`
    SELECT
      up.*,
      s.memory_session_id,
      s.project,
    ...
    LIMIT 1
  `).get(i,s,n)??void 0}var te=["private","claude-mem-context","system_instruction","system-instruction","persisted-output","system-reminder"],ee=new RegExp(`<(${te.join("|")})\\b[^>]*>[\\s\\S]*?</\\1>`,"g");var se=100;function Ie(d){let e=Object.fromEntries(te.map(r=>[r,0]));ee.lastIndex=0;let s=0,t=d.replace(ee,(r,n)=>(e[n]=(e[n]??0)+1,s+=1,""));return s>se&&a.warn("SYSTEM","tag count exceeds limit",void 0,{tagCount:s,maxAllowed:se,contentLength:d.length}),{stripped:t.trim(),counts:e}}function re(d){return Ie(d).stripped}var he=["task-notification"],Ye=new RegExp(`^\\s*<(${he.join("|")})\\b[^>]*>(?:(?!<\\1\\b|</\\1\\b)[\\s\\S])*</\\1>\\s*$`),Ke=256*1024;var H=4e3;function w(d){let e=d.trim(),t=re(d).trim()||e;return t.length<=H?t:(a.debug("DB","Truncated stored prompt text to the configured cap",{originalLength:t.length,storedLength:H}),`${t.slice(0,H-1)}\u2026`)}var ge=require("bun:sqlite");var Oe=5e3,fe=4194304;function Ae(d){return d.prepare(`
    SELECT name
    FROM sqlite_master
    WHERE type = 'table'
      AND name NOT LIKE 'sqlite_%'
    LIMIT 1
  `).get()!=null}function y(d,e,s){try{d.run(e)}catch(t){let r=t instanceof Error?t:new Error(String(t));throw a.warn("DB",`Failed to apply SQLite pragma ${s}`,{sql:e},r),t}}function ne(d,e={}){let{enableWal:s=!0,enableIncrementalAutoVacuum:t=!0}=e;y(d,`PRAGMA busy_timeout = ${Oe}`,"busy_timeout"),y(d,"PRAGMA foreign_keys = ON","foreign_keys"),y(d,"PRAGMA synchronous = NORMAL","synchronous"),y(d,`PRAGMA journal_size_limit = ${fe}`,"journal_size_limit"),t&&!Ae(d)&&y(d,"PRAGMA auto_vacuum = INCREMENTAL","auto_vacuum"),s&&y(d,"PRAGMA journal_mode = WAL","journal_mode")}var j=class{db;constructor(e=V,s={}){e instanceof W.Database?this.db=e:(e!==":memory:"&&Y(I),this.db=new W.Database(e)),ne(this.db),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn(),this.ensureSDKSessionsPlatformContentIdentity(),this.ensureUserPromptsSessionDbId(),this.ensurePendingMessagesSessionToolUniqueIndex(),this.ensureSyncedAtColumns(s.cloudSyncStatePath??U.cloudSyncState()),this.requeuePromptCloudSyncAfterMapperFix(),this.ensureSyncOriginColumns(),this.ensureSyncOutbox(),this.requeueAllForHubCutover(s.cloudSyncHubUrl)}getIndexColumns(e){return this.db.query(`PRAGMA index_info(${JSON.stringify(e)})`).all().map(s=>s.name)}hasUniqueIndexOnColumns(e,s){return this.db.query(`PRAGMA index_list(${e})`).all().some(r=>{if(r.unique!==1)return!1;let n=this.getIndexColumns(r.name);return n.length===s.length&&n.every((o,i)=>o===s[i])})}resolvePromptSessionDbId(e,s,t){if(s!==void 0)return s;let r=t?L(t):void 0;return r?this.db.prepare(`
        SELECT id
        FROM sdk_sessions
    ...
    `).run();a.info("DB","Requeued prompt cloud sync after mapper fix (v40)",{requeued:s.changes}),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(40,new Date().toISOString())}ensureSyncOriginColumns(){for(let e of["observations","session_summaries","user_prompts"]){let s=this.db.query(`PRAGMA table_info(${e})`).all(),t=new Set(s.map(r=>r.name));t.has("origin_device_id")||(this.db.run(`ALTER TABLE ${e} ADD COLUMN origin_device_id TEXT`),a.debug("DB",`Added origin_device_id column to ${e} table`)),t.has("origin_local_id")||(this.db.run(`ALTER TABLE ${e} ADD COLUMN origin_local_id TEXT`),a.debug("DB",`Added origin_local_id column to ${e} table`)),t.has("sync_rev")||(this.db.run(`ALTER TABLE ${e} ADD COLUMN sync_rev INTEGER NOT NULL DEFAULT 1`),a.debug("DB",`Added sync_rev column to ${e} table`)),this.db.run(`
    ...
    `).run(s,e),s&&this.requeuePromptSync(e)}enqueueMutationOp(e,s){this.db.prepare(`
      ...
      VALUES (?, ?, ?, ?)
    `).run((0,oe.randomUUID)(),e,JSON.stringify(s),Date.now())}requeuePromptSync(e){let s=this.db.prepare(`
    ...
    `).get(e);if(!r)throw new Error(`Session ${e} not found in sdk_sessions`);r.memory_session_id!==s&&(this.db.prepare(`
      ...
      WHERE project IS NOT NULL AND project != ''
        AND project != ?
    `,r=[P];return s&&(t+=" AND COALESCE(platform_source, ?) = ?",r.push(p,s)),t+=" ORDER BY project ASC",this.db.prepare(t).all(...r).map(o=>o.project)}getProjectCatalog(){let e=this.db.prepare(`
      SELECT
    ...
    `).get(e,L(s))||null:this.db.prepare(`
        ...
        FROM observations
        WHERE id = ?
      `).get(e)||null}getObservationsByIds(e,s={}){if(e.length===0)return[];let{orderBy:t="date_desc",limit:r,project:n,platformSource:o,type:i,concepts:u,files:_}=s,E=t==="relevance",h=E?"":`ORDER BY o.created_at_epoch ${t==="date_asc"?"ASC":"DESC"}`,m=r&&!E?`LIMIT ${r}`:"",R=e.map(()=>"?").join(","),O=[...e],N=[];if(n&&(N.push("o.project = ?"),O.push(n)),o&&(N.push(`COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`),O.push(L(o))),i)if(Array.isArray(i)){let g=i.map(()=>"?").join(",");N.push(`o.type IN (${g})`),O.push(...i)}else N.push("o.type = ?"),O.push(i);if(u){let g=Array.isArray(u)?u:[u],S=g.map(()=>"EXISTS (SELECT 1 FROM json_each(o.concepts) WHERE value = ?)");O.push(...g),N.push(`(${S.join(" OR ")})`)}if(_){let g=Array.isArray(_)?_:[_],S=g.map(()=>"(EXISTS (SELECT 1 FROM json_each(o.files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(o.files_modified) WHERE value LIKE ?))");g.forEach(A=>{O.push(`%${A}%`,`%${A}%`)}),N.push(`(${S.join(" OR ")})`)}let c=N.length>0?`WHERE o.id IN (${R}) AND ${N.join(" AND ")}`:`WHERE o.id IN (${R})`,f=this.db.prepare(`
      SELECT o.*
      FROM observations o
      LEFT JOIN sdk_sessions s ON s.memory_session_id = o.memory_session_id
      ${c}
      ${h}
      ${m}
    `).all(...O);if(!E)return f;let C=new Map(f.map(g=>[g.id,g])),b=e.map(g=>C.get(g)).filter(g=>!!g);return r?b.slice(0,r):b}getSummaryForSession(e,s){let t=[e],r="";return s&&(r=`
        AND EXISTS (
          SELECT 1
    ...
    `).get(e).count}createSDKSession(e,s,t,r,n){let o=new Date,i=o.getTime(),u=n?L(n):p,_=w(t),E=this.db.prepare(`
      SELECT id, platform_source
      FROM sdk_sessions
      WHERE COALESCE(NULLIF(platform_source, ''), ?) = ?
        AND content_session_id = ?
    `).get(p,u,e);if(E){if(s&&this.db.prepare(`
          UPDATE sdk_sessions SET project = ?
          WHERE id = ? AND (project IS NULL OR project = '')
        `).run(s,E.id),r){let m=this.db.prepare("SELECT custom_title FROM sdk_sessions WHERE id = ?").get(E.id);m&&m.custom_title===null&&(this.db.prepare(`
            UPDATE sdk_sessions SET custom_title = ?
            WHERE id = ? AND custom_title IS NULL
          `).run(r,E.id),this.enqueueSetTitleOp(e,u,r))}return E.id}let h=this.db.prepare(`
      INSERT INTO sdk_sessions
      (content_session_id, memory_session_id, project, platform_source, user_prompt, custom_title, started_at, started_at_epoch, status)
      VALUES (?, NULL, ?, ?, ?, ?, ?, ?, 'active')
    `).run(e,s,u,_,r||null,o.toISOString(),i);return r&&this.enqueueSetTitleOp(e,u,r),Number(h.lastInsertRowid)}enqueueSetTitleOp(e,s,t){this.enqueueMutationOp(1,{op:"set_title",target:{content_session_id:e,platform_source:s},fields:{custom_title:t}})}saveUserPrompt(e,s,t,r){let n=new Date,o=n.getTime(),i=w(t),u=this.resolvePromptSessionDbId(e,r);return this.db.prepare(`
    ...
    `).run(u,e,s,i,n.toISOString(),o).lastInsertRowid}getUserPrompt(e,s,t){let r=this.resolvePromptSessionDbId(e,t);return r!==null?this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,s)?.prompt_text??null}storeObservation(e,s,t,r,n=0,o,i){let u=this.storeObservations(e,s,[t],null,r,n,o,i);return{id:u.observationIds[0],createdAtEpoch:u.createdAtEpoch}}storeSummary(e,s,t,r,n=0,o){let i=o??Date.now(),u=new Date(i).toISOString(),E=this.db.prepare(`
      INSERT INTO session_summaries
      (memory_session_id, project, request, investigated, learned, completed,
       next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,s,t.request,t.investigated,t.learned,t.completed,t.next_steps,t.notes,r||null,n,u,i);return{id:Number(E.lastInsertRowid),createdAtEpoch:i}}storeObservations(e,s,t,r,n,o=0,i,u){let _=i??Date.now(),E=new Date(_).toISOString();return this.db.transaction(()=>{let m=[],R=this.db.prepare(`
        ...
        RETURNING id
      `),O=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let c of t){let l=J(e,c.title,c.narrative),f=R.get(e,s,c.type,c.title,c.subtitle,JSON.stringify(c.facts),c.narrative,JSON.stringify(c.concepts),JSON.stringify(c.files_read),JSON.stringify(c.files_modified),n||null,o,c.agent_type??null,c.agent_id??null,l,E,_,u||null,c.metadata??null);if(f){m.push(f.id);continue}let C=O.get(e,l);if(!C)throw new Error(`storeObservations: ON CONFLICT without existing row for content_hash=${l}`);m.push(C.id)}let N=null;if(r){let l=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,s,r.request,r.investigated,r.learned,r.completed,r.next_steps,r.notes,n||null,o,E,_);N=Number(l.lastInsertRowid)}return{observationIds:m,summaryId:N,createdAtEpoch:_}})()}getSessionSummariesByIds(e,s={}){if(e.length===0)return[];let{orderBy:t="date_desc",limit:r,project:n,platformSource:o}=s,i=t==="relevance",u=i?"":`ORDER BY ss.created_at_epoch ${t==="date_asc"?"ASC":"DESC"}`,_=r&&!i?`LIMIT ${r}`:"",E=e.map(()=>"?").join(","),h=[...e],m=[];n&&(m.push("ss.project = ?"),h.push(n)),o&&(m.push(`COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`),h.push(L(o)));let R=m.length>0?`AND ${m.join(" AND ")}`:"",N=this.db.prepare(`
      SELECT ss.*
      ...
      ${u}
      ${_}
    `).all(...h);if(!i)return N;let c=new Map(N.map(f=>[f.id,f])),l=e.map(f=>c.get(f)).filter(f=>!!f);return r?l.slice(0,r):l}getUserPromptsByIds(e,s={}){if(e.length===0)return[];let{orderBy:t="date_desc",limit:r,project:n,platformSource:o}=s,i=t==="relevance",u=i?"":`ORDER BY up.created_at_epoch ${t==="date_asc"?"ASC":"DESC"}`,_=r?`LIMIT ${r}`:"",E=e.map(()=>"?").join(","),h=[...e],m=[];n&&(m.push("s.project = ?"),h.push(n)),o&&(m.push(`COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`),h.push(L(o)));let R=m.length>0?`AND ${m.join(" AND ")}`:"",N=this.db.prepare(`
      SELECT
        up.*,
        s.project,
        s.memory_session_id,
      ...
      ${u}
      ${_}
    `).all(...h);if(!i)return N;let c=new Map(N.map(l=>[l.id,l]));return e.map(l=>c.get(l)).filter(l=>!!l)}getTimelineAroundTimestamp(e,s=10,t=10,r,n){return this.getTimelineAroundObservation(null,e,s,t,r,n)}getTimelineAroundObservation(e,s,t=10,r=10,n,o){let i=o?L(o):void 0,u=(b,g)=>{let S=[],A=[];return n&&(S.push(`${b}.project = ?`),A.push(n)),i&&(S.push(`COALESCE(NULLIF(${g}.platform_source, ''), '${p}') = ?`),A.push(i)),{clause:S.length>0?`AND ${S.join(" AND ")}`:"",params:A}},_=u("o","src"),E=u("ss","src"),h=u("s","s"),m,R;if(e!==null){let b=`
      ...
      `,g=`
        ...
        LIMIT ?
      `;try{let S=this.db.prepare(b).all(s,..._.params,t),A=this.db.prepare(g).all(s,..._.params,r+1);if(S.length===0&&A.length===0)return{observations:[],sessions:[],prompts:[]};m=S.length>0?S[S.length-1].created_at_epoch:s,R=A.length>0?A[A.length-1].created_at_epoch:s}catch(S){return S instanceof Error?a.error("DB","Error getting boundary timestamps",{project:n},S):a.error("DB","Error getting boundary timestamps with non-Error",{},new Error(String(S))),{observations:[],sessions:[],prompts:[]}}}let O=`
      SELECT o.*
      FROM observations o
      LEFT JOIN sdk_sessions src ON src.memory_session_id = o.memory_session_id
