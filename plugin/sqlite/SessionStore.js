...
"use strict";var $=Object.defineProperty;var fe=Object.getOwnPropertyDescriptor;var ge=Object.getOwnPropertyNames;var Se=Object.prototype.hasOwnProperty;var Ne=(i,e)=>{for(var t in e)$(i,t,{get:e[t],enumerable:!0})},he=(i,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of ge(e))!Se.call(i,n)&&n!==t&&$(i,n,{get:()=>e[n],enumerable:!(s=fe(e,n))||s.enumerable});return i};var Re=i=>he($({},"__esModule",{value:!0}),i);var je={};Ne(je,{SessionStore:()=>Z});module.exports=Re(je);var z=require("bun:sqlite"),be=require("crypto");var b=require("path"),j=require("os"),U=require("fs"),te=require("url");var Oe=null;function Ie(i){return(Oe??process.stderr.write.bind(process.stderr))(i)}function F(i){Ie(i)}var Ve=process.platform==="win32";function Ae(i){return i.replace(/^\uFEFF/,"")}function k(i){return JSON.parse(Ae(i))}var ee=require("os"),se=require("path");function X(i,e=process.platform,t=(0,ee.homedir)()){return typeof i!="string"||i.length===0?i:i==="~"?t:i.startsWith("~/")||e==="win32"&&i.startsWith("~\\")?(0,se.join)(t,i.slice(2)):i}function Le(){return typeof __dirname<"u"?__dirname:(0,b.dirname)((0,te.fileURLToPath)(__IMPORT_META_URL__))}var Ze=Le();function ye(){if(process.env.CLAUDE_MEM_DATA_DIR)return X(process.env.CLAUDE_MEM_DATA_DIR);let i=(0,b.join)((0,j.homedir)(),".claude-mem"),e=(0,b.join)(i,"settings.json");try{if((0,U.existsSync)(e)){let t=k((0,U.readFileSync)(e,"utf-8")),s=t.env??t;if(s.CLAUDE_MEM_DATA_DIR)return X(s.CLAUDE_MEM_DATA_DIR)}}catch{}return i}var O=ye(),ve=process.env.CLAUDE_CONFIG_DIR||(0,b.join)((0,j.homedir)(),".claude"),es=(0,b.join)(ve,"plugins","marketplaces","thedotmack"),Ce=(0,b.join)(O,"logs"),ss=(0,b.join)(O,"settings.json"),ne=(0,b.join)(O,"claude-mem.db"),De=(0,b.join)(O,"observer-sessions"),H=(0,b.basename)(De);function re(i){(0,U.mkdirSync)(i,{recursive:!0})}var W={dataDir:()=>O,workerPid:()=>(0,b.join)(O,"worker.pid"),serverPid:()=>(0,b.join)(O,".server-beta.pid"),serverPort:()=>(0,b.join)(O,".server-beta.port"),serverRuntime:()=>(0,b.join)(O,".server-beta.runtime.json"),settings:()=>(0,b.join)(O,"settings.json"),database:()=>(0,b.join)(O,"claude-mem.db"),chroma:()=>(0,b.join)(O,"chroma"),combinedCerts:()=>(0,b.join)(O,"combined_certs.pem"),transcriptsConfig:()=>(0,b.join)(O,"transcript-watch.json"),transcriptsState:()=>(0,b.join)(O,"transcript-watch-state.json"),corpora:()=>(0,b.join)(O,"corpora"),supervisorRegistry:()=>(0,b.join)(O,"supervisor.json"),envFile:()=>(0,b.join)(O,".env"),logsDir:()=>Ce};var v=require("fs"),oe=require("path");var V=(r=>(r[r.DEBUG=0]="DEBUG",r[r.INFO=1]="INFO",r[r.WARN=2]="WARN",r[r.ERROR=3]="ERROR",r[r.SILENT=4]="SILENT",r))(V||{}),q=null,Y=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=W.logsDir();(0,v.existsSync)(e)||(0,v.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,oe.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=W.settings();if((0,v.existsSync)(e)){let t=(0,v.readFileSync)(e,"utf-8"),n=(k(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=V[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
${e.stack}`:e.message;if(Array.isArray(e))return`[${e.length} items]`;let t=Object.keys(e);return t.length===0?"{}":t.length<=3?JSON.stringify(e):`{${t.length} keys: ${t.slice(0,3).join(", ")}...}`}return String(e)}formatTool(e,t){if(!t)return e;let s=t;if(typeof t=="string")try{s=JSON.parse(t)}catch{s=t}if(e==="Bash"&&s.command)return`${e}(${s.command})`;if(s.file_path)return`${e}(${s.file_path})`;if(s.notebook_path)return`${e}(${s.notebook_path})`;if(e==="Glob"&&s.pattern)return`${e}(${s.pattern})`;if(e==="Grep"&&s.pattern)return`${e}(${s.pattern})`;if(s.url)return`${e}(${s.url})`;if(s.query)return`${e}(${s.query})`;if(e==="Task"){if(s.subagent_type)return`${e}(${s.subagent_type})`;if(s.description)return`${e}(${s.description})`}return e==="Skill"&&s.skill?`${e}(${s.skill})`:e==="LSP"&&s.operation?`${e}(${s.operation})`:e}formatTimestamp(e){let t=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0"),r=String(e.getHours()).padStart(2,"0"),o=String(e.getMinutes()).padStart(2,"0"),a=String(e.getSeconds()).padStart(2,"0"),_=String(e.getMilliseconds()).padStart(3,"0");return`${t}-${s}-${n} ${r}:${o}:${a}.${_}`}log(e,t,s,n,r){if(e<this.getLevel())return;this.ensureLogFileInitialized();let o=this.formatTimestamp(new Date),a=V[e].padEnd(5),_=t.padEnd(6),c="";n?.correlationId?c=`[${n.correlationId}] `:n?.sessionId&&(c=`[session-${n.sessionId}] `);let u="";if(r!=null)if(r instanceof Error)u=this.getLevel()===0?`
${r.message}
${r.stack}`:` ${r.message}`;else if(this.getLevel()===0&&typeof r=="object")try{u=`
`+JSON.stringify(r,null,2)}catch{u=" "+this.formatData(r)}else u=" "+this.formatData(r);let m="";if(n){let{sessionId:h,memorySessionId:I,correlationId:S,...l}=n;Object.keys(l).length>0&&(m=` {${Object.entries(l).map(([f,C])=>`${f}=${C}`).join(", ")}}`)}let T=`[${o}] [${a}] [${_}] ${c}${s}${m}${u}`;if(this.logFilePath)try{(0,v.appendFileSync)(this.logFilePath,T+`
`,"utf8")}catch(h){let I=h instanceof Error?h:new Error(String(h));F(`[LOGGER] Failed to write to log file: ${I.message}
${I.stack??""}
`)}else F(T+`
`)}debug(e,t,s,n){this.log(0,e,t,s,n)}info(e,t,s,n){this.log(1,e,t,s,n)}warn(e,t,s,n){this.log(2,e,t,s,n)}setErrorSink(e){q=e}error(e,t,s,n){this.log(3,e,t,s,n),this.routeErrorToSink(t,s,n)}routeErrorToSink(e,t,s){try{if(!q||!(s instanceof Error))return;q(s)}catch{}}dataIn(e,t,s,n){this.info(e,`\u2192 ${t}`,s,n)}dataOut(e,t,s,n){this.info(e,`\u2190 ${t}`,s,n)}success(e,t,s,n){this.info(e,`\u2713 ${t}`,s,n)}failure(e,t,s,n){this.error(e,`\u2717 ${t}`,s,n)}},d=new Y;var ie=require("crypto");function ae(i,e,t){return(0,ie.createHash)("sha256").update([i||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}var p="claude";function Ue(i){return i.trim().toLowerCase().replace(/\s+/g,"-")}function L(i){if(!i)return p;let e=Ue(i);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:p}function de(i){let e=["claude","codex","cursor"];return[...i].sort((t,s)=>{let n=e.indexOf(t),r=e.indexOf(s);return n!==-1||r!==-1?n===-1?1:r===-1?-1:n-r:t.localeCompare(s)})}function _e(i,e,t,s,n){let r=Date.now()-s,o=n!==void 0?"up.session_db_id = ?":"up.content_session_id = ?",a=n??e;return i.prepare(`
    SELECT
      up.*,
      s.memory_session_id,
      s.project,
  ...
  `).get()!=null}function w(i,e,t){try{i.run(e)}catch(s){let n=s instanceof Error?s:new Error(String(s));throw d.warn("DB",`Failed to apply SQLite pragma ${t}`,{sql:e},n),s}}function me(i,e={}){let{enableWal:t=!0,enableIncrementalAutoVacuum:s=!0}=e;w(i,`PRAGMA busy_timeout = ${Fe}`,"busy_timeout"),w(i,"PRAGMA foreign_keys = ON","foreign_keys"),w(i,"PRAGMA synchronous = NORMAL","synchronous"),w(i,`PRAGMA journal_size_limit = ${ke}`,"journal_size_limit"),s&&!Xe(i)&&w(i,"PRAGMA auto_vacuum = INCREMENTAL","auto_vacuum"),t&&w(i,"PRAGMA journal_mode = WAL","journal_mode")}var Ee=4096;var Pe=new Set(["set_title","set_prompt_session","remap_project"]),Be=/^(?:0|[1-9][0-9]*)$/,Te=18446744073709551615n;function y(i){throw d.debug("CLOUD_SYNC","Rejected invalid canonical content",{reason:i}),new Error(`canonical content: ${i}`)}function G(i,e={}){return typeof i!="string"||!Be.test(i)?y("decimal values must be unsigned base-10 strings without leading zeroes"):(BigInt(i)>Te&&y("decimal value exceeds uint64"),e.positive&&i==="0"&&y("decimal value must be positive"),i)}function J(i){let e=G(i);return BigInt(e)===Te&&y("uint64 sequence overflow"),(BigInt(e)+1n).toString(10)}function Ge(i){(i===null||typeof i!="object"||Array.isArray(i))&&y("mutation must be an object");let e=i;if((typeof e.op!="string"||!Pe.has(e.op))&&y("unsupported mutation op"),e.op==="set_title"){let r=M(e,["fields","op","target"],"set_title"),o=B(r.target,["content_session_id","memory_session_id","platform_source"],"set_title.target");o.memory_session_id===void 0&&o.content_session_id===void 0&&y("set_title target requires a session identifier");for(let _ of["memory_session_id","content_session_id","platform_source"])o[_]!==void 0&&D(o[_],_);let a=M(r.fields,["custom_title"],"set_title.fields");D(a.custom_title,"custom_title");return}if(e.op==="set_prompt_session"){let r=M(e,["fields","op","target"],"set_prompt_session"),o=M(r.target,["origin_device_id","origin_local_id"],"set_prompt_session.target");$e(o.origin_device_id),G(o.origin_local_id);let a=B(r.fields,["content_session_id","memory_session_id","platform_source","project"],"set_prompt_session.fields");D(a.memory_session_id,"memory_session_id");for(let _ of["content_session_id","platform_source","project"])a[_]!==void 0&&D(a[_],_);return}let t=M(e,["fields","op","where"],"remap_project"),s=B(t.where,["memory_session_id","merged_into_project_is_null","project"],"remap_project.where");s.project!==void 0&&D(s.project,"project"),s.memory_session_id!==void 0&&D(s.memory_session_id,"memory_session_id"),s.merged_into_project_is_null!==void 0&&s.merged_into_project_is_null!==!0&&y("merged_into_project_is_null may only be true"),Object.keys(s).length===0&&y("remap_project where is empty");let n=B(t.fields,["merged_into_project","project"],"remap_project.fields");n.project!==void 0&&D(n.project,"project"),n.merged_into_project!==void 0&&D(n.merged_into_project,"merged_into_project"),Object.keys(n).length===0&&y("remap_project fields are empty")}function Q(i){Ge(i)}function $e(i){return typeof i!="string"||i.length===0||Buffer.byteLength(i,"utf8")>128?y("origin_device_id must be a non-empty string of at most 128 UTF-8 bytes"):i}function D(i,e){return typeof i!="string"||i.length===0||i.trim().length===0||Buffer.byteLength(i,"utf8")>Ee?y(`${e} must be a non-blank string of at most ${Ee} UTF-8 bytes`):i}function M(i,e,t){if(i===null||typeof i!="object"||Array.isArray(i))return y(`${t} must be an object`);let s=i,n=Object.keys(s).sort(),r=[...e].sort();return(n.length!==r.length||n.some((o,a)=>o!==r[a]))&&y(`${t} must contain exactly: ${r.join(", ")}`),s}function B(i,e,t){if(i===null||typeof i!="object"||Array.isArray(i))return y(`${t} must be an object`);let s=i,n=new Set(e),r=Object.keys(s).find(o=>!n.has(o));return r&&y(`${t} contains unknown field ${r}`),s}var Z=class{db;constructor(e=ne){e instanceof z.Database?this.db=e:(e!==":memory:"&&re(O),this.db=new z.Database(e)),me(this.db),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn(),this.ensureSDKSessionsPlatformContentIdentity(),this.ensureUserPromptsSessionDbId(),this.ensurePendingMessagesSessionToolUniqueIndex(),this.ensureSyncedAtColumns(),this.ensureSyncOriginColumns(),this.ensureSyncOutbox(),this.ensureSyncEntityLedger(),this.ensureSyncRevisionTextAffinity(),this.initializeSyncHubLaunchBaseline(),this.normalizeConceptTags(),this.ensureSDKSessionsObservedColumns()}getIndexColumns(e){return this.db.query(`PRAGMA index_info(${JSON.stringify(e)})`).all().map(t=>t.name)}hasUniqueIndexOnColumns(e,t){return this.db.query(`PRAGMA index_list(${e})`).all().some(n=>{if(n.unique!==1)return!1;let r=this.getIndexColumns(n.name);return r.length===t.length&&r.every((o,a)=>o===t[a])})}resolvePromptSessionDbId(e,t,s){if(t!==void 0)return t;let n=s?L(s):void 0;return n?this.db.prepare(`
    ...
    `);let e=new Set(this.db.query("PRAGMA table_info(sync_outbox)").all().map(t=>t.name));e.has("canonical_body")||this.db.run("ALTER TABLE sync_outbox ADD COLUMN canonical_body TEXT"),e.has("operation_sha256")||this.db.run("ALTER TABLE sync_outbox ADD COLUMN operation_sha256 TEXT"),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(42,new Date().toISOString())}ensureSyncRevisionTextAffinity(){let e=[{table:"observations",column:"sync_rev",temporary:"sync_rev_text_v46"},{table:"session_summaries",column:"sync_rev",temporary:"sync_rev_text_v46"},{table:"user_prompts",column:"sync_rev",temporary:"sync_rev_text_v46"},{table:"sync_outbox",column:"rev",temporary:"rev_text_v46"}],t=(o,a)=>this.db.query(`PRAGMA table_info(${o})`).all().find(_=>_.name===a),s=o=>o?.type.trim().toUpperCase()==="TEXT";if(this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(46)&&e.every(o=>s(t(o.table,o.column))))return;this.db.transaction(()=>{for(let o of e){let a=this.db.query(`PRAGMA table_info(${o.table})`).all(),_=a.find(u=>u.name===o.column);if(!_)throw new Error(`schema v46: missing ${o.table}.${o.column}`);for(let u of this.db.query(`
          ...
          FROM ${o.table}
        `).iterate()){let m=u;if(m.storage_type==="real")throw new Error(`schema v46: ${o.table}.${o.column} row ${m.row_id} is REAL and unrecoverably rounded`);if(m.storage_type!=="integer"&&m.storage_type!=="text")throw new Error(`schema v46: ${o.table}.${o.column} row ${m.row_id} has unsupported ${m.storage_type} storage`);try{G(m.revision,{positive:!0})}catch{throw new Error(`schema v46: ${o.table}.${o.column} row ${m.row_id} is not a positive canonical uint64 revision`)}}if(s(_))continue;if(a.some(u=>u.name===o.temporary))throw new Error(`schema v46: unexpected temporary column ${o.table}.${o.temporary}`);this.db.run(`ALTER TABLE ${o.table} ADD COLUMN ${o.temporary} TEXT NOT NULL DEFAULT '1'`),this.db.run(`UPDATE ${o.table} SET ${o.temporary} = CAST(${o.column} AS TEXT)`);let c=this.db.prepare(`
          SELECT CAST(id AS TEXT) AS row_id
          FROM ${o.table}
    ...
    `);let s=this.db.prepare("SELECT version, applied_at FROM schema_versions WHERE version = ?").get(47);if(!s){let a=Date.now();this.db.transaction(()=>{this.db.run("DELETE FROM sync_launch_exclusions");for(let{table:u,kind:m}of e)this.db.prepare(`
    ...
    `).run(t,e),t&&this.requeuePromptSync(e)}enqueueMutationOp(e,t){let s=JSON.parse(JSON.stringify(t));if(s.op==="set_prompt_session"){let n=s.target;n?.origin_device_id===null&&(n.origin_device_id="self")}Q(s),this.db.prepare(`
      ...
      VALUES (?, ?, ?, ?)
    `).run((0,be.randomUUID)(),String(e),JSON.stringify(t),Date.now())}requeuePromptSync(e){let t=this.db.prepare(`
    ...
    `).get(e);if(!n)throw new Error(`Session ${e} not found in sdk_sessions`);n.memory_session_id!==t&&(this.db.prepare(`
      ...
      WHERE project IS NOT NULL AND project != ''
        AND project != ?
    `,n=[H];return t&&(s+=" AND COALESCE(platform_source, ?) = ?",n.push(p,t)),s+=" ORDER BY project ASC",this.db.prepare(s).all(...n).map(o=>o.project)}getProjectCatalog(){let e=this.db.prepare(`
      SELECT
    ...
    `).all(H),t=[],s=new Set,n={};for(let o of e){let a=L(o.platform_source);n[a]||(n[a]=[]),n[a].includes(o.project)||n[a].push(o.project),s.has(o.project)||(s.add(o.project),t.push(o.project))}let r=de(Object.keys(n));return{projects:t,sources:r,projectsBySource:Object.fromEntries(r.map(o=>[o,n[o]||[]]))}}getLatestUserPrompt(e,t){let s=this.resolvePromptSessionDbId(e,t),n=s!==null?"up.session_db_id = ?":"up.content_session_id = ?",r=s!==null?s:e;return this.db.prepare(`
      ...
      ORDER BY up.created_at_epoch DESC
      LIMIT 1
    `).get(r)}findRecentDuplicateUserPrompt(e,t,s,n){return _e(this.db,e,P(t),s,this.resolvePromptSessionDbId(e,n)??void 0)}getRecentSessionsWithStatus(e,t=3,s){let n=[e],r="";return s&&(r=`AND COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`,n.push(L(s))),n.push(t),this.db.prepare(`
      SELECT * FROM (
        SELECT
          s.memory_session_id,
          s.status,
    ...
    `).get(e,L(t))||null:this.db.prepare(`
        ...
        FROM observations
        WHERE id = ?
      `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:r,platformSource:o,type:a,concepts:_,files:c}=t,u=s==="relevance",m=u?"":`ORDER BY o.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,T=n&&!u?`LIMIT ${n}`:"",h=e.map(()=>"?").join(","),I=[...e],S=[];if(r&&(S.push("(o.project = ? OR o.merged_into_project = ?)"),I.push(r,r)),o&&(S.push(`COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`),I.push(L(o))),a)if(Array.isArray(a)){let R=a.map(()=>"?").join(",");S.push(`o.type IN (${R})`),I.push(...a)}else S.push("o.type = ?"),I.push(a);if(_){let R=Array.isArray(_)?_:[_],g=R.map(()=>"EXISTS (SELECT 1 FROM json_each(o.concepts) WHERE value = ?)");I.push(...R),S.push(`(${g.join(" OR ")})`)}if(c){let R=Array.isArray(c)?c:[c],g=R.map(()=>"(EXISTS (SELECT 1 FROM json_each(o.files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(o.files_modified) WHERE value LIKE ?))");R.forEach(A=>{I.push(`%${A}%`,`%${A}%`)}),S.push(`(${g.join(" OR ")})`)}let l=S.length>0?`WHERE o.id IN (${h}) AND ${S.join(" AND ")}`:`WHERE o.id IN (${h})`,f=this.db.prepare(`
      SELECT o.*
      FROM observations o
      LEFT JOIN sdk_sessions s ON s.memory_session_id = o.memory_session_id
      ${l}
      ${m}
      ${T}
    `).all(...I);if(!u)return f;let C=new Map(f.map(R=>[R.id,R])),E=e.map(R=>C.get(R)).filter(R=>!!R);return n?E.slice(0,n):E}getSummaryForSession(e,t){let s=[e],n="";return t&&(n=`
        AND EXISTS (
          SELECT 1
    ...
    `).get(...s)||null}getSessionById(e){return this.db.prepare(`
      ...
      WHERE id = ?
      LIMIT 1
    `).get(e)||null}setSessionObservedMetadata(e,t,s){this.db.prepare(`
      UPDATE sdk_sessions
    ...
    `).get(p,_,e);if(u){if(t&&this.db.prepare(`
        ...
        `).run(t,u.id),c&&c!=="[media prompt]"&&this.db.prepare(`
          UPDATE sdk_sessions SET user_prompt = ?
          WHERE id = ? AND (user_prompt IS NULL OR user_prompt = '' OR user_prompt = '[media prompt]')
        `).run(c,u.id),n){let T=this.db.prepare("SELECT custom_title FROM sdk_sessions WHERE id = ?").get(u.id);T&&T.custom_title===null&&(this.db.prepare(`
            UPDATE sdk_sessions SET custom_title = ?
            WHERE id = ? AND custom_title IS NULL
          `).run(n,u.id),this.enqueueSetTitleOp(e,_,n))}return u.id}let m=this.db.prepare(`
      INSERT INTO sdk_sessions
      (content_session_id, memory_session_id, project, platform_source, user_prompt, custom_title, started_at, started_at_epoch, status)
      VALUES (?, NULL, ?, ?, ?, ?, ?, ?, 'active')
    `).run(e,t,_,c,n||null,o.toISOString(),a);return n&&this.enqueueSetTitleOp(e,_,n),Number(m.lastInsertRowid)}enqueueSetTitleOp(e,t,s){let n=this.validateSetTitleMutation(e,t,s);this.enqueueMutationOp("1",n)}validateSetTitleMutation(e,t,s){let n={op:"set_title",target:{content_session_id:e,platform_source:t},fields:{custom_title:s}};return Q(n),n}saveUserPrompt(e,t,s,n){let r=new Date,o=r.getTime(),a=P(s),_=this.resolvePromptSessionDbId(e,n);return this.db.prepare(`
    ...
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,r=0,o,a){let _=this.storeObservations(e,t,[s],null,n,r,o,a);return{id:_.observationIds[0],createdAtEpoch:_.createdAtEpoch}}storeSummary(e,t,s,n,r=0,o){let a=o??Date.now(),_=new Date(a).toISOString(),u=this.db.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,r,_,a);return{id:Number(u.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,r,o=0,a,_){let c=a??Date.now(),u=new Date(c).toISOString();return this.db.transaction(()=>{let T=[],h=this.db.prepare(`
        ...
        RETURNING id
      `),I=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let l of s){if(!l.title&&!l.narrative&&(!l.facts||l.facts.length===0))continue;let N=l.title||(l.narrative?l.narrative.slice(0,100):`${l.type} observation`),f=ae(e,N,l.narrative),C=h.get(e,t,l.type,N,l.subtitle,JSON.stringify(l.facts),l.narrative,JSON.stringify(l.concepts),JSON.stringify(l.files_read),JSON.stringify(l.files_modified),r||null,o,l.agent_type??null,l.agent_id??null,f,u,c,_||null,l.metadata??null);if(C){T.push(C.id);continue}let E=I.get(e,f);if(!E)throw new Error(`storeObservations: ON CONFLICT without existing row for content_hash=${f}`);T.push(E.id)}let S=null;if(n){let N=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,r||null,o,u,c);S=Number(N.lastInsertRowid)}return{observationIds:T,summaryId:S,createdAtEpoch:c}})()}getSessionSummariesByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:r,platformSource:o}=t,a=s==="relevance",_=a?"":`ORDER BY ss.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,c=n&&!a?`LIMIT ${n}`:"",u=e.map(()=>"?").join(","),m=[...e],T=[];r&&(T.push("(ss.project = ? OR ss.merged_into_project = ?)"),m.push(r,r)),o&&(T.push(`COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`),m.push(L(o)));let h=T.length>0?`AND ${T.join(" AND ")}`:"",S=this.db.prepare(`
      SELECT ss.*
      ...
      ${_}
      ${c}
    `).all(...m);if(!a)return S;let l=new Map(S.map(f=>[f.id,f])),N=e.map(f=>l.get(f)).filter(f=>!!f);return n?N.slice(0,n):N}getUserPromptsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:r,platformSource:o}=t,a=s==="relevance",_=a?"":`ORDER BY up.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,c=n&&!a?`LIMIT ${n}`:"",u=e.map(()=>"?").join(","),m=[...e],T=[];r&&(T.push("s.project = ?"),m.push(r)),o&&(T.push(`COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`),m.push(L(o)));let h=T.length>0?`AND ${T.join(" AND ")}`:"",S=this.db.prepare(`
      SELECT
        up.*,
        s.project,
        s.memory_session_id,
      ...
      ${_}
      ${c}
    `).all(...m);if(!a)return S;let l=new Map(S.map(f=>[f.id,f])),N=e.map(f=>l.get(f)).filter(f=>!!f);return n?N.slice(0,n):N}getTimelineAroundTimestamp(e,t=10,s=10,n,r){return this.getTimelineAroundObservation(null,e,t,s,n,r)}getTimelineAroundObservation(e,t,s=10,n=10,r,o){let a=o?L(o):void 0,_=(E,R,g=!1)=>{let A=[],x=[];return r&&(g?(A.push(`(${E}.project = ? OR ${E}.merged_into_project = ?)`),x.push(r,r)):(A.push(`${E}.project = ?`),x.push(r))),a&&(A.push(`COALESCE(NULLIF(${R}.platform_source, ''), '${p}') = ?`),x.push(a)),{clause:A.length>0?`AND ${A.join(" AND ")}`:"",params:x}},c=_("o","src",!0),u=_("ss","src",!0),m=_("s","s"),T,h;if(e!==null){let E=`
      ...
      `,R=`
        ...
        LIMIT ?
      `;try{let g=this.db.prepare(E).all(t,...c.params,s),A=this.db.prepare(R).all(t,...c.params,n+1);if(g.length===0&&A.length===0)return{observations:[],sessions:[],prompts:[]};T=g.length>0?g[g.length-1].created_at_epoch:t,h=A.length>0?A[A.length-1].created_at_epoch:t}catch(g){return g instanceof Error?d.error("DB","Error getting boundary timestamps",{project:r},g):d.error("DB","Error getting boundary timestamps with non-Error",{},new Error(String(g))),{observations:[],sessions:[],prompts:[]}}}let I=`
      SELECT o.*
      FROM observations o
      LEFT JOIN sdk_sessions src ON src.memory_session_id = o.memory_session_id
    ...
    `,N=this.db.prepare(I).all(T,h,...c.params),f=this.db.prepare(S).all(T,h,...u.params),C=this.db.prepare(l).all(T,h,...m.params);return{observations:N,sessions:f.map(E=>({id:E.id,memory_session_id:E.memory_session_id,project:E.project,request:E.request,completed:E.completed,next_steps:E.next_steps,created_at:E.created_at,created_at_epoch:E.created_at_epoch})),prompts:C.map(E=>({id:E.id,content_session_id:E.content_session_id,prompt_number:E.prompt_number,prompt_text:E.prompt_text,project:E.project,platform_source:E.platform_source,created_at:E.created_at,created_at_epoch:E.created_at_epoch}))}}getOrCreateManualSession(e,t=p){let s=`manual-${e}`,n=`manual-content-${e}`;if(this.db.prepare("SELECT memory_session_id FROM sdk_sessions WHERE memory_session_id = ?").get(s))return t&&t!==p&&this.db.prepare("UPDATE sdk_sessions SET platform_source = ? WHERE memory_session_id = ?").run(t,s),s;let o=new Date;return this.db.prepare(`
      INSERT INTO sdk_sessions (memory_session_id, content_session_id, project, platform_source, started_at, started_at_epoch, status)
      VALUES (?, ?, ?, ?, ?, ?, 'active')
    `).run(s,n,e,p,o.toISOString(),o.getTime()),d.info("SESSION","Created manual session",{memorySessionId:s,project:e}),s}close(){this.db.close()}importSdkSession(e){let t=L(e.platform_source),s=this.db.prepare(`SELECT id FROM sdk_sessions
