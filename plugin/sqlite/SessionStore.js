...
"use strict";var M=Object.defineProperty;var ie=Object.getOwnPropertyDescriptor;var ae=Object.getOwnPropertyNames;var de=Object.prototype.hasOwnProperty;var _e=(a,e)=>{for(var s in e)M(a,s,{get:e[s],enumerable:!0})},Ee=(a,e,s,t)=>{if(e&&typeof e=="object"||typeof e=="function")for(let r of ae(e))!de.call(a,r)&&r!==s&&M(a,r,{get:()=>e[r],enumerable:!(t=ie(e,r))||t.enumerable});return a};var pe=a=>Ee(M({},"__esModule",{value:!0}),a);var Ae={};_e(Ae,{SessionStore:()=>$});module.exports=pe(Ae);var oe=require("bun:sqlite");var T=require("path"),F=require("os"),D=require("fs"),W=require("url");function y(a){return a.charCodeAt(0)===65279?a.slice(1):a}function ue(){return typeof __dirname<"u"?__dirname:(0,T.dirname)((0,W.fileURLToPath)(__IMPORT_META_URL__))}var ye=ue();function me(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let a=(0,T.join)((0,F.homedir)(),".claude-mem"),e=(0,T.join)(a,"settings.json");try{if((0,D.existsSync)(e)){let s=JSON.parse(y((0,D.readFileSync)(e,"utf-8"))),t=s.env??s;if(t.CLAUDE_MEM_DATA_DIR)return t.CLAUDE_MEM_DATA_DIR}}catch{}return a}var g=me(),le=process.env.CLAUDE_CONFIG_DIR||(0,T.join)((0,F.homedir)(),".claude"),Ue=(0,T.join)(le,"plugins","marketplaces","thedotmack"),ce=(0,T.join)(g,"logs"),Me=(0,T.join)(g,"settings.json"),j=(0,T.join)(g,"claude-mem.db"),Te=(0,T.join)(g,"observer-sessions"),x=(0,T.basename)(Te);function q(a){(0,D.mkdirSync)(a,{recursive:!0})}var k={dataDir:()=>g,workerPid:()=>(0,T.join)(g,"worker.pid"),serverPid:()=>(0,T.join)(g,".server-beta.pid"),serverPort:()=>(0,T.join)(g,".server-beta.port"),serverRuntime:()=>(0,T.join)(g,".server-beta.runtime.json"),settings:()=>(0,T.join)(g,"settings.json"),database:()=>(0,T.join)(g,"claude-mem.db"),chroma:()=>(0,T.join)(g,"chroma"),combinedCerts:()=>(0,T.join)(g,"combined_certs.pem"),transcriptsConfig:()=>(0,T.join)(g,"transcript-watch.json"),transcriptsState:()=>(0,T.join)(g,"transcript-watch-state.json"),corpora:()=>(0,T.join)(g,"corpora"),supervisorRegistry:()=>(0,T.join)(g,"supervisor.json"),envFile:()=>(0,T.join)(g,".env"),logsDir:()=>ce};var C=require("fs"),V=require("path");var be=null;function Re(a){return(be??process.stderr.write.bind(process.stderr))(a)}function w(a){Re(a)}var G=(n=>(n[n.DEBUG=0]="DEBUG",n[n.INFO=1]="INFO",n[n.WARN=2]="WARN",n[n.ERROR=3]="ERROR",n[n.SILENT=4]="SILENT",n))(G||{}),X=null,P=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=k.logsDir();(0,C.existsSync)(e)||(0,C.mkdirSync)(e,{recursive:!0});let s=new Date().toISOString().split("T")[0];this.logFilePath=(0,V.join)(e,`claude-mem-${s}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=k.settings();if((0,C.existsSync)(e)){let s=(0,C.readFileSync)(e,"utf-8"),r=(JSON.parse(y(s)).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=G[r]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`)}debug(e,s,t,r){this.log(0,e,s,t,r)}info(e,s,t,r){this.log(1,e,s,t,r)}warn(e,s,t,r){this.log(2,e,s,t,r)}setErrorSink(e){X=e}error(e,s,t,r){this.log(3,e,s,t,r),this.routeErrorToSink(s,t,r)}routeErrorToSink(e,s,t){try{if(!X||!(t instanceof Error))return;X(t)}catch{}}dataIn(e,s,t,r){this.info(e,`\u2192 ${s}`,t,r)}dataOut(e,s,t,r){this.info(e,`\u2190 ${s}`,t,r)}success(e,s,t,r){this.info(e,`\u2713 ${s}`,t,r)}failure(e,s,t,r){this.error(e,`\u2717 ${s}`,t,r)}},d=new P;var Y=require("crypto");function K(a,e,s){return(0,Y.createHash)("sha256").update([a||"",e||"",s||""].join("\0")).digest("hex").slice(0,16)}var p="claude";function Ne(a){return a.trim().toLowerCase().replace(/\s+/g,"-")}function A(a){if(!a)return p;let e=Ne(a);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:p}function Q(a){let e=["claude","codex","cursor"];return[...a].sort((s,t)=>{let r=e.indexOf(s),n=e.indexOf(t);return r!==-1||n!==-1?r===-1?1:n===-1?-1:r-n:s.localeCompare(t)})}function J(a,e,s,t,r){let n=Date.now()-t,o=r!==void 0?"up.session_db_id = ?":"up.content_session_id = ?",i=r??e;return a.prepare(`
  ...
  `).get(i,s,n)??void 0}var ee=["private","claude-mem-context","system_instruction","system-instruction","persisted-output","system-reminder"],z=new RegExp(`<(${ee.join("|")})\\b[^>]*>[\\s\\S]*?</\\1>`,"g");var Z=100;function Se(a){let e=Object.fromEntries(ee.map(r=>[r,0]));z.lastIndex=0;let s=0,t=a.replace(z,(r,n)=>(e[n]=(e[n]??0)+1,s+=1,""));return s>Z&&d.warn("SYSTEM","tag count exceeds limit",void 0,{tagCount:s,maxAllowed:Z,contentLength:a.length}),{stripped:t.trim(),counts:e}}function se(a){return Se(a).stripped}var Ie=["task-notification"],je=new RegExp(`^\\s*<(${Ie.join("|")})\\b[^>]*>(?:(?!<\\1\\b|</\\1\\b)[\\s\\S])*</\\1>\\s*$`),qe=256*1024;var B=4e3;function U(a){let e=a.trim(),t=se(a).trim()||e;return t.length<=B?t:(d.debug("DB","Truncated stored prompt text to the configured cap",{originalLength:t.length,storedLength:B}),`${t.slice(0,B-1)}\u2026`)}var te=require("bun:sqlite"),re=require("node:path");var he=5e3;function Oe(a){a!==":memory:"&&q((0,re.dirname)(a))}function H(a){a.run(`PRAGMA busy_timeout = ${he}`)}function ge(a){let{tableCount:e}=a.query("SELECT COUNT(*) AS tableCount FROM sqlite_master WHERE type = 'table'").get(),{page_count:s}=a.query("PRAGMA page_count").get();return e>0||s>1?!1:(a.run("PRAGMA auto_vacuum = INCREMENTAL"),!0)}function fe(a){H(a),a.run("PRAGMA journal_mode = WAL"),a.run("PRAGMA synchronous = NORMAL"),a.run("PRAGMA foreign_keys = ON"),a.run("PRAGMA journal_size_limit = 4194304")}function ne(a){Oe(a);let e=new te.Database(a);return ge(e),fe(e),e}var $=class{db;constructor(e=j){e instanceof oe.Database?(this.db=e,H(this.db)):this.db=ne(e),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn(),this.ensureSDKSessionsPlatformContentIdentity(),this.ensureUserPromptsSessionDbId(),this.ensurePendingMessagesSessionToolUniqueIndex(),this.addObservationContentSessionIdColumns(),this.createObservationFeedbackTable()}getIndexColumns(e){return this.db.query(`PRAGMA index_info(${JSON.stringify(e)})`).all().map(s=>s.name)}hasUniqueIndexOnColumns(e,s){return this.db.query(`PRAGMA index_list(${e})`).all().some(r=>{if(r.unique!==1)return!1;let n=this.getIndexColumns(r.name);return n.length===s.length&&n.every((o,i)=>o===s[i])})}resolvePromptSessionDbId(e,s,t){if(s!==void 0)return s;let r=t?A(t):void 0;return r?this.db.prepare(`
    ...
    `).get(e,A(s))||null:this.db.prepare(`
        ...
        FROM observations
        WHERE id = ?
      `).get(e)||null}getObservationsByIds(e,s={}){if(e.length===0)return[];let{orderBy:t="date_desc",limit:r,project:n,platformSource:o,type:i,concepts:E,files:_}=s,u=t==="relevance",b=u?"":`ORDER BY o.created_at_epoch ${t==="date_asc"?"ASC":"DESC"}`,R=r&&!u?`LIMIT ${r}`:"",N=e.map(()=>"?").join(","),h=[...e],S=[];if(n&&(S.push("o.project = ?"),h.push(n)),o&&(S.push(`COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`),h.push(A(o))),i)if(Array.isArray(i)){let I=i.map(()=>"?").join(",");S.push(`o.type IN (${I})`),h.push(...i)}else S.push("o.type = ?"),h.push(i);if(E){let I=Array.isArray(E)?E:[E],c=I.map(()=>"EXISTS (SELECT 1 FROM json_each(o.concepts) WHERE value = ?)");h.push(...I),S.push(`(${c.join(" OR ")})`)}if(_){let I=Array.isArray(_)?_:[_],c=I.map(()=>"(EXISTS (SELECT 1 FROM json_each(o.files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(o.files_modified) WHERE value LIKE ?))");I.forEach(f=>{h.push(`%${f}%`,`%${f}%`)}),S.push(`(${c.join(" OR ")})`)}let L=S.length>0?`WHERE o.id IN (${N}) AND ${S.join(" AND ")}`:`WHERE o.id IN (${N})`,O=this.db.prepare(`
      SELECT o.*
      FROM observations o
      LEFT JOIN sdk_sessions s ON s.memory_session_id = o.memory_session_id
      ${L}
      ${b}
      ${R}
    `).all(...h);if(!u)return O;let v=new Map(O.map(I=>[I.id,I])),l=e.map(I=>v.get(I)).filter(I=>!!I);return r?l.slice(0,r):l}dismissObservation(e,s){let t=typeof s=="string"?s.trim():"",r=t?JSON.stringify({reason:t}):null;this.db.prepare(`
    ...
    `).run(e)}isDismissed(e){return this.db.prepare(`
      ...
      WHERE observation_id = ? AND signal_type = 'dismissed'
      LIMIT 1
    `).get(e)!=null}getSummaryForSession(e,s){let t=[e],r="";return s&&(r=`
        AND EXISTS (
          SELECT 1
    ...
    `).get(e).count}createSDKSession(e,s,t,r,n){let o=new Date,i=o.getTime(),E=n?A(n):p,_=U(t),u=this.db.prepare(`
    ...
    `).get(p,E,e);if(u)return s&&this.db.prepare(`
        ...
        `).run(r,u.id),u.id;let b=this.db.prepare(`
      INSERT INTO sdk_sessions
      (content_session_id, memory_session_id, project, platform_source, user_prompt, custom_title, started_at, started_at_epoch, status)
      VALUES (?, NULL, ?, ?, ?, ?, ?, ?, 'active')
    `).run(e,s,E,_,r||null,o.toISOString(),i);return Number(b.lastInsertRowid)}saveUserPrompt(e,s,t,r){let n=new Date,o=n.getTime(),i=U(t),E=this.resolvePromptSessionDbId(e,r);return this.db.prepare(`
    ...
    `).run(E,e,s,i,n.toISOString(),o).lastInsertRowid}getUserPrompt(e,s,t){let r=this.resolvePromptSessionDbId(e,t);return r!==null?this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,s)?.prompt_text??null}storeObservation(e,s,t,r,n=0,o,i,E){let _=this.storeObservations(e,s,[t],null,r,n,o,i,E);return{id:_.observationIds[0],createdAtEpoch:_.createdAtEpoch}}storeSummary(e,s,t,r,n=0,o,i){let E=o??Date.now(),_=new Date(E).toISOString(),b=this.db.prepare(`
      INSERT INTO session_summaries
      (memory_session_id, project, request, investigated, learned, completed,
       next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch,
       content_session_id)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,s,t.request,t.investigated,t.learned,t.completed,t.next_steps,t.notes,r||null,n,_,E,i??null);return{id:Number(b.lastInsertRowid),createdAtEpoch:E}}storeObservations(e,s,t,r,n,o=0,i,E,_){let u=i??Date.now(),b=new Date(u).toISOString();return this.db.transaction(()=>{let N=[],h=this.db.prepare(`
        ...
        RETURNING id
      `),S=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let m of t){let O=K(e,m.title,m.narrative),v=h.get(e,s,m.type,m.title,m.subtitle,JSON.stringify(m.facts),m.narrative,JSON.stringify(m.concepts),JSON.stringify(m.files_read),JSON.stringify(m.files_modified),n||null,o,m.agent_type??null,m.agent_id??null,O,b,u,E||null,m.metadata??null,_??null);if(v){N.push(v.id);continue}let l=S.get(e,O);if(!l)throw new Error(`storeObservations: ON CONFLICT without existing row for content_hash=${O}`);N.push(l.id)}let L=null;if(r){let O=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch,
           content_session_id)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,s,r.request,r.investigated,r.learned,r.completed,r.next_steps,r.notes,n||null,o,b,u,_??null);L=Number(O.lastInsertRowid)}return{observationIds:N,summaryId:L,createdAtEpoch:u}})()}getSessionSummariesByIds(e,s={}){if(e.length===0)return[];let{orderBy:t="date_desc",limit:r,project:n,platformSource:o}=s,i=t==="relevance",E=i?"":`ORDER BY ss.created_at_epoch ${t==="date_asc"?"ASC":"DESC"}`,_=r&&!i?`LIMIT ${r}`:"",u=e.map(()=>"?").join(","),b=[...e],R=[];n&&(R.push("ss.project = ?"),b.push(n)),o&&(R.push(`COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`),b.push(A(o)));let N=R.length>0?`AND ${R.join(" AND ")}`:"",S=this.db.prepare(`
      SELECT ss.*
      ...
      ${E}
      ${_}
    `).all(...b);if(!i)return S;let L=new Map(S.map(O=>[O.id,O])),m=e.map(O=>L.get(O)).filter(O=>!!O);return r?m.slice(0,r):m}getUserPromptsByIds(e,s={}){if(e.length===0)return[];let{orderBy:t="date_desc",limit:r,project:n,platformSource:o}=s,i=t==="relevance",E=i?"":`ORDER BY up.created_at_epoch ${t==="date_asc"?"ASC":"DESC"}`,_=r?`LIMIT ${r}`:"",u=e.map(()=>"?").join(","),b=[...e],R=[];n&&(R.push("s.project = ?"),b.push(n)),o&&(R.push(`COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`),b.push(A(o)));let N=R.length>0?`AND ${R.join(" AND ")}`:"",S=this.db.prepare(`
      SELECT
        up.*,
        s.project,
        s.memory_session_id,
      ...
      ${E}
      ${_}
    `).all(...b);if(!i)return S;let L=new Map(S.map(m=>[m.id,m]));return e.map(m=>L.get(m)).filter(m=>!!m)}getTimelineAroundTimestamp(e,s=10,t=10,r,n){return this.getTimelineAroundObservation(null,e,s,t,r,n)}getTimelineAroundObservation(e,s,t=10,r=10,n,o){let i=o?A(o):void 0,E=(l,I)=>{let c=[],f=[];return n&&(c.push(`${l}.project = ?`),f.push(n)),i&&(c.push(`COALESCE(NULLIF(${I}.platform_source, ''), '${p}') = ?`),f.push(i)),{clause:c.length>0?`AND ${c.join(" AND ")}`:"",params:f}},_=E("o","src"),u=E("ss","src"),b=E("s","s"),R,N;if(e!==null){let l=`
