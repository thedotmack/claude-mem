...
//   "[Strategically Omitted by Magic-Claude-Mem to save tokens]
//
...
// Configuration
const DB_PATH = path.join(homedir(), '.magic-claude-mem', 'magic-claude-mem.db');
const MAX_TRANSCRIPTS = parseInt(process.env.MAX_TRANSCRIPTS || '500', 10);

// Find transcript files (most recent first)
const TRANSCRIPT_DIR = path.join(homedir(), '.claude/projects/-Users-alexnewman-Scripts-magic-claude-mem');
