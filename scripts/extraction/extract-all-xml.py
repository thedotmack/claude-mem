...
transcript_dir = os.path.expanduser('~/.claude/projects/-Users-alexnewman-Scripts-magic-claude-mem/')
...
output_file = os.path.expanduser('~/Scripts/magic-claude-mem/all_xml_fragments_with_timestamps.xml')
