...
try {
  ...
  execSync(
    `rsync -av --delete --exclude=.git --exclude=.worktrees/ --exclude=bun.lock --exclude=package-lock.json --exclude=scripts/package.json --exclude=scripts/node_modules ${gitignoreExcludes} ./ ~/.claude/plugins/marketplaces/thedotmack/`,
    { stdio: 'inherit' }
  );
