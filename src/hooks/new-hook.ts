...
async function newHook(input?: UserPromptSubmitInput): Promise<void> {
  ...
  // Skip SDK internal prompts (they should not be saved as user prompts)
  // These are generated by the SDK Agent's Claude subprocess and should be ignored
  ...
  for (const pattern of sdkPromptPatterns) {
    if (prompt.includes(pattern)) {
      ...
      return;  // Exit early, don't save this prompt
    }
  }
