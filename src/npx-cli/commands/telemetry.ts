...
const COLLECTED_FIELDS = [
  ...
  'invalid_output_class   closed parser reason such as idle / transport / xml_drift / prose (never the output)',
  'consecutive_invalid_outputs   bounded retry counter for one claimed batch',
  'respawn_triggered      legacy recovery flag for old invalid-output restarts',
  'abort_reason     idle / shutdown / overflow / restart_guard / auth / quota / output_retry / output_paused / storage_paused / none',
