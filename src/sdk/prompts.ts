...
Return either one or more <observation>...</observation> blocks, or a single self-closing <skip_summary reason="..."/> tag if this tool use should be skipped.
An empty response is still accepted as a skip, but it carries no reason and is indistinguishable from a dropped turn in the worker logs.
