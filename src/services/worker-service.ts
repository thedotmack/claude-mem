...
import { OrcaRouterProvider, isOrcaRouterSelected, isOrcaRouterAvailable } from './worker/OrcaRouterProvider.js';
...
export class WorkerService implements WorkerRef {
  ...
  private orcaRouterAgent: OrcaRouterProvider;
  ...
  constructor() {
    ...
    this.orcaRouterAgent = new OrcaRouterProvider(this.dbManager, this.sessionManager);
    ...
    this.server = new Server({
      ...
      getAiStatus: () => {
        let provider = 'claude';
        if (isOrcaRouterSelected() && isOrcaRouterAvailable()) provider = 'orcarouter';
  ...
  private registerRoutes(): void {
    ...
    const sessionRoutes = new SessionRoutes(this.sessionManager, this.dbManager, this.sdkAgent, this.geminiAgent, this.openRouterAgent, this.orcaRouterAgent, this.sessionEventBroadcaster, this, this.completionHandler);
