...
import { AimlapiProvider, isAimlapiSelected, isAimlapiAvailable } from './worker/AimlapiProvider.js';
...
export class WorkerService implements WorkerRef {
  ...
  private aimlapiAgent: AimlapiProvider;
  ...
  constructor() {
    ...
    this.aimlapiAgent = new AimlapiProvider(this.dbManager, this.sessionManager);
    ...
    this.server = new Server({
      ...
      getAiStatus: () => {
        let provider = 'claude';
        if (isAimlapiSelected() && isAimlapiAvailable()) provider = 'aimlapi';
  ...
  private registerRoutes(): void {
    ...
    const sessionRoutes = new SessionRoutes(this.sessionManager, this.dbManager, this.sdkAgent, this.geminiAgent, this.openRouterAgent, this.aimlapiAgent, this.sessionEventBroadcaster, this, this.completionHandler);
