...
import { MiniMaxProvider, isMiniMaxSelected, isMiniMaxAvailable } from './worker/MiniMaxProvider.js';
...
export class WorkerService implements WorkerRef {
  ...
  private miniMaxAgent: MiniMaxProvider;
  ...
  constructor() {
    ...
    this.miniMaxAgent = new MiniMaxProvider(this.dbManager, this.sessionManager);
    ...
    this.server = new Server({
      ...
      getAiStatus: () => {
        let provider = 'claude';
        if (isMiniMaxSelected() && isMiniMaxAvailable()) provider = 'minimax';
  ...
  private registerRoutes(): void {
    ...
    const sessionRoutes = new SessionRoutes(this.sessionManager, this.dbManager, this.sdkAgent, this.geminiAgent, this.openRouterAgent, this.miniMaxAgent, this.sessionEventBroadcaster, this, this.completionHandler);
