...
import { GenericCliProvider, isGenericCliSelected, isGenericCliAvailable } from './worker/GenericCliProvider.js';
...
export class WorkerService implements WorkerRef {
  ...
  constructor() {
    ...
    this.genericCliAgent = new GenericCliProvider(this.dbManager, this.sessionManager);
    ...
    this.server = new Server({
      ...
      getAiStatus: () => {
        ...
        else if (isGenericCliSelected() && isGenericCliAvailable()) provider = 'generic-cli';
        return {
          provider,
  ...
  private registerRoutes(): void {
    ...
    const sessionRoutes = new SessionRoutes(this.sessionManager, this.dbManager, this.sdkAgent, this.geminiAgent, this.openRouterAgent, this.genericCliAgent, this.sessionEventBroadcaster, this, this.completionHandler);
