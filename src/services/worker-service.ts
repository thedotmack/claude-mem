...
import { OpenCodeProvider } from './worker/OpenCodeProvider.js';
...
export class WorkerService implements WorkerRef {
  ...
  private registerRoutes(): void {
    ...
    const sessionRoutes = new SessionRoutes(this.sessionManager, this.dbManager, this.sdkAgent, this.geminiAgent, this.openRouterAgent, this.sessionEventBroadcaster, this, this.completionHandler, this.openCodeAgent);
