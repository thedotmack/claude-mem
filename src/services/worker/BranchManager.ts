 ...
 * The installed plugin at ~/.claude/plugins/marketplaces/doublefx/ is a git repo.
 */
...
const INSTALLED_PLUGIN_PATH = join(homedir(), '.claude', 'plugins', 'marketplaces', 'doublefx');
