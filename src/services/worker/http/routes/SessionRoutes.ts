...
import { AimlapiProvider, isAimlapiSelected, isAimlapiAvailable } from '../../AimlapiProvider.js';
...
export class SessionRoutes extends BaseRouteHandler {
  ...
  private getSelectedProvider(): 'claude' | 'gemini' | 'openrouter' | 'aimlapi' {
    if (isAimlapiSelected() && isAimlapiAvailable()) {
      return 'aimlapi';
    }
