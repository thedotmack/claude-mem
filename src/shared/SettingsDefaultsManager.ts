...
export interface SettingsDefaults {
  ...
  CLAUDE_MEM_OPENAI_CODEX_MODEL: string;
  CLAUDE_MEM_OPENAI_CODEX_MAX_CONTEXT_MESSAGES: string;
  CLAUDE_MEM_OPENAI_CODEX_MAX_TOKENS: string;
...
export class SettingsDefaultsManager {
  private static readonly DEFAULTS: SettingsDefaults = {
    ...
    CLAUDE_MEM_OPENAI_CODEX_MODEL: 'gpt-5.4-mini',  // Default OpenAI Codex OAuth model
    CLAUDE_MEM_OPENAI_CODEX_MAX_CONTEXT_MESSAGES: '20',  // Max messages in context window
    CLAUDE_MEM_OPENAI_CODEX_MAX_TOKENS: '100000',  // Max estimated tokens (~100k safety limit)
