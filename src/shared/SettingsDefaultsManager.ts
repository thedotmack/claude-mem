...
export interface SettingsDefaults {
  ...
  CLAUDE_MEM_CONTEXT_SHOW_DIRECTIVES: string;
  CLAUDE_MEM_CONTEXT_DIRECTIVES_MAX: string;
...
export class SettingsDefaultsManager {
  private static readonly DEFAULTS: SettingsDefaults = {
    ...
    CLAUDE_MEM_CONTEXT_SHOW_DIRECTIVES: 'true',
    CLAUDE_MEM_CONTEXT_DIRECTIVES_MAX: '25',
