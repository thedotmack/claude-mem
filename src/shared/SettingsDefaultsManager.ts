...
export interface SettingsDefaults {
  ...
  CLAUDE_MEM_EAT_MODEL: string;
  CLAUDE_MEM_EAT_MAX_CHUNK_CHARS: string;
  CLAUDE_MEM_EAT_FETCH_TIMEOUT_MS: string;
  ...
  // Automatic local DB snapshots (BackupManager). Opt-in via ENABLED.
  CLAUDE_MEM_BACKUP_ENABLED: string;
...
export class SettingsDefaultsManager {
  private static readonly DEFAULTS: SettingsDefaults = {
    ...
    CLAUDE_MEM_EAT_MODEL: 'anthropic/claude-haiku-4.5',  // OpenRouter slug used by the EAT ingester's digest step
    CLAUDE_MEM_EAT_MAX_CHUNK_CHARS: '12000',  // Max chars per EAT chunk (stays under the 16k prompt-field precedent)
    CLAUDE_MEM_EAT_FETCH_TIMEOUT_MS: '30000',  // Timeout for EAT URL/feed fetches
    ...
    // Automatic local DB snapshots (BackupManager). Off by default; opt-in.
