...
export interface SettingsDefaults {
  ...
  CLAUDE_MEM_OPENROUTER_API_URL: string;  // Custom OpenAI-compatible API base URL
...
export class SettingsDefaultsManager {
  ...
  private static readonly DEFAULTS: SettingsDefaults = {
    ...
    CLAUDE_MEM_OPENROUTER_API_URL: '',  // Custom OpenAI-compatible API base URL (e.g. http://localhost:8080/v1)
