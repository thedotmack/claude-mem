...
export interface SettingsDefaults {
  ...
  CLAUDE_MEM_PROVIDER: string;  // 'claude' | 'gemini' | 'openrouter' | 'docker-model-runner'
  ...
  CLAUDE_MEM_DOCKER_MODEL_RUNNER_MODEL: string;
  CLAUDE_MEM_DOCKER_MODEL_RUNNER_PORT: string;
  CLAUDE_MEM_DOCKER_MODEL_RUNNER_MAX_CONTEXT_MESSAGES: string;
  CLAUDE_MEM_DOCKER_MODEL_RUNNER_MAX_TOKENS: string;
...
export class SettingsDefaultsManager {
  ...
  private static readonly DEFAULTS: SettingsDefaults = {
    ...
    CLAUDE_MEM_DOCKER_MODEL_RUNNER_MODEL: 'ai/gemma4',  // Default Docker Model Runner model
    CLAUDE_MEM_DOCKER_MODEL_RUNNER_PORT: '12434',  // Default Docker Model Runner port
    CLAUDE_MEM_DOCKER_MODEL_RUNNER_MAX_CONTEXT_MESSAGES: '20',  // Max messages in context window
    CLAUDE_MEM_DOCKER_MODEL_RUNNER_MAX_TOKENS: '4096',  // 4K tokens max context
    // System Configuration
