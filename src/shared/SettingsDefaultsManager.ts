...
export interface SettingsDefaults {
  ...
  CLAUDE_MEM_CHROMA_CONNECT_TIMEOUT_MS: string;
...
export class SettingsDefaultsManager {
  private static readonly DEFAULTS: SettingsDefaults = {
    ...
    CLAUDE_MEM_AGY_CLI_MODEL: '',  // Empty = use the Antigravity CLI default model
    CLAUDE_MEM_AGY_CLI_PATH: '',  // Empty = auto-detect via 'which agy' or ~/.local/bin/agy
    CLAUDE_MEM_AGY_CLI_TIMEOUT_MS: '300000',  // Per-turn timeout for agy CLI subprocesses (ms)
    ...
    CLAUDE_MEM_ALLOW_DISMISS: 'false',               // Gate the observation dismiss/undismiss WRITE endpoints (reversible hide-from-surfacing). Read-side filter is unconditional. Disabled by default.
    ...
    CLAUDE_MEM_CHROMA_CONNECT_TIMEOUT_MS: '60000',
    CLAUDE_MEM_CHROMA_PREWARM_TIMEOUT_MS: '300000',
