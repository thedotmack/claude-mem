...
export class SettingsDefaultsManager {
  private static readonly DEFAULTS: SettingsDefaults = {
    ...
    CLAUDE_MEM_CODEX_REASONING_EFFORT: 'low',  // Valid: none, minimal, low, medium, high, xhigh
    CLAUDE_MEM_CODEX_MAX_CONTEXT_MESSAGES: '20',  // Legacy setting; shared observer recycling now owns history
    CLAUDE_MEM_CODEX_MAX_TOKENS: '100000',  // Max estimated tokens (~100k safety limit)
    CLAUDE_MEM_CODEX_TIMEOUT_MS: '120000',  // Per Codex app-server attempt timeout
    CLAUDE_MEM_CODEX_MAX_OBSERVATIONS_PER_PROMPT: '6',  // Legacy setting; no longer limits observation capture
