export const HOOK_TIMEOUTS = {
  ...
  POST_SPAWN_WAIT: 15000,     // Wait for daemon to start after spawn. The budget predates the in-process vector index and has not been re-measured since; it is headroom, not a target.
