    ...
    authFetch(API_ENDPOINTS.SETTINGS)
      ...
      .then(data => {
        setSettings({
          ...
          CLAUDE_MEM_OPENAI_CODEX_MODEL: data.CLAUDE_MEM_OPENAI_CODEX_MODEL ?? DEFAULT_SETTINGS.CLAUDE_MEM_OPENAI_CODEX_MODEL,
          CLAUDE_MEM_OPENAI_CODEX_MAX_CONTEXT_MESSAGES: data.CLAUDE_MEM_OPENAI_CODEX_MAX_CONTEXT_MESSAGES ?? DEFAULT_SETTINGS.CLAUDE_MEM_OPENAI_CODEX_MAX_CONTEXT_MESSAGES,
          CLAUDE_MEM_OPENAI_CODEX_MAX_TOKENS: data.CLAUDE_MEM_OPENAI_CODEX_MAX_TOKENS ?? DEFAULT_SETTINGS.CLAUDE_MEM_OPENAI_CODEX_MAX_TOKENS,
