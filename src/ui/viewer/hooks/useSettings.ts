    ...
    fetch(API_ENDPOINTS.SETTINGS)
      ...
      .then(data => {
        ...
        setSettings({
          ...
          CLAUDE_MEM_DOCKER_MODEL_RUNNER_MODEL: data.CLAUDE_MEM_DOCKER_MODEL_RUNNER_MODEL ?? DEFAULT_SETTINGS.CLAUDE_MEM_DOCKER_MODEL_RUNNER_MODEL,
          CLAUDE_MEM_DOCKER_MODEL_RUNNER_PORT: data.CLAUDE_MEM_DOCKER_MODEL_RUNNER_PORT ?? DEFAULT_SETTINGS.CLAUDE_MEM_DOCKER_MODEL_RUNNER_PORT,
          CLAUDE_MEM_DOCKER_MODEL_RUNNER_MAX_TOKENS: data.CLAUDE_MEM_DOCKER_MODEL_RUNNER_MAX_TOKENS ?? DEFAULT_SETTINGS.CLAUDE_MEM_DOCKER_MODEL_RUNNER_MAX_TOKENS,
