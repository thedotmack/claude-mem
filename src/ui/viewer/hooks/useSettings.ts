    ...
    authFetch(API_ENDPOINTS.SETTINGS)
      ...
      .then(data => {
        setSettings({
          ...
          CLAUDE_MEM_CODEX_PATH: data.CLAUDE_MEM_CODEX_PATH ?? DEFAULT_SETTINGS.CLAUDE_MEM_CODEX_PATH,
          ...
          CLAUDE_MEM_CODEX_MAX_CONTEXT_MESSAGES: data.CLAUDE_MEM_CODEX_MAX_CONTEXT_MESSAGES ?? DEFAULT_SETTINGS.CLAUDE_MEM_CODEX_MAX_CONTEXT_MESSAGES,
          CLAUDE_MEM_CODEX_MAX_TOKENS: data.CLAUDE_MEM_CODEX_MAX_TOKENS ?? DEFAULT_SETTINGS.CLAUDE_MEM_CODEX_MAX_TOKENS,
          CLAUDE_MEM_CODEX_TIMEOUT_MS: data.CLAUDE_MEM_CODEX_TIMEOUT_MS ?? DEFAULT_SETTINGS.CLAUDE_MEM_CODEX_TIMEOUT_MS,
