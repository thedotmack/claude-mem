    ...
    fetch(API_ENDPOINTS.SETTINGS)
      ...
      .then(data => {
        setSettings({
          ...
          CLAUDE_MEM_OPENCODE_BASE_URL: data.CLAUDE_MEM_OPENCODE_BASE_URL || DEFAULT_SETTINGS.CLAUDE_MEM_OPENCODE_BASE_URL,
          CLAUDE_MEM_OPENCODE_MODE: data.CLAUDE_MEM_OPENCODE_MODE || DEFAULT_SETTINGS.CLAUDE_MEM_OPENCODE_MODE,
