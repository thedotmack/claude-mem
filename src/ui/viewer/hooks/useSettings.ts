    ...
    fetch(API_ENDPOINTS.SETTINGS)
      ...
      .then(data => {
        ...
        setSettings({
          ...
          CLAUDE_MEM_OLLAMA_TEMPERATURE: data.CLAUDE_MEM_OLLAMA_TEMPERATURE ?? DEFAULT_SETTINGS.CLAUDE_MEM_OLLAMA_TEMPERATURE,
          CLAUDE_MEM_OLLAMA_MAX_CONTEXT_MESSAGES: data.CLAUDE_MEM_OLLAMA_MAX_CONTEXT_MESSAGES ?? DEFAULT_SETTINGS.CLAUDE_MEM_OLLAMA_MAX_CONTEXT_MESSAGES,
          CLAUDE_MEM_OLLAMA_MAX_TOKENS: data.CLAUDE_MEM_OLLAMA_MAX_TOKENS ?? DEFAULT_SETTINGS.CLAUDE_MEM_OLLAMA_MAX_TOKENS,
          CLAUDE_MEM_OLLAMA_FALLBACK_TO_CLAUDE: data.CLAUDE_MEM_OLLAMA_FALLBACK_TO_CLAUDE ?? DEFAULT_SETTINGS.CLAUDE_MEM_OLLAMA_FALLBACK_TO_CLAUDE,
