    ...
    fetch(API_ENDPOINTS.SETTINGS)
      ...
      .then(data => {
        setSettings({
          ...
          CLAUDE_MEM_OPENAI_COMPATIBLE_PROFILES: data.CLAUDE_MEM_OPENAI_COMPATIBLE_PROFILES || DEFAULT_SETTINGS.CLAUDE_MEM_OPENAI_COMPATIBLE_PROFILES,
          CLAUDE_MEM_OPENAI_COMPATIBLE_ACTIVE_PROFILE: data.CLAUDE_MEM_OPENAI_COMPATIBLE_ACTIVE_PROFILE || DEFAULT_SETTINGS.CLAUDE_MEM_OPENAI_COMPATIBLE_ACTIVE_PROFILE,
