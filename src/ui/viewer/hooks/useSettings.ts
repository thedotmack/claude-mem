    ...
    fetch(API_ENDPOINTS.SETTINGS)
      ...
      .then(data => {
        setSettings({
          ...
          // GLM Configuration
          CLAUDE_MEM_GLM_API_KEY: data.CLAUDE_MEM_GLM_API_KEY || DEFAULT_SETTINGS.CLAUDE_MEM_GLM_API_KEY,
          CLAUDE_MEM_GLM_MODEL: data.CLAUDE_MEM_GLM_MODEL || DEFAULT_SETTINGS.CLAUDE_MEM_GLM_MODEL,
